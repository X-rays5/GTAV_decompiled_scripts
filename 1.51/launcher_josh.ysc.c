void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_306(&(Global_110725[Var0].f_9));
			}
		}
		func_289(&Var0, 1);
	}
	...
	else if (Var0 == 30)
	{
		...
		iLocal_262 = unk_0x1C0640BA9A7327B3();
	}
	while (true)
	{
		wait(0);
...
void func_192()
{
	...
	{
		case 0:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
...
{
	if ((((func_205(unk_0x16F2683693E537C9()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_217(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_232(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_37[iVar4].f_3) < iParam4);
}

int func_232(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_205(iParam4))
	{
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_237(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_258(int iParam0, bool bParam1)
{
	...
	func_259(iParam0, iLocal_93, vVar0, iVar3);
...
void func_259(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_260(iParam0);
...
int func_271(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_17[1] = { 565,3445f, -1775,931f, 31,3515f };
			uParam0->f_24 = 7f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
...
int func_273(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 574,0521f, -1770,594f, 27,66929f };
			uParam0->f_17[1] = { 559,1631f, -1768,663f, 31,41929f };
			uParam0->f_24 = 17,25f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				iLocal_94 = unk_0xE9744DB7B8CA6965(563,76f, -1773,86f, 28,36f, 0,02f, 0,02f, -110,7f, 2);
				unk_0xC90224D9E95E5E3A(iLocal_94, true);
				unk_0x915804B434753CBD(uParam0->f_28[0], iLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_287(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
...
void func_289(int iParam0, bool bParam1)
{
	...
	if (unk_0xE4EDC4B0E92C078B(iLocal_264))
	{
		unk_0x142CC44DB769B57E(&iLocal_264);
	}
	...
	{
		case 30:
			unk_0xF34067446A5C640F(-1101,62f, 290,36f, 64,76f, 5f, -1249591818);
			break;
	}
	if (bParam1)
	{
