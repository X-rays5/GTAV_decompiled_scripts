	...
	switch (iLocal_684)
	{
		case 0:
			...
			if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				...
				if (func_37(iVar0) && unk_0x134B62B726CEC8E6(iVar0) == -1323100960)
				{
					func_36(iVar0, 2);
				}
			}
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				unk_0x536F1BE96C726C4B(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 30f, 1, 0, 0, false);
				func_375();
			}
			break;
	}
...
void func_3()
{
	func_7(&(Local_111[0].f_4));
	func_7(&(Local_111[1].f_4));
	func_6(&iLocal_109);
	func_5(&(Local_111[0]), 1, 0, 1);
	func_5(&(Local_111[1]), 1, 0, 1);
	func_4(&(Local_134[iLocal_661].f_17), 0);
	unk_0x51732B934211201A(iLocal_80);
...
int func_109(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bVar0 = false;
	if (func_10(iParam0))
	{
...
int func_113(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vParam1, fParam12, fParam12, 2f, 0, true, 2))
			{
				unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vParam1, fParam12, fParam12, 2f, 1, true, 2);
	...
	else if (unk_0x5A91F08DF773C39D(iParam0, vParam1, fParam12, fParam12, 2f, 0, true, 2))
	{
		if (*iParam9 == -1)
		{
...
void func_117(int iParam0, vector3 vParam1, bool bParam4)
{
	if (!unk_0xE4EDC4B0E92C078B(*iParam0))
	{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_149(1, vLocal_824, 0))
			{
				...
				{
					func_147(33);
					unk_0xAB8E2DDC7AF955E0(1917016601, true);
					unk_0xAB8E2DDC7AF955E0(-1323100960, true);
					unk_0xAB8E2DDC7AF955E0(-294281201, true);
					iLocal_683 = 2;
					func_7(&iLocal_821);
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	Local_111[1].f_5 = 0;
	Local_111[1].f_10 = 1;
	Local_111[1].f_2 = 1500;
	Local_111[1].f_3 = 500;
	Local_111[0].f_5 = 0;
	Local_111[0].f_10 = 0;
	Local_111[0].f_2 = 1000;
	Local_111[0].f_3 = 100;
	unk_0xF63400DBE3303D26("Enemies", &iLocal_80);
	unk_0x6DF7BF67E86AAE86(Local_111[0], iLocal_80);
	unk_0x6DF7BF67E86AAE86(Local_111[1], iLocal_80);
	unk_0xE2F0767314863BD8(Local_111[0], 1, 0);
	unk_0xE2F0767314863BD8(Local_111[1], 1, 0);
...
void func_129()
{
	if (!unk_0xC42A92762C58E1B9(Local_111[0], iLocal_109, 0))
	{
		unk_0x96167B03C5A77156(Local_111[0], unk_0x68E4ADDDDCD7BDDE(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
		Local_111[0].f_7 = 1;
	}
	else
	{
...
void func_130(bool bParam0)
{
	if (!unk_0xBBA8A868118C90ED(iLocal_109, 0, 0))
	{
		...
		if (iLocal_661 != (iLocal_81 - 1))
		{
			if (iLocal_661 == 4)
			{
				unk_0xF613E1FD4A150FE0(Local_111[0], iLocal_109, Local_134[iLocal_661], 15f, 2883755, Local_134[iLocal_661].f_6);
			}
			else
			{
				unk_0xE9362E4D600DD12A(Local_111[0], iLocal_109, Local_134[iLocal_661], 15f, 0, 0, 2883755, Local_134[iLocal_661].f_6, Local_134[iLocal_661].f_7);
			}
			Local_111[0].f_8 = Local_111[0].f_7;
			Local_111[0].f_7 = 4;
		}
		else
		{
			unk_0xE072601B4380E9DF(Local_111[0], iLocal_109, 15f, 786599);
			Local_111[0].f_8 = Local_111[0].f_7;
			Local_111[0].f_7 = 10;
		}
	}
...
void func_131(bool bParam0)
{
	if (iLocal_661 != -1)
	{
		if (!func_136(Local_134[iLocal_661].f_11) && !func_136(Local_134[iLocal_661].f_14))
		{
			unk_0xE342F209E49C5314(Local_134[iLocal_661].f_11 - Local_134[iLocal_661].f_14, Local_134[iLocal_661].f_11 + Local_134[iLocal_661].f_14, true, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_661 != -1)
	{
		if (!func_136(Local_134[iLocal_661].f_11) && !func_136(Local_134[iLocal_661].f_14))
		{
			unk_0xE342F209E49C5314(Local_134[iLocal_661].f_11 - Local_134[iLocal_661].f_14, Local_134[iLocal_661].f_11 + Local_134[iLocal_661].f_14, false, 1);
		}
	}
}
...
int func_132()
{
	...
	{
		vVar1 = { unk_0x68F4C0EC296D3901(iLocal_109, 1) };
		iVar4 = 0;
		while (iVar4 <= (iLocal_81 - 1))
		{
			fVar28 = unk_0x0EB28750412C3A5A(vVar1, Local_134[iVar4], true);
			if (!func_136(Local_134[iVar4]) && fVar28 > 25f)
			{
				fVar6[iVar4] = fVar28;
			}
			else
		...
		fVar30 = func_133(Local_134[iVar0] - vVar1, unk_0x08D89CE2E20AE305(iLocal_109));
		iVar5 = iVar0;
		iVar31 = 0;
		while (fVar30 < 0f && iVar31 < 40)
		{
			...
			vVar1 = { unk_0x68F4C0EC296D3901(iLocal_109, 1) };
			fVar30 = func_133(Local_134[iVar5] - vVar1, unk_0x08D89CE2E20AE305(iLocal_109));
			iVar31++;
		}
		if (iVar31 >= 40)
		{
...
void func_134()
{
	...
	if (bLocal_663)
	{
		while (Local_134[iLocal_661].f_18 && iVar0 != -1)
		{
			iLocal_661++;
			if (iLocal_661 >= (iLocal_81 - 1))
			{
...
Vector3 func_137(bool bParam0)
{
	if (!bParam0)
	{
		iVar3 = unk_0xF653B9B22DA806A9(iLocal_109, "wheel_rf");
	}
	else
	{
		iVar3 = unk_0xF653B9B22DA806A9(iLocal_109, "wheel_lf");
	}
	vVar0 = { unk_0xBF584557291FDD31(iLocal_109, iVar3) };
	vVar0 = { unk_0x5293C88BD2F4DE13(iLocal_109, vVar0) };
	if (!bParam0)
	{
...
int func_148()
{
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		if (unk_0x4906F8A34E9F4814(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 1917016601))
		{
	...
	switch (iParam0)
	{
		...
		case 2:
			if (func_37(Global_95241[0]))
			{
				...
				{
					func_36(Local_868, 0);
					unk_0x44A200C9B6E1CEA6(Local_868, 1);
			...
			if (unk_0xC844350D5D58C99A(Global_95241.f_9[0]))
			{
				if (!unk_0x28072FDD60CE3A6E(Global_95241.f_9[0], 1))
				{
					...
					if (func_341(Local_840))
					{
						...
						unk_0xAFF39FB306F8E232(Local_840, 50, 1);
						return 1;
					}
				}
				else
		...
		case 4:
			if (unk_0xC844350D5D58C99A(Global_95241.f_9[1]))
			{
				if (!unk_0x28072FDD60CE3A6E(Global_95241.f_9[1], 1))
				{
					...
					if (func_341(Local_854))
					{
						...
						unk_0xAFF39FB306F8E232(Local_854, 50, 1);
						unk_0x11AD11297DC58CC7(Local_854, true);
						unk_0xE8832A9E16A57A1F(Local_854, 1, 1);
						return 1;
					}
				}
				else
			...
			else if (func_150(&Local_854, Local_854.f_5, Local_854.f_1, Local_854.f_4, 1, 0, 1, 1))
			{
				if (func_37(Local_868))
				{
					unk_0xF821F915BC24D246(Local_854, Local_868, 0);
					unk_0x4E885A246A9D983A(Local_854, 170, false);
					unk_0xBAFED2F6486F771A(Local_854, 65536, true);
					unk_0xAFF39FB306F8E232(Local_854, 50, 1);
					unk_0x11AD11297DC58CC7(Local_854, true);
...
int func_150(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!unk_0xC844350D5D58C99A(*iParam0))
	{
		...
		{
			*iParam0 = unk_0x36F2404464202779(26, iParam1, vParam2, fParam5, 1, true);
			if (func_341(*iParam0))
			{
				if (bParam7)
				{
				...
				if (bParam8)
				{
					unk_0x11AD11297DC58CC7(*iParam0, bParam8);
				}
				if (!bParam9)
				{
					unk_0x25C5402CC10F76CD(*iParam0, bParam9);
				}
				if (bParam6)
				{
					func_151(iParam1, 1);
...
int func_153(int iParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6)
{
	if (!unk_0xC844350D5D58C99A(*iParam0))
	{
		if (func_152(iParam1, "Loading", 0))
...
void func_155()
{
	...
	while (iVar0 <= (2 - 1))
	{
		func_156(&(Local_111[iVar0]), iVar0);
		iVar0++;
	}
}
...
void func_156(int iParam0, int iParam1)
{
	if (func_341(*iParam0))
	{
		...
		if (unk_0xB4ECF989E2C1DAC8(*iParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			...
			{
				if (func_10(Local_134[iLocal_661].f_17) && unk_0xD59B17D2DFF98E26(Local_134[iLocal_661].f_17))
				{
					unk_0x76D5D8AF296F50CE(*iParam0, 1048576000);
					unk_0xAB690CF5866CB826(*iParam0);
					if (iLocal_661 <= 20 && iLocal_661 != -1)
					{
						Local_134[iLocal_661].f_18 = 1;
						iParam0->f_9 = 0;
					}
					unk_0x15AFB6CBDE990FB6(Local_134[iLocal_661].f_17, 1, 0);
					unk_0xEF3C30F70D2ED135(Local_134[iLocal_661].f_17, 1, unk_0x08D89CE2E20AE305(*iParam0), 0, 1, 1, 0);
				}
			}
		}
		switch (iParam0->f_5)
	...
	{
		if (func_10(Local_134[iLocal_661].f_17))
		{
			if (unk_0xD59B17D2DFF98E26(Local_134[iLocal_661].f_17))
			{
				unk_0x15AFB6CBDE990FB6(Local_134[iLocal_661].f_17, 1, 0);
				unk_0xEF3C30F70D2ED135(Local_134[iLocal_661].f_17, 1, unk_0x08D89CE2E20AE305(*iParam0), 0, 1, 1, 0);
			}
		...
		if (unk_0xC844350D5D58C99A(*iParam0))
		{
			if (!func_157(unk_0x16F2683693E537C9(), *iParam0, 150f, 1) && !bLocal_665)
			{
	...
	switch (iParam0->f_6)
	{
		...
		case 11:
			...
			if ((unk_0x1C0640BA9A7327B3() - iParam0->f_1) > 5000)
			{
				...
				{
					if (unk_0xC844350D5D58C99A(Local_111[func_171(iParam0->f_10)]))
					{
						unk_0x96167B03C5A77156(*iParam0, vLocal_667, 1f, -1, 2f, 0, 1193033728);
					}
				}
				iParam0->f_1 = unk_0x1C0640BA9A7327B3();
				iParam0->f_6 = 23;
		...
		case 18:
			if (!func_184(*iParam0, -2017877118))
			{
				...
				if (func_170(unk_0x68F4C0EC296D3901(*iParam0, 1), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1)) > 1,5f)
				{
		...
		case 1:
			if (!unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 0))
			{
				func_168(iParam0);
			}
			break;
		...
		case 7:
			if (unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 1))
			{
		...
		case 13:
			if ((unk_0x1C0640BA9A7327B3() - iParam0->f_1) >= iParam0->f_2)
			{
				...
				else if (func_177(Local_111[func_171(iParam0->f_10)], *iParam0, 1126825984, 1, 250, 7))
				{
					func_176(iParam0, 0);
				}
				else
		...
		case 20:
			...
			{
				if (!unk_0x3D1053F9EB43B7AD(*iParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, 5f, 0f, -2f), unk_0x68F4C0EC296D3901(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
				{
					func_163(iParam0);
				}
				else
				{
					func_168(iParam0);
					func_168(&(Local_111[func_171(iParam0->f_10)]));
				}
				iParam0->f_1 = unk_0x1C0640BA9A7327B3();
			}
			func_172(iParam0);
...
{
	vVar0 = { func_160(vParam1 - unk_0x68F4C0EC296D3901(iParam0, 1)) };
	...
	{
		vVar3 = { func_160(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(iLocal_109, 0f, 10f, -2f), unk_0x68E4ADDDDCD7BDDE(iLocal_109, 0f, 3f, 2f), 5f, 0, true, 0) && unk_0x4024663A44BC1535(*iParam0))
	{
		return 1;
	}
	return 0;
...
{
	unk_0x0E2400AB9174FA81(2, iLocal_80, 1862763509);
	switch (iParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_184(*iParam0, 242628503))
			{
				...
				if (!unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 0))
				{
					if (iParam0->f_10 == 0)
					{
						unk_0x96167B03C5A77156(*iParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
						iParam0->f_7 = 1;
					}
					else
					{
						unk_0x96167B03C5A77156(*iParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
						iParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 0))
			{
				if (iParam0->f_10 == 0)
				{
					unk_0x96167B03C5A77156(*iParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
...
void func_164(var uParam0)
{
	...
	{
		if (Local_134[iLocal_661].f_23 != 0)
		{
			if (func_10(Local_134[iLocal_661].f_17))
			{
				unk_0xDE7F7A4DA93201CF(*uParam0, Local_134[iLocal_661].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			unk_0x96167B03C5A77156(*uParam0, Local_134[iLocal_661].f_19, 1f, 20000, -1f, 0, func_165(Local_134[iLocal_661].f_19, unk_0x68F4C0EC296D3901(*uParam0, 1), 1));
		}
		if (func_37(iLocal_109))
		{
...
float func_165(struct<2> Param0, var uParam2, struct<2> Param3, float fParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
float func_170(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5)
{
...
{
	if (func_37(iLocal_109) && (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_109, 0) && !unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 0)))
	{
...
bool func_177(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_178(&(Local_38[iVar4]), vVar1, iParam1, &(Local_38[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_38[iVar4].f_3) < iParam4);
}

int func_178(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_10(iParam4))
	{
...
{
	vVar0 = { func_160(unk_0x68F4C0EC296D3901(iParam1, 1) - unk_0x68F4C0EC296D3901(iParam0, 1)) };
...
void func_185(var uParam0)
{
	...
	switch (uParam0->f_7)
	{
		...
		case 3:
			...
			if (bLocal_664)
			{
				if (iLocal_661 <= 20 && iLocal_661 != -1)
				{
					if (!Local_134[iLocal_661].f_18)
					{
						if (func_107(*uParam0, Local_134[iLocal_661], 20f))
						{
							if (Local_134[iLocal_661].f_9 && unk_0x8B38C0DAEEDB5F9C(iLocal_109))
							{
								func_195();
							}
						}
		...
		case 4:
			if (func_107(*uParam0, Local_134[iLocal_661], 25f))
			{
				if (Local_134[iLocal_661].f_9)
				{
					func_194(uParam0);
				}
				else
		...
		case 7:
			if (func_341(Local_111[1]))
			{
				if (unk_0xC42A92762C58E1B9(Local_111[1], iLocal_109, 0) && Local_111[1].f_7 == 3)
				{
					func_130(0);
				}
			}
...
void func_186(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case 1:
			...
			{
				unk_0xDD353D0E9C789D0E(&uVar0);
				if (func_170(unk_0x68F4C0EC296D3901(*uParam0, 1), Local_134[iLocal_661].f_19) > 1,5f)
				{
					unk_0x796BDF31572BB055(0, Local_134[iLocal_661].f_19, 0);
				}
			...
			else if (func_191(Local_134[iLocal_661].f_19, *uParam0, 1f, 1f, 8f))
			{
				func_190(uParam0);
				return;
			}
			...
			if (func_184(*uParam0, 242628503))
			{
				if (unk_0xB4ECF989E2C1DAC8(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man", 3))
				{
					if (unk_0x8CA9406E01C7EE58(*uParam0, "missfbi4prepp1", "_bag_pickup_garbage_man") >= 0,333f)
					{
						...
						if (func_10(Local_134[iLocal_661].f_17) && !unk_0xD59B17D2DFF98E26(Local_134[iLocal_661].f_17))
						{
							unk_0x9F528B1B53FBC5D9(Local_134[iLocal_661].f_17, *uParam0, unk_0x4A089F2B762B8D33(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						}
					}
				}
				if (func_191(Local_134[iLocal_661].f_19, *uParam0, 1f, 1f, 8f))
				{
					func_190(uParam0);
					return;
				}
		...
		case 3:
			if (func_37(iLocal_109))
			{
				...
				{
					if (unk_0x5A91F08DF773C39D(*uParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, 0f, -5,5f, 0f), 0,9f, 0,9f, 2f, 0, true, 0))
					{
						...
						if (unk_0x8CA9406E01C7EE58(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0,391f)
						{
							if (func_10(Local_134[iLocal_661].f_17))
							{
								if (unk_0xD59B17D2DFF98E26(Local_134[iLocal_661].f_17))
								{
									...
									unk_0xAB690CF5866CB826(*uParam0);
									unk_0x15AFB6CBDE990FB6(Local_134[iLocal_661].f_17, 1, 0);
									unk_0x6662F466071F8128(Local_134[iLocal_661].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									unk_0xEF3C30F70D2ED135(Local_134[iLocal_661].f_17, 1, unk_0x08D89CE2E20AE305(*uParam0), 0, 1, 1, 0);
								}
								if (unk_0x1B3D109B39CC2C89(Local_134[iLocal_661].f_17, iLocal_109))
								{
									func_187(&(Local_134[iLocal_661].f_17));
								}
							}
						}
					}
...
void func_194(var uParam0)
{
	...
	{
		unk_0xDD353D0E9C789D0E(&uVar0);
		unk_0xE9362E4D600DD12A(0, iLocal_109, Local_134[iLocal_661].f_3, 8f, 0, 1917016601, 786469, 10f, 15f);
		unk_0x27F3789FF35EEDF1(0, iLocal_109, Local_134[iLocal_661].f_3, Local_134[iLocal_661].f_8, Local_134[iLocal_661].f_10, 5f, 1);
		unk_0x75ABDC5F81978924(uVar0);
		unk_0x78ADC381772E3D54(*uParam0, uVar0);
		unk_0xF82EA857DA10E0CD(&uVar0);
		uParam0->f_7 = 6;
...
void func_196(var uParam0, bool bParam1)
{
	...
	{
		if (unk_0x3D1053F9EB43B7AD(*uParam0, unk_0x68E4ADDDDCD7BDDE(iLocal_109, 5f, 0f, -2f), unk_0x68F4C0EC296D3901(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(iLocal_109, 5f, 0f, -2f), unk_0x68F4C0EC296D3901(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
			func_197(uParam0);
		}
		else if (!func_184(*uParam0, 1227113341) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(iLocal_109, 5f, 0f, -2f), unk_0x68F4C0EC296D3901(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, true, 0))
		{
...
void func_199()
{
	...
	while (iVar0 <= (iLocal_81 - 1))
	{
		if (Local_134[iVar0].f_23 != 0)
		{
			if (Local_134[iVar0].f_24)
			{
				if ((iVar0 != iLocal_661 && func_10(Local_134[iVar0].f_17)) && func_201(Local_134[iVar0].f_17, unk_0x16F2683693E537C9(), 1) > 200f)
				{
					unk_0xF690C84DADBB3551(&(Local_134[iVar0].f_17));
					Local_134[iVar0].f_24 = 0;
				}
			}
			else if (Local_134[iVar0].f_23 != 0)
			{
				if (func_107(unk_0x16F2683693E537C9(), Local_134[iVar0], 100f) || func_107(Local_111[0], Local_134[iVar0], 120f))
				{
					Local_134[iVar0].f_24 = func_200(&(Local_134[iVar0].f_17), Local_134[iVar0].f_23, Local_134[iVar0].f_19, Local_134[iVar0].f_22, 1);
				}
			}
		}
		iVar0++;
...
int func_200(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!unk_0xC844350D5D58C99A(*uParam0))
	{
		if (func_152(iParam1, "Loading", 0))
		{
			*uParam0 = unk_0x7707E48765093646(iParam1, vParam2, 1, true, false);
			if (unk_0xC844350D5D58C99A(*uParam0))
			{
...
void func_202(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_341(Local_111[func_171(iParam1)]))
		{
			if (!bLocal_665)
			{
				if (unk_0xC844350D5D58C99A(Local_111[func_171(iParam1)]))
				{
					if (func_181(*iParam0, Local_111[func_171(iParam1)], 140f, 0) || func_157(Local_111[func_171(iParam1)], *iParam0, 3f, 1))
					{
						func_176(iParam0, 0);
						bLocal_665 = true;
						return;
					...
					{
						vLocal_667 = { unk_0x68F4C0EC296D3901(Local_111[func_171(iParam1)], 1) };
						iParam0->f_1 = unk_0x1C0640BA9A7327B3();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
		...
		else if (Local_111[func_171(iParam1)].f_6 == 22)
		{
			if (func_181(*iParam0, Local_111[func_171(iParam1)], 140f, 0) && func_157(Local_111[func_171(iParam1)], unk_0x16F2683693E537C9(), 15f, 1))
			{
				iParam0->f_5 = 1;
				iParam0->f_6 = 21;
			}
		}
		else if (Local_111[func_171(iParam1)].f_6 == 5 || Local_111[func_171(iParam1)].f_6 == 7)
		{
			if (func_157(Local_111[func_171(iParam1)], *iParam0, 10f, 1))
			{
				func_176(iParam0, 0);
			}
		}
		...
		if (func_204(*iParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_203(iParam0))
		{
				...
				if (func_37(iLocal_109))
				{
					if (unk_0xC42A92762C58E1B9(*iParam0, iLocal_109, 0))
					{
						if (unk_0x9C66D99E63E8E24C(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								unk_0x89258193691A7600(*iParam0, iLocal_109, unk_0x16F2683693E537C9(), 8, 30f, 786469, 300f, 2f, 1);
								iParam0->f_6 = 7;
								unk_0x8BE3D040D15AEA1D(Local_111[func_171(iParam1)], -1);
								Local_111[func_171(iParam1)].f_6 = 10;
								Local_111[func_171(iParam1)].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = unk_0x1C0640BA9A7327B3();
								Local_111[func_171(iParam1)].f_1 = unk_0x1C0640BA9A7327B3();
							}
							else
							{
								unk_0x8BE3D040D15AEA1D(*iParam0, -1);
								iParam0->f_6 = 12;
								unk_0x89258193691A7600(Local_111[func_171(iParam1)], iLocal_109, unk_0x16F2683693E537C9(), 8, 30f, 786469, 300f, 2f, 1);
								Local_111[func_171(iParam1)].f_6 = 5;
								Local_111[func_171(iParam1)].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = unk_0x1C0640BA9A7327B3();
								Local_111[func_171(iParam1)].f_1 = unk_0x1C0640BA9A7327B3();
						...
						else
						{
							...
							if (unk_0xC844350D5D58C99A(Local_111[func_171(iParam1)]))
							{
								if (func_181(Local_111[func_171(iParam1)], unk_0x16F2683693E537C9(), 1126825984, 0))
								{
									func_176(&(Local_111[func_171(iParam1)]), 0);
								}
							}
						}
					...
					else
					{
						...
						if (unk_0xC844350D5D58C99A(Local_111[func_171(iParam1)]))
						{
							if (func_177(Local_111[func_171(iParam1)], *iParam0, 1126825984, 1, 250, 7))
							{
								func_176(&(Local_111[func_171(iParam1)]), 0);
							}
						}
			...
			else
			{
				...
				{
					Local_111[func_171(iParam1)].f_1 = unk_0x1C0640BA9A7327B3();
					Local_111[func_171(iParam1)].f_8 = iParam0->f_7;
					Local_111[func_171(iParam1)].f_5 = 1;
					Local_111[func_171(iParam1)].f_6 = 21;
					unk_0xE910A68AA670B4AA(Local_111[func_171(iParam1)]);
				}
			}
			iParam0->f_5 = 1;
		}
	...
	if (iParam0->f_5 != 1)
	{
		if (func_341(Local_111[func_171(iParam1)]))
		{
			if (unk_0x36646919F20EAFFC(Local_111[func_171(iParam1)]))
			{
				func_169(iParam0);
...
{
	if ((unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, true, 0) && !unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6)) && unk_0x5F596B0E13677FE9(unk_0x16F2683693E537C9()))
	{
		return 1;
	}
	return 0;
...
void func_214()
{
	if (func_37(Local_868))
	{
		if (func_157(unk_0x16F2683693E537C9(), Local_868, 100f, 1) && !iLocal_837)
		{
			unk_0xD4D331DFE794EACD(1917016601, 3);
			if (!unk_0x1F04E7FA44219580(1917016601))
			{
				iLocal_837 = 1;
			}
		}
		else if (!func_157(unk_0x16F2683693E537C9(), Local_868, 120f, 1) && iLocal_837)
		{
			unk_0x058E3033265DBA9A(1917016601);
			iLocal_837 = 0;
		}
	}
}
	...
	if (func_37(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 1:
				...
				{
					func_7(iParam4);
					if (!unk_0x5A91F08DF773C39D(*iParam0, vParam5, fParam10, fParam10, 2f, 0, true, 2))
					{
	...
	if ((iParam6 == 1 || iParam6 == 2) || iParam6 == 3)
	{
		if (iParam5 == 0)
		{
			...
			if (!bParam10)
			{
				if (func_37(iParam0))
				{
					if (unk_0x5A91F08DF773C39D(iParam0, vParam1, fParam11, fParam11, 2f, 1, true, 0))
					{
						return 1;
					}
				}
			}
			else if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vParam1, fParam11, fParam11, 2f, 1, true, 2))
			{
				return 1;
			}
			if (func_106(func_114(func_77()), 0, 0))
			...
			else if (unk_0x9C77D2D0559097F0(iVar2, 1))
			{
				if (func_231(iVar2))
				{
					if (unk_0xD1960163A3042274(iVar2, -1273030092) != 1 && unk_0xD1960163A3042274(iVar2, -1273030092) != 0)
					{
						...
						{
							unk_0xE9362E4D600DD12A(iVar2, unk_0x6937EA2286828455(iVar2, 0), vLocal_827, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
				...
				else if (func_229(iVar2))
				{
					if (func_37(Local_868))
					{
						if (!func_157(iVar2, Local_868, 17f, 1))
						{
							if (unk_0xD1960163A3042274(iVar2, -1273030092) != 1 && unk_0xD1960163A3042274(iVar2, -1273030092) != 0)
							{
								unk_0x60274E99F9B27DEA(iVar2, unk_0x6937EA2286828455(iVar2, 0), Local_868, 3, 20f, 786468, 2f, 0,5f, 1);
							}
						}
					}
				}
...
int func_229(int iParam0)
{
	if (!func_230())
	{
		if ((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0)) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0)
		{
			...
			if (func_37(iVar0))
			{
				if (unk_0x4906F8A34E9F4814(iVar0, 1917016601))
				{
					return 0;
				}
...
int func_231(int iParam0)
{
	if (!func_230())
	{
		if ((unk_0xC844350D5D58C99A(Local_868) && unk_0xDF1306B443CD3D15(Local_868, 0)) && !unk_0x5A91F08DF773C39D(Local_868, vLocal_827, 2f, 2f, 2f, 0, true, 0))
		{
			...
			{
				if (unk_0xC42A92762C58E1B9(iParam0, Local_868, 0) && unk_0xA30B8362589C124A(Local_868, -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
void func_232(int iParam0)
{
	if (iLocal_683 > 1)
	{
		if (iLocal_685 > 0)
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_688[iParam0].f_7, 0) && iLocal_686 == 1)
			{
				if (!unk_0xD17F06053799A7CA())
				{
					if (func_236(&uLocal_879, cLocal_878, Local_688[iParam0][0], 8, 0, 0, 0))
					{
						unk_0x5D96D8530B3D0904(&(Local_688[iParam0].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((unk_0xEAE0D21A50E6C7F4(Local_688[iParam0].f_7, 0) && !unk_0xEAE0D21A50E6C7F4(Local_688[iParam0].f_7, 1)) && iLocal_686 == 1)
			{
				if (!unk_0xD17F06053799A7CA())
				{
					if (func_236(&uLocal_879, cLocal_878, Local_688[iParam0][1], 7, 0, 0, 0))
					{
						unk_0x5D96D8530B3D0904(&(Local_688[iParam0].f_7), 1);
					}
				}
			}
			if (!unk_0xEAE0D21A50E6C7F4(Local_688[iParam0].f_7, 5))
			{
				if (func_235(iLocal_874, vLocal_827, 1) < 15f && iLocal_686 == 1)
				{
					if (!unk_0xD17F06053799A7CA())
					{
						if (func_236(&uLocal_879, cLocal_878, Local_688[iParam0][5], 7, 0, 0, 0))
						{
							unk_0x5D96D8530B3D0904(&(Local_688[iParam0].f_7), 5);
						}
					}
				}
			}
...
{
	if (!unk_0xEAE0D21A50E6C7F4(Local_688[iParam0].f_7, iParam1))
	{
		if (iLocal_1052 != -1)
		{
			if (!unk_0xD17F06053799A7CA())
			{
				if (func_236(&uLocal_879, cLocal_878, Local_688[iParam0][iParam1], 7, 0, 0, 0))
				{
					unk_0x5D96D8530B3D0904(&(Local_688[iParam0].f_7), iParam1);
				}
			}
		}
...
{
	if ((unk_0xEAE0D21A50E6C7F4(Local_688[0].f_7, iParam0) || unk_0xEAE0D21A50E6C7F4(Local_688[1].f_7, iParam0)) || unk_0xEAE0D21A50E6C7F4(Local_688[2].f_7, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_238()
{
	...
	{
		if (!iLocal_877 && !func_107(unk_0x16F2683693E537C9(), vLocal_827, 100f))
		{
			iLocal_877 = func_153(&iLocal_876, -789894171, 1370,912f, -2060,055f, 50,9983f, 312,8686f, 1);
		}
	}
...
void func_244(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
...
void func_245(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
...
void func_260(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (Global_1319117 == 1)
	{
		return;
...
int func_317(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_15(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_320(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_317(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_325(iParam0);
			func_324(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
void func_338()
{
	...
	else
	{
		...
		{
			if (!func_157(unk_0x16F2683693E537C9(), iLocal_875, fVar0, 1))
			{
				iVar1++;
			}
		}
...
void func_346(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_347(iParam2)];
	if (iVar0 != 0)
	{
...
int func_348(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_347(iParam1)];
...
void func_359()
{
	...
	iLocal_1048[1] = 0;
	iLocal_1048[2] = 0;
	Local_688[0] = { func_360("FP1_WANTM", "FP1_LOSTM", "FP1_THEREM", "FP1_CHATFM", "", "FP1_CHATTM") };
	Local_688[1] = { func_360("FP1_WANTT", "FP1_LOSTT", "FP1_THERET", "FP1_CHATFM", "FP1_CHATFT", "") };
	Local_688[2] = { func_360("FP1_WANTF", "FP1_LOSTF", "FP1_THEREF", "", "FP1_CHATFT", "FP1_CHATTM") };
}
...
void func_361()
{
	Local_134[0] = { func_363(1203,146f, -337,3543f, 67,9314f, 1245,118f, -348,5059f, 68,2099f, 253,1908f, 0) };
	func_362(&(Local_134[0]), vLocal_824, 0, 15f, 5f, 270f, 3, 1192,006f, -631,4703f, 61,6972f, 10f, 10f, 5f);
	Local_134[1] = { func_363(1215,084f, -339,3139f, 68,1323f, 964,9214f, -555,212f, 58,0211f, 39,645f, 0) };
	func_362(&(Local_134[1]), vLocal_824, 0, 15f, 10f, 270f, 3, 1103,29f, -764,532f, 56,633f, 10f, 10f, 5f);
	Local_134[2] = { func_363(1179,533f, -361,3286f, 67,4559f, 929,8701f, -619,4534f, 56,4632f, 164,3631f, 0) };
	func_362(&(Local_134[2]), vLocal_824, 0, 15f, 10f, 270f, 3, 933,3745f, -615,9453f, 56,3041f, 10f, 10f, 5f);
	Local_134[3] = { func_363(1107,674f, -364,0569f, 65,9581f, 1099,266f, -775,0809f, 57,3525f, 178,2038f, 0) };
	func_362(&(Local_134[3]), vLocal_824, 0, 15f, 2f, 270f, 3, 1062,149f, -479,4801f, 62,9454f, 10f, 10f, 5f);
	Local_134[4] = { func_363(1069,279f, -393,5795f, 66,0262f, 1065,364f, -389,9561f, 66,1504f, 220,1611f, 0) };
	func_362(&(Local_134[4]), vLocal_824, 0, 5f, 30f, 128,1732f, 3, 1069,718f, -393,9912f, 66,0261f, 10f, 10f, 5f);
	Local_134[5] = { func_363(1031,673f, -424,599f, 64,5439f, 1027,179f, -420,6656f, 64,6268f, 178,2038f, -819563011) };
	func_362(&(Local_134[5]), 1028,201f, -428,3677f, 64,3571f, 1, 15f, 2f, 128,3915f, 1, 1027,179f, -420,6656f, 64,6268f, 10f, 10f, 5f);
	Local_134[6] = { func_363(942,1528f, -488,8956f, 59,3129f, 932,0198f, -489,3886f, 58,9212f, 202,5785f, -819563011) };
	func_362(&(Local_134[6]), 930,7186f, -494,9253f, 58,616f, 1, 15f, 2f, 119,6518f, 1, 952,9781f, -482,5082f, 60,0003f, 10f, 10f, 5f);
	Local_134[7] = { func_363(868,2734f, -529,5473f, 56,2071f, 865,0042f, -522,4746f, 56,3363f, 241,9711f, -819563011) };
	func_362(&(Local_134[7]), 865,2349f, -535,8759f, 56,1574f, 1, 15f, 2f, 162,7219f, 1, 1062,149f, -479,4801f, 62,9454f, 10f, 10f, 5f);
	Local_134[8] = { func_363(874,8076f, -571,2073f, 56,2987f, 983,125f, -541,9902f, 58,5929f, 49,7653f, 0) };
	func_362(&(Local_134[8]), vLocal_824, 0, 15f, 2f, 270f, 3, 1062,149f, -479,4801f, 62,9454f, 10f, 10f, 5f);
	Local_134[9] = { func_363(931,5218f, -614,2144f, 56,3119f, 928,6471f, -620,711f, 56,4611f, -108,06f, -819563011) };
	func_362(&(Local_134[9]), 940,4086f, -622,1787f, 56,3003f, 1, 15f, 2f, 228,1176f, 1, 918,6716f, -602,9258f, 56,3395f, 10f, 10f, 5f);
	Local_134[10] = { func_363(964,9758f, -645,9614f, 56,4465f, 927,1033f, -575,4162f, 56,5329f, 55,9317f, 0) };
	func_362(&(Local_134[10]), vLocal_824, 0, 15f, 2f, 270f, 3, 1062,149f, -479,4801f, 62,9454f, 10f, 10f, 5f);
	Local_134[11] = { func_363(983,4438f, -683,1442f, 56,4087f, 929,3757f, -618,9091f, 56,4612f, 181,1844f, 0) };
	func_362(&(Local_134[11]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	Local_134[12] = { func_363(1016,261f, -731,546f, 56,555f, 1011,801f, -733,0652f, 56,7435f, 314,5626f, -819563011) };
	func_362(&(Local_134[12]), 1020,251f, -736,815f, 56,6235f, 1, 15f, 2f, 220,7804f, 1, 1011,238f, -724,7085f, 56,5183f, 10f, 10f, 5f);
	Local_134[13] = { func_363(1164,126f, -762,2866f, 56,6656f, 1099,342f, -775,4273f, 57,3525f, 177,5729f, 0) };
	func_362(&(Local_134[13]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	Local_134[14] = { func_363(1199,339f, -678,0995f, 59,9051f, 1205,415f, -672,1282f, 60,1445f, 105,2374f, 0) };
	func_362(&(Local_134[14]), vLocal_824, 0, 15f, 2f, 12,1103f, 3, 1199,339f, -678,0995f, 59,9051f, 10f, 10f, 5f);
	Local_134[15] = { func_363(1183,445f, -582,9476f, 63,0962f, 929,3757f, -618,9091f, 56,4612f, 181,1844f, 0) };
	func_362(&(Local_134[15]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	Local_134[16] = { func_363(1192,479f, -485,1086f, 64,7195f, 1264,359f, -719,084f, 63,328f, 65,0519f, 0) };
	func_362(&(Local_134[16]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	Local_134[17] = { func_363(1212,693f, -400,0532f, 67,0971f, 1284,109f, -676,728f, 65,0225f, 69,9898f, 0) };
	func_362(&(Local_134[17]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	Local_134[18] = { func_363(1114,573f, -232,3706f, 68,0949f, 929,3757f, -618,9091f, 56,4612f, 181,1844f, 0) };
	func_362(&(Local_134[18]), vLocal_824, 0, 15f, 2f, 270f, 3, 1149,136f, -981,231f, 45,0495f, 10f, 10f, 5f);
	iLocal_830 = 19;
}
...
void func_364()
{
	vVar0[0] = { 1251,308f, -400,6231f, 68,0926f };
	vVar0[1] = { 1183,993f, -403,3443f, 66,8734f };
	vVar0[2] = { 1161,54f, -372,6073f, 66,6034f };
	vVar0[3] = { 1167,644f, -273,7987f, 67,9705f };
	vVar0[4] = { 1252,362f, -247,353f, 77,5631f };
	vVar0[5] = { 1330,062f, -341,0342f, 100,3476f };
	func_365(&vVar0, 6);
}
...
void func_365(var uParam0, int iParam1)
{
	...
	{
		func_369(&uLocal_713, *uParam0[iVar0]);
		iVar0++;
	}
	func_368(&uLocal_713);
...
void func_366(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_367(uParam1, *uParam1[iVar1] + vVar9))
		{
			vVar9 = { -vVar9 };
		}
...
void func_371()
{
	Local_840 = { func_372(1200,61f, -344,2721f, 68,0424f, 269,2015f, -294281201) };
	Local_854 = { func_372(1202,42f, -341,6034f, 67,9378f, 273,1125f, -294281201) };
}
...
void func_373()
{
	Local_868 = { func_374(1203,146f, -337,3543f, 67,9314f, 189,7047f, 1917016601) };
}
...
void func_375()
{
	func_240(1);
	func_386(1);
	unk_0xAB8E2DDC7AF955E0(1917016601, false);
	unk_0xAB8E2DDC7AF955E0(-1323100960, false);
	unk_0xAB8E2DDC7AF955E0(-294281201, false);
	func_63();
	func_385();
	func_384();
	func_376(0);
