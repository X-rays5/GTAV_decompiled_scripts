			...
			if (bVar4)
			{
				if (unk_0x7E60C62A7CE58FC8(*uParam0, "SET_DATA_SLOT"))
				{
					...
					while (iVar7 < uParam0->f_2[iVar6].f_14)
					{
						...
						{
							sVar3 = unk_0xE32F7AC5E6DF304A(uVar0, uVar1, bVar2);
						}
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, vector3 vParam5, int iParam8, int iParam9)
{
...
void func_234(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8)
{
	...
	{
		*uParam0 = unk_0x36F2404464202779(26, iParam1, vParam2, fParam5, 1, 1);
	}
