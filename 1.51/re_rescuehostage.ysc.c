	...
	while (true)
	{
		...
		if (unk_0x338D6FF72D84D90F())
		{
			switch (iLocal_47)
			{
				...
				case 2:
					iLocal_56 = unk_0x6E7D01E16ABEFABB(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), 35f, 0, 101383);
					if (unk_0xDF1306B443CD3D15(iLocal_56, 0))
					{
						if (!bLocal_100)
						{
				...
				case 3:
					...
					else
					{
						...
						iLocal_56 = unk_0x6E7D01E16ABEFABB(vLocal_48, 5f, 1171614426, 0);
						if (unk_0xDF1306B443CD3D15(iLocal_56, 0))
						{
							settimera(0);
							iLocal_84 = 1;
						}
						iLocal_55 = unk_0xF187F2EA5437526A(vLocal_48, 1,5f, 1,5f, 1,5f, -1);
						...
						if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_48) > 5625f && !unk_0x8E28E832BEAC3DCE(vLocal_48, 10f))
						{
							func_28();
						}
					}
...
void func_3()
{
	if (func_4())
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_53))
		{
			...
			unk_0xEEB67C3D0A71A47B(iLocal_53, vLocal_48, 50f, -1, 0, 0);
			unk_0xFADC0A217229F6B5(iLocal_53, true);
		...
		if (!unk_0xEB6A8945D1AC98A1(iLocal_54))
		{
			...
			unk_0xEEB67C3D0A71A47B(iLocal_54, vLocal_48, 50f, -1, 0, 0);
...
bool func_4()
{
	...
	if (!unk_0xEB6A8945D1AC98A1(iLocal_53))
	{
		...
		vVar1 = { vVar1 + unk_0x64430C979F516F7A(iLocal_53, 31086, 0f, 0f, 0f) };
		vVar4 = { vVar4 + unk_0x64430C979F516F7A(iLocal_53, 31086, 0f, 0f, 0f) };
	...
	if (!iLocal_81)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(iLocal_53))
		{
			if (iLocal_68 == -1)
			{
				...
				if (!unk_0xEB6A8945D1AC98A1(iLocal_54))
				{
					unk_0x6DF7BF67E86AAE86(iLocal_54, iLocal_59);
				...
				if (unk_0xA45992A6CE82FB43(iLocal_68) == 1f)
				{
					...
					if (!unk_0xEB6A8945D1AC98A1(iLocal_54))
					{
						...
						else
						{
							...
							unk_0x78ADC381772E3D54(iLocal_54, iLocal_79);
						}
						unk_0xFADC0A217229F6B5(iLocal_54, true);
						unk_0x6DF7BF67E86AAE86(iLocal_54, iLocal_61);
					}
					unk_0x915804B434753CBD(iLocal_53, iLocal_68, sLocal_267, "girl_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
					unk_0xFADC0A217229F6B5(iLocal_53, true);
					unk_0x6DF7BF67E86AAE86(iLocal_53, iLocal_61);
					unk_0x46CB381A452EF99D(iLocal_53, 1);
...
int func_58(int iParam0)
{
	...
	if (unk_0xAFB8387ED2D7213E(unk_0x16F2683693E537C9(), iVar0, 2076495324))
	{
		if (unk_0x7EB17A4C8D1002FD(unk_0x16F2683693E537C9(), iVar0, 2076495324))
		{
			bVar1 = true;
		}
	}
	else if (unk_0xAFB8387ED2D7213E(unk_0x16F2683693E537C9(), iVar0, 899381934))
	{
		if (unk_0x7EB17A4C8D1002FD(unk_0x16F2683693E537C9(), iVar0, 899381934))
		{
			bVar1 = true;
		}
	}
...
{
	fVar0 = 75f;
	iVar36 = unk_0xF187F2EA5437526A(unk_0x68F4C0EC296D3901(iLocal_52, false), fVar0, fVar0, fVar0, -1);
	if (!unk_0xEB6A8945D1AC98A1(iVar36))
	{
		if (unk_0x134B62B726CEC8E6(iVar36) == 368603149 || unk_0x134B62B726CEC8E6(iVar36) == 1581098148)
		{
			return 1;
		}
	}
	iVar37 = unk_0x6E7D01E16ABEFABB(unk_0x68F4C0EC296D3901(iLocal_52, false), fVar0, 0, 66561);
	if (unk_0xDF1306B443CD3D15(iVar37, 0))
	{
		return 1;
	}
	...
	if (iVar35 > 0)
	{
		...
		while (iVar34 < iVar35)
		{
			...
			{
				if (((unk_0x134B62B726CEC8E6(uVar1[iVar34]) == 2046537925 || unk_0x134B62B726CEC8E6(uVar1[iVar34]) == 741586030) || unk_0x134B62B726CEC8E6(uVar1[iVar34]) == -1683328900) || unk_0x134B62B726CEC8E6(uVar1[iVar34]) == 1922257928)
				{
					return 1;
				}
			}
...
bool func_64()
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (unk_0x565509D116400807(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), &iVar14))
			{
				unk_0xA6B02C1DB14DDA13(unk_0x134B62B726CEC8E6(iVar14), &uVar5, &Var8);
	...
	if (bVar1)
	{
		...
		fVar11 = unk_0xE7D606C557C86100(vVar2.x, vVar2.y);
	...
	iVar13 = unk_0x728870EB733D12A1();
	if (unk_0xC844350D5D58C99A(iVar13))
	{
		if (unk_0x3D1053F9EB43B7AD(iVar13, -91,56341f, 6391,747f, 30,6397f, -101,2611f, 6401,7f, 32,45449f, 7,5f, 0, true, 0))
		{
			bVar0 = true;
		}
	}
...
void func_102()
{
	...
	if (!unk_0xEB6A8945D1AC98A1(iLocal_52))
	{
		unk_0x9DD8618CA5BF832D(iLocal_52, 156, true);
		if (unk_0x69DF961355195C3C(iLocal_67))
		{
...
void func_103()
{
	if (!iLocal_83)
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_52))
		{
			...
			unk_0x0E2400AB9174FA81(5, iLocal_60, iLocal_59);
			unk_0x0E2400AB9174FA81(5, iLocal_59, iLocal_60);
			unk_0x0E2400AB9174FA81(0, iLocal_61, iLocal_59);
			unk_0x0E2400AB9174FA81(2, iLocal_61, iLocal_60);
			unk_0x0E2400AB9174FA81(2, iLocal_60, iLocal_61);
...
void func_105()
{
	...
	func_108();
	unk_0xDE5F9F54005367A1(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), &vLocal_48, 1, 1077936128, 0);
	...
	if (iLocal_80)
	{
		if (!unk_0x54648B774DB42A3A(iLocal_54, 453432689, 0) && unk_0xEB6A8945D1AC98A1(iLocal_52))
		{
			if (!bLocal_100)
			{
				iLocal_47 = 2;
...
void func_108()
{
	...
	if (bLocal_98 == 0)
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_54) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
		{
			...
			{
				unk_0xDD353D0E9C789D0E(&iLocal_79);
				unk_0x80AA372E04ED318D(0, vLocal_48, 1f, 20000, 40000f, 0,5f);
				unk_0xDBE4EC9C88839074(0, vLocal_48, -1, 2048, 2);
				unk_0xC6EB89C59F2AF6B8(0, sLocal_267, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
				unk_0x75ABDC5F81978924(iLocal_79);
				unk_0x78ADC381772E3D54(iLocal_54, iLocal_79);
				unk_0xF82EA857DA10E0CD(&iLocal_79);
...
void func_109()
{
	...
	{
		unk_0x08082071A5F7C155(iLocal_53, 4, 0f, 0);
	}
}
...
int func_112()
{
	...
	if (((unk_0xB87F6CF6E5628C67(iVar0) && unk_0xB87F6CF6E5628C67(iVar2)) && unk_0xB87F6CF6E5628C67(iVar1)) && unk_0xB4AE0788C1587752(sLocal_267))
	{
		...
		iLocal_53 = unk_0x36F2404464202779(5, iVar2, vLocal_48, fLocal_51, 1, true);
		unk_0x00A6D36F507FD6EA(iLocal_53, 1);
		unk_0x4F39CC3882DD074E(iLocal_53, sVar3);
		unk_0x4E885A246A9D983A(iLocal_53, 20, true);
		iLocal_52 = unk_0x36F2404464202779(22, iVar0, vLocal_48, fLocal_51, 1, true);
		unk_0xD458AC1C1D29C3B4(iLocal_52, 125, 0);
		unk_0x093A734E5AEA758F(iLocal_52, 125);
		unk_0xBAFED2F6486F771A(iLocal_52, 128, true);
		unk_0x00A6D36F507FD6EA(iLocal_52, 1);
		unk_0x4E885A246A9D983A(iLocal_52, 42, true);
		unk_0x967762C930C0C5FD(iLocal_52, 1,5f);
		unk_0x33CE5A9E32EA10B2(iLocal_52, true);
		unk_0x9FA191B317572861(iLocal_52, 40f);
		unk_0x4E885A246A9D983A(iLocal_52, 20, true);
		...
		iLocal_54 = unk_0x36F2404464202779(4, iVar1, -98,113f, 6405,354f, 30,6005f, fLocal_51, 1, true);
		...
		unk_0x33CE5A9E32EA10B2(iLocal_54, true);
		...
		unk_0x262EF6C6306BEA6C(iLocal_52, 453432689, -1, true, true);
		unk_0x20EC6650986ACDC7(iLocal_52, 1);
		unk_0xF63400DBE3303D26("re_rescuehostage relManager", &iLocal_61);
		unk_0xF63400DBE3303D26("re_rescuehostage relBadGuy", &iLocal_60);
		iLocal_59 = unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9());
		unk_0x0E2400AB9174FA81(5, iLocal_60, iLocal_59);
		unk_0x0E2400AB9174FA81(5, iLocal_59, iLocal_60);
		unk_0x6DF7BF67E86AAE86(iLocal_54, iLocal_61);
		unk_0x6DF7BF67E86AAE86(iLocal_52, iLocal_60);
		unk_0x11AD11297DC58CC7(iLocal_53, true);
		unk_0x11AD11297DC58CC7(iLocal_54, true);
		unk_0x11AD11297DC58CC7(iLocal_52, true);
		unk_0xAFF39FB306F8E232(iLocal_54, 11, true);
		unk_0xAFF39FB306F8E232(iLocal_54, 17, true);
		unk_0xAFF39FB306F8E232(iLocal_54, 13, false);
		unk_0xAFF39FB306F8E232(iLocal_54, 5, false);
		unk_0x8685456FA9090367(iLocal_54, 0);
		unk_0xAFF39FB306F8E232(iLocal_53, 11, true);
		unk_0x8685456FA9090367(iLocal_53, 0);
		unk_0xAFF39FB306F8E232(iLocal_53, 13, false);
		unk_0xAFF39FB306F8E232(iLocal_53, 5, false);
...
void func_163()
{
	...
	if (iLocal_47 != 0)
	{
		...
		unk_0x51732B934211201A(iLocal_61);
