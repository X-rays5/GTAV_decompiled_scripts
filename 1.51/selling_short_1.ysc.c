...
void func_23(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			func_24(&(uParam0->f_155[0]), 659,867f, 571,539f, 128,531f, vVar0, 0, 0,5f, -1,5f);
			func_24(&(uParam0->f_155[1]), 660,646f, 567,108f, 128,521f, vVar0, 0, 0,5f, -1,5f);
			break;
		...
		case 2:
			...
			func_24(&(uParam0->f_155[0]), 669,564f, 563,469f, 128,521f, vVar0, 2, -1,5f, -1,5f);
			func_24(&(uParam0->f_155[1]), 672,34f, 559,914f, 128,522f, vVar0, 2, -1,5f, -1,5f);
			break;
		...
		case 4:
			...
			func_24(&(uParam0->f_155[0]), 685,931f, 556,306f, 128,522f, vVar0, 0, 0,5f, -1,5f);
			func_24(&(uParam0->f_155[1]), 685,897f, 555,108f, 128,521f, vVar0, 1, -1,5f, -1,5f);
			break;
		...
		case 6:
			...
			func_24(&(uParam0->f_155[0]), 698,861f, 554,048f, 128,521f, vVar0, 0, 0,5f, -1,5f);
			func_24(&(uParam0->f_155[1]), 703,267f, 554,91f, 128,522f, vVar0, 0, 0,5f, -1,5f);
			break;
...
void func_25(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, int iParam9, int iParam10)
{
	...
	func_26(uParam0[uParam0->f_154], iParam1, vParam2, vParam5, iParam8, iParam9, iParam10);
	uParam0->f_154++;
}
