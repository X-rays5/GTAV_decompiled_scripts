...
void func_186()
{
	unk_0x7E60C62A7CE58FC8(iLocal_96, "SET_COLOUR");
	...
	unk_0x7E60C62A7CE58FC8(iLocal_96, "SET_DISTANCE");
	unk_0x7C19E5E4784BD7CF(10f);
	unk_0x7E60D21B163E9D56();
	unk_0x3039591AD3E735CE(iLocal_97);
	fVar0 = 0,1f;
	fVar1 = 0,24f;
	fVar2 = 0,21f;
	fVar3 = 0,51f;
	...
	unk_0xEF45C43067063F18(iLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x1C0640BA9A7327B3() - iLocal_98) > 1250)
	{
		unk_0xEB819BD1E585E9CB(iLocal_99, "IDLE_BEEP", 2468,51f, 3437,39f, 49,9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = unk_0x1C0640BA9A7327B3();
	}
}
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			...
			if (func_194(unk_0x16F2683693E537C9(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_218(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_223(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_242()
{
	...
	while (!unk_0x83D8570832F172A7(iLocal_96))
	{
		wait(0);
	}
	...
	if (unk_0xE6CD5C6925050049("digiscanner"))
	{
		iLocal_97 = unk_0x3FF702268B97B673("digiscanner");
	}
	iLocal_99 = unk_0xD68EA767274B7444();
	iLocal_98 = unk_0x1C0640BA9A7327B3();
}
...
void func_245(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_246(iParam0);
