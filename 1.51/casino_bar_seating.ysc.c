...
int func_83(int iParam0)
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_84(Global_2425662[iParam0].f_310.f_5) == 14;
			}
		}
	}
	return 0;
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1->f_16[iParam2].f_6.f_1 = { func_105(func_107(), func_106(iParam3, fVar3)) + vVar0 };
	uParam1->f_16[iParam2].f_6.f_4 = { func_105(func_104(), func_106(iParam3, fVar3)) + vVar0 };
