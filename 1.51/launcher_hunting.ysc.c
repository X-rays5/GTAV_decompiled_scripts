void __EntryFunction__()
{
	...
	iLocal_93 = -1661854193;
	iLocal_94 = unk_0x6B7EC7B5B6B57364(100416529);
	iLocal_95 = unk_0xE8213142E3A84F79(-767279652);
	iLocal_96 = unk_0xE8213142E3A84F79(-1489156508);
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_272(&(Global_110725[Var0].f_9));
			}
		}
		func_260(&Var0, 1);
	}
...
bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_212(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_217(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				iLocal_100 = unk_0x5ACD4E66C7BF0F49(100416529, 0, vLocal_97, 0, 1065353216, 0, 0, 1);
				unk_0x3599C729CF725E87(iLocal_100, -767279652);
				unk_0x3599C729CF725E87(iLocal_100, -1489156508);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0xBF75E4DF4C367CD9(vLocal_97, 1f, iLocal_94, 0))
			{
				unk_0xC023D1C4BF532815(iLocal_100, 0f, -90f, -162,64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
void func_237(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	func_238(iParam0, iLocal_93, vParam1, iParam4);
	if (unk_0xC844350D5D58C99A(*iParam0))
	{
...
void func_238(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_239(iParam0);
...
int func_258(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
