...
int func_39(var uParam0)
{
	...
	while (iVar0 <= 11)
	{
		if (uParam0->f_1[iVar0] == 1)
		{
			if (!unk_0xEA6BC48857E0AC4C(&(uParam0->f_331[iVar0])))
			{
				unk_0x0D3BE1DE0262A012(&(uParam0->f_331[iVar0]), false);
				if (!unk_0x27117E2CDD4D67C3(&(uParam0->f_331[iVar0])))
				{
					return 0;
				}
			}
...
int func_47(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_45(iParam1)];
...
{
	iVar0 = Global_2585280[iParam0][func_45(iParam1)];
	if (unk_0x6FB46C25CCB7E6D5(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
