...
int func_2()
{
	...
	if (vdist(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_104) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0xC844350D5D58C99A(iParam0))
	{
		switch (iLocal_82[iParam1])
		{
			...
			case 1:
				...
				if (!unk_0xEA6BC48857E0AC4C(&(Local_87[iParam1])))
				{
					start_new_script_with_args(&(Local_87[iParam1]), &(iLocal_72[iParam1]), 1, 1424);
					iLocal_82[iParam1] = 4;
					return 0;
				}
				if (func_4(iParam0))
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!unk_0xEA6BC48857E0AC4C(&(Local_87[iVar0])))
			{
				unk_0x92DCE5C81176D2B4(&(Local_87[iVar0]));
				if (!unk_0x1FBF08B001C4788A(&(Local_87[iVar0])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0x36F2404464202779(4, iLocal_77[iVar0], vLocal_104 + vLocal_108[iVar0], 0f, 1, true);
...
void func_22()
{
	...
	{
		case 97:
			vLocal_108[0] = { Vector(45,5004f, -205,8167f, -1416,54f) - vLocal_104 };
			vLocal_108[1] = { Vector(45,5004f, -207,5375f, -1423,898f) - vLocal_104 };
			vLocal_108[2] = { Vector(45,5004f, -210,4254f, -1428,501f) - vLocal_104 };
			vLocal_108[3] = { Vector(45,5004f, unk_0x79833B02DBD2A244(-205,8167f, -210,4254f), unk_0x79833B02DBD2A244(-1416,54f, -1428,501f)) - vLocal_104 };
		...
		case 158:
			vLocal_108[0] = { 1,2712f, 6,071f, -0,75f };
			vLocal_108[1] = { 3,8061f, 5,7599f, -0,5f };
			vLocal_108[2] = { 4,541f, 7,8487f, -0,4f };
			vLocal_108[3] = { 3,1051f, 13,7474f, -0,3463f };
		...
		default:
			vLocal_108[0] = { 0f, 0f, 0f };
			vLocal_108[1] = { 0f, 0f, 0f };
			vLocal_108[2] = { 0f, 0f, 0f };
			vLocal_108[3] = { 0f, 0f, 0f };
			fLocal_121[0] = 0f;
			fLocal_121[1] = 0f;
			fLocal_121[2] = 0f;
			fLocal_121[3] = 0f;
