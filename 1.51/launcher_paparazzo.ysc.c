...
{
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_192(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_216(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_221(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_243(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_244(iParam0);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				iLocal_94 = unk_0xE9744DB7B8CA6965(unk_0x68F4C0EC296D3901(uParam0->f_41[0], true), unk_0x835730A2D89F6093(uParam0->f_41[0], 2), 2);
				unk_0xE14EC663EED44AD5(uParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				unk_0xC90224D9E95E5E3A(iLocal_94, true);
				if (func_127(uParam0->f_28[0]))
				{
					unk_0x915804B434753CBD(uParam0->f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_127(uParam0->f_41[1]))
				{
					unk_0xE14EC663EED44AD5(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_127(uParam0->f_41[2]))
				{
					unk_0xE14EC663EED44AD5(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(unk_0x16F2683693E537C9()))
			{
				...
				iLocal_94 = unk_0xE9744DB7B8CA6965(-71,283f, 301,557f, 106,711f, 0f, 0f, 4,659f, 2);
				unk_0xC90224D9E95E5E3A(iLocal_94, true);
				unk_0x915804B434753CBD(uParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
void func_270(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				...
				unk_0x2952D66A502EA873(iLocal_96, 0);
				func_272(iParam0, 0, 0, 0);
				break;
			
			case 48:
				unk_0x77ADAEFF81EAE1E4(-260,62f, 292,13f, 90,6f, 10f, 684586828, true);
				unk_0x77ADAEFF81EAE1E4(-261,58f, 291,66f, 92,06f, 10f, 1620484584, true);
				unk_0x77ADAEFF81EAE1E4(-261,54f, 292,54f, 92,1f, 10f, -1111368675, true);
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (unk_0x8A22C4C08282BF26(-570008042) > 0)
			{
				wait(0);
			}
		}
