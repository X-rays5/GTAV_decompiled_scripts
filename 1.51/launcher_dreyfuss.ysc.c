	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_287(&(Global_110725[Var0].f_9));
			}
		}
		func_269(&Var0, 1);
	}
...
{
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_171(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_239(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_248(&(uParam0->f_35[0]), iVar0[1], vLocal_94, iLocal_97);
				if (func_127(uParam0->f_35[0]))
				{
					unk_0xC6A6B4DDD6DC073A(uParam0->f_35[0], 1);
					unk_0x55A3C4ED4728EA42(uParam0->f_35[0], "DR3YFU55");
					unk_0xAB8E2DDC7AF955E0(iLocal_93, true);
				}
			}
			if (bVar4)
			{
...
void func_269(int iParam0, bool bParam1)
{
	...
	func_270(sVar0);
	unk_0xAB8E2DDC7AF955E0(iLocal_93, false);
	unk_0x2952D66A502EA873(iLocal_99, 0);
	func_240(1);
	if (bParam1)
	{
		func_198(*iParam0);
