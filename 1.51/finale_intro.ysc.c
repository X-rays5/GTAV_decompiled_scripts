...
void func_6()
{
	...
	{
		unk_0x29E8331978B73E7F(unk_0x16F2683693E537C9(), "FRANKLIN", 0, -1692214353, 0);
	}
...
int func_8(int iParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, int iParam7)
{
	if (func_76(iParam1))
	{
		Var5.f_11 = 12;
...
int func_14(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	{
		if ((func_15(iParam0) && unk_0x134B62B726CEC8E6(iParam0) != 873639469) && unk_0x134B62B726CEC8E6(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
void func_78(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_79(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
...
int func_87(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		if (((((((((((((((func_88(vVar18[0], vVar18[1], vVar6, vVar9) || func_88(vVar18[0], vVar18[1], vVar9, vVar15)) || func_88(vVar18[0], vVar18[1], vVar12, vVar15)) || func_88(vVar18[0], vVar18[1], vVar6, vVar12)) || func_88(vVar18[1], vVar18[3], vVar6, vVar9)) || func_88(vVar18[1], vVar18[3], vVar9, vVar15)) || func_88(vVar18[1], vVar18[3], vVar12, vVar15)) || func_88(vVar18[1], vVar18[3], vVar6, vVar12)) || func_88(vVar18[3], vVar18[2], vVar6, vVar9)) || func_88(vVar18[3], vVar18[2], vVar9, vVar15)) || func_88(vVar18[3], vVar18[2], vVar12, vVar15)) || func_88(vVar18[3], vVar18[2], vVar6, vVar12)) || func_88(vVar18[2], vVar18[0], vVar6, vVar9)) || func_88(vVar18[2], vVar18[0], vVar9, vVar15)) || func_88(vVar18[2], vVar18[0], vVar12, vVar15)) || func_88(vVar18[2], vVar18[0], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_91(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_79(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
...
void func_108(char[4] cParam0, int iParam1, int iParam2, int iParam3)
{
	Var0 = 12;
	Var0.f_13 = 12;
	Var0.f_26 = 12;
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_127(iParam1)];
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_123(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0x1A5A491D253EA7BA(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_123(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0x1A5A491D253EA7BA(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
