...
int func_85()
{
	if (Global_2425662[unk_0xD803B885F5E47A62()].f_310.f_8 != func_19())
	{
		if (unk_0xADC2AA9A68E522A1("business_hub_garage_seats", Global_2425662[unk_0xD803B885F5E47A62()].f_310.f_8, 1, 0))
		{
			return 0;
		}
...
void func_87(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1[iParam2]->f_1 = { func_89(func_90(), fVar3) + vVar0 };
	uParam1[iParam2]->f_1.f_3 = { func_89(func_88(), fVar3) + vVar0 };
