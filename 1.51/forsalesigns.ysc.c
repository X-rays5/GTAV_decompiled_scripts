void __EntryFunction__()
{
	...
	if (unk_0x8A22C4C08282BF26(-1556949284) > 1)
	{
...
void func_1()
{
	...
	while (iVar0 < 15)
	{
		if (unk_0xC844350D5D58C99A(Local_210[iVar0]))
		{
			if (unk_0x713261485D0F1B6C(Local_210[iVar0], 0) || func_24(Local_210[iVar0]))
			{
				unk_0x5D96D8530B3D0904(&(Global_111638.f_10044.f_108), iVar0);
				func_21(iVar0);
				unk_0xEEEE2E5FA6F78DF0(&(Local_210[iVar0]));
				bLocal_39 = true;
				func_20(1, 0);
				func_18();
			}
			...
			{
				func_16(&(Local_210[iVar0]), &(Local_210[iVar0].f_10));
			}
		}
		else if (!unk_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_108, iVar0))
		{
			func_13(&(Local_210[iVar0]), iLocal_38, 0, 200f);
		}
		iVar0++;
	}
	func_11();
			...
			case 0:
				if (!unk_0x757EF87A33649210())
				{
					...
					if (unk_0x83D8570832F172A7(iLocal_41))
					{
						...
						unk_0x4D7F4CC43D4D0DE3(iVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_40++;
					}
				}
				break;
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (func_15(unk_0x16F2683693E537C9(), uParam0->f_3, fParam3) && !unk_0xC844350D5D58C99A(*uParam0))
		{
			...
			*uParam0 = unk_0x7707E48765093646(iParam1, uParam0->f_3, 1, true, false);
			uParam0->f_10 = 1;
...
void func_53()
{
	...
	if (!func_2(2))
	{
		Local_210[0].f_3 = { -1569,525f, 444,04f, 108,135f };
		Local_210[0].f_9 = 80f;
		Local_210[1].f_3 = { -1352,88f, 613,77f, 134,34f };
		Local_210[1].f_9 = 198f;
		Local_210[2].f_3 = { -1467f, -5,5f, 53,105f };
		Local_210[2].f_9 = 104f;
		Local_210[3].f_3 = { -1632,833f, -413,8573f, 39,9441f };
		Local_210[3].f_9 = 321,5f;
		Local_210[4].f_3 = { -1765,678f, -423,9763f, 41,5f };
		Local_210[4].f_9 = 256,25f;
		Local_210[5].f_3 = { -380,75f, 427,79f, 110,97f };
		Local_210[5].f_9 = 286,5f;
		Local_210[6].f_3 = { -163,2826f, 989,2324f, 234,0641f };
		Local_210[6].f_9 = 0f;
		Local_210[7].f_3 = { -493,083f, 588,6333f, 122,485f };
		Local_210[7].f_9 = 177,2061f;
		Local_210[8].f_3 = { -818,84f, 434,74f, 88,15f };
		Local_210[8].f_9 = 91,5f;
		Local_210[9].f_3 = { -913,24f, 785,4f, 184,66f };
		Local_210[9].f_9 = 96,26f;
		Local_210[10].f_3 = { -825,92f, -26,67f, 38,68f };
		Local_210[10].f_9 = 15f;
		Local_210[11].f_3 = { -1103,5f, 587,29f, 103,25f };
		Local_210[11].f_9 = 305,5f;
		Local_210[12].f_3 = { -1253,439f, 491,05f, 94,3706f };
		Local_210[12].f_9 = 0f;
		Local_210[13].f_3 = { 160,29f, 486,71f, 142,96f };
		Local_210[13].f_9 = 95f;
		Local_210[14].f_3 = { -1163,859f, 319,19f, 67,96f };
		Local_210[14].f_9 = 40f;
		iLocal_37 = 1;
	}
	else
	{
...
void func_59()
{
	...
	while (iVar0 < 15)
	{
		func_72(&(Local_210[iVar0].f_2));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 15)
	{
		func_71(&(Local_210[iVar0]), 0);
		iVar0++;
	}
...
void func_68()
{
	...
	{
		func_70(13, floor(Global_111638.f_10189.f_3853));
	}
