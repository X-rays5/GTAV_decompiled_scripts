	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_292(&(Global_110725[Var0].f_9));
			}
		}
		func_275(&Var0, 1);
	}
...
{
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - uParam0->f_60) > iParam8) && func_192(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	if (func_127(*uParam1) && func_127(unk_0x16F2683693E537C9()))
	{
		switch (*iParam0)
		{
			...
			case 1:
				...
				{
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -1588,664f, 5210,44f, 2,488135f };
			uParam0->f_17[1] = { -1596,975f, 5228,684f, 5,966843f };
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_255(iParam0);
...
int func_261(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -1598,57f, 5231,605f, 1,969029f };
			uParam0->f_17[1] = { -1610,413f, 5257,687f, 5,965584f };
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
...
int func_273(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
