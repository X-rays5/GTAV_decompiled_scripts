void __EntryFunction__()
{
	...
	Local_481[0] = Local_108.f_28[2];
	Local_481[1] = Local_108.f_28[3];
	Local_481[2] = Local_108.f_28[4];
	Local_782.f_1 = Local_108.f_41[0];
	Local_825 = Local_108.f_41[1];
	iLocal_777 = Local_108.f_41[2];
	Local_749 = Local_108.f_35[0];
	Local_694[4] = Local_108.f_35[1];
	Local_694[5] = Local_108.f_35[2];
	unk_0x2F625BED8BF7F26A(Local_749);
	iLocal_354 = 1;
	iLocal_345 = 1;
	...
	{
		if (func_511(Local_481[iVar0]))
		{
			unk_0x6DF7BF67E86AAE86(Local_481[iVar0], iLocal_774);
			unk_0xCA84BD02FBA0BEA4(Local_481[iVar0], false, iLocal_774);
			unk_0x0E2400AB9174FA81(5, iLocal_774, 1862763509);
		}
		iVar0++;
	}
...
void func_2()
{
	...
	switch (iLocal_169)
	{
		...
		case 3:
			...
			if (!func_32())
			{
				...
				if (func_6(Local_455))
				{
					if (func_5(Local_749))
					{
						if (!unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
						{
							unk_0xF821F915BC24D246(Local_455, Local_749, -1);
						}
					}
				}
			}
		...
		case 4:
			...
			if (func_5(Local_749))
			{
				if (unk_0xDD4B920CF5E7E9EC(Local_749))
				{
					unk_0x2C17FD7B117DEDF0(Local_749);
				}
				unk_0xA47B46945FF6DE74(Local_749, -1246,956f, -89,9753f, 42,904f, 1, false, 0, 1);
				unk_0xD8F6A53F4799FAFE(Local_749, 238f);
				if (func_6(Local_455))
				{
					if (!unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
					{
			...
			if (!func_32())
			{
				if (func_5(Local_694[4]))
				{
					if (func_511(unk_0x16F2683693E537C9()))
					{
						if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_694[4], 0))
						{
							unk_0xF821F915BC24D246(unk_0x16F2683693E537C9(), Local_694[4], -1);
						}
					}
					unk_0xA47B46945FF6DE74(Local_694[4], -1273,736f, -75,3014f, 44,6289f, 1, false, 0, 1);
					unk_0xD8F6A53F4799FAFE(Local_694[4], 242f);
				}
				else
				{
		...
		case 5:
			...
			if (func_5(Local_749))
			{
				unk_0xD458AC1C1D29C3B4(Local_749, 450, 0);
				func_530("SKIPPED CITY CHASE SETTING HEALTH TO 450 ");
			}
			if (func_511(iLocal_777))
			{
				if (unk_0xD59B17D2DFF98E26(iLocal_777))
				{
					unk_0x15AFB6CBDE990FB6(iLocal_777, 1, true);
				}
			}
			func_4(&Local_455);
			iLocal_354 = 0;
		...
		case 6:
			...
			if (!func_32())
			{
				if (func_511(unk_0x16F2683693E537C9()))
				{
					unk_0xA47B46945FF6DE74(unk_0x16F2683693E537C9(), unk_0x68F4C0EC296D3901(iLocal_777, true) + Vector(0f, 1,5f, 0f), 1, false, 0, 1);
				}
			}
			iLocal_362 = 1;
			iLocal_171 = 2;
		...
		case 9:
			...
			while (iVar0 <= 2)
			{
				if (func_511(Local_481[iVar0]))
				{
					unk_0xD458AC1C1D29C3B4(Local_481[iVar0], 0, 0);
				}
				iVar0++;
			}
			break;
...
int func_7(int iParam0)
{
	...
	while (iVar0 <= 2)
	{
		unk_0x523BCC9DC80CD82F(Local_521[iVar0].f_8);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_521[iVar0].f_8))
			{
				return 0;
			}
			iVar0++;
...
int func_8(int iParam0)
{
	...
	while (iVar0 <= 2)
	{
		unk_0x523BCC9DC80CD82F(Local_481[iVar0].f_8);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_481[iVar0].f_8))
			{
				return 0;
			}
			iVar0++;
...
int func_9(int iParam0)
{
	...
	while (iVar0 <= 3)
	{
		unk_0x523BCC9DC80CD82F(Local_402[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		unk_0x523BCC9DC80CD82F(Local_694[iVar0].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 3)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_402[iVar0].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 8)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_694[iVar0].f_5))
			{
				return 0;
			}
			iVar0++;
	...
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_511(unk_0x16F2683693E537C9()))
			{
				...
				while (iVar0 <= 2)
				{
					func_296(Local_481[iVar0], 0);
					func_295(&(Local_481[iVar0].f_11));
					iVar0++;
				}
				func_295(&iLocal_339);
				...
				func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
		...
		case 1:
			...
			if (!func_14())
			{
				if (!iLocal_359)
				{
					if ((unk_0x1C0640BA9A7327B3() - iLocal_373) > 3000)
					{
...
void func_38(int iParam0, bool bParam1)
{
	...
	{
		func_201(&(Global_110725[iVar0].f_9));
	}
	if (bParam1)
	{
		if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
...
void func_190(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != -1)
	{
		...
		func_191(&sVar32, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
{
	func_206(iParam0, 1);
	Global_111638.f_18569[iParam0].f_3 = func_205();
...
int func_233(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 0) && !unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 1, Global_76434[1].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == 225514697)
		...
		{
			func_104(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 1, Global_76434[1].f_1, 0, 1);
		}
...
int func_234(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 0) && !unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 6))
	{
		if (bParam3)
		{
			func_104(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 0, Global_76434[1].f_1, 1, 0);
		}
		else
		{
			func_104(iParam1, Global_76434[1].f_5, Global_76434[1].f_2, 0, Global_76434[1].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
	...
	if (func_511(Local_455))
	{
		switch (iLocal_170)
		{
			case 0:
				...
				if (func_272(Local_455, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						...
						unk_0x9F528B1B53FBC5D9(Local_782.f_1, Local_455, unk_0x4A089F2B762B8D33(Local_455, 28422), 0,06f, 0,04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
						if (func_5(Local_749))
						{
							if (func_6(Local_455))
							{
								if (!unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
								{
									unk_0x5B1D360B9C6F0A09(Local_455, Local_749, -1, -1, 2f, 1, 0);
								}
							}
						}
						func_530("GS_WAIT_FOR_PLAYER, player threatened Glen; attacking...");
						func_293(&uLocal_174, 7, Local_481[0], "Nigel1DCelebSecurity", 0, 1);
						if (func_270())
						{
				...
				else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 11f, 11f, 11f, 0, 1, 0))
				{
					...
					{
						iLocal_388 = unk_0x1C0640BA9A7327B3();
			...
			case 1:
				...
				{
					if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 11f, 11f, 11f, 0, 1, 0))
					{
						unk_0x9F528B1B53FBC5D9(Local_782.f_1, Local_455, unk_0x4A089F2B762B8D33(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						unk_0xDD353D0E9C789D0E(&uLocal_776);
						...
						unk_0x25644C31B4B6E9F3(uLocal_776, 1);
						unk_0x75ABDC5F81978924(uLocal_776);
						unk_0x78ADC381772E3D54(Local_455, uLocal_776);
						unk_0xF82EA857DA10E0CD(&uLocal_776);
						if (func_511(Local_468))
						{
							unk_0xBC43ED9FE28DB191(Local_468);
						}
						iLocal_350 = 1;
						iVar0 = 0;
						while (iVar0 <= 2)
					...
					else if ((unk_0x1C0640BA9A7327B3() - iLocal_381) >= 2500)
					{
						if (unk_0x1B3D109B39CC2C89(Local_455, unk_0x16F2683693E537C9()))
						{
							if (!func_14())
							{
								func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
					...
					if ((func_5(Local_749) && func_5(Local_694[5])) && func_511(unk_0x16F2683693E537C9()))
					{
						if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 0) || unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_694[5], 0))
						{
							if (func_14())
							{
								func_15();
							}
							iLocal_387 = unk_0x1C0640BA9A7327B3();
							func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
							func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
					...
					if ((unk_0x1C0640BA9A7327B3() - iLocal_388) >= 15000)
					{
						if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 11f, 11f, 11f, 0, 1, 0))
						{
							func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
			...
			case 3:
				if (((func_5(Local_749) && func_262(Local_455, Local_749, 1) < 10f) && !unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 0)) && !unk_0x377BE9A1BF38C7CE(Local_749))
				{
					if (unk_0x82CCEAB29E9451DD(Local_455, Local_749))
					{
						func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
						func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
						...
						if (func_6(Local_455))
						{
							if (!func_260())
							{
								unk_0x1B901F542DF070CF(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
							else
							{
								iLocal_363 = 1;
								unk_0x1B901F542DF070CF(Local_455, Local_749, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
						}
						iLocal_170 = 4;
					}
			...
			case 4:
				...
				if (func_5(Local_749))
				{
					if (unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
					{
						if (iLocal_169 != 4)
						{
							if (unk_0x275E6FB578075475(Local_749) >= 200)
							{
					...
					if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 1))
					{
						iLocal_170 = 7;
					}
				}
			...
			case 6:
				...
				if (func_5(Local_749))
				{
					if (!unk_0xC42A92762C58E1B9(Local_455, Local_749, 0) || unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 1))
					{
						iLocal_170 = 7;
					}
				}
...
int func_255()
{
	if (unk_0x9C66D99E63E8E24C(Local_749) < 0,15f && unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
	{
		iLocal_378++;
		if (iLocal_378 > 30)
		{
			...
			{
				unk_0xE0C0351D5B931E37(Local_749, 2f, 3, 0);
				if (unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
				{
					unk_0xA3BF0AA5A2608191(Local_455);
					if (func_14())
					{
						func_12();
					}
...
void func_256()
{
	if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_455, true), 20f, 1))
	{
		if (!unk_0xD17F06053799A7CA())
		{
			if (!func_14())
			{
				if ((unk_0x1C0640BA9A7327B3() - iLocal_385) >= 3000)
				{
					switch (iLocal_379)
					{
						case 0:
					...
					iLocal_385 = unk_0x1C0640BA9A7327B3();
				}
			}
		}
	}
	...
	if (iLocal_169 == 4 || iLocal_169 == 5)
	{
		if (iLocal_380 < 5)
		{
			if (!unk_0xD17F06053799A7CA())
			{
				if (!func_14())
				{
					if ((unk_0x1C0640BA9A7327B3() - iLocal_386) > 15000)
					{
						if (func_6(Local_455))
						{
							if (func_258(Local_455, unk_0x16F2683693E537C9()) < 40f)
							{
								func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
								func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
								switch (iLocal_380)
								{
									case 0:
										if (func_263(&uLocal_174, "NIG1DAU", "NIG1D_CHASE1", 8, 0, 0, 0))
										{
											...
											iLocal_386 = unk_0x1C0640BA9A7327B3();
											iLocal_380++;
										}
										break;
...
int func_260()
{
	if (func_511(unk_0x16F2683693E537C9()))
	{
		if (func_261(&uLocal_935, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)))
		{
			return 1;
		}
	}
...
void func_264()
{
	if (iLocal_357 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_511(Local_481[iVar0]))
			{
				unk_0xA3BF0AA5A2608191(Local_481[iVar0]);
				unk_0xDD353D0E9C789D0E(&uLocal_775);
				unk_0x78A77CDD64392938(0, unk_0x09AC81E49EA267F7(250, 600));
				unk_0x6C3AE6E278DB3D0E(0, unk_0x16F2683693E537C9(), 0, 16);
				unk_0x75ABDC5F81978924(uLocal_775);
				unk_0x78ADC381772E3D54(Local_481[iVar0], uLocal_775);
				unk_0xF82EA857DA10E0CD(&uLocal_775);
				unk_0xAFF39FB306F8E232(Local_481[iVar0], 25, true);
				unk_0xE8832A9E16A57A1F(Local_481[iVar0], true, 1);
				unk_0xFADC0A217229F6B5(Local_481[iVar0], true);
				unk_0x08EAEE08061C1898(Local_481[iVar0], 1);
				unk_0x0E2400AB9174FA81(5, iLocal_774, 1862763509);
				iLocal_667[iVar0] = 4;
				if (!unk_0xE4EDC4B0E92C078B(Local_481[iVar0].f_11))
				{
					Local_481[iVar0].f_11 = func_268(Local_481[iVar0], 0, 0, 5);
				}
		...
		if (func_5(Local_749))
		{
			if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 0))
			{
				if (func_6(Local_455))
				{
					if (!unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
					{
						...
						unk_0x5B1D360B9C6F0A09(0, Local_749, -1, -1, 2f, 1, 0);
						unk_0x75ABDC5F81978924(uLocal_775);
						unk_0x78ADC381772E3D54(Local_455, uLocal_775);
						unk_0xF82EA857DA10E0CD(&uLocal_775);
		...
		if (func_511(Local_468))
		{
			unk_0xE8832A9E16A57A1F(Local_468, true, 1);
		}
		...
		if (iLocal_169 <= 3 && func_511(Local_455))
		{
			...
			if (func_511(Local_468))
			{
				unk_0x9F528B1B53FBC5D9(Local_825, Local_468, unk_0x4A089F2B762B8D33(Local_468, 28422), 0,06f, 0,04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			}
		}
		else if (unk_0xD59B17D2DFF98E26(Local_782.f_1))
		{
			unk_0x15AFB6CBDE990FB6(Local_782.f_1, 1, true);
		}
		func_265(790, 0);
		iLocal_357 = 1;
	}
...
{
	if (unk_0xC844350D5D58C99A(Local_788[iParam0]))
	{
		if (unk_0xD59B17D2DFF98E26(Local_788[iParam0]))
		{
			unk_0x15AFB6CBDE990FB6(Local_788[iParam0], 1, true);
		}
	}
	func_296(Local_561[iParam0], 1);
}
...
int func_270()
{
	if ((func_271(unk_0x16F2683693E537C9()) == 100416529 || func_271(unk_0x16F2683693E537C9()) == 205991906) || func_271(unk_0x16F2683693E537C9()) == 856002082)
	{
		return 1;
	}
	return 0;
...
bool func_275(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_276(&(Local_49[iVar4]), vVar1, iParam1, &(Local_49[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_49[iVar4].f_3) < iParam4);
}

int func_276(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_511(iParam4))
	{
...
int func_279(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_281(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_289(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
...
void func_291()
{
	...
	{
		case 0:
			if (func_6(Local_455) && func_511(unk_0x16F2683693E537C9()))
			{
				if (((func_292(unk_0x16F2683693E537C9(), Local_455, 35f, 1) && iLocal_667[0] != 5) && iLocal_667[1] != 5) && iLocal_667[2] != 5)
				{
					if (!func_14())
					{
						func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
		...
		case 2:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_381) > 4500)
			{
				iLocal_693 = 0;
			}
			break;
...
void func_296(int iParam0, int iParam1)
{
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			unk_0x75ABDC5F81978924(uLocal_776);
			unk_0x78ADC381772E3D54(iParam0, uLocal_776);
			unk_0xF82EA857DA10E0CD(&uLocal_776);
			unk_0xFADC0A217229F6B5(iParam0, true);
		}
	}
...
void func_301()
{
	if (iLocal_348 == 0)
	{
		if (func_307(0))
		{
			...
			while (iVar0 <= 1)
			{
				func_306(&(Local_640[iVar0]), 0);
				unk_0x11AD11297DC58CC7(Local_640[iVar0], true);
				unk_0x25C5402CC10F76CD(Local_640[iVar0], false);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 1)
			{
				func_305(&(Local_755[iVar0]), 0);
				unk_0xAB8E2DDC7AF955E0(Local_755[iVar0].f_5, true);
				iVar0++;
			}
			iLocal_348 = 1;
		}
...
void func_302(int iParam0)
{
	switch (iLocal_678[iParam0])
	{
		case 0:
			if (func_5(Local_749))
			{
				if (func_511(Local_455))
				{
					if (unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
					{
						if (unk_0x12DE711B1C681E9E(Local_455, Local_640[iParam0], 62f, 62f, 62f, 0, 1, 0))
						{
							if (func_6(Local_640[iParam0]))
							{
								unk_0xF96A174EE26D7588(Local_640[iParam0], Local_455, -1);
								iLocal_678[iParam0] = 1;
							}
						}
						else if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_640[iParam0], true), 15f, 1))
						{
							func_293(&uLocal_174, 8, Local_640[iParam0], "NIGEL1DAMBIENTGOLFER1", 0, 1);
							if (func_262(unk_0x16F2683693E537C9(), Local_640[iParam0], 1) < 45f)
							{
								func_303(Local_561[iParam0], "GENERIC_CURSE_MED", 34);
							}
							func_296(Local_640[iParam0], 0);
							iLocal_678[iParam0] = 3;
						}
					}
					else if (func_272(Local_640[iParam0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || unk_0x12DE711B1C681E9E(Local_455, Local_640[iParam0], 30f, 30f, 30f, 0, 1, 0))
					{
						func_296(Local_640[iParam0], 0);
						iLocal_678[iParam0] = 3;
					}
		...
		case 1:
			if (unk_0x12DE711B1C681E9E(Local_455, Local_640[iParam0], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_640[iParam0]))
				{
					func_293(&uLocal_174, 8, Local_640[iParam0], "NIGEL1DAMBIENTGOLFER1", 0, 1);
					if (func_262(unk_0x16F2683693E537C9(), Local_640[iParam0], 1) < 45f)
					{
						func_303(Local_561[iParam0], "GENERIC_CURSE_HIGH", 34);
					}
					unk_0x327AAEE25F323797(Local_640[iParam0]);
					unk_0x80AA372E04ED318D(Local_640[iParam0], Local_640[iParam0].f_4, 3f, -1, 40000f, 0,5f);
					unk_0xFADC0A217229F6B5(Local_640[iParam0], true);
		...
		case 2:
			if (unk_0x5A91F08DF773C39D(Local_640[iParam0], Local_640[iParam0].f_4, 2f, 2f, 2f, false, true, 0))
			{
				func_296(Local_640[iParam0], 0);
				iLocal_678[iParam0] = 3;
			}
...
void func_305(var uParam0, int iParam1)
{
	...
	{
		*uParam0 = unk_0x122AAB0B1D6F55AD(uParam0->f_5, uParam0->f_1, uParam0->f_4, true, 1, false);
	}
	if (iParam1 == 1)
	{
...
int func_307(int iParam0)
{
	...
	while (iVar0 <= 1)
	{
		unk_0x523BCC9DC80CD82F(Local_640[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		unk_0x523BCC9DC80CD82F(Local_755[iVar0].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 1)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_640[iVar0].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 1)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_755[iVar0].f_5))
			{
				return 0;
			}
			iVar0++;
...
void func_308()
{
	if (iLocal_345 == 0)
	{
		if (func_8(0))
		{
			...
			while (iVar0 <= 2)
			{
				func_306(&(Local_481[iVar0]), 0);
				unk_0x11AD11297DC58CC7(Local_481[iVar0], true);
				unk_0x262EF6C6306BEA6C(Local_481[iVar0], 453432689, -1, false, true);
				unk_0x7980D72D61BEF4D5(Local_481[iVar0], true);
				unk_0x25C5402CC10F76CD(Local_481[iVar0], true);
				unk_0x6DF7BF67E86AAE86(Local_481[iVar0], iLocal_774);
				unk_0x1365063FA6365BE8(Local_481[iVar0], true);
				unk_0xC05DBA7D4F88D5E5(Local_481[iVar0].f_8, true);
				iVar0++;
			}
			iLocal_345 = 1;
		}
...
void func_309()
{
	...
	while (iVar0 <= 2)
	{
		if (func_511(Local_481[iVar0]))
		{
			if (iLocal_357 == 0 && iLocal_351 == 0)
			{
				if (func_318())
				{
					...
					{
						func_293(&uLocal_174, 7, Local_481[iVar0], "Nigel1DCelebSecurity", 0, 1);
		...
		else
		{
			if (unk_0xE4EDC4B0E92C078B(Local_481[iVar0].f_11))
			{
				unk_0x142CC44DB769B57E(&(Local_481[iVar0].f_11));
			}
			if (unk_0xC844350D5D58C99A(Local_481[iVar0]))
			{
				if (unk_0x437347B10A200C4B(Local_481[iVar0], 0))
				{
					Local_481[iVar0].f_9 = 1;
				}
			}
		}
		iVar0++;
...
{
	if (func_511(unk_0x16F2683693E537C9()) && func_511(Local_481[iParam0]))
	{
		if (func_262(unk_0x16F2683693E537C9(), Local_481[iParam0], 1) < 20f)
		{
			if (!unk_0xC7E2E6167C09468B(Local_481[iParam0], unk_0x16F2683693E537C9()))
			{
				unk_0x0C8C0C840C2D1AD2(Local_481[iParam0], unk_0x16F2683693E537C9(), 1000, 0, 2);
			}
		}
	}
	...
	{
		case 0:
			if (func_272(Local_481[iParam0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || unk_0xFA4CE147B4D9AEE0(Local_481[iParam0], 61))
			{
				if (func_274(Local_481[iParam0], 110f))
				{
					if (func_14())
					{
						func_12();
					...
					if (func_270())
					{
						func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
			...
			{
				if ((unk_0x0A059E0DB9253280(Local_481[iParam0]) && func_274(Local_481[iParam0], 1126825984)) && func_262(Local_481[iParam0], unk_0x16F2683693E537C9(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
			...
			else if (unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), Local_481[iParam0]))
			{
				if (func_270())
				{
					if (func_274(Local_481[iParam0], 1126825984))
					{
						if (func_14())
						{
							func_12();
			...
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_180(unk_0x16F2683693E537C9(), 12, 4))
					{
						if (!func_314())
						{
							if (func_274(Local_481[iParam0], 1126825984) && unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 18f, 18f, 18f, 0, 1, 0))
							{
								if (func_14())
								{
									func_12();
						...
						else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 18f, 18f, 18f, 0, 1, 0))
						{
							if (iLocal_349 == 0)
							{
								func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
								if (!unk_0xD17F06053799A7CA() || unk_0x0A4C9A3D51EAE31F(203) == 0)
								{
									if (func_269(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										...
										unk_0xF96A174EE26D7588(0, unk_0x16F2683693E537C9(), -1);
										unk_0x75ABDC5F81978924(uLocal_775);
										unk_0x78ADC381772E3D54(Local_481[iParam0], uLocal_775);
										unk_0xF82EA857DA10E0CD(&uLocal_775);
										iLocal_387 = unk_0x1C0640BA9A7327B3();
										iLocal_349 = 1;
							...
							{
								if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 12f, 12f, 12f, 0, 1, 0))
								{
									if (func_14())
									{
										func_12();
					...
					else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 18f, 18f, 18f, 0, 1, 0))
					{
						if (iLocal_349 == 0)
						{
							...
							{
								if (func_6(Local_481[iParam0]))
								{
									unk_0xF96A174EE26D7588(Local_481[iParam0], unk_0x16F2683693E537C9(), -1);
								}
								if (func_6(Local_468))
								{
									unk_0x0C8C0C840C2D1AD2(Local_468, unk_0x16F2683693E537C9(), -1, 0, 2);
								}
								if (func_6(Local_455))
								{
									unk_0x0C8C0C840C2D1AD2(Local_455, unk_0x16F2683693E537C9(), -1, 0, 2);
									unk_0xDD353D0E9C789D0E(&uLocal_776);
			...
			else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 50f, 50f, 50f, 0, 1, 0))
			{
				if (!unk_0x4906F8A34E9F4814(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), Local_749.f_5))
				{
					if (func_274(Local_481[iParam0], 1126825984))
					{
						if (func_14())
				...
				else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 25f, 25f, 25f, 0, 1, 0))
				{
					if (unk_0x9C66D99E63E8E24C(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0)) >= 15f)
					{
						...
						if (unk_0xFA4CE147B4D9AEE0(Local_481[iParam0], 61) || unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 6f, 6f, 6f, 0, 1, 0))
						{
							if (func_274(Local_481[iParam0], 1126825984))
							{
								if (func_14())
					...
					else if (func_274(Local_481[iParam0], 1126825984))
					{
						func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
						if (iLocal_356 == 0)
						{
		...
		case 1:
			if (!func_314())
			{
				if (func_274(Local_481[iParam0], 1126825984))
				{
					if (func_262(unk_0x16F2683693E537C9(), Local_481[iParam0], 1) < 80f)
					{
			...
			else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 9f, 9f, 9f, 0, 1, 0) && iLocal_351 == 1)
			{
				func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
			...
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_387) >= 8000)
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 20f, 20f, 20f, 0, 1, 0))
				{
					func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
		...
		case 2:
			...
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 4f, 4f, 4f, 0, 1, 0) || (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 8f, 8f, 8f, 0, 1, 0) && iLocal_351 == 1))
				{
					func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
					if (func_269(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
					{
				...
				{
					if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 9f, 9f, 9f, 0, 1, 0))
					{
					...
					if ((unk_0x1C0640BA9A7327B3() - iLocal_387) >= 7000)
					{
						if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 20f, 20f, 20f, 0, 1, 0))
						{
							func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
						...
						else if (func_262(unk_0x16F2683693E537C9(), Local_481[iParam0], 1) > 20f)
						{
							unk_0xE655C47E46F9A7E4(Local_481[iParam0], Local_481[iParam0].f_7, 0);
							unk_0xBC43ED9FE28DB191(Local_481[iParam0]);
			...
			else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 18f, 18f, 18f, 0, 1, 0))
			{
				if (iLocal_349 == 0)
				{
					if (!func_14() && iLocal_359 == 0)
					{
						...
						if (func_6(Local_455))
						{
							unk_0xF96A174EE26D7588(Local_455, unk_0x16F2683693E537C9(), -1);
						}
						func_293(&uLocal_174, 7, Local_481[iParam0], "Nigel1DCelebSecurity", 0, 1);
						func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
						func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
		...
		case 3:
			if (!func_314())
			{
				if (func_274(Local_481[iParam0], 1126825984))
				{
					if (func_262(unk_0x16F2683693E537C9(), Local_481[iParam0], 1) < 80f)
					{
						...
						{
							unk_0xA3BF0AA5A2608191(Local_481[iParam0]);
							unk_0xDD353D0E9C789D0E(&uLocal_775);
							...
							unk_0x78ADC381772E3D54(Local_481[iParam0], uLocal_775);
							unk_0xF82EA857DA10E0CD(&uLocal_775);
							unk_0xAFF39FB306F8E232(Local_481[iParam0], 25, true);
							unk_0xE8832A9E16A57A1F(Local_481[iParam0], true, 1);
							unk_0xFADC0A217229F6B5(Local_481[iParam0], true);
							unk_0x08EAEE08061C1898(Local_481[iParam0], 1);
							unk_0x0E2400AB9174FA81(5, iLocal_774, 1862763509);
							iLocal_667[iParam0] = 4;
							if (!unk_0xE4EDC4B0E92C078B(Local_481[iParam0].f_11))
							{
								Local_481[iParam0].f_11 = func_268(Local_481[iParam0], 0, 0, 5);
							}
			...
			{
				if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_481[iParam0], true), 20f, 0) && unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
				...
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 7f, 7f, 5f, 0, 1, 0) || (func_312(unk_0x16F2683693E537C9(), -1097,28f, 68,05f, 52,99f, 10f) && iLocal_351 == 1))
				{
					if (func_14())
					{
						func_12();
				...
				else
				{
					...
					if ((unk_0x1C0640BA9A7327B3() - iLocal_387) >= 10000)
					{
						if (func_511(Local_455))
						{
							if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 25f, 25f, 25f, 0, 1, 0) && !unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_481[iParam0]))
								{
									unk_0x327AAEE25F323797(Local_481[iParam0]);
									unk_0x80AA372E04ED318D(Local_481[iParam0], Local_481[iParam0].f_1, 3f, -1, Local_481[iParam0].f_7, 0,5f);
								}
								iLocal_351 = 1;
								iLocal_667[iParam0] = 0;
							}
							else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 20f, 20f, 20f, 0, 1, 0))
							{
								if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iParam0], 9f, 9f, 9f, 0, 1, 0) || (unk_0x1C0640BA9A7327B3() - iLocal_387) >= 12000)
								{
									if (func_14())
									{
										func_12();
		...
		case 4:
			if (func_262(Local_481[iParam0], unk_0x16F2683693E537C9(), 1) > 120f && (unk_0x405E212DDE472467(Local_455, 0) || func_511(Local_455)))
			{
				if (unk_0xE4EDC4B0E92C078B(Local_481[iParam0].f_11))
				{
					unk_0x142CC44DB769B57E(&(Local_481[iParam0].f_11));
					func_296(Local_481[iParam0], 1);
					iLocal_667[iParam0] = 6;
				}
			}
			else if (!func_311(Local_481[iParam0], 242628503))
			{
				unk_0xDD353D0E9C789D0E(&uLocal_775);
				unk_0x78A77CDD64392938(0, unk_0x09AC81E49EA267F7(5, 200));
				unk_0x6C3AE6E278DB3D0E(0, unk_0x16F2683693E537C9(), 0, 16);
...
int func_314()
{
	if (func_271(unk_0x16F2683693E537C9()) != -1569615261 && func_271(unk_0x16F2683693E537C9()) != 966099553)
	{
		if (func_271(unk_0x16F2683693E537C9()) != 1141786504)
		{
			return 0;
		}
		if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
...
void func_315()
{
	if (unk_0xC844350D5D58C99A(Local_455))
	{
		if (iLocal_169 < 3 || func_262(unk_0x16F2683693E537C9(), Local_455, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_481[iVar0]))
				{
					unk_0xE8832A9E16A57A1F(Local_481[iVar0], true, 1);
					if (iVar0 == 1)
					{
						if (unk_0xC844350D5D58C99A(Local_455))
						{
							unk_0xF96A174EE26D7588(Local_481[iVar0], Local_455, 0);
							unk_0xE185F110925D87DB(Local_481[iVar0], Local_455, 20000, 6f, 2f, 1073741824, 0);
						}
					}
					else
					{
						unk_0x0C8C0C840C2D1AD2(Local_481[iVar0], unk_0x16F2683693E537C9(), -1, 0, 2);
					}
					unk_0x5745EA6329A91E29(Local_481[iVar0], 453432689, true);
					unk_0xD5EF6A937E06E46F(Local_481[iVar0], 1, -1, "DEFAULT_ACTION");
			...
			if (func_511(Local_455))
			{
				...
				{
					unk_0xA3BF0AA5A2608191(Local_455);
					unk_0x8BE3D040D15AEA1D(Local_455, -1);
				}
			}
			if (func_511(Local_468))
			{
				unk_0xA3BF0AA5A2608191(Local_468);
				if (unk_0xD59B17D2DFF98E26(Local_825))
				{
					unk_0x15AFB6CBDE990FB6(Local_825, 1, true);
				}
				unk_0xF3268524E9BE6D6E(Local_468, unk_0x16F2683693E537C9(), 300f, -1, 1, 0);
...
int func_318()
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_511(Local_481[iVar0]) || func_319(unk_0x16F2683693E537C9(), Local_481[iVar0], 1)) || unk_0x869EFD0BC0868856(Local_481[iVar0]))
		{
	...
	if ((!func_511(Local_455) || func_319(unk_0x16F2683693E537C9(), Local_455, 1)) || unk_0x869EFD0BC0868856(Local_455))
	{
		func_530("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return 1;
	}
	if ((!func_511(Local_468) || func_319(unk_0x16F2683693E537C9(), Local_468, 1)) || unk_0x869EFD0BC0868856(Local_468))
	{
		func_530("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return 1;
	}
	if (func_5(Local_749) && func_511(unk_0x16F2683693E537C9()))
	{
		if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_749, 0))
		{
	...
	if (func_5(Local_694[4]) && func_511(unk_0x16F2683693E537C9()))
	{
		if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_694[4], 0))
		{
	...
	if (func_5(Local_694[5]) && func_511(unk_0x16F2683693E537C9()))
	{
		if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_694[5], 0))
		{
	...
	switch (iLocal_171)
	{
		case 0:
			...
			while (iVar0 <= 2)
			{
				if (unk_0xE4EDC4B0E92C078B(Local_481[iVar0].f_11))
				{
					unk_0x516E63E474722206(Local_481[iVar0].f_11, 0,7f);
				}
				iVar0++;
			}
...
int func_321()
{
	...
	while (iVar0 <= 2)
	{
		if (func_511(Local_481[iVar0]))
		{
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_481[iVar0], 70f, 70f, 70f, 0, 1, 0))
			{
				return 0;
			}
		}
...
void func_322()
{
	switch (iLocal_171)
	{
		...
		case 1:
			...
			if (func_511(Local_782.f_1))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_782.f_1, 0,8f, 0,8f, 2f, 0, 1, 1))
				{
					if (unk_0x3A0342D9BFBD378D(Local_782.f_1))
					{
						func_530("Golf club attached to bag - correct?");
						unk_0xCEAA091B490F8407(iLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", false, 0);
					}
					else
					{
						func_530("Golf club NOT attached to bag - correct?");
						unk_0xCEAA091B490F8407(iLocal_389, "COLLECT_OUT_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", false, 0);
					}
		...
		case 2:
			if (iLocal_362 == 1)
			{
				unk_0x790015DC92C918E2();
				iLocal_359 = 0;
				if (unk_0xC844350D5D58C99A(Local_782.f_1))
				{
					unk_0xF690C84DADBB3551(&(Local_782.f_1));
				}
				func_295(&iLocal_339);
				if (!func_300() && !func_321())
				{
...
{
	if (func_261(&uLocal_831, unk_0x68F4C0EC296D3901(iParam0, true)))
	{
		return 1;
	}
	return 0;
...
void func_326()
{
	if (iLocal_364 == 0)
	{
		...
		{
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_782.f_1, 25f, 25f, 25f, 0, 1, 0))
			{
				iLocal_364 = 1;
			}
		}
	...
	if (func_511(unk_0x16F2683693E537C9()))
	{
		if (iLocal_358 == 0)
		{
			if (iLocal_170 == 7 || iLocal_169 == 6)
			{
				if (func_511(Local_782.f_1))
				{
					if (iLocal_364 == 1)
					{
						if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_782.f_1, 65f, 65f, 65f, 0, 1, 0))
						{
		...
		else if (iLocal_170 == 7 || iLocal_169 == 6)
		{
			if (func_511(Local_782.f_1))
			{
				if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_782.f_1, 140f, 140f, 140f, 0, 1, 0))
				{
					func_34(3);
				}
			}
		...
		if (iLocal_169 < 6)
		{
			if (func_511(Local_455))
			{
				if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 140f, 140f, 140f, 0, 1, 0) && !func_275(unk_0x16F2683693E537C9(), Local_455, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_329()
{
	...
	if (unk_0xC844350D5D58C99A(Local_455) && func_511(Local_782.f_1))
	{
		if (unk_0x50B5F6F3C29E9380(Local_782.f_1, Local_455))
		{
			unk_0x15AFB6CBDE990FB6(Local_782.f_1, 1, true);
		}
	}
	...
	if (unk_0xC844350D5D58C99A(Local_782.f_1))
	{
		iLocal_339 = unk_0x5C3B41825F6AC5A0(Local_782.f_1);
		unk_0x61755AC17D8F538E(iLocal_339, 2);
	}
}
...
void func_330()
{
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_5(Local_749))
			{
				if (unk_0x7F6DC62EA9922664(Local_749) > 600)
				{
					unk_0xD458AC1C1D29C3B4(Local_749, 600, 0);
				}
			}
			if (func_511(iLocal_777))
			{
				if (!unk_0xD59B17D2DFF98E26(iLocal_777))
				{
					...
					unk_0x9F528B1B53FBC5D9(iLocal_777, Local_749, 0, 0,2f, -1,3f, 0,5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
			}
			if (func_511(Local_782.f_1) && func_511(Local_455))
			{
				if (!unk_0xD59B17D2DFF98E26(Local_782.f_1))
				{
					func_530("Reattaching club to bag!?");
					unk_0x9F528B1B53FBC5D9(Local_782.f_1, iLocal_777, 0, 0,1f, 0f, -0,25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else if (unk_0x50B5F6F3C29E9380(Local_782.f_1, Local_455))
				{
		...
		case 1:
			...
			if (bLocal_369)
			{
				if (func_511(Local_782.f_1) && func_511(iLocal_777))
				{
					if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
					{
						if (unk_0x50B5F6F3C29E9380(Local_782.f_1, iLocal_777))
						{
							if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_782.f_1, 0,8f, 0,8f, 2f, 0, 1, 1))
							{
								unk_0xCEAA091B490F8407(iLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", false, 0);
...
int func_331()
{
	if (func_5(Local_749))
	{
		if (func_511(Local_455))
		{
			...
			if ((func_255() || unk_0x464B3D84B739AE72(Local_749, 0, 0)) || unk_0x464B3D84B739AE72(Local_749, 1, 0))
			{
			...
			if (unk_0x7F6DC62EA9922664(Local_749) < 500)
			{
...
void func_332()
{
	if (func_511(Local_455))
	{
		if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_455, 20f, 20f, 20f, 0, 1, 0))
		{
			unk_0xE76AF7E1683414C6(Local_455, 0,3f);
		}
		else
		{
			unk_0xE76AF7E1683414C6(Local_455, 0f);
		}
	}
}
...
void func_334(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	func_335(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_335(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
...
void func_336(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
...
void func_352(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (Global_1319117 == 1)
	{
		return;
...
void func_365()
{
	switch (iLocal_171)
	{
		case 0:
			...
			iLocal_385 = unk_0x1C0640BA9A7327B3();
			iLocal_386 = unk_0x1C0640BA9A7327B3();
			unk_0x516E63E474722206(iLocal_339, 1f);
			func_379(&(Local_694[3]));
		...
		case 1:
			...
			else
			{
				...
				if (unk_0x6B63E065F442DAD2(Local_749) >= 200)
				{
					iLocal_171 = 2;
				}
			}
...
int func_366()
{
	if (func_5(Local_749))
	{
		if (func_511(Local_455))
		{
			...
			if (unk_0xB87D13D0C064E9D1(Local_749, unk_0x16F2683693E537C9(), 1) && !unk_0x54648B774DB42A3A(Local_749, 0, 2))
			{
				func_367();
				func_507("VEHICLE HEALTH IS ", unk_0x7F6DC62EA9922664(Local_749));
				unk_0xE910A68AA670B4AA(Local_749);
			}
			else if (unk_0xB87D13D0C064E9D1(Local_749, unk_0x16F2683693E537C9(), 1))
			{
				func_507("VEHICLE HEALTH IS ", unk_0x7F6DC62EA9922664(Local_749));
				unk_0xE910A68AA670B4AA(Local_749);
			}
...
void func_367()
{
	if (!unk_0xD17F06053799A7CA() || unk_0x0A4C9A3D51EAE31F(203) == 0)
	{
		if (!func_14())
		{
			if ((unk_0x1C0640BA9A7327B3() - iLocal_384) >= 6000)
			{
				func_293(&uLocal_174, 6, Local_455, "FOSTENBURG", 0, 1);
			...
			if (func_5(Local_749))
			{
				if (unk_0xC42A92762C58E1B9(Local_455, Local_749, 0))
				{
					if (iLocal_363 == 0)
					{
						if (!unk_0xDD4B920CF5E7E9EC(Local_749))
						{
							unk_0x1B901F542DF070CF(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
						}
					}
					else if (!unk_0xDD4B920CF5E7E9EC(Local_749))
					{
						iLocal_363 = 0;
					}
				}
...
void func_369()
{
	if (iLocal_347 == 0)
	{
		if (func_376(0))
		{
			...
			while (iVar0 <= 5)
			{
				func_306(&(Local_561[iVar0]), 0);
				unk_0x11AD11297DC58CC7(Local_561[iVar0], true);
				unk_0x25C5402CC10F76CD(Local_561[iVar0], true);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 5)
			{
				func_375(&(Local_788[iVar0]), 0);
				unk_0x9F528B1B53FBC5D9(Local_788[iVar0], Local_561[iVar0], unk_0x4A089F2B762B8D33(Local_561[iVar0], 28422), 0,06f, 0,04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
				iVar0++;
			}
			unk_0x9F528B1B53FBC5D9(Local_788[0], Local_561[0], unk_0x4A089F2B762B8D33(Local_561[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x9F528B1B53FBC5D9(Local_788[1], Local_561[1], unk_0x4A089F2B762B8D33(Local_561[1], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x9F528B1B53FBC5D9(Local_788[2], Local_561[2], unk_0x4A089F2B762B8D33(Local_561[2], 28422), 0f, 0f, 0,05f, 0f, -10f, -90f, 0, 0, 0, 0, 2, 1);
			unk_0x9F528B1B53FBC5D9(Local_788[3], Local_561[3], unk_0x4A089F2B762B8D33(Local_561[3], 28422), -0,01f, 0f, 0f, 10f, 0f, -90f, 0, 0, 0, 0, 2, 1);
			iVar0 = 0;
			while (iVar0 <= 1)
			{
				if (func_6(Local_561[iVar0]))
				{
					unk_0xC6EB89C59F2AF6B8(Local_561[iVar0], "rcmnigel1d", Local_561[iVar0].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iVar0 = 2;
			while (iVar0 <= 3)
			{
				if (func_6(Local_561[iVar0]))
				{
					unk_0xC6EB89C59F2AF6B8(Local_561[iVar0], "mini@golf", Local_561[iVar0].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iLocal_347 = 1;
...
void func_370(int iParam0)
{
	switch (iLocal_671[iParam0])
	{
		case 0:
			if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_561[iParam0], true), 50f, 0))
				{
					func_267(iParam0);
					if (!func_14() && !unk_0xD17F06053799A7CA())
					{
						func_303(Local_561[iParam0], "GENERIC_SHOCKED_HIGH", 34);
					}
					func_530("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle); alerted...");
					func_315();
					iLocal_671[iParam0] = 1;
				}
				else if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_561[iParam0], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_272(Local_561[iParam0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						if (!func_314())
						{
							if (!func_14() && !unk_0xD17F06053799A7CA())
							{
								func_303(Local_561[iParam0], "GENERIC_FRIGHTENED_HIGH", 34);
							}
							func_267(iParam0);
						...
						{
							vLocal_399 = { unk_0x68F4C0EC296D3901(Local_561[iParam0], true) };
							Local_561[iParam0].f_10 = 1;
							func_371();
							if (!func_14() && !unk_0xD17F06053799A7CA())
							{
								func_303(Local_561[iParam0], "GENERIC_FUCK_YOU", 34);
								func_530("Played aggro line from ambient golfer...");
							}
							unk_0x25C5402CC10F76CD(Local_561[iParam0], true);
							unk_0x6C3AE6E278DB3D0E(Local_561[iParam0], unk_0x16F2683693E537C9(), 0, 16);
							if (unk_0xC844350D5D58C99A(Local_788[iParam0]))
							{
								if (unk_0xD59B17D2DFF98E26(Local_788[iParam0]))
								{
					...
					else if (func_274(Local_561[iParam0], 1126825984))
					{
						if (!func_314())
						{
							if (!func_14() && !unk_0xD17F06053799A7CA())
			...
			{
				if ((unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_561[iParam0], 11f, 11f, 11f, 0, 1, 0) && unk_0xFA4CE147B4D9AEE0(Local_561[iParam0], 61)) || unk_0xE147126C9AD09A60(Local_561[iParam0]))
				{
					if (!func_14() && !unk_0xD17F06053799A7CA())
					{
						func_303(Local_561[iParam0], "GENERIC_CURSE_MED", 34);
			...
			else if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_561[iParam0], true), 50f, 1))
			{
				func_296(Local_561[iParam0], 1);
				func_372(iParam0);
				if (!func_14() && !unk_0xD17F06053799A7CA())
			...
			else if (unk_0xE147126C9AD09A60(Local_561[iParam0]) || unk_0xB87D13D0C064E9D1(Local_561[iParam0], unk_0x16F2683693E537C9(), 1))
			{
		...
		case 1:
			if (func_272(Local_561[iParam0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && !func_314())
			{
				if (!func_14() && !unk_0xD17F06053799A7CA())
				{
					func_293(&uLocal_174, 8, Local_561[iParam0], "NIGEL1DAMBIENTGOLFER1", 0, 1);
					func_303(Local_561[iParam0], "GENERIC_CURSE_MED", 34);
				}
		...
		case 3:
			if (!func_311(Local_561[iParam0], 1805844857))
			{
				func_267(iParam0);
			}
			func_316(&(Local_561[iParam0]), 1, 0, 1);
			break;
...
void func_371()
{
	...
	while (iVar0 <= 5)
	{
		if (func_511(Local_561[iVar0]))
		{
			if (Local_561[iVar0].f_10 == 0)
			{
				if (unk_0x5A91F08DF773C39D(Local_561[iVar0], vLocal_399, 20f, 20f, 20f, false, true, 0))
				{
					unk_0x25C5402CC10F76CD(Local_561[iVar0], true);
					unk_0x6C3AE6E278DB3D0E(Local_561[iVar0], unk_0x16F2683693E537C9(), 0, 16);
					if (unk_0xC844350D5D58C99A(Local_788[iVar0]))
					{
						if (unk_0xD59B17D2DFF98E26(Local_788[iVar0]))
						{
							unk_0x15AFB6CBDE990FB6(Local_788[iVar0], 1, true);
						}
					}
					iLocal_671[iVar0] = 1;
				}
...
{
	if (unk_0xC844350D5D58C99A(Local_561[iParam0]))
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
			if (func_511(Local_561[iVar0]))
			{
				if (func_373(Local_561[iParam0], Local_561[iVar0], 20f))
				{
...
int func_374(int iParam0)
{
	if (unk_0xC844350D5D58C99A(Local_561[iParam0]))
	{
		if (unk_0x437347B10A200C4B(Local_561[iParam0], 0))
		{
			if (unk_0xC844350D5D58C99A(Local_788[iParam0]))
			{
				if (unk_0xD59B17D2DFF98E26(Local_788[iParam0]))
...
void func_375(var uParam0, int iParam1)
{
	if (unk_0xB87F6CF6E5628C67(uParam0->f_5))
	{
		*uParam0 = unk_0x7707E48765093646(uParam0->f_5, uParam0->f_1, 1, true, false);
...
int func_376(int iParam0)
{
	...
	while (iVar0 <= 5)
	{
		unk_0x523BCC9DC80CD82F(Local_561[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x523BCC9DC80CD82F(Local_788[iVar0].f_5);
		iVar0++;
	}
	if (iParam0 == 0)
	{
		...
		while (iVar0 <= 5)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_561[iVar0].f_8))
			{
				return 0;
			}
			iVar0++;
		...
		while (iVar0 <= 5)
		{
			if (!unk_0xB87F6CF6E5628C67(Local_788[iVar0].f_5))
			{
				return 0;
			}
			iVar0++;
...
void func_380()
{
	switch (iLocal_171)
	{
		...
		case 1:
			...
			if (func_511(Local_455))
			{
				if (unk_0xE9FDA1035CFEA94F(Local_455))
				{
					bLocal_366 = true;
				}
				if (func_5(Local_749))
			...
			if (bLocal_366 == 1)
			{
				if (func_511(Local_455))
				{
					if (unk_0x869EFD0BC0868856(Local_455))
					{
						if (unk_0xD59B17D2DFF98E26(Local_782.f_1))
						{
							unk_0x15AFB6CBDE990FB6(Local_782.f_1, 1, true);
...
void func_381()
{
	switch (iLocal_690)
	{
		...
		case 1:
			if (!unk_0x9F4FE516EAACCFC5(iLocal_343))
			{
				iLocal_343 = func_383();
			}
			if (!unk_0x9F4FE516EAACCFC5(iLocal_341))
			{
				iLocal_341 = unk_0xAE06CCC36C49929C(180543640, -1409,452f, 53,5135f, 78,0868f, -26,7543f, 0f, -85,6976f, 50f, 0, 2);
				unk_0x31C5C518D2E9D8BC(iLocal_341, 4500);
				unk_0xD5AAEA1E1236FBA3(iLocal_341, iLocal_343, 1500, 3);
				unk_0xB2ABBA6B919F5CE7(iLocal_341, -1382,719f, 55,216f, 58,0408f, -15,6873f, 0f, -88,6059f, 1500, 3, 2);
				unk_0xB2ABBA6B919F5CE7(iLocal_341, -1409,452f, 53,5135f, 78,0868f, -26,7543f, 0f, -85,6976f, 1500, 3, 2);
			}
		...
		case 2:
			if (!unk_0xFBB4F23D534EB790(iLocal_343))
			{
				if (!unk_0xFBB4F23D534EB790(iLocal_341))
				{
					unk_0xE3BB8E05FCEB3FBE(iLocal_343, true);
					unk_0xB3A1B75CB59FEB56(true, true, 3000, 1, 0, 0);
				}
			}
			else if (!unk_0xFBB4F23D534EB790(iLocal_341))
			{
				unk_0xE3BB8E05FCEB3FBE(iLocal_341, true);
				unk_0xB3A1B75CB59FEB56(true, true, 3000, 1, 0, 0);
				iLocal_690 = 3;
			}
			break;
		...
		case 4:
			if (!unk_0x9F4FE516EAACCFC5(iLocal_342))
			{
				iLocal_342 = unk_0xAE06CCC36C49929C(180543640, -1373,681f, 57,0584f, 54,9717f, -10,6657f, 0f, 91,5916f, 50f, 0, 2);
				unk_0x31C5C518D2E9D8BC(iLocal_342, 4500);
				unk_0xD5AAEA1E1236FBA3(iLocal_342, iLocal_341, 1500, 3);
				unk_0xB2ABBA6B919F5CE7(iLocal_342, -1382,719f, 55,216f, 58,0408f, -15,6873f, 0f, -88,6059f, 1500, 3, 2);
				unk_0xB2ABBA6B919F5CE7(iLocal_342, -1373,681f, 57,0584f, 54,9717f, -10,6657f, 0f, 91,5916f, 1500, 3, 2);
			}
			if (!unk_0xFBB4F23D534EB790(iLocal_342))
			{
				unk_0xB3A1B75CB59FEB56(true, true, 3000, 1, 0, 0);
				unk_0xE3BB8E05FCEB3FBE(iLocal_342, true);
				wait(3500);
				iLocal_690 = 5;
			}
			if (unk_0xFBB4F23D534EB790(iLocal_343))
			{
				unk_0xE3BB8E05FCEB3FBE(iLocal_343, false);
			}
			if (unk_0xFBB4F23D534EB790(iLocal_341))
			{
				unk_0xE3BB8E05FCEB3FBE(iLocal_341, false);
			}
			break;
		...
		case 5:
			if (unk_0x9F4FE516EAACCFC5(iLocal_342))
			{
				if (unk_0xFBB4F23D534EB790(iLocal_342))
				{
					...
					unk_0xE3BB8E05FCEB3FBE(iLocal_342, false);
					wait(2000);
					unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), true, 0);
					unk_0xBFE31971E49FA500(true);
					unk_0x9A8DDC7C522F5BF5(iLocal_343, 0);
					unk_0x9A8DDC7C522F5BF5(iLocal_341, 0);
					unk_0x9A8DDC7C522F5BF5(iLocal_342, 0);
				}
			}
			func_295(&iLocal_340);
			break;
...
void func_384()
{
	if (iLocal_360 == 0)
	{
		if (func_9(0))
		{
			...
			while (iVar0 <= 3)
			{
				func_306(&(Local_402[iVar0]), 0);
				unk_0x11AD11297DC58CC7(Local_402[iVar0], true);
				iVar0++;
			}
			func_305(&(Local_694[0]), 0);
			unk_0xF821F915BC24D246(Local_402[1], Local_694[0], -1);
			unk_0x5507FCD92D15E617(Local_402[1], 0);
			iLocal_360 = 1;
			iVar0 = 0;
			while (iVar0 <= 3)
			{
				unk_0x71199B01895C6202(Local_402[iVar0].f_8);
				iVar0++;
			}
			iVar0 = 0;
			while (iVar0 <= 8)
			{
				unk_0x71199B01895C6202(Local_694[iVar0].f_5);
				iVar0++;
			}
		}
	}
...
void func_386(int iParam0)
{
	...
	{
		case 0:
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_402[iParam0], 6f, 6f, 6f, 0, 1, 1))
			{
				if (unk_0xD1960163A3042274(Local_402[iParam0], 150319005) != 1)
				{
					unk_0x0C8C0C840C2D1AD2(Local_402[iParam0], unk_0x16F2683693E537C9(), 500, 12, 2);
				}
			}
			if (func_272(Local_402[iParam0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (!unk_0xD17F06053799A7CA() || unk_0x0A4C9A3D51EAE31F(203) == 0)
				{
					if (!func_14())
					{
						if (iParam0 == 0)
						{
							func_293(&uLocal_174, 7, Local_402[iParam0], "CONCIERGE", 0, 1);
							func_293(&uLocal_174, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
			...
			else if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(Local_402[iParam0], true), 30f, 1))
			{
				if (!unk_0xD17F06053799A7CA() || unk_0x0A4C9A3D51EAE31F(203) == 0)
				{
					if (!func_14())
...
void func_388()
{
	if (func_511(unk_0x16F2683693E537C9()))
	{
		if (!func_325(unk_0x16F2683693E537C9()))
		{
			...
			{
				unk_0xF412DD40DE84CE72(iLocal_339, 1);
			}
		}
		else if (!unk_0xE4EDC4B0E92C078B(iLocal_339))
		{
		...
		{
			unk_0xF412DD40DE84CE72(iLocal_339, 0);
		}
	}
}
...
{
	if (func_261(&uLocal_883, unk_0x68F4C0EC296D3901(iParam0, false)))
	{
		return 1;
	}
	return 0;
...
void func_390()
{
	switch (iLocal_171)
	{
		...
		case 1:
			...
			func_254();
			func_381();
			if (func_511(Local_455) && func_511(unk_0x16F2683693E537C9()))
			{
				if (func_292(unk_0x16F2683693E537C9(), Local_455, 50f, 1) || iLocal_170 == 3)
				{
					iLocal_171 = 2;
				}
				else if (func_32())
				...
				{
					if (func_292(unk_0x16F2683693E537C9(), Local_455, 150f, 1))
					{
						iLocal_171 = 2;
					}
				}
...
void func_391(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_232(unk_0xBB0808A181D4745C(), 1);
			if (iVar5 != -1)
			{
...
void func_393(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_250();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_415())
		{
			func_411(unk_0x16F2683693E537C9(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_416(int iParam0, bool bParam1)
{
	...
	if (func_185(iVar0) && !unk_0xEB6A8945D1AC98A1(iParam0))
	{
		if (iParam0 == unk_0x16F2683693E537C9())
		{
			func_417(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_432(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	fVar2 = 1000000f;
	iVar3 = -1;
	iVar0 = 0;
...
void func_467(int iParam0)
{
	...
	{
		if (!unk_0xE4EDC4B0E92C078B(iLocal_340))
		{
			iLocal_340 = func_468(-1377,18f, 55,39f, 53,7f, 0);
			unk_0xBC8E0A7390523199(iLocal_340, 109);
		}
		iLocal_690 = 0;
	}
}
...
void func_470()
{
	while (iLocal_354 == 0)
	{
		if (func_471(0))
		{
			...
			unk_0x9A28E8CB86CD4694(Local_455, 0, 0, 0, false);
			unk_0x11AD11297DC58CC7(Local_455, true);
			unk_0x25C5402CC10F76CD(Local_455, false);
			unk_0x7980D72D61BEF4D5(Local_455, true);
			unk_0xE8832A9E16A57A1F(Local_455, true, 1);
			func_481(Local_455, 0);
			func_306(&Local_468, 0);
			func_375(&Local_825, 0);
			unk_0x9F528B1B53FBC5D9(Local_825, Local_468, unk_0x4A089F2B762B8D33(Local_468, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0xC6EB89C59F2AF6B8(Local_468, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
			unk_0x11AD11297DC58CC7(Local_468, true);
			unk_0x25C5402CC10F76CD(Local_468, false);
			if (func_511(Local_455))
			{
				Local_782.f_3 = { unk_0x550B1459B4642A86(unk_0x68F4C0EC296D3901(Local_455, true), 1067030938, 1069547520) };
			}
			iLocal_777 = unk_0x7707E48765093646(886428669, Local_782.f_3, 1, true, false);
			func_305(&Local_749, 0);
			if (unk_0x562F77A7F33D2E46("NIGEL_1D_SCENE"))
			{
				if (func_5(Local_749))
				{
					unk_0x2E1E5367A885F9B7(Local_749, "NIGEL_1D_GOLF_CART_A", 0);
				}
			}
			unk_0x56FDC9ADE35F7DB0(Local_749, true, 1, 0);
			unk_0xD458AC1C1D29C3B4(Local_749, 1200, 0);
			unk_0x9F528B1B53FBC5D9(iLocal_777, Local_749, 0, 0,2f, -1,3f, 0,5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0xAB8E2DDC7AF955E0(Local_749.f_5, true);
			Local_782.f_1 = unk_0x7707E48765093646(1705580940, Local_782.f_3, 1, true, false);
			unk_0x9F528B1B53FBC5D9(Local_782.f_1, Local_455, unk_0x4A089F2B762B8D33(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			unk_0x71199B01895C6202(Local_455.f_8);
			unk_0xDD353D0E9C789D0E(&uLocal_776);
			unk_0xE655C47E46F9A7E4(0, 112f, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmnigel1d", "swing_a_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmnigel1d", "swing_b_mark", 8f, -2f, -1, 0, 0, 0, 0, 0);
			...
			unk_0x78ADC381772E3D54(Local_455, uLocal_776);
			unk_0xF82EA857DA10E0CD(&uLocal_776);
			func_305(&(Local_694[4]), 0);
			func_305(&(Local_694[5]), 0);
...
{
	unk_0x523BCC9DC80CD82F(iLocal_781);
	unk_0x523BCC9DC80CD82F(-685776591);
	unk_0x523BCC9DC80CD82F(Local_749.f_5);
	unk_0x523BCC9DC80CD82F(Local_825.f_5);
	if (iParam0 == 0)
	{
		if (!unk_0xB87F6CF6E5628C67(iLocal_781))
		{
			return 0;
		}
		if (!unk_0xB87F6CF6E5628C67(-685776591))
		{
			return 0;
		}
		if (!unk_0xB87F6CF6E5628C67(Local_749.f_5))
		{
			return 0;
		}
		if (!unk_0xB87F6CF6E5628C67(Local_825.f_5))
		{
			return 0;
		}
	}
...
void func_475()
{
	...
	while (iVar0 <= 3)
	{
		func_4(&(Local_402[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_4(&(Local_561[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_4(&(Local_640[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_4(&(Local_481[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_4(&(Local_521[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		func_3(&(Local_694[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_3(&(Local_755[iVar0]));
		iVar0++;
	}
	func_3(&Local_749);
	...
	while (iVar0 <= 5)
	{
		func_477(&(Local_788[iVar0]));
		iVar0++;
	}
	if (unk_0x762119754C50557A(Local_782))
	{
		unk_0x40B7230FD4C59AA2(Local_782);
	}
	func_295(&iLocal_339);
	iVar0 = 0;
	while (iVar0 <= 2)
	...
	unk_0x51732B934211201A(iLocal_774);
...
void func_500()
{
	...
	while (iVar0 <= 2)
	{
		unk_0x71199B01895C6202(Local_521[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		unk_0x71199B01895C6202(Local_481[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x71199B01895C6202(Local_561[iVar0].f_8);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		unk_0x71199B01895C6202(Local_640[iVar0].f_8);
		iVar0++;
	}
	unk_0x71199B01895C6202(iLocal_781);
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		unk_0x71199B01895C6202(Local_694[iVar0].f_5);
	...
	while (iVar0 <= 1)
	{
		unk_0x71199B01895C6202(Local_755[iVar0].f_5);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		unk_0x71199B01895C6202(Local_788[iVar0].f_5);
		iVar0++;
	}
}
...
int func_509(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bVar0 = false;
	if (func_511(iParam0))
	{
...
void func_512()
{
	...
	iLocal_379 = 0;
	iLocal_380 = 0;
	iLocal_389 = unk_0xD68EA767274B7444();
	if (!unk_0x562F77A7F33D2E46("NIGEL_1D_SCENE"))
	{
	...
	unk_0xF63400DBE3303D26("SecurityGroup", &iLocal_774);
	unk_0x0E2400AB9174FA81(1, iLocal_774, -1533126372);
	unk_0x0E2400AB9174FA81(1, -1533126372, iLocal_774);
	...
	unk_0x523BCC9DC80CD82F(1147287684);
	while (((((((!unk_0x67C1D9E5B91B2E37(0) || !unk_0xB4AE0788C1587752("rcmnigel1d")) || !unk_0xB4AE0788C1587752("mini@golf")) || !unk_0x1C2E18E9C63BEB77("NIGEL1DTRANS")) || !unk_0x1C2E18E9C63BEB77("NIGEL1DGOLF")) || !unk_0x1C2E18E9C63BEB77("NIGEL1DGOLF2")) || !unk_0x1C2E18E9C63BEB77("NIGEL1DCRASH")) || !unk_0xB87F6CF6E5628C67(1147287684))
	{
		wait(0);
	}
	unk_0x7DE464FD26F7E7E7(0,75f);
	unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), true, 256);
	iLocal_778 = unk_0x7D6CA5F52B3748BF(-1122,202f, 48,5724f, 51,4652f, -1076,233f, 92,1041f, 60,0617f, 0, 1, 1, 1);
	unk_0x10F3BFFADF2CE3DA(-1073,19f, 342,05f, 63,32832f, -966,24f, 411,05f, 84,82043f);
	iLocal_779 = unk_0x7D6CA5F52B3748BF(-1379,33f, 45,13f, 50,68f, -1368,01f, 69,83f, 55,9f, 0, 1, 1, 1);
	if (iLocal_780 == -1)
	{
		iLocal_780 = unk_0x544B74C043CE9948(-1375,08f, 55,55f, 52,93f, 4f, 6f, 4f, 355f, 0, 7);
	}
	func_521(64, 2, 0);
	if (func_351(0))
	{
...
void func_513(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_261(uParam1, *uParam1[iVar1] + vVar9))
		{
			vVar9 = { -vVar9 };
		}
		...
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1] = { func_523(iParam0) };
					...
					{
						Global_7966[1] = { func_523(iParam0) };
...
void func_529()
{
	...
	Local_749.f_4 = 243f;
	Local_749.f_5 = 1147287684;
	Local_468.f_1 = { -1096,258f, 69,723f, 53,0107f };
	Local_468.f_7 = 163f;
	Local_468.f_8 = -685776591;
	Local_825.f_1 = { Local_468.f_1 };
	Local_825.f_5 = 1705580940;
	Local_694[0].f_1 = { -1370,192f, 61,6015f, 52,4847f };
	Local_694[0].f_4 = 206f;
	Local_694[0].f_5 = 1147287684;
	Local_694[1].f_1 = { -1373,868f, 65,9104f, 52,5826f };
	Local_694[1].f_4 = 224f;
	Local_694[1].f_5 = 1147287684;
	Local_694[2].f_1 = { -1302,413f, -6,6432f, 48,8636f };
	Local_694[2].f_4 = 20f;
	Local_694[2].f_5 = 1147287684;
	Local_694[3].f_1 = { -1328,512f, 26,7404f, 52,4943f };
	Local_694[3].f_4 = 272f;
	Local_694[3].f_5 = 1147287684;
	Local_694[4].f_1 = { -1102,335f, 75,7757f, 53,2591f };
	Local_694[4].f_4 = 293f;
	Local_694[4].f_5 = 1147287684;
	Local_694[5].f_1 = { -1103,023f, 65,6267f, 53,056f };
	Local_694[5].f_4 = 203f;
	Local_694[5].f_5 = 1147287684;
	Local_694[6].f_1 = { -1356,7f, 145,34f, 55,67f };
	Local_694[6].f_4 = 187f;
	Local_694[6].f_5 = 1147287684;
	Local_694[7].f_1 = { -1158,52f, 68,38f, 55,97f };
	Local_694[7].f_4 = 226,84f;
	Local_694[7].f_5 = 1147287684;
	Local_694[8].f_1 = { -1165,397f, 72,9072f, 55,6258f };
	Local_694[8].f_4 = 238f;
	Local_694[8].f_5 = 1147287684;
	Local_768.f_1 = { -1191,22f, 36,83f, 52,03f };
	Local_768.f_4 = -77,1337f;
	Local_768.f_5 = 1147287684;
	Local_481[0].f_1 = { -1105,622f, 66,4609f, 53,07f };
	Local_481[0].f_7 = 118f;
	Local_481[0].f_8 = -245247470;
	Local_481[1].f_1 = { -1090,09f, 64,3905f, 52,5607f };
	Local_481[1].f_7 = 238f;
	Local_481[1].f_8 = -245247470;
	Local_481[2].f_1 = { -1093,736f, 73,8568f, 53,0388f };
	Local_481[2].f_7 = 319f;
	Local_481[2].f_8 = -245247470;
	Local_521[0].f_1 = { -1298,49f, -23,89f, 47,99f };
	Local_521[0].f_7 = 126,55f;
	Local_521[0].f_4 = { -1314,059f, -35,6361f, 48,1836f };
	Local_521[0].f_8 = -681004504;
	Local_521[1].f_1 = { -1344,505f, 18,8674f, 51,9921f };
	Local_521[1].f_7 = 205f;
	Local_521[1].f_4 = { -1344,4f, 18,11f, 52,19f };
	Local_521[1].f_8 = -681004504;
	Local_521[2].f_1 = { -1376,71f, 140,2f, 55,25f };
	Local_521[2].f_7 = 99f;
	Local_521[2].f_4 = { -1375,577f, 131,1931f, 55,3238f };
	Local_521[2].f_8 = -681004504;
	Local_402[0].f_1 = { -1377,18f, 55,39f, 53,7f };
	Local_402[0].f_7 = 101f;
	Local_402[0].f_8 = 999748158;
	Local_402[1].f_1 = { -1369,305f, 52,1333f, 52,4768f };
	Local_402[1].f_7 = 20f;
	Local_402[1].f_8 = 999748158;
	Local_402[2].f_1 = { -1366,581f, 54,04f, 52,4633f };
	Local_402[2].f_7 = 94f;
	Local_402[2].f_8 = 999748158;
	Local_402[3].f_1 = { -1367,691f, 60,2214f, 52,4635f };
	Local_402[3].f_7 = 126f;
	Local_402[3].f_8 = 999748158;
	Local_561[0].f_1 = { -1161,109f, 72,2742f, 55,6518f };
	Local_561[0].f_7 = 328,424f;
	Local_561[0].f_8 = -685776591;
	Local_561[0].f_12 = "idle_b";
	Local_561[1].f_1 = { -1159,803f, 71,7432f, 55,6988f };
	Local_561[1].f_7 = 344,2791f;
	Local_561[1].f_8 = -685776591;
	Local_561[1].f_12 = "idle_c";
	Local_561[2].f_1 = { -1143,173f, 112,0022f, 58,1151f };
	Local_561[2].f_7 = 109f;
	Local_561[2].f_8 = -685776591;
	Local_561[2].f_12 = "wood_idle_low_b";
	Local_561[3].f_1 = { -1157,17f, 79,4863f, 56,7109f };
	Local_561[3].f_7 = 159f;
	Local_561[3].f_8 = -685776591;
	Local_561[3].f_12 = "wedge_idle_high_c";
	Local_561[4].f_1 = { -1060,173f, 79,7097f, 51,0781f };
	Local_561[4].f_7 = 222f;
	Local_561[4].f_8 = -685776591;
	Local_561[4].f_12 = "wedge_idle_high_b";
	Local_561[5].f_1 = { -1025,151f, 8,619f, 48,7672f };
	Local_561[5].f_7 = 133f;
	Local_561[5].f_8 = -685776591;
	Local_561[5].f_12 = "putt_idle_high_b";
	Local_788[0].f_1 = { Local_561[0].f_1 };
	Local_788[0].f_5 = 1750479612;
	Local_788[1].f_1 = { Local_561[1].f_1 };
	Local_788[1].f_5 = 1750479612;
	Local_788[2].f_1 = { Local_561[2].f_1 };
	Local_788[2].f_5 = 1705580940;
	Local_788[3].f_1 = { Local_561[3].f_1 };
	Local_788[3].f_5 = 1705580940;
	Local_788[4].f_1 = { Local_561[4].f_1 };
	Local_788[4].f_5 = 334347537;
	Local_788[5].f_1 = { Local_561[5].f_1 };
	Local_788[5].f_5 = 1750479612;
	Local_640[0].f_1 = { -1096,278f, -117,3159f, 40,537f };
	Local_640[0].f_4 = { -1095,01f, -56,45f, 43,83f };
	Local_640[0].f_7 = 343f;
	Local_640[0].f_8 = -685776591;
	Local_640[1].f_1 = { -1115,548f, -104,4307f, 40,8407f };
	Local_640[1].f_4 = { -1139,619f, -114,8868f, 40,0996f };
	Local_640[1].f_7 = 45f;
	Local_640[1].f_8 = -685776591;
	Local_755[0].f_1 = { -1100,818f, -103,591f, 40,874f };
	Local_755[0].f_4 = 99f;
	Local_755[0].f_5 = 1147287684;
	Local_755[1].f_1 = { -1114,088f, -97,6378f, 41,0175f };
	Local_755[1].f_4 = 233f;
	Local_755[1].f_5 = 1147287684;
}
...
int func_532(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_537(&iVar0) || !unk_0xB4AE0788C1587752(uParam0->f_48)) || !unk_0xB4AE0788C1587752(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			uParam0->f_41[0] = unk_0x7707E48765093646(iVar0[1], -1096,855f, 67,6858f, 52,952f, 1, true, false);
			...
			unk_0x25644C31B4B6E9F3(uVar10, 1);
			unk_0x75ABDC5F81978924(uVar10);
			unk_0x78ADC381772E3D54(uParam0->f_28[0], uVar10);
			...
			uParam0->f_41[1] = unk_0x7707E48765093646(iVar0[2], -1096,258f, 69,723f, 53,0107f, 1, true, false);
			...
			while (iVar9 <= 4)
			{
				unk_0x11AD11297DC58CC7(uParam0->f_28[iVar9], true);
				unk_0x262EF6C6306BEA6C(uParam0->f_28[iVar9], 453432689, -1, false, true);
				unk_0x7980D72D61BEF4D5(uParam0->f_28[iVar9], true);
				unk_0x25C5402CC10F76CD(uParam0->f_28[iVar9], true);
				unk_0x1365063FA6365BE8(uParam0->f_28[iVar9], true);
				unk_0x08EAEE08061C1898(uParam0->f_28[iVar9], 1);
				unk_0xC05DBA7D4F88D5E5(iVar0[0], true);
				iVar9++;
			}
			uParam0->f_35[0] = unk_0x122AAB0B1D6F55AD(iVar0[5], -1099,91f, 61,2608f, 52,8124f, 243f, true, 1, false);
			unk_0xB9FD7450C0DAB575(uParam0->f_35[0], 1084227584);
			unk_0x56FDC9ADE35F7DB0(uParam0->f_35[0], true, 1, 0);
			unk_0xD458AC1C1D29C3B4(uParam0->f_35[0], 1200, 0);
			unk_0xAB8E2DDC7AF955E0(iVar0[5], true);
			uParam0->f_41[2] = unk_0x7707E48765093646(iVar0[6], -1099,91f, 63,2608f, 52,8124f, 1, true, false);
			unk_0x9F528B1B53FBC5D9(uParam0->f_41[2], uParam0->f_35[0], 0, 0,2f, -1,3f, 0,5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			uParam0->f_35[1] = unk_0x122AAB0B1D6F55AD(iVar0[5], -1102,335f, 75,7757f, 53,2591f, 293f, true, 1, false);
			uParam0->f_35[2] = unk_0x122AAB0B1D6F55AD(iVar0[5], -1103,023f, 65,6267f, 53,056f, 203f, true, 1, false);
			iVar9 = 1;
			while (iVar9 <= 2)
			{
				unk_0xB9FD7450C0DAB575(uParam0->f_35[iVar9], 1084227584);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 <= (iVar0 - 1))
	...
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				...
				unk_0xC05DBA7D4F88D5E5(579932932, true);
				unk_0xC05DBA7D4F88D5E5(-1613485779, true);
				...
				unk_0xAB8E2DDC7AF955E0(-1800170043, true);
			}
			else
			{
				unk_0x2952D66A502EA873(iLocal_107, 0);
				...
				unk_0xEFED0CD6E25037B9();
				unk_0xC05DBA7D4F88D5E5(579932932, false);
				unk_0xC05DBA7D4F88D5E5(-1613485779, false);
				unk_0xE342F209E49C5314(-577,274f, 270,6505f, 77f, -543,1793f, 315,2973f, 94f, true, 1);
				unk_0xAB8E2DDC7AF955E0(-1800170043, false);
			}
			break;
...
void func_539(int iParam0)
{
	...
	while (iVar0 <= 3)
	{
		func_316(&(Local_402[iVar0]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_316(&(Local_521[iVar0]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_316(&(Local_481[iVar0]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_316(&(Local_561[iVar0]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_316(&(Local_640[iVar0]), 1, 0, 1);
		iVar0++;
	}
	func_316(&Local_468, 1, 0, 1);
	...
	while (iVar0 <= 8)
	{
		func_379(&(Local_694[iVar0]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_379(&(Local_755[iVar0]));
		iVar0++;
	}
	func_379(&Local_749);
	iVar0 = 0;
	...
	unk_0x2952D66A502EA873(iLocal_779, 0);
	if (iLocal_780 > -1)
	{
		unk_0xDDABC98CFF1A4C60(iLocal_780);
	}
...
int func_552(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_555())
	{
		...
		{
			iVar33 = func_460(unk_0xBB0808A181D4745C());
			if (iVar33 > -1)
			{
