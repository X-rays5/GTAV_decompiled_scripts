	...
	while (true)
	{
		...
		if (unk_0x338D6FF72D84D90F())
		{
			...
			if (!func_99())
			{
				...
				switch (iLocal_46)
				{
					...
					case 1:
						...
						{
							if ((!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0xEB6A8945D1AC98A1(iLocal_69[0])) && !unk_0xEB6A8945D1AC98A1(iLocal_69[1]))
							{
						...
						else
						{
							...
							{
								unk_0xF3268524E9BE6D6E(iLocal_68, unk_0x16F2683693E537C9(), 150f, -1, 0, 0);
							}
							func_69();
						}
						break;
			...
			else
			{
				...
				if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
				{
					if (unk_0xB87D13D0C064E9D1(iLocal_68, unk_0x16F2683693E537C9(), 1))
					{
						unk_0xF3268524E9BE6D6E(iLocal_68, unk_0x16F2683693E537C9(), 150f, -1, 0, 0);
						func_69();
					}
					if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (iLocal_48 < 7 && !unk_0xEB6A8945D1AC98A1(iLocal_68))
								{
									if (unk_0x7069CC4DE1EA3FAA(unk_0x16F2683693E537C9(), iLocal_68, 90f))
									{
										if (unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iLocal_68) || unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), iLocal_68))
										{
											func_64();
										}
									}
...
void func_1()
{
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
		{
			unk_0x7980D72D61BEF4D5(iLocal_68, false);
	...
	if (unk_0x0EB28750412C3A5A(func_2(unk_0xD803B885F5E47A62()), vLocal_50, true) > 50f)
	{
		func_146();
	}
}
	...
	switch (iLocal_48)
	{
					...
					if (!unk_0xEB6A8945D1AC98A1(iLocal_69[iVar0]) && !unk_0x437347B10A200C4B(iLocal_77[iVar0], 0))
					{
						if (!unk_0xE4EDC4B0E92C078B(iLocal_61[iVar0]))
						{
							...
							if (unk_0x405E212DDE472467(iLocal_69[iVar0], 0))
							{
								if (!bLocal_55)
								{
									unk_0xFFDDE8CC59EB6D40(iLocal_69[iVar0], unk_0x16F2683693E537C9(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									unk_0xDD353D0E9C789D0E(&uLocal_84);
									unk_0x6C3AE6E278DB3D0E(0, unk_0x16F2683693E537C9(), 0, 16);
									unk_0x75ABDC5F81978924(uLocal_84);
									unk_0x78ADC381772E3D54(iLocal_69[iVar0], uLocal_84);
									unk_0xF82EA857DA10E0CD(&uLocal_84);
									unk_0xFADC0A217229F6B5(iLocal_69[iVar0], true);
								}
							}
						}
				...
				if (!unk_0xEB6A8945D1AC98A1(iLocal_69[iVar1]))
				{
					if (unk_0x5A91F08DF773C39D(iLocal_69[iVar1], 904,3153f, 3631,684f, 31,574f, 7f, 7f, 7f, false, true, 0))
					{
						...
						if (unk_0x405E212DDE472467(iLocal_69[iVar1], 0))
						{
							...
							unk_0x6C3AE6E278DB3D0E(0, unk_0x16F2683693E537C9(), 0, 16);
							unk_0x75ABDC5F81978924(uLocal_84);
							unk_0x78ADC381772E3D54(iLocal_69[iVar1], uLocal_84);
							unk_0xF82EA857DA10E0CD(&uLocal_84);
		...
		case 2:
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				...
				unk_0x75ABDC5F81978924(uLocal_84);
				unk_0x78ADC381772E3D54(iLocal_68, uLocal_84);
				unk_0xF82EA857DA10E0CD(&uLocal_84);
			}
			if (!unk_0x437347B10A200C4B(iLocal_76, 0))
			{
				unk_0xE910A68AA670B4AA(iLocal_76);
				if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x7069CC4DE1EA3FAA(iLocal_68, unk_0x16F2683693E537C9(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (!unk_0x12DE711B1C681E9E(iLocal_68, unk_0x16F2683693E537C9(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0x437347B10A200C4B(iLocal_76, 0))
			{
				if (unk_0xB87D13D0C064E9D1(iLocal_76, unk_0x16F2683693E537C9(), 0))
				{
					func_69();
				}
			}
		...
		case 6:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0xB4ECF989E2C1DAC8(iLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0x8CA9406E01C7EE58(iLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade") > 0,436f && unk_0x405E212DDE472467(iLocal_68, 0))
					{
						unk_0xE3971CAD01180CD0(unk_0x68E4ADDDDCD7BDDE(unk_0x6937EA2286828455(iLocal_68, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_48++;
					}
				}
			}
...
void func_59()
{
	switch (iLocal_48)
	{
		...
		case 1:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0x0C8C0C840C2D1AD2(iLocal_68, unk_0x16F2683693E537C9(), -1, 2060, 2);
		...
		case 4:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0x5A91F08DF773C39D(iLocal_68, 916,5764f, 3602,146f, 31,9262f, 3,3f, 3,3f, 3,3f, false, true, 0))
				{
					if (!unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
							if (func_42(&uLocal_85, "RECGFAU", "RECGF_STASH", 4, 0, 0, 0))
							{
								unk_0xF96A174EE26D7588(iLocal_68, unk_0x16F2683693E537C9(), -1);
								if (!unk_0x437347B10A200C4B(iLocal_76, 0))
								{
									unk_0xE910A68AA670B4AA(iLocal_76);
								}
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0) || unk_0x7A649D473D0B6339(unk_0x16F2683693E537C9()))
					{
						...
						{
							func_41(1000);
							if ((!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0xEB6A8945D1AC98A1(iLocal_69[2])) && !unk_0x437347B10A200C4B(iLocal_76, 0))
							{
								unk_0xDD353D0E9C789D0E(&uLocal_84);
								unk_0x7B5CD34C8882F120(0, iLocal_76, -1, -1, 1f);
								unk_0x0C8C0C840C2D1AD2(0, iLocal_69[2], 2000, 0, 2);
								unk_0xF96A174EE26D7588(0, iLocal_69[2], 0);
								unk_0x75ABDC5F81978924(uLocal_84);
								unk_0x78ADC381772E3D54(iLocal_68, uLocal_84);
								unk_0xF82EA857DA10E0CD(&uLocal_84);
								func_41(2000);
								...
								if ((!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0x437347B10A200C4B(iLocal_76, 0)) && unk_0x405E212DDE472467(iLocal_68, 0))
								{
									iLocal_48++;
								}
								else
								{
									if (!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0xEB6A8945D1AC98A1(iLocal_69[2]))
									{
										unk_0xDD353D0E9C789D0E(&uLocal_84);
		...
		case 7:
			if ((((!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0x437347B10A200C4B(iLocal_76, 0)) && !unk_0xC42A92762C58E1B9(iLocal_68, iLocal_76, 0)) && !unk_0xC379FAA7E9DFE7A4(iLocal_68, 0)) && !unk_0xBC695A145F39D2EF(iLocal_68))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			...
			if (unk_0x5A91F08DF773C39D(iLocal_69[2], 970,3641f, 3629,886f, 31,3694f, 5f, 5f, 5f, false, true, 0) || timerb() > 13000)
			{
				func_41(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_69)
				...
				if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
				{
					if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 15f, 15f, 15f, 0, 1, 0))
					{
						func_60();
						func_41(0);
...
int func_62()
{
	...
	{
		unk_0x523BCC9DC80CD82F(301427732);
		unk_0x523BCC9DC80CD82F(1330042375);
		unk_0x523BCC9DC80CD82F(1032073858);
		unk_0x8BC9595FD2792B5D("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
		if (unk_0xB87F6CF6E5628C67(301427732))
		{
			iLocal_77[2] = unk_0x122AAB0B1D6F55AD(301427732, 863,4697f, 3633,5f, 31,9874f, 290,5797f, true, true, false);
			iLocal_77[3] = unk_0x122AAB0B1D6F55AD(301427732, 866,4073f, 3636,039f, 31,9514f, 270,3649f, true, true, false);
			iLocal_77[4] = unk_0x122AAB0B1D6F55AD(301427732, 866,3153f, 3631,587f, 31,9545f, 276,6327f, true, true, false);
			iLocal_77[5] = unk_0x122AAB0B1D6F55AD(301427732, 868,5937f, 3633,523f, 31,9622f, 267,0991f, true, true, false);
			unk_0x71199B01895C6202(301427732);
			unk_0x5C73CD40F396DC05(iLocal_77[2], 3);
			unk_0x5C73CD40F396DC05(iLocal_77[4], 3);
			iLocal_59 = unk_0x1C0640BA9A7327B3() + 1500;
		}
		if ((unk_0xB87F6CF6E5628C67(1330042375) && unk_0xB87F6CF6E5628C67(1032073858)) && unk_0x562F77A7F33D2E46("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			iLocal_69[2] = unk_0x852A19533F896693(iLocal_77[2], 22, 1330042375, -1, 1, true);
			iLocal_69[3] = unk_0x852A19533F896693(iLocal_77[3], 22, 1032073858, -1, 1, true);
			iLocal_69[4] = unk_0x852A19533F896693(iLocal_77[4], 22, 1330042375, -1, 1, true);
			iLocal_69[5] = unk_0x852A19533F896693(iLocal_77[5], 22, 1032073858, -1, 1, true);
			...
			while (iVar0 < iLocal_69)
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_69[iVar0]) && !unk_0x437347B10A200C4B(iLocal_77[iVar0], 0))
				{
					...
					unk_0x6DF7BF67E86AAE86(iLocal_69[iVar0], iLocal_250);
					...
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x262EF6C6306BEA6C(iLocal_69[iVar0], 453432689, -1, true, true);
					}
					else
					{
						unk_0x262EF6C6306BEA6C(iLocal_69[iVar0], 2017895192, -1, true, true);
					}
					unk_0xDD353D0E9C789D0E(&uLocal_84);
					unk_0xE9362E4D600DD12A(0, iLocal_77[2], 966,7098f, 3633,926f, 31,3974f, 10f, 0, 301427732, 786725, 4f, 100f);
					unk_0xDBE4EC9C88839074(0, vLocal_50, 5000, 0, 2);
					unk_0x75ABDC5F81978924(uLocal_84);
					unk_0x78ADC381772E3D54(iLocal_69[2], uLocal_84);
					unk_0xF82EA857DA10E0CD(&uLocal_84);
					unk_0xDD353D0E9C789D0E(&uLocal_84);
					unk_0xE9362E4D600DD12A(0, iLocal_77[3], 970,6208f, 3636,743f, 31,3666f, 10f, 0, 301427732, 786725, 4f, 100f);
					unk_0xDBE4EC9C88839074(0, vLocal_50, 5000, 0, 2);
					unk_0x75ABDC5F81978924(uLocal_84);
					unk_0x78ADC381772E3D54(iLocal_69[3], uLocal_84);
					unk_0xF82EA857DA10E0CD(&uLocal_84);
					unk_0xFADC0A217229F6B5(iLocal_69[3], true);
					unk_0xDD353D0E9C789D0E(&uLocal_84);
					unk_0xE9362E4D600DD12A(0, iLocal_77[4], 971,023f, 3631,225f, 31,3807f, 10f, 0, 301427732, 786725, 4f, 100f);
					unk_0xDBE4EC9C88839074(0, vLocal_50, 5000, 0, 2);
					unk_0x75ABDC5F81978924(uLocal_84);
					unk_0x78ADC381772E3D54(iLocal_69[4], uLocal_84);
					unk_0xF82EA857DA10E0CD(&uLocal_84);
					unk_0xDD353D0E9C789D0E(&uLocal_84);
					unk_0xE9362E4D600DD12A(0, iLocal_77[5], 974,8073f, 3633,771f, 31,3818f, 10f, 0, 301427732, 786725, 4f, 100f);
					unk_0xDBE4EC9C88839074(0, vLocal_50, 5000, 0, 2);
					unk_0x75ABDC5F81978924(uLocal_84);
					unk_0x78ADC381772E3D54(iLocal_69[5], uLocal_84);
					unk_0xF82EA857DA10E0CD(&uLocal_84);
				}
				iVar0++;
			}
			unk_0x71199B01895C6202(301427732);
			unk_0x71199B01895C6202(1330042375);
			unk_0x71199B01895C6202(1032073858);
			return 1;
		}
	}
	return 0;
...
void func_64()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
	{
		unk_0xF3268524E9BE6D6E(iLocal_68, unk_0x16F2683693E537C9(), 200f, -1, 0, 0);
		unk_0xFADC0A217229F6B5(iLocal_68, true);
		if (!unk_0x437347B10A200C4B(iLocal_69[0], 0) && !unk_0x437347B10A200C4B(iLocal_69[1], 0))
		{
			unk_0xD458AC1C1D29C3B4(iLocal_68, 101, 0);
			unk_0x7980D72D61BEF4D5(iLocal_68, false);
			unk_0x2C4A1A0F54A166E8(iLocal_69[0], iLocal_68, 1000, 0);
			unk_0x2C4A1A0F54A166E8(iLocal_69[1], iLocal_68, 1000, 0);
		}
		else
		{
			func_4();
...
void func_67()
{
	...
	{
		case 0:
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_54() == 0)
		...
		case 1:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!unk_0xEB6A8945D1AC98A1(iLocal_68) && !unk_0xEB6A8945D1AC98A1(iLocal_69[0])) && !unk_0xEB6A8945D1AC98A1(iLocal_69[1]))
			{
				...
				if (timera() < 28000)
				{
					if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_68, 12f, 12f, 2,5f, 0, 1, 0))
					{
					...
					{
						if (!unk_0x7069CC4DE1EA3FAA(iLocal_69[0], iLocal_68, 10f))
						{
							unk_0x9BE7E7B6B488CC55(iLocal_69[0], iLocal_68, -1, 0);
						}
					}
				}
		...
		case 4:
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
			{
				unk_0x8BE3D040D15AEA1D(iLocal_68, -1);
			}
			iLocal_48++;
			break;
...
int func_83()
{
	if (!bLocal_55)
	{
		unk_0x0E2400AB9174FA81(255, iLocal_250, 1862763509);
		if (!unk_0x437347B10A200C4B(iLocal_69[0], 0) && !unk_0x437347B10A200C4B(iLocal_69[1], 0))
		{
		...
		{
			if (unk_0xD3DCEC81D13AAFB1(unk_0x64430C979F516F7A(iLocal_69[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			...
			if (((unk_0xBBE430A566D01EF3(vVar3, vVar0, -37975472, 1) || unk_0xBBE430A566D01EF3(vVar3, vVar0, -1813897027, 1)) || unk_0xBBE430A566D01EF3(vVar3, vVar0, -1568386805, 1)) || unk_0xBBE430A566D01EF3(vVar3, vVar0, 741814745, 1))
			{
				func_4();
				return 1;
			}
...
void func_84()
{
	if (unk_0xDF1306B443CD3D15(iLocal_76, 0))
	{
		if ((!unk_0x5A91F08DF773C39D(iLocal_76, 915,7905f, 3603,449f, 31,9111f, 5f, 5f, 5f, false, true, 0) && !unk_0xC42A92762C58E1B9(iLocal_68, iLocal_76, 0)) || unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_76, 1))
		{
			func_64();
		}
	}
...
int func_85()
{
	if (((((!unk_0xC844350D5D58C99A(iLocal_68) && !unk_0xC844350D5D58C99A(iLocal_69[0])) && !unk_0xC844350D5D58C99A(iLocal_69[1])) && !unk_0xC844350D5D58C99A(iLocal_76)) && !unk_0xC844350D5D58C99A(iLocal_77[0])) && !unk_0xC844350D5D58C99A(iLocal_77[1]))
	{
		unk_0x523BCC9DC80CD82F(32417469);
		unk_0x523BCC9DC80CD82F(1330042375);
		unk_0x523BCC9DC80CD82F(1032073858);
		unk_0x523BCC9DC80CD82F(1507916787);
		unk_0x523BCC9DC80CD82F(301427732);
		...
		if (((((((unk_0xB87F6CF6E5628C67(32417469) && unk_0xB87F6CF6E5628C67(1330042375)) && unk_0xB87F6CF6E5628C67(1032073858)) && unk_0xB87F6CF6E5628C67(1507916787)) && unk_0xB87F6CF6E5628C67(301427732)) && unk_0xB4AE0788C1587752("random@countryside_gang_fight")) && unk_0xB4AE0788C1587752("veh@drivebystd_ds_grenades")) && unk_0xDF3FDDA1EADEDD07("move_m@gangster@var_i"))
		{
			unk_0xAB8E2DDC7AF955E0(1507916787, true);
			unk_0xAB8E2DDC7AF955E0(301427732, true);
			...
			unk_0xF63400DBE3303D26("rghLost", &iLocal_250);
			unk_0x0E2400AB9174FA81(5, iLocal_250, 1862763509);
			iLocal_68 = unk_0x36F2404464202779(26, 32417469, 973,053f, 3616,738f, 31,6181f, 110,2753f, 1, true);
			unk_0x64F9F278AB9DCA2C(iLocal_68, 0, 0, 1, 0);
			unk_0x64F9F278AB9DCA2C(iLocal_68, 2, 1, 0, 0);
			unk_0x64F9F278AB9DCA2C(iLocal_68, 3, 1, 2, 0);
			unk_0x64F9F278AB9DCA2C(iLocal_68, 4, 0, 0, 0);
			unk_0x71199B01895C6202(32417469);
			unk_0x11AD11297DC58CC7(iLocal_68, true);
			unk_0xAFF39FB306F8E232(iLocal_68, 17, true);
			unk_0x25C5402CC10F76CD(iLocal_68, false);
			unk_0x7980D72D61BEF4D5(iLocal_68, true);
			unk_0x4E885A246A9D983A(iLocal_68, 185, true);
			unk_0x5E678B691C852774(iLocal_68, 16);
			unk_0x4F39CC3882DD074E(iLocal_68, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_63(&uLocal_85, 1, iLocal_68, "RECGFDealer", 0, 1);
			unk_0x33CE5A9E32EA10B2(iLocal_68, true);
			unk_0xC6EB89C59F2AF6B8(iLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x79C43E2BAC7C696F(iLocal_68, "move_m@gangster@var_i", 1048576000);
			iLocal_76 = unk_0x122AAB0B1D6F55AD(1507916787, 915,7905f, 3603,449f, 31,9111f, 111,9593f, true, true, false);
			unk_0xC002508A277213DE(iLocal_76, 37, 0);
			unk_0x58A0C35FA7CA6162(iLocal_76, 4, 0);
			unk_0xB26AC67EF006D7D4(iLocal_76, 1);
			unk_0x55A3C4ED4728EA42(iLocal_76, "WDU 696");
			iLocal_69[0] = unk_0x36F2404464202779(22, 1330042375, 970,2217f, 3614,821f, 31,6909f, 297,4345f, 1, true);
			func_63(&uLocal_85, 3, iLocal_69[0], "RECGFLost2", 0, 1);
			iLocal_69[1] = unk_0x36F2404464202779(22, 1032073858, 971,504f, 3618,054f, 31,5565f, 216,9967f, 1, true);
			func_63(&uLocal_85, 2, iLocal_69[1], "RECGFLost1", 0, 1);
			unk_0x71199B01895C6202(1330042375);
			unk_0x71199B01895C6202(1032073858);
			iLocal_77[0] = unk_0x122AAB0B1D6F55AD(301427732, 968,2626f, 3611,717f, 31,7874f, 296,8978f, true, true, false);
			iLocal_77[1] = unk_0x122AAB0B1D6F55AD(301427732, 970,8362f, 3625,563f, 31,3415f, 212,3456f, true, true, false);
			unk_0x71199B01895C6202(301427732);
			unk_0xC6EB89C59F2AF6B8(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(iLocal_69[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x262EF6C6306BEA6C(iLocal_69[0], 453432689, -1, true, true);
					unk_0x262EF6C6306BEA6C(iLocal_69[1], 2017895192, -1, true, true);
					unk_0xFADC0A217229F6B5(iLocal_69[iVar0], true);
					unk_0x11AD11297DC58CC7(iLocal_69[iVar0], true);
...
void func_146()
{
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(iLocal_68))
		{
			unk_0x4E885A246A9D983A(iLocal_68, 317, true);
			unk_0x7980D72D61BEF4D5(iLocal_68, false);
			unk_0x11AD11297DC58CC7(iLocal_68, false);
		}
		iVar0 = 0;
