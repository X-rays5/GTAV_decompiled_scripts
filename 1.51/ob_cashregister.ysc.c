			...
			if (unk_0x63D2C15453688621(iScriptParam_0))
			{
				switch (iLocal_18)
				{
					case 0:
						...
						{
							vLocal_19 = { unk_0x68F4C0EC296D3901(iScriptParam_0, true) };
							iLocal_18 = 1;
						}
						break;
					
					case 1:
						if ((unk_0x713261485D0F1B6C(iScriptParam_0, 0) && unk_0x4FC40AB0ECCE6E18(iScriptParam_0)) && !unk_0xAF6690C489CC6203(iScriptParam_0))
						{
							func_1();
							iLocal_18 = 2;
						}
...
void func_1()
{
	...
	if (unk_0x8CD06866876216F2())
	{
		unk_0xB8D1BBEFD1257857(iVar1, unk_0x550B1459B4642A86(vLocal_19, 1067030938, 1069547520), iVar2, iVar3, iVar0, 0, 0);
	}
	else
	{
		unk_0xA6FF0828D17CF374(iVar1, unk_0x550B1459B4642A86(vLocal_19, 1067030938, 1069547520), iVar2, iVar3, 0, iVar0);
	}
}
