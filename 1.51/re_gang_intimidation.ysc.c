void __EntryFunction__()
{
	...
	iVar7 = 0;
	iLocal_51 = 3;
	vLocal_226 = { ScriptParam_0.f_1[0] };
	vLocal_229[0] = { 1283,85f, -1622,501f, 53,2255f };
	fLocal_239[0] = 198,9926f;
	vLocal_229[1] = { 1286,655f, -1627f, 53,225f };
	fLocal_239[1] = 22,3073f;
	vLocal_229[2] = { 1286,452f, -1624,782f, 53,225f };
	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				unk_0xF63400DBE3303D26("GangOne", &iLocal_49);
				unk_0x0E2400AB9174FA81(5, iLocal_49, 1862763509);
				iVar22 = unk_0x36F2404464202779(12, Var1.f_4, vVar14, fVar17, 1, true);
				unk_0x11AD11297DC58CC7(iVar22, true);
				unk_0x71199B01895C6202(Var1.f_4);
				unk_0x6DF7BF67E86AAE86(iVar22, iLocal_49);
				unk_0x25C5402CC10F76CD(iVar22, false);
				...
				while (iVar24 <= (iLocal_51 - 1))
				{
					...
					{
						iVar18[iVar24] = unk_0x36F2404464202779(12, Var1[iVar24], vLocal_229[iVar24], fLocal_239[iVar24], 1, true);
						unk_0x11AD11297DC58CC7(iVar18[iVar24], true);
						unk_0x71199B01895C6202(Var1[iVar24]);
						unk_0x6DF7BF67E86AAE86(iVar18[iVar24], iLocal_49);
				...
				unk_0x262EF6C6306BEA6C(iVar18[0], 2017895192, 40, true, true);
			...
			case 5:
				...
				if (iVar7 < 3)
				{
					if ((((((((func_79(&iVar18, &uVar11, &uVar10, &uVar9, iVar8, bVar12, 1075838976, 0) || func_78(iVar18[0], 0)) || func_78(iVar18[1], 0)) || func_78(iVar18[2], 0)) || unk_0xD3DCEC81D13AAFB1(vLocal_229[0], 40f, 1)) || unk_0xBBE430A566D01EF3(vLocal_229[0] - Vector(25f, 25f, 25f), vLocal_229[0] + Vector(25f, 25f, 25f), -37975472, 1)) || unk_0xBBE430A566D01EF3(vLocal_229[0] - Vector(25f, 25f, 25f), vLocal_229[0] + Vector(25f, 25f, 25f), -1813897027, 1)) || unk_0xBBE430A566D01EF3(vLocal_229[0] - Vector(25f, 25f, 25f), vLocal_229[0] + Vector(25f, 25f, 25f), -1568386805, 1)) || unk_0xBBE430A566D01EF3(vLocal_229[0] - Vector(25f, 25f, 25f), vLocal_229[0] + Vector(25f, 25f, 25f), 741814745, 1))
					{
						iVar25 = 0;
						while (iVar25 < iVar18)
						{
						...
						if (!unk_0xEB6A8945D1AC98A1(iVar22))
						{
							if (!unk_0xEB6A8945D1AC98A1(iVar22))
							{
								...
								unk_0xF82EA857DA10E0CD(&iLocal_50);
								unk_0xFADC0A217229F6B5(iVar22, true);
							}
						}
						iLocal_248 = 1;
					}
	...
	switch (*iParam0)
	{
		case 0:
			if (func_60(iParam7, iParam8))
			{
				...
				{
					unk_0x9DD8618CA5BF832D(iParam7, 247, true);
							...
							if ((unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6) && unk_0xE115347EA59F7B86(iParam7, unk_0x16F2683693E537C9())) && !unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
							{
								if ((unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6) || unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), iParam7)) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iParam7))
								{
									...
									if (!unk_0xEB6A8945D1AC98A1(iParam7))
									{
										...
										unk_0xFADC0A217229F6B5(iParam7, true);
									}
									iLocal_248 = 1;
								}
							}
				...
				else if (unk_0x869EFD0BC0868856(iParam7))
				{
					...
					{
						unk_0xFB131B855F2FD560(iParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -8f);
					}
				}
			}
			else
		...
		case 2:
			unk_0x4ADCCF23C40DC113(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_243, 0, 0, 255, 255);
			...
			if (unk_0x69DF961355195C3C(iLocal_53))
			{
				...
				if (unk_0xA45992A6CE82FB43(iLocal_53) > 0,35f)
				{
					if (!unk_0xEB6A8945D1AC98A1((*iParam8)[1]))
					{
						...
						unk_0xDD353D0E9C789D0E(&iLocal_50);
						unk_0x161356BF7864C47B(0, unk_0x16F2683693E537C9(), unk_0x16F2683693E537C9(), 2f, 0, 5f, 4f, 1, 0, -957453492);
						unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 25000, 0);
						unk_0x75ABDC5F81978924(iLocal_50);
				...
				if (unk_0xA45992A6CE82FB43(iLocal_53) > 0,275f)
				{
					if (!unk_0xEB6A8945D1AC98A1((*iParam8)[2]))
					{
						...
						unk_0xDD353D0E9C789D0E(&iLocal_50);
						unk_0x161356BF7864C47B(0, unk_0x16F2683693E537C9(), unk_0x16F2683693E537C9(), 2f, 0, 3,5f, 4f, 1, 0, -957453492);
						unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 25000, 0);
						unk_0x75ABDC5F81978924(iLocal_50);
		...
		case 2:
			if (!unk_0xEB6A8945D1AC98A1((*uParam7)[2]))
			{
				if (!unk_0xEB6A8945D1AC98A1((*uParam7)[0]))
				{
					...
					unk_0x96167B03C5A77156(0, vLocal_229[0], 1f, -1, 1048576000, 0, 1193033728);
					unk_0xE655C47E46F9A7E4(0, fLocal_239[0], 0);
					unk_0x3E8E48829F3C7624(0, Param0.f_5, "sit_down_idle_01", vLocal_229[0], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0f, 2, 0);
					unk_0x75ABDC5F81978924(iLocal_50);
				...
				if (!unk_0xEB6A8945D1AC98A1((*uParam7)[1]))
				{
					...
					unk_0x96167B03C5A77156(0, vLocal_229[1], 1f, -1, 1048576000, 0, 1193033728);
				...
				if (!unk_0xEB6A8945D1AC98A1((*uParam7)[2]))
				{
					...
					unk_0xA8CC11FF8D2962D4(0, (*uParam7)[0], 0f, -0,5f, 0f, 1f, 10000, 0,1f, 1);
					unk_0x01E4BB5190DF7317(0, 1193033728, 0);
					unk_0x75ABDC5F81978924(iLocal_50);
	...
	switch (iLocal_255)
	{
		...
		case 1:
			...
			if (!unk_0xEB6A8945D1AC98A1(iParam0) && !unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				...
				{
					unk_0xDD353D0E9C789D0E(&iLocal_50);
					unk_0x96167B03C5A77156(0, vLocal_243, 2f, 20000, 0,25f, 0, 32,2195f);
		...
		case 3:
			...
			{
				if (timera() > 8000 && unk_0x5A91F08DF773C39D(iParam0, vLocal_243, 3f, 3f, 3f, false, true, 0))
				{
		...
		case 4:
			if (!unk_0xEB6A8945D1AC98A1(iParam0))
			{
				...
				unk_0x96167B03C5A77156(0, vLocal_243, 2f, 20000, 1048576000, 0, 1193033728);
				unk_0x75ABDC5F81978924(iLocal_50);
				unk_0xF82EA857DA10E0CD(&iLocal_50);
				iLocal_50 = 0;
			}
...
int func_63()
{
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (unk_0xF94CCE643440E68B(unk_0x16F2683693E537C9(), 782665360))
			{
				return 1;
			}
		}
...
int func_74(vector3 vParam0, int iParam3)
{
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (vdist(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vParam0) > IntToFloat(iParam3))
		{
			return 1;
		}
	}
...
void func_152(struct<6> Param0, int iParam6, int iParam7, int iParam8)
{
	...
	if (iLocal_249)
	{
		...
		{
			unk_0x11AD11297DC58CC7(iParam8, false);
		}
		func_89(0);
		func_115(0, Param0);
	}
