...
void func_1()
{
	...
	unk_0x71199B01895C6202(744758650);
	...
	if (unk_0xC844350D5D58C99A(iLocal_275))
	{
		...
		{
			unk_0x71199B01895C6202(-1323100960);
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	*iParam3 = 500;
	if (!unk_0x437347B10A200C4B(iParam1, 0))
	{
		...
		func_149(Global_111638.f_19968.f_3, &vVar3, &iVar7, &uVar0, &uVar6);
		if (Global_111638.f_19968.f_3 >= 5 || uLocal_263)
		{
			func_148(iParam1, vVar3, iVar7, iParam0);
			...
			case 17:
				if (!unk_0x1727A44C562FBED2(iLocal_249))
				{
					...
					else
					{
						...
						if (unk_0xE4EDC4B0E92C078B(iLocal_273))
						{
							unk_0x142CC44DB769B57E(&iLocal_273);
						}
			...
			case 18:
				if (Global_98744 == 10)
				{
					if (Global_98778)
					{
						...
						{
							unk_0x523BCC9DC80CD82F(-442313018);
						}
						else
						{
							unk_0x523BCC9DC80CD82F(-1323100960);
...
void func_27(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	*uParam0 = func_106();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_56())
		{
			func_49(unk_0x16F2683693E537C9(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_107()
{
	if (unk_0x1FBF08B001C4788A("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_53.z = 1;
			iLocal_249 = start_new_script_with_args("Towing", &vLocal_53, 9, 35000);
			unk_0x5E8C29AE121DF1C7("Towing");
...
void func_118()
{
	switch (iLocal_74)
	{
		case 1:
			if (!func_142())
			{
				if (!unk_0xFEBC1E4EC9E001F0() && !func_141(&iLocal_62))
				{
					unk_0xC0FB48F966BB7D11(0);
					func_139(&iLocal_62);
				}
				else if (!unk_0xFEBC1E4EC9E001F0() && func_141(&iLocal_62))
				{
...
void func_148(int iParam0, vector3 vParam1, int iParam4, var uParam5)
{
	fVar0 = vdist2(vParam1, unk_0x68F4C0EC296D3901(iParam0, 1));
	switch (iLocal_75)
	{
		case 0:
			...
			if (unk_0x405E212DDE472467(iParam0, 0))
			{
				...
				if (!unk_0x437347B10A200C4B(iVar1, 0))
				{
					...
					if ((iVar2 == -1323100960 || iVar2 == -442313018) && unk_0x7F6DC62EA9922664(iVar1) > 400)
					{
						return;
					}
				}
		...
		case 2:
			if (unk_0xB87F6CF6E5628C67(-1323100960))
			{
				if (!unk_0x8E28E832BEAC3DCE(vLocal_258, fLocal_261) || func_22(Global_111638.f_19968.f_1, 1073741824))
				{
					if (!unk_0xC844350D5D58C99A(iLocal_275))
					{
						iLocal_275 = unk_0x122AAB0B1D6F55AD(-1323100960, vParam1, iParam4, 1, 1, 0);
						unk_0x71199B01895C6202(-1323100960);
						iLocal_75 = 3;
					}
				}
