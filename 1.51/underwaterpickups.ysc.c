		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar5, &iVar9))
		{
			if (func_2(vVar5, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == -831529621)
				{
					if (bLocal_24)
					{
						iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar8, iVar9, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_25) > 400f)
				{
					...
					else if ((iVar1 == 779501861 || iVar1 == 1295434569) || iVar1 == -2050315855)
					{
						if (bLocal_24)
						{
							iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar8, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == -831529621)
				{
					if (bLocal_24)
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar5, iVar8, 10000, 2, 1, 0);
					}
				}
				else if (vdist2(vVar2, vLocal_25) > 400f)
				{
					if (iVar1 == 1274757841)
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar5, iVar8, -1, 2, 1, 0);
					}
					else if ((iVar1 == 779501861 || iVar1 == 1295434569) || iVar1 == -2050315855)
					{
						if (bLocal_24)
...
{
	vVar0[0] = { -1029f, 6517f, -21f };
	vVar0[1] = { 3265f, 6407f, -47f };
	vVar0[2] = { 4215f, 3603f, -48f };
	vVar0[3] = { -3247f, 3669f, -28f };
	vVar0[4] = { -3192f, 3029f, -35f };
	vVar0[5] = { -2838f, -446f, -38f };
	vVar0[6] = { 3156f, -307f, -17f };
	vVar0[7] = { 2695f, -1334f, -26f };
	vVar0[8] = { 264f, -2280f, -8f };
	vVar0[9] = { 1804f, -2993f, -46f };
	vVar0[10] = { -131f, -2867f, -10f };
	vVar0[11] = { 3595f, 3041f, -15f };
	iVar37 = 0;
	while (iVar37 <= (12 - 1))
	{
		if (func_25(vParam0, vVar0[iVar37], 1056964608, 0))
		{
			iLocal_2 = iVar37;
			return;
		}
