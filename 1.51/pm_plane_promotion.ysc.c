...
void func_1()
{
	...
	iLocal_329 = 0;
	if (unk_0xC844350D5D58C99A(iLocal_241))
	{
		if (!unk_0xDF1306B443CD3D15(iLocal_241, 0))
		{
			func_141();
		}
		else if (iLocal_47 == 2)
		{
			if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_241, 0))
			{
				...
				if (func_138(unk_0x16F2683693E537C9(), iLocal_241, 1) > 300f)
				{
					func_141();
				}
			}
	...
	if ((((unk_0xC844350D5D58C99A(iLocal_241) && unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_241, 0)) && unk_0xE934758D273C899A(iLocal_241)) && iLocal_325) && unk_0xAE317D00A5A55DF6("PLANES", false, -1))
	{
		if (!bLocal_326)
		{
			if (unk_0xBFC0798A6E3417F9(0, 114))
			{
				if (iLocal_324 == -1 || (unk_0x1C0640BA9A7327B3() - iLocal_324) > 2000)
				{
					...
					{
						iLocal_332 = unk_0xC1879030EB463216("scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0,65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_330 = 0f;
					}
					if (func_137("LEAFLET"))
					{
					...
					unk_0xCEAA091B490F8407(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_241, 0, false, 0);
	...
	if (unk_0x83A8177D302E1A7E(iLocal_332))
	{
		...
		unk_0x9AB5B84DE011D632(iLocal_332, "spawn", fLocal_330, 0);
	}
	switch (iLocal_47)
	{
		case 0:
			unk_0x523BCC9DC80CD82F(-2122757008);
			if (unk_0xB87F6CF6E5628C67(-2122757008))
			{
				iLocal_241 = Global_110348.f_222[0];
				if (!unk_0xC844350D5D58C99A(iLocal_241))
				{
					iLocal_241 = unk_0x122AAB0B1D6F55AD(-2122757008, vVar0, 121,2244f, true, true, false);
					unk_0xB9FD7450C0DAB575(iLocal_241, 1084227584);
				}
				else
				{
					unk_0x73270B3C9CC833FD(iLocal_241, true, 1);
				}
				unk_0x71199B01895C6202(-2122757008);
				unk_0x790015DC92C918E2();
		...
		case 1:
			if (unk_0xC844350D5D58C99A(iLocal_241) && unk_0xDF1306B443CD3D15(iLocal_241, 0))
			{
				if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_241, 0))
				{
					unk_0x790015DC92C918E2();
		...
		case 3:
			if (func_30(&iLocal_51, vLocal_36, -1067,083f, -2922,601f, 12,82418f, -1091,854f, -2965,403f, 23,94564f, 31,5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !unk_0xE934758D273C899A(iLocal_241))
			{
				func_133(&iLocal_51, 1, 0);
				iLocal_47++;
			}
		...
		case 5:
			...
			unk_0x05EC10F460C3A4AF(iLocal_241, 0);
			func_27();
			break;
	}
	switch (iLocal_48)
	{
		case 0:
			...
			else if ((func_26() && (unk_0x1C0640BA9A7327B3() - iLocal_49) > 5000) && iLocal_329)
			{
...
int func_30(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, float fParam10, bool bParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)
{
...
{
	iVar0 = unk_0x3F3860E60C44719E(vParam0, fParam3);
	...
	if (unk_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (unk_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_132(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_129(unk_0x68F4C0EC296D3901(Global_102203.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_82(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_112(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
int func_112(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_122(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_122(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_122(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_115(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_112(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_120(iParam0);
			func_119(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
void func_143()
{
	...
	Local_242[0] = { -1039,556f, -1071,264f, 150f };
	Local_242[0].f_3 = 200f;
	Local_242[1] = { -1014,976f, 450,128f, 150f };
	Local_242[1].f_3 = 200f;
	Local_242[2] = { -598,1714f, -310,67f, 150f };
	Local_242[2].f_3 = 200f;
	Local_242[3] = { -392,5704f, 514,8138f, 150f };
	Local_242[3].f_3 = 200f;
	Local_242[4] = { 127,7632f, -135,7758f, 150f };
	Local_242[4].f_3 = 200f;
	Local_242[5] = { 1033,469f, -570,8278f, 150f };
	Local_242[5].f_3 = 200f;
	Local_242[6] = { 246,5894f, -890,811f, 150f };
	Local_242[6].f_3 = 200f;
	Local_242[7] = { 1231,393f, -1694,348f, 150f };
	Local_242[7].f_3 = 200f;
	Local_242[8] = { 424,9531f, -1904,325f, 150f };
	Local_242[8].f_3 = 200f;
	Local_242[9] = { -22,4342f, -1414,275f, 160f };
	Local_242[9].f_3 = 200f;
	iVar0 = 0;
	while (iVar0 <= 9)
	{
		if (!func_145(Local_242[iVar0]))
		{
			fVar1 = 0f;
			unk_0xE82754C349C7B581(Local_242[iVar0], &fVar1, 0, 0);
			Local_242[iVar0].f_2 = fVar1;
		}
		iVar0++;
	}
	switch (func_144())
...
void func_148()
{
	if (unk_0xC844350D5D58C99A(iLocal_241))
	{
		unk_0x046C362CF15F1935(&iLocal_241);
	}
	if (unk_0xE4EDC4B0E92C078B(Local_242[0].f_4))
	{
		unk_0x142CC44DB769B57E(&(Local_242[0].f_4));
	}
	if (unk_0xE4EDC4B0E92C078B(Local_242[0].f_5))
	{
		unk_0x142CC44DB769B57E(&(Local_242[0].f_5));
	}
	if (unk_0xE4EDC4B0E92C078B(Local_242[1].f_4))
	{
		unk_0x142CC44DB769B57E(&(Local_242[1].f_4));
	}
	if (unk_0xE4EDC4B0E92C078B(Local_242[1].f_5))
	{
		unk_0x142CC44DB769B57E(&(Local_242[1].f_5));
	}
