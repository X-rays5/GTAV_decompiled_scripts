	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				if (func_251())
				{
					unk_0x262EF6C6306BEA6C(unk_0x16F2683693E537C9(), -1569615261, -1, 0, 1);
				}
			...
			case 2:
				...
				{
					func_133(iLocal_399, &iLocal_401, &iLocal_402, &uLocal_404, &uLocal_83, vLocal_422, iLocal_427, iLocal_57);
					func_131(func_253());
					func_244(&uLocal_251);
				...
				else
				{
					...
					if (!iLocal_439)
					{
						...
						if (func_137(&uLocal_263) > 2f)
						{
							...
							uLocal_404 = unk_0xAE06CCC36C49929C(26379945, vVar26, vVar29, 50f, 0, 2);
...
void func_57()
{
	...
	fVar6 = vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
...
void func_90()
{
	...
	if ((!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0) && !unk_0x437347B10A200C4B(iLocal_401, 0)) && unk_0xDF1306B443CD3D15(iLocal_401, 0))
	{
		...
		unk_0xA47B46945FF6DE74(iLocal_401, vLocal_422, 1, 0, 0, 1);
...
void func_133(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, vector3 vParam5, int iParam8, int iParam9)
{
	*iParam2 = unk_0x728870EB733D12A1();
	...
	if (unk_0xC844350D5D58C99A(*iParam2))
	{
		...
		{
			unk_0x73270B3C9CC833FD(*iParam2, 1, 0);
		}
	}
