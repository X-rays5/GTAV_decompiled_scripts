	...
	while (true)
	{
		...
		switch (func_888(unk_0x57270EE11514DC67()))
		{
				...
				if (func_887() == 1)
				{
					if (func_886())
					{
						...
						if (func_884())
						{
							...
							func_868(0f);
							iLocal_1407 = unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9());
							unk_0x6DF7BF67E86AAE86(unk_0x16F2683693E537C9(), iLocal_1406);
						}
						else
						{
							func_869(166, 0, -1, 0);
						...
						func_866();
						func_865();
						Local_952[unk_0x57270EE11514DC67()] = 1;
					}
				}
				else if (func_887() == 4)
				{
					Local_952[unk_0x57270EE11514DC67()] = 3;
				}
				break;
			...
			case 1:
				if (func_861(1))
				{
					Local_952[unk_0x57270EE11514DC67()] = 2;
				}
				if (func_887() == 1)
				{
					func_860();
			...
			case 3:
				...
				{
					Local_952[unk_0x57270EE11514DC67()] = 4;
				}
				break;
...
void func_11()
{
	if (unk_0xBFF81ED3B99522C7())
	{
		...
		while (iVar0 < 4)
		{
			...
			{
				case 0:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
					{
						if (Local_80.f_2[iVar0] == 0)
						{
							if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
							{
					...
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
					{
						if (!func_14(Local_80.f_2[iVar0].f_1))
						{
							if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
							{
								...
								{
									if (unk_0x82CCEAB29E9451DD(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2)))
									{
				...
				case 2:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
					{
						if (!func_14(Local_80.f_2[iVar0].f_1))
						{
							if (!unk_0x0E0E6175453415CB(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1)))
							{
								Local_80.f_2[iVar0].f_17 = 4;
							}
							else if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
							{
								if (!func_12(Local_80.f_2[iVar0].f_2))
								{
									Local_80.f_2[iVar0].f_17 = 3;
				...
				case 3:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
					{
						if (!func_14(Local_80.f_2[iVar0].f_1))
						{
							if (!unk_0x405E212DDE472467(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 0))
							{
								Local_80.f_2[iVar0].f_17 = 4;
							}
						}
			...
			while (iVar1 < 3)
			{
				...
				{
					case 0:
						if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
						{
							if (Local_80.f_2[iVar0] == 0)
							{
					...
					case 3:
						if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
						{
							...
							{
								if (!unk_0x405E212DDE472467(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), 0))
								{
									Local_80.f_2[iVar0].f_18[iVar1] = 6;
								}
							}
...
void func_16(int iParam0)
{
	...
	while (iVar0 < unk_0x54EABC0DD106045B())
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iVar0)))
		{
			...
			if (!func_17(iVar1, 0))
			{
				unk_0xF1259063ADD6A7AF(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), iVar1, 0);
			}
		}
		iVar0++;
	}
...
{
	if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
	{
		return 0;
	}
	...
	while (iVar0 < 3)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar0]))
		{
...
void func_21()
{
	...
	{
		iLocal_1403 = 0;
		while (iLocal_1403 < unk_0x54EABC0DD106045B())
		{
			if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iLocal_1403)))
			{
				iVar3 = unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iLocal_1403));
				if (!func_17(iVar3, 0))
				{
					...
					if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_1, 2))
					{
						if (!bVar2)
						{
							...
							{
								if (!unk_0xEAE0D21A50E6C7F4(Local_952[iLocal_1403].f_1, 4))
								{
									bVar2 = true;
								}
							}
...
void func_23(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_109, iVar0))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_5, iVar0))
			{
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_110, iVar0))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_2, iVar0))
			{
		...
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_3, iVar0))
			{
		...
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_4, iVar0))
			{
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_113, iVar0))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_6, iVar0))
			{
				unk_0x5D96D8530B3D0904(&(Local_80.f_113), iVar0);
			}
			else if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_7, iVar0))
			{
				unk_0x5D96D8530B3D0904(&(Local_80.f_113), iVar0);
			}
		}
		if (Local_80.f_2[iVar0] == 2)
		{
			if (!Local_80.f_2[iVar0].f_24)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_12, iVar0))
				{
			...
			if (!Local_80.f_2[iVar0].f_25)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_952[iParam0].f_13, iVar0))
				{
			...
			if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
			{
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (func_12(Local_80.f_2[iVar0].f_2))
						{
							unk_0xF1259063ADD6A7AF(unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2), unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iParam0)), 1);
...
int func_27(int iParam0)
{
	...
	while (iVar1 < 3)
	{
		vVar2 = { Local_80.f_123[iVar0].f_18[iVar1] };
		if (!func_28(vVar2, 0f, 0f, 0f, 0))
		{
			if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_7[iVar1]))
			{
				return 0;
			}
		}
...
int func_29(int iParam0)
{
	...
	while (iVar1 < 3)
	{
		if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_7[iVar1]))
		{
			vVar3 = { Local_80.f_123[iVar0].f_18[iVar1] };
			iVar6 = Local_80.f_123[iVar0].f_28[iVar1];
			if (!func_28(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (unk_0xE75B31D140F2F10B(1))
				{
					if (func_33(iVar2))
					{
						if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_2[iParam0].f_23, iVar1))
						{
							unk_0x536F1BE96C726C4B(vVar3, 10f, 1, 0, 0, true);
							unk_0x5D96D8530B3D0904(&(Local_80.f_2[iParam0].f_23), iVar1);
						}
						if (func_30(&(Local_80.f_2[iParam0].f_7[iVar1]), iVar2, vVar3, iVar6, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
						{
							unk_0x79E38224B223335B(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_7[iVar1]), 1);
							unk_0xA6B2C9FCA24AAC6F(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_7[iVar1]), 1);
							unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_7[iVar1]), 1, iLocal_1406);
							unk_0x9A8BCD43DBDDCDCA(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_7[iVar1]), false, 0);
							unk_0x60A2E7213232AA6E(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_7[iVar1]), 0);
						}
					}
				}
			}
...
int func_30(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	...
	iVar1 = unk_0x122AAB0B1D6F55AD(iParam1, vParam2, iParam5, bParam7, iParam6, bParam14);
...
int func_36(int iParam0)
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar0]))
		{
			...
			{
				vVar3 = { Local_80.f_123[iVar2].f_4[iVar0] };
				if (!func_28(vVar3, 0f, 0f, 0f, 0))
				{
					return 0;
				}
	...
	if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
	{
		switch (Local_80.f_2[iParam0])
		{
			case 0:
				...
				{
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_2))
					{
						iVar0 = func_43();
						iVar1 = 0;
						while (iVar1 < 3)
						{
							if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar1]))
							{
								if (unk_0xA3FA8B6D2780D661(1))
								{
									if (func_33(iVar0))
									{
										...
										{
											unk_0x7980D72D61BEF4D5(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), true);
											unk_0xE2F0767314863BD8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1, 0);
											unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), true);
											unk_0x6DF7BF67E86AAE86(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), Global_1575012);
											unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1, iLocal_1406);
											unk_0x1365063FA6365BE8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), true);
											unk_0x262EF6C6306BEA6C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 324215364, 99999999, false, true);
											unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 3, false);
											unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 5, true);
											unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 2, true);
										}
									}
								}
							}
				...
				while (iVar1 < 3)
				{
					if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar1]))
					{
						if (unk_0xA3FA8B6D2780D661(1))
						{
							...
							{
								iVar2 = Local_80.f_2[iParam0].f_22;
								vVar5 = { Local_80.f_123[iVar2].f_4[iVar1] };
								fVar8 = Local_80.f_123[iVar2].f_14[iVar1];
								if (!func_28(vVar5, 0f, 0f, 0f, 0))
								{
									if (func_41(&(Local_80.f_2[iParam0].f_3[iVar1]), 22, iVar0, vVar5, fVar8, 1, 1, 1))
									{
										unk_0x7980D72D61BEF4D5(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), true);
										unk_0xE2F0767314863BD8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1, 0);
										unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), true);
										unk_0x6DF7BF67E86AAE86(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), Global_1575012);
										unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1, iLocal_1406);
										unk_0x262EF6C6306BEA6C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), -2084633992, 99999999, false, true);
										unk_0x3CC33E4E9CE523F4(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1);
										unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 42, true);
										unk_0xB8AFFA077E15E999(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1);
										unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 43, true);
										unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 44, true);
										unk_0x26A6B1686E33113F(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 1);
										unk_0xED253B8DDB3FFB77(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), vVar5, 7f, 0, 0);
										unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 132, true);
										iVar3 = func_40();
										unk_0x722454E43E496678(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), iVar3);
										unk_0xD458AC1C1D29C3B4(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), iVar3, 0);
										iVar4 = func_39();
										unk_0x0B42C743EF171FF5(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), iVar4);
										unk_0x298903DD96203C2C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), func_38());
										unk_0x00A6D36F507FD6EA(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 0);
										unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar1]), 281, true);
									}
								}
							}
						}
...
int func_41(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, int iParam8, bool bParam9)
{
	if (!unk_0xA3FA8B6D2780D661(1))
	{
		return 0;
				...
				if (unk_0xE75B31D140F2F10B(1))
				{
					if (func_33(iVar0))
					{
						if (func_28(Local_80.f_2[iParam0].f_13, 0f, 0f, 0f, 0))
						{
							...
							{
								Local_80.f_2[iParam0].f_13 = { vVar2 };
						...
						if (!func_28(Local_80.f_2[iParam0].f_13, 0f, 0f, 0f, 0))
						{
							...
							{
								unk_0xA6B2C9FCA24AAC6F(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 1);
								unk_0x79E38224B223335B(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 1);
								unk_0x56FDC9ADE35F7DB0(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), true, 1, 0);
								unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_2), 1, iLocal_1406);
								unk_0xA22F71BBC8173C39(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), false);
								unk_0x9A8BCD43DBDDCDCA(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), false, 0);
								unk_0xE8832A9E16A57A1F(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), true, 1);
								unk_0xD5A0214B20BCBAD8(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 1);
								unk_0x95BB35ED98D1976A(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 1);
								unk_0x60A2E7213232AA6E(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 0);
								unk_0x09C4C5C870748A1F(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 0);
							}
						}
					}
				}
				...
				if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
				{
					if (unk_0xA3FA8B6D2780D661(1))
					{
						...
						if (func_33(iVar1))
						{
							...
							{
								unk_0x7980D72D61BEF4D5(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true);
								unk_0xE2F0767314863BD8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1, 0);
								unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true);
								unk_0x6DF7BF67E86AAE86(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), Global_1575012);
								unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1, iLocal_1406);
								unk_0x1365063FA6365BE8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true);
					...
					if (func_33(iVar1))
					{
						...
						if (!func_28(Local_80.f_2[iParam0].f_13, 0f, 0f, 0f, 0))
						{
							if (func_41(&(Local_80.f_2[iParam0].f_1), 22, iVar1, Local_80.f_2[iParam0].f_13, Local_80.f_2[iParam0].f_16, 1, 1, 1))
							{
								...
								unk_0xCC7D8FBD1C29250B(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1, iLocal_1406);
								unk_0x1365063FA6365BE8(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true);
								unk_0x3CC33E4E9CE523F4(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1);
								unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 42, true);
								unk_0xB8AFFA077E15E999(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1);
								unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 11, true);
								unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 44, true);
								unk_0x26A6B1686E33113F(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 1);
								unk_0x262EF6C6306BEA6C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 453432689, 99999999, false, true);
								fVar9 = func_52(iParam0);
								unk_0xED253B8DDB3FFB77(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), Local_80.f_2[iParam0].f_13, fVar9, 0, 0);
								unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 132, true);
								unk_0x4E885A246A9D983A(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 281, true);
								iVar7 = func_51();
								unk_0x722454E43E496678(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), iVar7);
								unk_0xD458AC1C1D29C3B4(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), iVar7, 0);
								iVar8 = func_50();
								unk_0x0B42C743EF171FF5(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), iVar8);
								unk_0x298903DD96203C2C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), func_49());
								unk_0xE8832A9E16A57A1F(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true, 1);
								unk_0x5D96D8530B3D0904(&(Local_80.f_107), iParam0);
							}
						}
					}
	...
	if (iParam4 && !bParam7)
	{
		if (func_996(unk_0xD803B885F5E47A62(), 1, 1))
		{
			if (!unk_0x757EF87A33649210())
			{
				...
				if (unk_0x0EB28750412C3A5A(func_58(unk_0xD803B885F5E47A62()), vParam0, true) <= (fVar2 + fParam3))
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != unk_0xD803B885F5E47A62()))
				{
					if ((func_57(iVar1) || !bParam10) && !Global_2425662[iVar1].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (unk_0x0EB28750412C3A5A(func_58(iVar1), vParam0, true) <= (fVar2 + fParam3))
								{
				...
				if (unk_0xF816C4B5324CB295(unk_0xD803B885F5E47A62(), iVar1))
				{
					if (!bParam7 || (!unk_0xEB6A8945D1AC98A1(unk_0x9539D44F3E4492F6(iVar1)) && func_57(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && unk_0x08067D4957B73C02(unk_0xD803B885F5E47A62()) != unk_0x08067D4957B73C02(iVar1))) || unk_0x08067D4957B73C02(unk_0xD803B885F5E47A62()) == -1)
						{
							...
							{
								if (unk_0x0EB28750412C3A5A(func_59(iVar1), vParam0, true) < fParam3)
								{
									return 1;
								}
							}
...
void func_78()
{
	...
	if (fVar4 <= 1600f)
	{
		if (!func_150(unk_0xD803B885F5E47A62()))
		{
			if (!func_144())
			{
				...
				unk_0x5D96D8530B3D0904(&iLocal_1401, 18);
			}
		}
	}
	if (Local_80.f_119 > -1)
	{
		if (iVar3 > -1)
		{
			vVar0 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iVar3].f_1), false) };
		}
	}
	if (!func_28(vVar0, 0f, 0f, 0f, 0))
	{
		func_79(166, vVar0, &uLocal_1694, 1140457472, 1144750080, 0);
	}
}

void func_79(int iParam0, vector3 vParam1, var uParam4, float fParam5, float fParam6, int iParam7)
{
	if ((((func_132(unk_0xD803B885F5E47A62()) && !func_131(unk_0xD803B885F5E47A62())) && !unk_0xEAE0D21A50E6C7F4(Global_1628237[unk_0xD803B885F5E47A62()].f_1, 8)) && (func_130(unk_0xD803B885F5E47A62()) || func_129(unk_0xD803B885F5E47A62()))) || func_60(vParam1))
	{
		return;
	}
	...
	if (fVar0 < fParam5)
	{
		...
		if (!*uParam4 && func_996(unk_0xD803B885F5E47A62(), 1, 1))
		{
			*uParam4 = 1;
			if (func_119(iParam0))
			{
	...
	else
	{
		...
		if (*uParam4 && func_996(unk_0xD803B885F5E47A62(), 1, 1))
		{
			*uParam4 = 0;
			...
			if (iParam7 && !func_132(unk_0xD803B885F5E47A62()))
			{
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (unk_0xEAE0D21A50E6C7F4(Global_2425662[Global_2439138.f_1894.f_703.f_16].f_404, 0) && func_93())
		{
			iParam0 = 23;
		}
	}
...
{
	iVar0 = 2;
	bVar1 = ((func_132(iParam0) && !func_131(iParam0)) && !unk_0xEAE0D21A50E6C7F4(Global_1628237[iParam0].f_1, 8));
...
float func_151(int iParam0, bool bParam1)
{
	...
	while (iVar2 < 4)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar2].f_1))
		{
			if (Local_80.f_2[iVar2] == 2 || !bParam1)
			{
				if (!func_14(Local_80.f_2[iVar2].f_1))
				{
					vVar6 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iVar2].f_1), true) };
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 28)
						{
							...
							while (iVar52 < 32)
							{
								if (func_996(unk_0x117658E336116132(iVar52), 0, 1))
								{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_217(iVar35) && func_213(iVar35, iParam2)) && func_996(iVar35, 0, 1))
							{
								...
								*uParam4[iVar52] = { func_67(iVar35) };
								...
								if (func_189(iParam5))
								{
									func_188(iVar35, iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
								else
								{
									func_188(iVar35, iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, uParam0[iVar52]->f_40, iVar48, bParam6);
								}
						...
						{
							iVar35 = unk_0x117658E336116132(iVar52);
							if (func_996(iVar35, 0, 1) && !unk_0xEAE0D21A50E6C7F4(iVar49, iVar35))
							{
								iVar35 = unk_0x117658E336116132(iVar52);
							}
							else
							...
							if (func_217(iVar35))
							{
								if (func_996(unk_0x117658E336116132(iVar52), 0, 1))
								{
									...
									*uParam4[iVar52] = { func_67(iVar35) };
									...
									uParam3->f_38[iVar44].f_1 = iVar53;
									func_166(iVar35, unk_0x6E524813889AECF8(iVar35), iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
		...
		if (iVar2 != func_65())
		{
			if (func_996(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0].f_1 != -1)
				{
					...
					func_164(iParam1, uParam0->f_38[iVar0].f_1, iVar1, Global_1590535[iVar0].f_211.f_6);
				}
			}
		}
		iVar0++;
...
char* func_248(var uParam0)
{
	...
	switch (func_105(unk_0xD803B885F5E47A62()))
	{
		...
		case 192:
			if (func_249(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_181))
			{
				return "GB_DPAD_BSET";
			}
			return "GB_DPAD_BBUY";
...
int func_272()
{
	...
	else if (!func_280(unk_0xD803B885F5E47A62(), 1, 0) && Global_1311716[0] > 0)
	{
		return 0;
	}
...
int func_300()
{
	...
	if (iVar0 != -1)
	{
		return unk_0xEAE0D21A50E6C7F4(Local_952[iVar0].f_1, 1);
	}
	return 0;
}
...
void func_303(int iParam0)
{
	if (unk_0x218F818E64020C17(1, iParam0, &Var0, 13))
	{
		...
		while (iVar32 < 4)
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_113, iVar32))
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_6, iVar32))
				{
					if (unk_0xC844350D5D58C99A(Var0))
					{
						if (unk_0xE2F1E99DD161A861(Var0))
						{
							if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_109, iVar32))
							{
								if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_5, iVar32))
								{
									if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar32].f_2))
									{
										if (unk_0xC844350D5D58C99A(unk_0xB177666FAB6F4417(Local_80.f_2[iVar32].f_2)))
										{
											if (unk_0x96A5FE5834B81CE7(Var0) == unk_0xB177666FAB6F4417(Local_80.f_2[iVar32].f_2))
											{
												if (unk_0xC844350D5D58C99A(Var0.f_1))
												{
													if (unk_0xEC560E589DF8370E(Var0.f_1))
													{
														if (unk_0x940C1429253D3B1B(Var0.f_1) == unk_0x16F2683693E537C9())
														{
															...
															{
																unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_5), iVar32);
															}
														}
													}
												}
						...
						else if (unk_0xEC560E589DF8370E(Var0))
						{
							...
							if (iVar14 == unk_0x1B50683925F00106(Local_80.f_2[iVar32].f_1))
							{
								if (unk_0xC844350D5D58C99A(Var0.f_1))
								{
									if (unk_0xEC560E589DF8370E(Var0.f_1))
										...
										if (unk_0x34BFC6F0CB887BC2(iVar13))
										{
											...
											if (unk_0xFB75B0F82CA525F6(iVar16))
											{
												if (Var0.f_5)
												{
													...
													{
														Local_952[unk_0x57270EE11514DC67()].f_11++;
														unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_6), iVar32);
														Var18.f_2 = -332709484;
											...
											else if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_7, iVar32))
											{
												if (Var0.f_5)
												{
													iVar16 = unk_0x83FACCC48B68F9D1(iVar13);
													unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_7), iVar32);
												}
											}
										}
										else if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_7, iVar32))
									...
									if (iVar16 == unk_0xD803B885F5E47A62())
									{
										if (unk_0xFB75B0F82CA525F6(iVar15))
										{
											if (func_190(iVar15, 1))
											{
												if (Local_80.f_118 > -1)
												{
													iVar17 = unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(Local_80.f_118));
...
void func_311()
{
	if (!func_17(unk_0xD803B885F5E47A62(), 0))
	{
		if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 14))
		{
			unk_0x0674E58A79778E99(&iLocal_1401, 14);
		}
		return;
	}
	...
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 14))
	{
		if (Local_952[unk_0x57270EE11514DC67()].f_1 != 0)
		{
			Local_952[unk_0x57270EE11514DC67()].f_1 = 0;
		}
		unk_0x5D96D8530B3D0904(&iLocal_1401, 14);
	}
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 15))
	{
		unk_0x5D96D8530B3D0904(&iLocal_1401, 15);
		func_816();
	}
...
void func_312()
{
	...
	Var0.f_18 = -1;
	Var0.f_19 = -1;
	iVar23 = unk_0x57270EE11514DC67();
	iVar24 = unk_0xD803B885F5E47A62();
	if (func_17(unk_0xD803B885F5E47A62(), 0))
	{
		iVar23 = func_301();
		iVar24 = Global_1590535[unk_0xD803B885F5E47A62()].f_740;
	}
	if (!unk_0xEAE0D21A50E6C7F4(Local_952[iVar23].f_1, 4))
	{
		if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 9))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_80.f_1, 1))
			{
				if (iVar23 == Local_80.f_118 || func_885() == Local_80.f_118)
				{
					...
					{
						if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 6))
						{
							func_621(1, 1, 0, 0, -1, -1, -1, -1, -1, 0);
							unk_0x5D96D8530B3D0904(&iLocal_1401, 6);
						}
						Var0 = func_620();
						Var0.f_1 = func_619();
						func_440(166, 1, &Var0, 0);
						unk_0x2B9CF4095FF44019(iVar24);
						iLocal_1695 = unk_0x02A813E6E0380440();
						unk_0x34D79252800B23FF(0);
						unk_0x5D96D8530B3D0904(&iLocal_1401, 17);
				...
				else if (func_300())
				{
					if (func_190(iVar24, 1))
					{
						if (func_141(iVar24) >= 2)
						{
							sVar25 = func_736(unk_0x117658E336116132(Local_80.f_119));
							iVar26 = func_735(unk_0x117658E336116132(Local_80.f_119));
				...
				unk_0x5D96D8530B3D0904(&iLocal_1401, 9);
			}
			else if (unk_0xEAE0D21A50E6C7F4(Local_80.f_1, 3))
			{
		...
		{
			func_816();
			if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 8))
			{
				func_332();
				func_75();
				unk_0x5D96D8530B3D0904(&iLocal_1402, 8);
			}
			if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 10))
			{
			}
			if (func_313(&uLocal_1409, 0, 0))
			{
				if (iVar23 == unk_0x57270EE11514DC67())
				{
					unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_1), 4);
				}
			}
			else if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 17))
			{
				if (func_6(&uLocal_1696, 10000, 0))
				{
					unk_0x34D79252800B23FF(iLocal_1695);
					unk_0x0674E58A79778E99(&iLocal_1401, 17);
				}
			}
		}
	}
...
int func_319(int iParam0)
{
	switch (iParam0)
	{
		...
		case 180:
		case 148:
			if (Global_1590535[unk_0xD803B885F5E47A62()] == 148 && func_179(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_35, 1))
			{
				return 1;
			}
			else
...
void func_332()
{
	...
	while (iVar0 < 4)
	{
		if (unk_0xE4EDC4B0E92C078B(iLocal_1416[iVar0]))
		{
			unk_0x142CC44DB769B57E(&(iLocal_1416[iVar0]));
		}
		iVar0++;
	}
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 18))
	{
		func_346(1);
		unk_0x0674E58A79778E99(&iLocal_1401, 18);
	}
	func_343();
	func_333();
}
...
void func_333()
{
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 7))
	{
		unk_0x5D96D8530B3D0904(&iLocal_1401, 7);
		iVar0 = 0;
		while (iVar0 < 32)
		{
			iVar1 = unk_0x117658E336116132(iVar0);
			if (unk_0x40B8C182D63932FC(iVar1))
			{
				...
				{
					if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_8, iVar0))
					{
...
void func_343()
{
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 16))
	{
		func_86();
		func_344();
		unk_0x0674E58A79778E99(&iLocal_1401, 16);
	}
}
...
int func_385()
{
	if (!func_17(unk_0xD803B885F5E47A62(), 0))
	{
		if (!func_386(1, 1, 1, 0))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_1, 6))
			{
				unk_0x0674E58A79778E99(&(Local_952[unk_0x57270EE11514DC67()].f_1), 6);
			}
			return 0;
		}
		if (func_144())
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_1, 6))
		{
			unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_1), 6);
		}
	}
	else
	{
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_952[iVar0].f_1, 6))
		{
			return 0;
		}
	}
...
{
	iVar0 = func_105(unk_0xD803B885F5E47A62());
	if (((func_420(Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_28) || func_419(unk_0xD803B885F5E47A62())) || func_418(unk_0xD803B885F5E47A62())) || func_413(unk_0xD803B885F5E47A62()))
	{
...
bool func_415(int iParam0, bool bParam1)
{
	if (Global_1590373 != func_65())
	{
		...
		if (bParam1)
		{
			...
			{
				if (unk_0xEAE0D21A50E6C7F4(Global_2425662[Global_1590373].f_195, 24) || func_416(Global_1590373))
				{
					return 1;
				}
			}
...
char* func_432()
{
	...
	if (iVar0 != func_65())
	{
		...
		sVar1 = func_433(&(Global_1628237[iVar0].f_11.f_104));
...
void func_509(int iParam0, int iParam1, int iParam2)
{
	if (func_525())
	{
		...
		if (func_515(unk_0xD803B885F5E47A62()))
		{
			...
			Global_1590535[unk_0xD803B885F5E47A62()].f_211.f_6 = func_513(iParam0, 1);
		}
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_454())
			{
				...
				iVar7 = func_586(unk_0xD803B885F5E47A62(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
	...
	else if (iParam0 == 168)
	{
		if (bParam1)
		{
			if (func_123(unk_0xD803B885F5E47A62()))
			{
				if (uParam2->f_5)
				{
					*iParam3 = (*iParam3 + func_599(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_182));
				}
				else
				{
					*uParam4 = uParam2->f_7;
...
char* func_736(int iParam0)
{
	if (iParam0 == unk_0xD803B885F5E47A62())
	{
		sVar0 = func_433(&(Global_1628237[iParam0].f_11.f_104));
		return sVar0;
	}
	...
	if (iVar1 != func_65())
	{
		sVar0 = func_433(&(Global_1628237[iVar1].f_11.f_104));
...
void func_748(int iParam0)
{
	...
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 15))
	{
		if (iParam0 <= 35000)
		{
			if (unk_0xC92DB9682A650680("APT_PRE_COUNTDOWN_STOP"))
			{
				unk_0x5D96D8530B3D0904(&iLocal_1402, 15);
				unk_0x5D96D8530B3D0904(&iLocal_1402, 9);
	...
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 9))
	{
		if (iParam0 <= 30000)
		{
			if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 11))
			{
				if (unk_0x13896FDECC859926("APT_COUNTDOWN_30S_KILL"))
				{
					unk_0x5D96D8530B3D0904(&iLocal_1402, 11);
				}
			}
			else
			{
				unk_0xEAE0D21A50E6C7F4(iLocal_1402, 11);
				if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 14))
				{
					if (unk_0xC92DB9682A650680("APT_COUNTDOWN_30S"))
					{
						unk_0x5D96D8530B3D0904(&iLocal_1402, 14);
					}
				}
			}
			if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 14))
			{
				if (iParam0 <= 27000)
				{
					if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 12))
					{
						unk_0xBEF52C1D400C0A44(1);
						unk_0x7352ACF3368DF65F("AllowScoreAndRadio", 0);
						unk_0x5D96D8530B3D0904(&iLocal_1402, 12);
					}
					if (iParam0 <= 500)
					{
						if (unk_0xC92DB9682A650680("APT_FADE_IN_RADIO"))
						{
							...
							unk_0x0674E58A79778E99(&iLocal_1402, 9);
						}
					}
				}
			}
...
void func_749()
{
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 8))
	{
		if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 9))
		{
			if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 10))
			{
				if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 11))
				{
					if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 12))
				...
				if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 16))
				{
					if (unk_0xC92DB9682A650680("APT_COUNTDOWN_30S_KILL"))
					{
						unk_0x5D96D8530B3D0904(&iLocal_1402, 16);
					}
				}
				if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 16))
				{
					if (!unk_0xEAE0D21A50E6C7F4(iLocal_1402, 13))
					{
						if (unk_0xC92DB9682A650680("APT_FADE_IN_RADIO"))
						{
							unk_0x5D96D8530B3D0904(&iLocal_1402, 13);
						}
					}
					if (unk_0xEAE0D21A50E6C7F4(iLocal_1402, 13))
					{
						unk_0x5D96D8530B3D0904(&iLocal_1402, 10);
					}
				}
			}
		}
...
{
	iVar17 = unk_0xD803B885F5E47A62();
	iVar18 = unk_0x57270EE11514DC67();
	if (func_17(unk_0xD803B885F5E47A62(), 0))
	{
		iVar18 = func_301();
		iVar17 = Global_1590535[unk_0xD803B885F5E47A62()].f_740;
	}
	...
	else if (!unk_0xEAE0D21A50E6C7F4(Local_952[iVar18].f_1, 6))
	{
		func_816();
		return;
	}
...
void func_770()
{
	...
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 1))
	{
		...
		unk_0x5D96D8530B3D0904(&iLocal_1401, 1);
	}
}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (Global_2460675)
							{
								if (iVar1 == 14)
								{
									func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(Global_21868), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							Global_7925[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7363[iVar1].f_4)
					{
						if (Global_7925[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(Global_21873), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_76622)
								{
									...
									func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(iVar4), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19486)
									...
									func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(iVar6), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7363[iVar1].f_10 == 57 && iVar1 == 23)
							{
								...
								func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(iVar9), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							else
							{
								func_801(Global_19467, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_7363[iVar1].f_10), to_float(0), -1f, &(Global_7363[iVar1]), 0, 0, 0, 0);
							}
							Global_7925[iVar0] = 1;
						}
					}
...
void func_817()
{
	...
	switch (Local_952[unk_0x57270EE11514DC67()].f_9)
	{
		case 0:
			func_819();
			func_312();
			if (Local_80.f_117 == 2)
			{
				Local_952[unk_0x57270EE11514DC67()].f_9 = 2;
			}
			else if (Local_80.f_117 == 3)
			{
				Local_952[unk_0x57270EE11514DC67()].f_9 = 3;
			}
			break;
...
void func_822()
{
	...
	if (fVar4 < 62500f)
	{
		if (iVar0 > -1)
		{
			...
			{
				vVar1 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), false) };
				func_92(10, 0, 0, 0, 0);
				func_823(vVar1, 0f, 250f, 1, 75f, 0, 1, 65f, 1, 0, 0, 1, -1082130432);
				iLocal_1408 = iVar0;
				unk_0x5D96D8530B3D0904(&iLocal_1401, 16);
			}
		}
	}
...
void func_828()
{
	...
	if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 2))
	{
		if (!func_836(86))
		{
			if (func_830(0, 1, 1, 1))
			{
				if (unk_0x57270EE11514DC67() == Local_80.f_118)
				{
					...
					func_321(1);
					unk_0x5D96D8530B3D0904(&iLocal_1401, 2);
				}
				else if (func_885() == Local_80.f_118)
				{
	...
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 2))
	{
		if (!unk_0xEAE0D21A50E6C7F4(iLocal_1401, 3))
		{
			if (func_830(0, 1, 1, 1))
			{
				if (!func_837("HUNT_HELPA", "HUNT_TARBLP"))
				{
					if (unk_0x57270EE11514DC67() == Local_80.f_118 || func_885() == Local_80.f_118)
					{
						...
						func_321(1);
						unk_0x5D96D8530B3D0904(&iLocal_1401, 3);
					}
				}
			}
		}
...
void func_839()
{
	if (func_144())
	{
		if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_1, 1))
		{
			func_112(0);
			unk_0x0674E58A79778E99(&(Local_952[unk_0x57270EE11514DC67()].f_1), 1);
		}
		return;
	}
	if (func_141(unk_0xD803B885F5E47A62()) == 0)
	...
	if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_1, 1))
	{
		if (!func_884())
		{
			if (!func_143())
			{
				...
				{
					func_112(1);
					unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_1), 1);
				}
			}
		}
	}
...
void func_840()
{
	...
	while (iVar0 < 4)
	{
		if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_2, iVar0))
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_110, iVar0))
			{
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
						{
							if (func_885() == Local_80.f_118)
							{
								if (func_858(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1)))
								{
									unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_2), iVar0);
								}
							}
						}
					}
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_3, iVar0))
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_112, iVar0))
			{
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
				{
					if (func_857(iVar0))
					{
						unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_3), iVar0);
					}
				}
			}
		}
		if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_4, iVar0))
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_80.f_111, iVar0))
			{
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), true), 10f, 1))
						{
							unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_4), iVar0);
						}
					}
				}
			}
			...
			if (!unk_0xE4EDC4B0E92C078B(iLocal_1416[iVar0]))
			{
				if (!func_818())
				{
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
					{
						if (!func_14(Local_80.f_2[iVar0].f_1))
						{
							iLocal_1416[iVar0] = unk_0x5C3B41825F6AC5A0(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1));
							if (func_885() == Local_80.f_118)
							{
								unk_0x2A065371C9D96655(iLocal_1416[iVar0], 12);
								unk_0xBC8E0A7390523199(iLocal_1416[iVar0], 432);
								func_855(&(iLocal_1416[iVar0]), 6);
							}
							else
							{
								unk_0xBC8E0A7390523199(iLocal_1416[iVar0], 480);
								func_855(&(iLocal_1416[iVar0]), 9);
							}
							unk_0xF412DD40DE84CE72(iLocal_1416[iVar0], 1);
							unk_0x0EC848EFF66DF45A(iLocal_1416[iVar0], 7000);
							unk_0x516E63E474722206(iLocal_1416[iVar0], 1,1f);
							unk_0xDC5B2F9D0CCE3A10(iLocal_1416[iVar0], "HUNT_BLIP");
						}
					}
				}
			}
			else if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
			{
				if (func_14(Local_80.f_2[iVar0].f_1))
				{
					unk_0x142CC44DB769B57E(&(iLocal_1416[iVar0]));
		...
		else if (unk_0xE4EDC4B0E92C078B(iLocal_1416[iVar0]))
		{
			unk_0x142CC44DB769B57E(&(iLocal_1416[iVar0]));
		}
		func_854(iVar0);
		...
		switch (Local_80.f_2[iVar0].f_17)
		{
					...
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_2))
					{
						if (func_12(Local_80.f_2[iVar0].f_2))
						{
							if (!func_14(Local_80.f_2[iVar0].f_1))
							{
								if (unk_0x82CCEAB29E9451DD(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2)))
								{
									if (unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -258271821) != 1 && unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -258271821) != 0)
									{
										unk_0xE072601B4380E9DF(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2), 20f, 786603);
									}
								}
							}
						}
						...
						if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
						{
							if (func_12(Local_80.f_2[iVar0].f_2))
							{
								if (!func_14(Local_80.f_2[iVar0].f_1))
								{
									if (unk_0x82CCEAB29E9451DD(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2)))
									{
										if ((unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -258271821) != 1 && unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -258271821) != 0) || unk_0xEAE0D21A50E6C7F4(Local_80.f_108, iVar0))
										{
											unk_0xE072601B4380E9DF(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xB177666FAB6F4417(Local_80.f_2[iVar0].f_2), 30f, 786469);
			...
			case 3:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -828834893) != 1 && unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -828834893) != 0)
						{
							if (func_849(Local_80.f_2[iVar0].f_1))
							{
								if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
								{
									unk_0x75CDA8644CD3B5F5(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 0, 0);
								}
							}
						}
					}
			...
			case 5:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
						{
							if (unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -1146898486) != 1 && unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -1146898486) != 0)
							{
								if (func_849(Local_80.f_2[iVar0].f_1))
								{
									if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
									{
										unk_0x01E4BB5190DF7317(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 1193033728, 0);
									}
								}
							}
						}
			...
			case 4:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
						{
							if (unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 1805844857) != 1 && unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 1805844857) != 0)
							{
								if (func_849(Local_80.f_2[iVar0].f_1))
								{
									if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
									{
										...
										{
											unk_0xF3268524E9BE6D6E(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), iVar2, 500f, -1, 0, 1);
										}
									}
								}
							}
			...
			case 6:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
						{
							unk_0x9DD8618CA5BF832D(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 187, true);
						}
						iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), -1442466670);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_849(Local_80.f_2[iVar0].f_1))
							{
								if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
								{
									unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), false);
									unk_0x7C8478BF70C1E072(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 299f, 0);
								}
							}
						}
					}
			...
			case 9:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						...
						iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 1910705116);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_849(Local_80.f_2[iVar0].f_1))
							{
								if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
								{
									unk_0x2051F535F4A99479(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 1);
									fVar5 = 0f;
									iVar4 = func_846(iVar0, &fVar5);
									if (iVar4 != func_65())
									{
										unk_0x5DA3F35E3BFDEE66(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0x9539D44F3E4492F6(iVar4), -1, 0);
									}
								}
							}
						}
			...
			case 8:
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
				{
					if (!func_14(Local_80.f_2[iVar0].f_1))
					{
						iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), 993674639);
						if (iVar3 != 1 && iVar3 != 0)
						{
							if (func_849(Local_80.f_2[iVar0].f_1))
							{
								if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_1))
								{
									unk_0x509B8296EBA9B408(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), "WORLD_HUMAN_SMOKING", 0, 0);
								}
							}
						}
					}
			...
			switch (Local_80.f_2[iVar0].f_18[iVar1])
			{
				...
				case 8:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
					{
						if (!func_14(Local_80.f_2[iVar0].f_3[iVar1]))
						{
							iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), 993674639);
							if (iVar3 != 1 && iVar3 != 0)
							{
								if (func_849(Local_80.f_2[iVar0].f_3[iVar1]))
								{
									if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_3[iVar1]))
									{
										unk_0x509B8296EBA9B408(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), "WORLD_HUMAN_GUARD_STAND", 0, 0);
									}
								}
							}
						}
				...
				case 7:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
					{
						if (!func_14(Local_80.f_2[iVar0].f_3[iVar1]))
						{
							iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), -1442466670);
							if (iVar3 != 1 && iVar3 != 0)
							{
								if (func_849(Local_80.f_2[iVar0].f_3[iVar1]))
								{
									if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_3[iVar1]))
									{
										unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), false);
										unk_0x7C8478BF70C1E072(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), 299f, 0);
									}
								}
							}
						}
				...
				case 3:
					if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
					{
						if (!func_14(Local_80.f_2[iVar0].f_3[iVar1]))
						{
							if (unk_0x0E0E6175453415CB(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1])))
							{
								iVar3 = unk_0xD1960163A3042274(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), -828834893);
								if (iVar3 != 1 && iVar3 != 0)
								{
									if (func_849(Local_80.f_2[iVar0].f_3[iVar1]))
									{
										if (unk_0x526BC32A660C89E6(Local_80.f_2[iVar0].f_3[iVar1]))
										{
											unk_0x11AD11297DC58CC7(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), true);
											unk_0x75CDA8644CD3B5F5(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), 299, 0);
											unk_0xAFF39FB306F8E232(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), 3, true);
										}
									}
								}
							}
...
void func_842(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, int iParam5, char* sParam6, int iParam7, int iParam8, bool bParam9)
{
	if (unk_0xE9F78D191AD5EDBA(iParam0))
	{
		...
		if (bParam3)
		{
			func_844(unk_0x1B50683925F00106(iParam0), iParam1, 1, Global_2439138, bParam4, iParam5, fParam2, sParam6, iParam7, iParam8, bParam9);
		}
		else
		{
			func_844(unk_0x1B50683925F00106(iParam0), iParam1, -1, Global_2439138, bParam4, iParam5, fParam2, sParam6, iParam7, iParam8, bParam9);
...
int func_846(int iParam0, float fParam1)
{
	iVar0 = func_65();
	fVar1 = 1E+08f;
	vVar3 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true) };
	iVar6 = 0;
	while (iVar6 < unk_0x54EABC0DD106045B())
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iVar6)))
		{
			iVar7 = unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iVar6));
			if (!func_17(iVar7, 0))
			{
				iVar8 = unk_0x9539D44F3E4492F6(iVar7);
				if (iVar6 == Local_80.f_118 || Local_952[iVar6].f_10 == Local_80.f_118)
				{
					if (!unk_0xEB6A8945D1AC98A1(iVar8))
					{
						fVar2 = vdist2(unk_0x68F4C0EC296D3901(iVar8, true), vVar3);
						if (fVar2 < fVar1)
						{
							fVar1 = fVar2;
							iVar0 = iVar7;
...
int func_848(int iParam0)
{
	...
	fVar1 = 1E+10f;
	fVar2 = 0f;
	vVar4 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), false) };
	iVar3 = 0;
	while (iVar3 < unk_0x54EABC0DD106045B())
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iVar3)))
		{
			iVar7 = unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iVar3));
			iVar8 = unk_0x9539D44F3E4492F6(iVar7);
			if (func_190(iVar7, 1))
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_952[iVar3].f_1, 1))
				{
					if (func_66(iVar7) == unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(Local_80.f_118)))
					{
						if (!unk_0xEB6A8945D1AC98A1(iVar8))
						{
							fVar2 = vdist2(unk_0x68F4C0EC296D3901(iVar8, true), vVar4);
							if (fVar2 < fVar1)
							{
								fVar1 = fVar2;
								iVar0 = iVar7;
...
void func_851(int iParam0)
{
	...
	if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
	{
		if (!func_14(Local_80.f_2[iParam0].f_1))
		{
			if (!unk_0x0E0E6175453415CB(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1)))
			{
				vVar4 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true) };
			...
			{
				iVar7 = unk_0x6937EA2286828455(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 0);
...
void func_853(int iParam0)
{
	...
	if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_13, iParam0))
	{
		return;
	}
	if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
	...
	if (func_14(Local_80.f_2[iParam0].f_1))
	{
		unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_12), iParam0);
		return;
	}
	iVar0 = unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1);
	vVar1 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false) };
	vVar4 = { unk_0x68F4C0EC296D3901(iVar0, false) };
	if (vdist2(vVar1, vVar4) < 5625f)
	{
		unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_13), iParam0);
		return;
	}
	if (unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
	...
	while (iVar7 < 3)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar7]))
		{
...
void func_854(int iParam0)
{
	...
	if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_12, iParam0))
	{
		return;
	}
	if (!unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
	...
	while (iVar8 < 3)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_3[iVar8]))
		{
			...
			{
				iVar7 = unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_3[iVar8]);
				if (func_885() == Local_80.f_118)
				{
...
void func_856(int iParam0)
{
	if (Local_80.f_2[iParam0] == 0)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_1))
		{
			if (unk_0x526BC32A660C89E6(Local_80.f_2[iParam0].f_1))
			{
				if (!func_14(Local_80.f_2[iParam0].f_1))
				{
					if (!unk_0x405E212DDE472467(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 0))
					{
						fVar0 = unk_0x9C66D99E63E8E24C(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1));
						if (fVar0 < 0,1f)
						{
							vVar2 = { unk_0x68F4C0EC296D3901(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), true) };
							vVar5 = { vVar2 };
							vVar5.z = (vVar5.z + 500f);
							if (unk_0xE82754C349C7B581(vVar5, &fVar1, 0, 0))
							{
								if (unk_0x755FF954DAE327E1((vVar2.z - fVar1)) > 30f)
								{
									unk_0xD458AC1C1D29C3B4(unk_0x1B50683925F00106(Local_80.f_2[iParam0].f_1), 0, 0);
								}
							}
						}
					}
...
int func_857(int iParam0)
{
	if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iParam0].f_2))
	{
		...
		{
			if (unk_0x7B5606C651AB51B5(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 0, 7000) || unk_0x7B5606C651AB51B5(unk_0xB177666FAB6F4417(Local_80.f_2[iParam0].f_2), 1, 40000))
			{
				return 1;
			}
		}
...
void func_860()
{
	if (Local_80 != 4)
	{
		iVar1 = unk_0x117658E336116132(iLocal_1404);
		if (unk_0x40B8C182D63932FC(iVar1))
		{
			if (unk_0xFB75B0F82CA525F6(iVar1))
			{
					...
					if (!func_884())
					{
						if (func_300())
						{
							if (func_190(iVar1, 1))
							{
								...
								{
									if (!unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_8, iLocal_1404))
									{
										func_341(iVar1, 432, 1, 0);
										func_334(iVar1, func_340(iLocal_1693), 1, 0);
										unk_0x5D96D8530B3D0904(&(Local_952[unk_0x57270EE11514DC67()].f_8), iLocal_1404);
									}
								}
							}
						}
			...
			else if (unk_0xEAE0D21A50E6C7F4(Local_952[unk_0x57270EE11514DC67()].f_8, iLocal_1404))
			{
				func_341(iVar1, 432, 0, 0);
				func_334(iVar1, func_340(iLocal_1693), 0, 0);
				unk_0x0674E58A79778E99(&(Local_952[unk_0x57270EE11514DC67()].f_8), iLocal_1404);
			}
		}
	}
	iLocal_1404++;
...
int func_864(bool bParam0)
{
	...
	{
		bVar0 = false;
		if (Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57 != func_65())
		{
			if (func_996(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57, 0, 1))
			{
		...
		if (bVar0)
		{
			if (bParam0)
			{
				...
				if (Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57 != func_65() && unk_0x40B8C182D63932FC(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57))
				{
					Global_1626725 = func_360(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57, -2, 0, 0, 0);
					if (!func_252(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57))
					{
						func_539(88);
					}
				}
...
void func_865()
{
	...
	while (iVar1 < 4)
	{
		if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar1].f_1))
		{
			if (Local_80.f_2[iVar1] == 2)
			{
				if (func_45(iVar1))
				{
					...
					while (iVar2 < 3)
					{
						if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar1].f_3[iVar2]))
						{
...
void func_866()
{
	...
	while (iVar0 < 4)
	{
		if (!bVar2)
		{
			if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_1))
			{
				unk_0x471081F9164BFC40(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_1), unk_0xD803B885F5E47A62(), false);
			}
			iVar1 = 0;
			iVar1 = 0;
			while (iVar1 < 3)
			{
				if (unk_0xE5DBF9B6126856CA(Local_80.f_2[iVar0].f_3[iVar1]))
				{
					unk_0x471081F9164BFC40(unk_0x1B50683925F00106(Local_80.f_2[iVar0].f_3[iVar1]), unk_0xD803B885F5E47A62(), false);
				}
				iVar1++;
			}
		}
...
void func_867()
{
	if (Local_80.f_118 > -1)
	{
		iLocal_1693 = func_735(unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(Local_80.f_118)));
	}
}
...
int func_885()
{
	...
	else if (func_190(iVar1, 1))
	{
		...
		if (iVar2 != func_65())
		{
			...
			{
				Local_952[iVar0].f_10 = unk_0x7B9C1F53FE442D06(iVar2);
			}
		}
	}
	return Local_952[iVar0].f_10;
...
void func_898()
{
	if (!func_17(unk_0xD803B885F5E47A62(), 0))
	{
		...
		if (unk_0x8CD06866876216F2())
		{
			iVar2 = Local_952[unk_0x57270EE11514DC67()].f_11;
		}
		func_944(uVar0, uVar1, iVar2, -1082130432);
		if (unk_0x8CD06866876216F2())
		{
			if (unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9()) == iLocal_1406)
			{
				unk_0x6DF7BF67E86AAE86(unk_0x16F2683693E537C9(), iLocal_1407);
			}
		}
	}
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 18))
	...
	if (Local_80.f_119 != -1)
	{
		if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 5))
		{
	...
	if (unk_0xEAE0D21A50E6C7F4(iLocal_1401, 17))
	{
		unk_0x34D79252800B23FF(iLocal_1695);
		unk_0x0674E58A79778E99(&iLocal_1401, 17);
	}
...
void func_900(bool bParam0, int iParam1)
{
	...
	func_108(29);
	Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57 = func_65();
...
{
	if (!func_28(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_337[iParam0], func_914(), 0))
	{
		Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_337[iParam0] = { func_914() };
	}
	if (!func_28(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_324[iParam0], func_914(), 0))
	{
		Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_324[iParam0] = { func_914() };
	}
}
...
{
	if (!func_28(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_150[iParam0], func_914(), 0))
	{
		Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_150[iParam0] = { func_914() };
	}
	if (!func_28(Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_125[iParam0], func_914(), 0))
	{
		Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_125[iParam0] = { func_914() };
	}
}
...
void func_927(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			func_929(iParam0, (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[iParam0].f_2 - (func_933(iVar2, bParam2) / 2)));
		}
...
void func_943()
{
	unk_0x51732B934211201A(iLocal_1406);
}
...
void func_946(struct<21> Param0)
{
	...
	unk_0x35B62793EAE9ADDF(&Local_952, 449);
	if (!func_992())
	{
		func_898();
	}
	if (unk_0x8CD06866876216F2())
	{
		...
		func_989();
		func_947(0, 0, 0);
		Local_952[unk_0x57270EE11514DC67()] = 0;
	}
	else
	{
		func_898();
...
void func_947(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_484(0))
	{
		Global_1628237[unk_0xD803B885F5E47A62()].f_11.f_57 = func_486();
	}
	if (func_319(iParam0))
	{
		func_712();
...
void func_989()
{
	unk_0xF63400DBE3303D26("relHeadHunterPlayer", &iLocal_1406);
	iVar0 = unk_0x256517DE1B6755D4(unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9()), -1533126372);
	iVar1 = 0;
	while (iVar1 < 32)
	{
		unk_0x0E2400AB9174FA81(5, Global_1574967[iVar1], iLocal_1406);
		unk_0x0E2400AB9174FA81(5, iLocal_1406, Global_1574967[iVar1]);
		unk_0x0E2400AB9174FA81(1, Global_1574967[iVar1], Global_1575012);
		unk_0x0E2400AB9174FA81(1, Global_1575012, Global_1574967[iVar1]);
		unk_0x0E2400AB9174FA81(iVar0, iLocal_1406, -1533126372);
		unk_0x0E2400AB9174FA81(iVar0, -1533126372, iLocal_1406);
		unk_0x0E2400AB9174FA81(1, iLocal_1406, Global_1575015[5]);
		unk_0x0E2400AB9174FA81(1, Global_1575015[5], iLocal_1406);
		unk_0x0E2400AB9174FA81(1, iLocal_1406, Global_1575000);
		unk_0x0E2400AB9174FA81(1, Global_1575000, iLocal_1406);
		iVar1++;
	}
	unk_0x0E2400AB9174FA81(5, iLocal_1406, Global_1575012);
	unk_0x0E2400AB9174FA81(5, Global_1575012, iLocal_1406);
	unk_0x0E2400AB9174FA81(1, 2017343592, Global_1575012);
	unk_0x0E2400AB9174FA81(5, 2017343592, iLocal_1406);
