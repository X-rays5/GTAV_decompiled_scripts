void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		...
		unk_0x536F1BE96C726C4B(vVar61, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_97 = func_245();
...
{
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_191(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_127(unk_0x16F2683693E537C9())) && func_191(unk_0x16F2683693E537C9(), vParam1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(unk_0x16F2683693E537C9(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
int func_207(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_223(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_228(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_248(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_249(iParam0);
...
int func_271(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
