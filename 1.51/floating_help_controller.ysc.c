...
void func_1()
{
	...
	while (iVar0 < Global_110290)
	{
		...
		{
			iVar1 = iVar0;
			if (unk_0x1C0640BA9A7327B3() > Global_110290[iVar0].f_21 && Global_110290[iVar0].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!unk_0xEAE0D21A50E6C7F4(Global_110290[iVar0].f_27, 0))
					{
						Global_110290[iVar0].f_21 = (Global_110290[iVar0].f_21 + round((unk_0x6117725E0134737F() * 1000f)));
						if (unk_0x9C6E1680B00A79AE(iVar1))
						{
							unk_0x5D96D8530B3D0904(&(Global_110290[iVar0].f_27), 0);
						}
					}
				}
				if (Global_110290[iVar0].f_24.f_2 != 9999f)
				{
					...
					{
						if (!unk_0x437347B10A200C4B(Global_110290[iVar0].f_23, 0))
						{
							if (!unk_0xEAE0D21A50E6C7F4(Global_110290[iVar0].f_27, 3))
							{
								unk_0xB5CBBD8CB1D39B8F(iVar1, unk_0x68E4ADDDDCD7BDDE(Global_110290[iVar0].f_23, Global_110290[iVar0].f_24));
							}
							else
							{
								unk_0xC7FCEAE8809CD8DE(iVar1, Global_110290[iVar0].f_23, Global_110290[iVar0].f_24, Global_110290[iVar0].f_24.f_1);
							}
						}
					}
					else if ((Global_110290[iVar0].f_24 != 0f || Global_110290[iVar0].f_24.f_1 != 0f) || Global_110290[iVar0].f_24.f_2 != 0f)
					{
						unk_0xB5CBBD8CB1D39B8F(iVar1, Global_110290[iVar0].f_24);
					}
				}
				else
				{
					unk_0x5FFE0E021F604464(iVar1, Global_110290[iVar0].f_24, Global_110290[iVar0].f_24.f_1);
				}
			}
			else if ((unk_0x1C0640BA9A7327B3() - Global_110290[iVar0].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
