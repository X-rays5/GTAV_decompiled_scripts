...
void func_12(char* sParam0, var uParam1, char* sParam2)
{
	...
	if (!func_53(uParam1->f_22, 0f, 0f, 0f, 0))
	{
		...
		unk_0x28F5E4DA506AC0CA(uParam1->f_5 + uParam1->f_19, (vmag(uParam1->f_22) + 25f), 0, 0, 0, 0, 0, 0);
		unk_0x536F1BE96C726C4B(uParam1->f_5 + uParam1->f_19, (vmag(uParam1->f_22) + 25f), 1, 0, 0, 0);
	}
	if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0))
	{
				...
				if (fVar0 >= uParam1->f_52)
				{
					if (!uParam1->f_32)
					{
						...
						if (uParam1->f_57 == 999f)
						{
							...
							fVar198 = unk_0xD9522BA9E27E1349(unk_0x16F2683693E537C9());
							fVar199 = vVar195.z;
							fVar200 = fVar198;
						...
						case -668482597:
							...
							if (unk_0x6C3F127AAF415E69() != 4)
							{
								...
								if (uParam1->f_31 == 999f)
								{
									...
									fVar214 = unk_0xD9522BA9E27E1349(unk_0x16F2683693E537C9());
									fVar215 = vVar211.z;
									fVar216 = fVar214;
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!unk_0x437347B10A200C4B(uParam0->f_5, 0))
			{
				...
				unk_0x5818C8D5303DCCF8(uParam0->f_1, fVar21);
				...
				unk_0x5818C8D5303DCCF8(uParam0->f_2, fVar21);
				if (uParam0->f_17 > 0 && iParam6 == 0)
				{
					...
					unk_0x5818C8D5303DCCF8(uParam0->f_4, fVar21);
				}
				if (uParam0->f_17 > 0 || iParam6 != 0)
				{
...
int func_57(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	...
	{
		func_61(0);
		unk_0x536F1BE96C726C4B(vParam0, 5f, 1, 0, 0, 0);
		...
		wait(0);
		unk_0x536F1BE96C726C4B(vParam0, 5000f, 1, 0, 0, 0);
...
bool func_114(int iParam0)
{
	...
	return unk_0x7F8A39872A07D2CE(vLocal_60.z, sVar1);
}
...
bool func_120()
{
	...
	vVar0 = { unk_0x68F4C0EC296D3901(Local_43.f_1, 1) };
	vVar3 = { unk_0x68F4C0EC296D3901(Local_43.f_4, 1) };
...
void func_121()
{
	...
	if ((Global_42383[iLocal_64].f_3 >= 10 || Global_42383[iLocal_64].f_4 >= 15) || unk_0xEAE0D21A50E6C7F4(Global_42599, 9))
	{
...
float func_137(int iParam0, float fParam1, int iParam2)
{
	fVar0 = unk_0x79833B02DBD2A244(-fParam1, fParam1);
	fVar1 = unk_0x79833B02DBD2A244(0f, iParam2);
	if (fVar0 < 0f)
	{
		fVar0 = (fVar0 - fVar1);
	}
...
void func_144()
{
	...
	func_145();
	unk_0x5B1D360B9C6F0A09(Local_43.f_1, Local_43.f_4, -1, iVar8, 2f, 1, 0);
	vLocal_60.x = 7;
}
...
void func_148(int iParam0)
{
	...
	unk_0x95E9A490A3D0029F(iParam0, 0, -1056964608);
...
void func_162()
{
	...
	if (bLocal_50)
	{
		...
		else
		{
			...
			iVar3 = 0;
			iVar4 = 0;
			unk_0x6FB46C25CCB7E6D5(668785249, &iVar2, -1);
			unk_0x6FB46C25CCB7E6D5(-964246833, &iVar3, -1);
			unk_0x6FB46C25CCB7E6D5(-486839853, &iVar4, -1);
			...
			{
				case 0:
					unk_0xCDC520E5E48E63D9(668785249, iVar2 + 1, 1);
					break;
				
				case 1:
					unk_0xCDC520E5E48E63D9(-964246833, iVar3 + 1, 1);
					break;
				
				case 2:
					unk_0xCDC520E5E48E63D9(-486839853, iVar4 + 1, 1);
					break;
				}
		}
		vLocal_60.y = 1;
