...
int func_30(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_36(&iVar20);
		iVar21 = func_35(Var10, Global_111638.f_7683.f_765[iVar20]);
		if (iVar21 == 2)
		{
			func_33(Global_111638.f_7683.f_765[iVar20]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_31(Global_111638.f_7683.f_765[iVar20]))
				{
					Global_111638.f_7683.f_765[iVar20] = { Var10 };
					func_32(&Var10);
					return 1;
...
void func_36(int iParam0)
{
	*iParam0 = 0;
	...
	{
		if (func_35(Global_111638.f_7683.f_765[iVar0], Global_111638.f_7683.f_765[*iParam0]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2548434[iParam0][func_60(iParam2)];
	if (iVar0 != 0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_60(iParam1)];
...
void func_74()
{
	if (func_64(iLocal_92) && func_73(iLocal_93))
	{
		...
		{
			func_78(0);
			unk_0x11AD11297DC58CC7(iLocal_92, false);
			unk_0x0E2400AB9174FA81(5, iLocal_122, 1862763509);
			unk_0x25C5402CC10F76CD(iLocal_92, true);
			unk_0x6C3AE6E278DB3D0E(iLocal_92, unk_0x16F2683693E537C9(), 0, 16);
			unk_0xFADC0A217229F6B5(iLocal_92, true);
			wait(0);
			func_62(7);
			func_26();
		}
		...
		else if (unk_0x12DE711B1C681E9E(iLocal_93, iLocal_92, 20f, 20f, 20f, 0, 1, 0))
		{
			if (func_77())
			{
				if (!func_75(iLocal_92, 242628503))
				{
					...
					unk_0x78ADC381772E3D54(iLocal_92, iLocal_95);
	...
	if (func_64(iLocal_92))
	{
		if (iParam0 == 1)
		{
			if (!unk_0x16102BEDC7435774(iLocal_92) && func_64(unk_0x16F2683693E537C9()))
			{
				...
				unk_0x18E279963C2FCEF4(func_79(), 2f, -1f, -1f);
...
bool func_81(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar4 == -1)
	{
		...
		Local_44[iVar4].f_1 = iParam0;
		Local_44[iVar4].f_2 = iParam1;
	}
	vVar1 = { unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f) };
	uVar0 = func_82(&(Local_44[iVar4]), vVar1, iParam1, &(Local_44[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_44[iVar4].f_3) < iParam4);
}

int func_82(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_64(iParam4))
	{
...
int func_84()
{
	...
	{
		if ((Local_44[iVar0] == 0 && Local_44[iVar0].f_1 == 0) && Local_44[iVar0].f_2 == 0)
		{
			return iVar0;
		}
		iVar0++;
...
int func_89(int iParam0, int iParam1)
{
	...
	while (iVar0 < Local_44)
	{
		if (Local_44[iVar0].f_1 == iParam0 && Local_44[iVar0].f_2 == iParam1)
		{
			return iVar0;
		}
		iVar0++;
...
void func_92()
{
	if (func_64(iLocal_91))
	{
		if (iLocal_120 == 0)
		{
			unk_0xBAFED2F6486F771A(iLocal_91, 2, false);
...
void func_103()
{
	if (func_104())
	{
		...
		if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 1))
		{
			...
			unk_0x73270B3C9CC833FD(iLocal_94, true, 1);
		}
		if (func_64(iLocal_92))
		{
	...
	{
		if (((bLocal_326 == 0 && unk_0xE4EDC4B0E92C078B(iLocal_131)) && func_64(unk_0x16F2683693E537C9())) && func_64(iLocal_91))
		{
			if (func_63(unk_0x16F2683693E537C9(), iLocal_91, 1) < 30f || unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(iLocal_91, true), 10f, 1))
			{
				bLocal_326 = true;
		...
		if (((iLocal_317 == 2 && func_64(iLocal_91)) && func_73(iLocal_93)) && unk_0xC42A92762C58E1B9(iLocal_91, iLocal_93, 0))
		{
			if (iLocal_312 == 0)
			{
				...
				iLocal_312 = 1;
				vLocal_313 = { unk_0xAA8A22FF67DFFDCD(unk_0x1A2511CB22B86C17(1, "RE_BikeThief2"), unk_0x1C8FE65729F6E371(1, "RE_BikeThief2")) };
			}
			else if (!unk_0x20D6474D5F4B9FC6(iLocal_93) || func_225(iLocal_93, vLocal_313, 1) < 5f)
			{
				if (unk_0x20D6474D5F4B9FC6(iLocal_93))
				{
					unk_0xC55F2A0377488064(iLocal_93);
	...
	if ((((iLocal_310 == 0 && func_64(iLocal_92)) && func_64(iLocal_91)) && func_73(iLocal_93)) && unk_0xC42A92762C58E1B9(iLocal_91, iLocal_93, 0))
	{
		if (iLocal_327 == 0)
		{
			if (func_2(&uLocal_134, "REBTHAU", sLocal_299, 4, func_110(), 0, 0))
			{
				...
				unk_0x80AA372E04ED318D(0, vLocal_105, 2f, 20000, 40000f, 0,5f);
...
int func_110()
{
	...
	{
		if (unk_0x12DE711B1C681E9E(iLocal_92, unk_0x16F2683693E537C9(), vVar1, 0, 1, 0))
		{
			iVar0 = 0;
		}
		else
...
void func_115(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (unk_0xC844350D5D58C99A(iLocal_91))
	{
		...
		else if (func_153())
		{
			...
			if (unk_0xDF1306B443CD3D15(iLocal_93, 0) && !unk_0xEB6A8945D1AC98A1(iLocal_91))
			{
				if (iLocal_317 == 2)
				{
					unk_0x5B1D360B9C6F0A09(iLocal_91, iLocal_93, 20000, -1, 2f, 1, 0);
				}
				else
				{
					unk_0xDD353D0E9C789D0E(&iLocal_95);
					unk_0x5B1D360B9C6F0A09(0, iLocal_93, 20000, -1, 2f, 1, 0);
...
int func_154()
{
	...
	if (func_64(iLocal_92))
	{
		...
		vVar0 = { vVar0 + unk_0x64430C979F516F7A(iLocal_92, 31086, 0f, 0f, 0f) };
		vVar3 = { vVar3 + unk_0x64430C979F516F7A(iLocal_92, 31086, 0f, 0f, 0f) };
...
void func_155()
{
	...
	unk_0x523BCC9DC80CD82F(-48477765);
	unk_0x523BCC9DC80CD82F(2114544056);
	unk_0x523BCC9DC80CD82F(iLocal_90);
	if ((((unk_0xB87F6CF6E5628C67(-48477765) && unk_0xB87F6CF6E5628C67(2114544056)) && unk_0xB87F6CF6E5628C67(iLocal_90)) && func_157()) && func_156())
	{
		iLocal_93 = unk_0x122AAB0B1D6F55AD(iLocal_90, vLocal_99, fLocal_111, true, true, false);
		unk_0x71199B01895C6202(iLocal_90);
		unk_0xAB8E2DDC7AF955E0(iLocal_90, true);
		unk_0x56FDC9ADE35F7DB0(iLocal_93, true, true, 0);
		unk_0xA22F71BBC8173C39(iLocal_93, false);
		unk_0x67E3D6EA8D96FD85(iLocal_93, 0);
		unk_0x44A200C9B6E1CEA6(iLocal_93, true);
		...
		if (iLocal_317 == 3)
		{
			...
			unk_0xEE6A1776A67F70C1(iLocal_93, 16, 2, false);
			unk_0xEE6A1776A67F70C1(iLocal_93, 11, 3, false);
			unk_0xEE6A1776A67F70C1(iLocal_93, 12, 2, false);
			unk_0xEE6A1776A67F70C1(iLocal_93, 13, 2, false);
			unk_0xEE6A1776A67F70C1(iLocal_93, 23, 10, false);
			unk_0xEE6A1776A67F70C1(iLocal_93, 24, 10, false);
			unk_0x73BEC6F1685574E6(iLocal_93, 22, true);
			unk_0x73BEC6F1685574E6(iLocal_93, 17, true);
			unk_0x73BEC6F1685574E6(iLocal_93, 21, true);
			unk_0x73BEC6F1685574E6(iLocal_93, 20, true);
			unk_0x73BEC6F1685574E6(iLocal_93, 19, true);
			unk_0xC002508A277213DE(iLocal_93, 89, 89);
			unk_0x58A0C35FA7CA6162(iLocal_93, 0, 1);
			unk_0xA22B35B584F0580A(iLocal_93, 1);
		}
		unk_0xF63400DBE3303D26("re_bikethief_relGroupVictim", &iLocal_122);
		unk_0xF63400DBE3303D26("re_bikethief_relGroupThief", &iLocal_123);
		unk_0x0E2400AB9174FA81(5, iLocal_123, iLocal_122);
		unk_0x0E2400AB9174FA81(5, iLocal_123, 1862763509);
		unk_0x0E2400AB9174FA81(1, iLocal_122, 1862763509);
		iLocal_91 = unk_0x36F2404464202779(19, -48477765, vLocal_108, fLocal_113, 1, true);
		unk_0x71199B01895C6202(-48477765);
		unk_0x11AD11297DC58CC7(iLocal_91, true);
		unk_0x7980D72D61BEF4D5(iLocal_91, true);
		unk_0x6DF7BF67E86AAE86(iLocal_91, iLocal_123);
		unk_0x3CC33E4E9CE523F4(iLocal_91, 3);
		unk_0xAFF39FB306F8E232(iLocal_91, 17, true);
		unk_0xAFF39FB306F8E232(iLocal_91, 13, false);
		unk_0xBAFED2F6486F771A(iLocal_91, 1, true);
		unk_0xCC095276B3DD380E(iLocal_91, 0);
		unk_0x4E885A246A9D983A(iLocal_91, 42, true);
		unk_0x4E885A246A9D983A(iLocal_91, 281, true);
		...
		iLocal_92 = unk_0x36F2404464202779(19, 2114544056, vLocal_102, fLocal_112, 1, true);
		unk_0x71199B01895C6202(2114544056);
		unk_0x11AD11297DC58CC7(iLocal_92, true);
		unk_0x7980D72D61BEF4D5(iLocal_92, true);
		unk_0xBAFED2F6486F771A(iLocal_92, 8, true);
		if (iLocal_317 == 3)
		{
		...
		unk_0x4E885A246A9D983A(iLocal_92, 26, true);
		unk_0x4E885A246A9D983A(iLocal_92, 42, true);
		unk_0x4E885A246A9D983A(iLocal_92, 167, true);
		unk_0x4E885A246A9D983A(iLocal_92, 281, true);
...
int func_178()
{
	...
	{
		if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_86) < (75f * 75f))
		{
			return 1;
		}
		if (vmag2(unk_0x56E9E0FD5ACCD35D(unk_0x16F2683693E537C9())) > 1369f && !func_173())
...
void func_226()
{
	...
	unk_0x71199B01895C6202(-48477765);
	unk_0x71199B01895C6202(2114544056);
	unk_0x71199B01895C6202(-186537451);
	unk_0x71199B01895C6202(-114291515);
