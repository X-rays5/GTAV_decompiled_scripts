...
void func_2()
{
	...
	bVar1 = false;
	if ((iLocal_55 == 6 && func_84(64)) || (iLocal_55 == 5 && unk_0x8A22C4C08282BF26(-1208726289) > 0))
	{
		bVar1 = true;
		iLocal_60 = 1;
	}
		...
		while (iVar12 < iVar11)
		{
			...
			if (func_56(iLocal_58, iVar8, iVar3, &iVar4))
			{
				...
				if (iVar4 > func_53(iLocal_58, iVar8, -1))
				{
					...
					else if ((!Global_111638.f_9080 && !func_52(0)) || !unk_0xEAE0D21A50E6C7F4(Global_111638.f_9080.f_2[27], 2))
					{
						bVar13 = false;
					}
					iVar14 = iVar4;
					...
					if (iVar4 >= 100)
					{
						if (func_3(iLocal_58, iVar8, &iVar9))
						{
							if (iLocal_58 == 0)
							{
								unk_0x6FB46C25CCB7E6D5(-1263997649, &iVar10, -1);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 1)
							{
								unk_0x6FB46C25CCB7E6D5(1157035214, &iVar10, -1);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 2)
							{
								unk_0x6FB46C25CCB7E6D5(-1923670641, &iVar10, -1);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 3)
							{
...
int func_9()
{
	...
	if (Global_1590535[unk_0xD803B885F5E47A62()].f_750 == 1)
	{
		return 0;
	}
	if (func_42())
	...
	{
		if (func_26(unk_0x16F2683693E537C9()) == 100416529 || func_26(unk_0x16F2683693E537C9()) == 205991906)
		{
			return 0;
		}
	}
	...
	if (Global_1590535[unk_0xD803B885F5E47A62()].f_732)
	{
		return 0;
	}
...
{
	return unk_0xEAE0D21A50E6C7F4(Global_1627020[iParam0].f_14, 0);
}
...
{
	iVar0 = Global_2583656[iParam0][func_5(iParam1)];
...
int func_57(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(1322098561, &iVar3, -1);
				fVar0 = to_float(iVar3);
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(1372388259, &iVar3, -1);
				fVar0 = to_float(iVar3);
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(95446082, &iVar3, -1);
				fVar0 = to_float(iVar3);
			}
			else if (iParam0 == 3)
			{
		...
		case 1:
			...
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + to_float(func_64(-2051928250)));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + to_float(func_64(16515143)));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + to_float(func_64(-475717996)));
			}
			else if (iParam0 == 3)
			{
			...
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + to_float(func_64(-1004410093)));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + to_float(func_64(1273684458)));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + to_float(func_64(1294042566)));
			}
			else if (iParam0 == 3)
			{
		...
		case 3:
			if (iParam0 == 0)
			{
				fVar0 = (to_float(func_62(1800856896)) / 30f);
			}
			else if (iParam0 == 1)
			{
				fVar0 = (to_float(func_62(1645443120)) / 30f);
			}
			else if (iParam0 == 2)
			{
				fVar0 = (to_float(func_62(1882821587)) / 30f);
			}
			else if (iParam0 == 3)
			{
		...
		case 2:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(1416478656, &iVar3, -1);
				fVar0 = (to_float((iVar3 - Global_111638.f_2358.f_539.f_2359[iParam0])) / 20f);
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(-1281617759, &iVar3, -1);
				fVar0 = (to_float((iVar3 - Global_111638.f_2358.f_539.f_2359[iParam0])) / 20f);
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(1553995821, &iVar3, -1);
				fVar0 = (to_float((iVar3 - Global_111638.f_2358.f_539.f_2359[iParam0])) / 20f);
			}
			else if (iParam0 == 3)
			{
		...
		case 4:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(53792835, &iVar3, -1);
				fVar0 = (fVar0 + (to_float((iVar3 - Global_111638.f_2358.f_539.f_2363[iParam0])) / 50f));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(-394025441, &iVar3, -1);
				fVar0 = (fVar0 + (to_float((iVar3 - Global_111638.f_2358.f_539.f_2363[iParam0])) / 50f));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(1000006342, &iVar3, -1);
				fVar0 = (fVar0 + (to_float((iVar3 - Global_111638.f_2358.f_539.f_2363[iParam0])) / 50f));
			}
			else if (iParam0 == 3)
			{
		...
		case 5:
			if (iParam0 == 0)
			{
				fVar0 = (to_float(func_64(-1878424599)) / 10f);
			}
			else if (iParam0 == 1)
			{
				fVar0 = (to_float(func_64(-486431088)) / 10f);
			}
			else if (iParam0 == 2)
			{
				fVar0 = (to_float(func_64(1632483039)) / 10f);
			}
			else if (iParam0 == 3)
			{
			...
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + (to_float(func_64(1761841536)) / 10f));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + (to_float(func_64(-495607361)) / 10f));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + (to_float(func_64(-1569504602)) / 10f));
			}
			else if (iParam0 == 3)
			{
			...
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(-928799097, &iVar3, -1);
				fVar0 = (fVar0 + to_float(iVar3));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(-991980757, &iVar3, -1);
				fVar0 = (fVar0 + to_float(iVar3));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(-1493562912, &iVar3, -1);
				fVar0 = (fVar0 + to_float(iVar3));
			}
			else if (iParam0 == 3)
			{
		...
		case 7:
			if (iParam0 == 0)
			{
				unk_0x893A626C476B583D(647385773, &fVar1, -1);
				fVar0 = ((fVar1 - Global_111638.f_2358.f_539.f_2367[iParam0]) / 45f);
			}
			else if (iParam0 == 1)
			{
				unk_0x893A626C476B583D(754892325, &fVar1, -1);
				fVar0 = ((fVar1 - Global_111638.f_2358.f_539.f_2367[iParam0]) / 45f);
			}
			else if (iParam0 == 2)
			{
				unk_0x893A626C476B583D(30674678, &fVar1, -1);
				fVar0 = ((fVar1 - Global_111638.f_2358.f_539.f_2367[iParam0]) / 45f);
			}
			else if (iParam0 == 3)
			{
			...
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(2015551237, &iVar3, -1);
				fVar0 = (fVar0 + ((to_float((iVar3 - Global_111638.f_2358.f_539.f_2371[iParam0])) / 2f) * 1,5f));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(1344599136, &iVar3, -1);
				fVar0 = (fVar0 + ((to_float((iVar3 - Global_111638.f_2358.f_539.f_2371[iParam0])) / 2f) * 1,5f));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(748593089, &iVar3, -1);
				fVar0 = (fVar0 + ((to_float((iVar3 - Global_111638.f_2358.f_539.f_2371[iParam0])) / 2f) * 1,5f));
			}
			else if (iParam0 == 3)
			{
		...
		case 6:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(2054327807, &iVar5, -1);
				unk_0x6FB46C25CCB7E6D5(-1001096750, &iVar6, -1);
				iVar6 = (iVar6 - iVar5);
			...
			{
				unk_0x6FB46C25CCB7E6D5(-470783371, &iVar5, -1);
				unk_0x6FB46C25CCB7E6D5(-1601251140, &iVar6, -1);
				iVar6 = (iVar6 - iVar5);
				fVar0 = (to_float((iVar5 - Global_111638.f_2358.f_539.f_2375[iParam0])) / 40f);
				fVar0 = (fVar0 + (to_float((iVar6 - Global_111638.f_2358.f_539.f_2379[iParam0])) / 80f));
			}
			...
			{
				unk_0x6FB46C25CCB7E6D5(1104928213, &iVar5, -1);
				unk_0x6FB46C25CCB7E6D5(-1090747299, &iVar6, -1);
				iVar6 = (iVar6 - iVar5);
				fVar0 = (to_float((iVar5 - Global_111638.f_2358.f_539.f_2375[iParam0])) / 40f);
				fVar0 = (fVar0 + (to_float((iVar6 - Global_111638.f_2358.f_539.f_2379[iParam0])) / 80f));
			}
...
void func_79()
{
	if (!iLocal_80)
	{
		if (iLocal_58 == 3)
		{
			...
			{
				Global_2097152[func_81()].f_6174.f_4 = unk_0xDD0E7998AE8AD485();
			}
...
void func_99()
{
	...
	if (unk_0x8CD06866876216F2())
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_2097152[func_81()].f_6174.f_1273, 2))
		{
			fVar0 = (to_float(func_70(192, -1, 0)) / 20f);
			iVar1 = floor(fVar0);
			iVar1 = func_69(iVar1, 0, 100);
			func_80(3, 2, iVar1);
			unk_0x5D96D8530B3D0904(&(Global_2097152[func_81()].f_6174.f_1273), 2);
		}
	}
	bLocal_59 = true;
	iLocal_54 = 1;
