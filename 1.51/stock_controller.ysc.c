void __EntryFunction__()
{
	...
	if (unk_0x8A22C4C08282BF26(-914146553) > 1)
	{
		func_98();
	}
	Global_61496 = 1;
	...
	while (iVar0 < 204)
	{
		if (!Global_57254[iVar0])
		{
			if (Global_57254[iVar0].f_2)
			{
				...
				{
					unk_0x6FB46C25CCB7E6D5(Global_57254[iVar0].f_3, &(Global_57254[iVar0].f_5), -1);
				}
				else
				{
					fVar1 = 0f;
					unk_0x893A626C476B583D(Global_57254[iVar0].f_3, &fVar1, -1);
					Global_57254[iVar0].f_5 = floor(fVar1);
				}
			}
		}
		iVar0++;
...
int func_5()
{
	...
	while (iVar0 < 80)
	{
		if (Global_53811[iVar0].f_8)
		{
			...
			{
				iVar2 = Global_56692[Global_53811[iVar0].f_35];
				unk_0x893A626C476B583D(iVar2, &(Global_53811[iVar0].f_9), -1);
				if (Global_53811[iVar0].f_9 > 0f)
				{
					fVar3 = 0f;
					unk_0x43B7F203CA37F346(iVar2, 0, &(Global_53811[iVar0].f_33));
...
void func_41()
{
	...
	while (iVar0 < 204)
	{
		if (!Global_57254[iVar0])
		{
			if (Global_57254[iVar0].f_2)
			{
				...
				if (!Global_57254[iVar0].f_4)
				{
					unk_0x6FB46C25CCB7E6D5(Global_57254[iVar0].f_3, &iVar1, -1);
				}
				else
				{
					fVar2 = 0f;
					unk_0x893A626C476B583D(Global_57254[iVar0].f_3, &fVar2, -1);
					iVar3 = floor(fVar2);
	...
	while (iVar0 < 80)
	{
		if (!Global_53811[iVar0].f_8)
		{
			...
			fVar5 = (fVar5 + ((unk_0x79833B02DBD2A244(-Global_56966[iVar4].f_6, Global_56966[iVar4].f_6) * 0,1f) * Global_53811[iVar0].f_9));
...
int func_61(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_75441.f_484[iVar0] == iParam0)
		{
			...
			{
				if (unk_0xEAE0D21A50E6C7F4(Global_75441.f_555[0].f_9, 10) && Global_75441.f_555[0].f_4 == unk_0x134B62B726CEC8E6(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
...
void func_80()
{
	...
	if (unk_0x405E212DDE472467(unk_0x9539D44F3E4492F6(unk_0xA30EC016B12C03E4()), 0))
	{
		...
		if (func_81(iVar1, unk_0x0EB28750412C3A5A(vLocal_27, vLocal_30, false)))
		{
			vLocal_30 = { vLocal_27 };
		}
	}
	...
	while (iVar0 < 80)
	{
		if (Global_53811[iVar0].f_8)
		{
			...
			if (iVar1 > -1)
			{
				...
				unk_0xCDC520E5E48E63D9(Global_56692[iVar1].f_3[iParam0], iVar2, 1);
			}
		}
		iVar0++;
	}
			...
			if ((Global_53811[iVar1].f_32 > 0f && Global_53811[iVar1].f_31 > 0f) && Global_53811[iVar1].f_9 > 0f)
			{
				...
				if (fVar16 != 1f)
				{
					...
					while (iVar3 <= 15)
					{
						...
						Global_53811[iVar1].f_14[iVar3] = (Global_53811[iVar1].f_14[iVar3] * (unk_0x79833B02DBD2A244(0,95f, 1,05f) + (fVar18 * fVar17)));
						if (iVar3 == 15)
						{
...
void func_94()
{
	if (!Global_111638.f_20559.f_101)
	{
		...
		while (iVar0 < 80)
		{
			if (!Global_53811[iVar0].f_8)
			{
				Global_53811[iVar0].f_9 = unk_0x79833B02DBD2A244(15f, 290f);
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_53811[iVar0].f_9 = (Global_53811[iVar0].f_9 * unk_0x79833B02DBD2A244(fVar2, fVar3));
				Global_53811[iVar0].f_9 = func_93(func_92(unk_0x755FF954DAE327E1(Global_53811[iVar0].f_9), 3,5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
