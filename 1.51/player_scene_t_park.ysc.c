...
int func_2()
{
	if (!unk_0xEA6BC48857E0AC4C(&cLocal_90))
	{
		if (!unk_0x83A8177D302E1A7E(iLocal_87))
		{
			...
			iLocal_87 = unk_0xB055A4268B938F30(&cLocal_90, vLocal_83 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (unk_0xB4ECF989E2C1DAC8(unk_0x16F2683693E537C9(), &sLocal_143, &cLocal_159, 2))
		{
			...
			switch (iLocal_224)
			{
				case 0:
					...
					if (fVar3 > fLocal_141)
					{
						if (!unk_0xC844350D5D58C99A(iLocal_72) || iLocal_89 != -1)
						{
							if (unk_0x97A0DB46CA749F31(&cLocal_106, unk_0x16F2683693E537C9(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_89, 1f, 0, 0, 0))
							{
								...
								unk_0xCEAA091B490F8407(iLocal_223, &cLocal_207, unk_0x16F2683693E537C9(), &cLocal_191, false, 0);
								iLocal_224++;
							}
						}
						else if (unk_0xE81656B429E5C4B5(&cLocal_106, iLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (unk_0x7F8A39872A07D2CE(&cLocal_106, "scr_meth_pipe_smoke"))
							{
								func_17(unk_0x16F2683693E537C9(), 0, 1);
			...
			{
				if (unk_0xD59B17D2DFF98E26(iLocal_72))
				{
					if (iLocal_82 != -1)
					{
						if (fVar3 > fLocal_81)
...
int func_3(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			if (unk_0x134B62B726CEC8E6(*iParam0) != 913235136 && unk_0x134B62B726CEC8E6(*iParam0) != -249304586)
			{
				unk_0x1E9649458B15960F(*iParam0, false);
				unk_0xEF190091B5B9F5EB(*iParam0, 1);
			}
			if (unk_0x134B62B726CEC8E6(*iParam0) == -249304586)
			{
				...
				unk_0xC023D1C4BF532815(*iParam0, vVar4.x, vVar4.y, vVar4.z, 2, 1);
			}
			if (unk_0x134B62B726CEC8E6(*iParam0) != -966274179)
			{
		...
		case 3:
			...
			if (((unk_0x134B62B726CEC8E6(*iParam0) != -1593767197 && unk_0x134B62B726CEC8E6(*iParam0) != -535483992) && unk_0x134B62B726CEC8E6(*iParam0) != -717890986) && unk_0x134B62B726CEC8E6(*iParam0) != 542291840)
			{
				unk_0x1BF8B16C32704027(*iParam0, -8f, 1);
			}
			if ((unk_0x134B62B726CEC8E6(*iParam0) != -1289815393 && unk_0x134B62B726CEC8E6(*iParam0) != -535483992) && unk_0x134B62B726CEC8E6(*iParam0) != -717890986)
			{
				unk_0x1E9649458B15960F(*iParam0, false);
			}
			unk_0xEF190091B5B9F5EB(*iParam0, 1);
		...
		case 4:
			vVar7 = { unk_0x68F4C0EC296D3901(*iParam0, true) };
			vVar10 = { unk_0x835730A2D89F6093(*iParam0, 2) };
			iVar13 = 0;
			switch (unk_0x134B62B726CEC8E6(*iParam0))
			{
				...
				case -2059029335:
					...
					vVar17 = { 0f, 0f, 53,6f };
					unk_0xA47B46945FF6DE74(*iParam0, vVar14, 1, false, 0, 1);
					unk_0xC023D1C4BF532815(*iParam0, vVar17, 2, 1);
			...
			while (!unk_0xB87F6CF6E5628C67(iVar13))
			{
			...
			unk_0xF690C84DADBB3551(iParam0);
			*iParam0 = unk_0x7707E48765093646(iVar13, vVar7, 1, true, false);
			unk_0xC023D1C4BF532815(*iParam0, vVar10, 2, 1);
			unk_0x71199B01895C6202(iVar13);
			return 1;
			break;
		
		case 5:
			unk_0xDA55CDFB97015579(unk_0x68F4C0EC296D3901(*iParam0, true), 0, 0,5f, 1, 0, 1065353216, 0);
			unk_0xF690C84DADBB3551(iParam0);
			return 1;
			break;
		...
		case 7:
			if (unk_0x134B62B726CEC8E6(*iParam0) == unk_0x6B7EC7B5B6B57364(453432689))
			{
		...
		case 8:
			vVar20 = { unk_0x68F4C0EC296D3901(*iParam0, true) };
			vVar23 = { unk_0x835730A2D89F6093(*iParam0, 2) };
			sVar26 = "";
			switch (unk_0x134B62B726CEC8E6(*iParam0))
			{
				case -1620762220:
			...
			unk_0xBA3209FB359D3EA4(sVar26, vVar20, vVar23, 1065353216, 0, 0, 0);
			unk_0xF690C84DADBB3551(iParam0);
			return 1;
			break;
		
		case 9:
			vVar27 = { unk_0x68F4C0EC296D3901(*iParam0, true) };
			vVar30 = { unk_0x835730A2D89F6093(*iParam0, 2) };
			sVar33 = "";
			switch (unk_0x134B62B726CEC8E6(*iParam0))
			{
				case -1620762220:
			...
			unk_0x523BCC9DC80CD82F(iVar34);
			while (!unk_0xB87F6CF6E5628C67(iVar34))
			{
				unk_0x3FC8DBCC154CA56B();
				unk_0x3584F71E5CA29322(18);
				unk_0xECEC50E724D52DC1();
			...
			unk_0xBA3209FB359D3EA4(sVar33, vVar27, vVar30, 1065353216, 0, 0, 0);
			unk_0xF690C84DADBB3551(iParam0);
			*iParam0 = unk_0x7707E48765093646(iVar34, vVar27, 1, true, false);
			unk_0xC023D1C4BF532815(*iParam0, vVar30, 2, 1);
			if (func_6(iVar0, &sVar35, &cVar51, &iVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					if (!unk_0xB4ECF989E2C1DAC8(*iParam0, &sVar68, &sVar35, 2))
					{
						unk_0xE14EC663EED44AD5(*iParam0, Global_96074, &sVar35, &sVar68, 1000f, -8f, iVar67, 1148846080);
					}
				}
			}
			unk_0x71199B01895C6202(iVar34);
			return 1;
			break;
	}
	return 0;
...
int func_36()
{
	if (!iLocal_73 == 0)
	{
		if (!unk_0xC844350D5D58C99A(iLocal_72))
		{
			...
			if (!unk_0xB87F6CF6E5628C67(iLocal_73))
			{
				unk_0x523BCC9DC80CD82F(iLocal_73);
			}
			else if (iLocal_80 != -1)
			{
				iLocal_72 = unk_0x7707E48765093646(iLocal_73, vLocal_83, 1, true, false);
				unk_0x9F528B1B53FBC5D9(iLocal_72, unk_0x16F2683693E537C9(), unk_0x4A089F2B762B8D33(unk_0x16F2683693E537C9(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				iLocal_72 = unk_0x7707E48765093646(iLocal_73, vLocal_83 + vLocal_74, 1, true, false);
				unk_0xA47B46945FF6DE74(iLocal_72, vLocal_83 + vLocal_74, 1, false, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_72, Vector(uLocal_86, 0f, 0f) + vLocal_77, 2, 1);
				unk_0x1E9649458B15960F(iLocal_72, true);
			}
		}
	}
	if (!func_37())
	{
		if (unk_0xC844350D5D58C99A(iLocal_72))
		{
			if (iLocal_80 != -1)
			{
				if (!unk_0x50B5F6F3C29E9380(iLocal_72, unk_0x16F2683693E537C9()))
				{
					unk_0x9F528B1B53FBC5D9(iLocal_72, unk_0x16F2683693E537C9(), unk_0x4A089F2B762B8D33(unk_0x16F2683693E537C9(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
				}
			}
