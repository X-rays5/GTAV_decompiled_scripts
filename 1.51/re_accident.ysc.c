void __EntryFunction__()
{
	...
	vLocal_305 = { ScriptParam_0.f_1[0] };
...
void func_1()
{
	if (iLocal_534 && !iLocal_535)
	{
		...
		while (iLocal_347 < 11)
		{
			if (unk_0xC844350D5D58C99A(iLocal_327[iLocal_347]))
			{
				unk_0x1E9649458B15960F(iLocal_327[iLocal_347], false);
			}
			iLocal_347++;
		}
		if (!unk_0x437347B10A200C4B(iLocal_319, 0))
		{
			...
			unk_0x1E9649458B15960F(iLocal_319, false);
		}
		if (unk_0xC844350D5D58C99A(iLocal_339))
		{
			unk_0x1E9649458B15960F(iLocal_339, false);
		}
		...
		if (unk_0x9F4FE516EAACCFC5(iLocal_529))
		{
			unk_0x9A8DDC7C522F5BF5(iLocal_529, 0);
			unk_0xB3A1B75CB59FEB56(false, false, 3000, 1, 0, 0);
		...
		if (unk_0xE4EDC4B0E92C078B(iLocal_323))
		{
			unk_0x142CC44DB769B57E(&iLocal_323);
		}
		if (unk_0xE4EDC4B0E92C078B(iLocal_324))
		{
			unk_0x142CC44DB769B57E(&iLocal_324);
		}
		if (unk_0xE4EDC4B0E92C078B(iLocal_325))
		{
			unk_0x142CC44DB769B57E(&iLocal_325);
		}
		if (unk_0xE4EDC4B0E92C078B(iLocal_326))
		{
			unk_0x142CC44DB769B57E(&iLocal_326);
		}
		iLocal_535 = 1;
	}
	if (unk_0xC844350D5D58C99A(iLocal_327[0]) || unk_0xC844350D5D58C99A(iLocal_327[1]))
	{
		if (!unk_0x8E28E832BEAC3DCE(vLocal_308 + Vector(20f, 0f, 0f), 30f) && !unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_308, 80f, 80f, 80f, false, true, 0))
		{
			func_180();
		}
	}
...
void func_14()
{
	...
	if (iLocal_222 == 0)
	{
		if (unk_0x49DBEF6684F02E67(&vVar1, Local_229[0]))
		{
			fVar4 = 0f;
			fVar7 = 999999f;
			iVar0 = 0;
			while (iVar0 < Local_229)
			{
				if (iVar0 > 0)
				{
					fVar4 = (fVar4 + unk_0x0EB28750412C3A5A(Local_229[(iVar0 - 1)], Local_229[iVar0], true));
				}
				if (Local_229[iVar0].f_4)
				{
					if (unk_0x49DBEF6684F02E67(&vVar1, Local_229[iVar0]))
					{
						fVar6 = unk_0x0EB28750412C3A5A(Local_229[iVar0], vVar1, true);
						if (fVar6 < fVar7)
						{
							fVar7 = fVar6;
							fVar8 = fVar4;
	...
	if (iLocal_222 == 1)
	{
		...
		fVar9 = (to_float((unk_0x1C0640BA9A7327B3() - iLocal_224)) / fLocal_300);
		...
		{
			if ((unk_0x1C0640BA9A7327B3() - Local_66[iVar0].f_4) > 1000)
			{
				unk_0xBB6D217402E588F9(Local_66[iVar0].f_1, 0,4f, 1f);
			}
			if ((unk_0x1C0640BA9A7327B3() - Local_66[iVar0].f_4) > 6000)
			{
				unk_0x060876FE4313F6DC(Local_66[iVar0]);
			}
			iVar0++;
		}
	}
...
void func_16(vector3 vParam0, int iParam3)
{
	...
	unk_0x060876FE4313F6DC(Local_66[iLocal_226]);
	if (Local_66[iLocal_226].f_4 != 0)
	{
		unk_0xBB6D217402E588F9(Local_66[iLocal_226].f_1, 0,4f, 1f);
	}
	Local_66[iLocal_226].f_4 = unk_0x1C0640BA9A7327B3();
	Local_66[iLocal_226].f_1 = { vParam0 };
	Local_66[iLocal_226] = unk_0xDF107B1FEA1F95CB(vParam0, iLocal_55, iParam3);
	iLocal_226++;
	if (iLocal_226 >= 31)
	{
		iLocal_226 = 0;
			...
			if (unk_0x06F8112AA79C53D9(0, 24) && unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
			{
				...
				if (unk_0x1C0640BA9A7327B3() > iLocal_56)
				{
					if (!bLocal_46)
					{
						...
						while (iVar0 < Local_229)
						{
							if (unk_0xE4EDC4B0E92C078B(Local_229[iVar0].f_3))
							{
								fVar2 = unk_0x0EB28750412C3A5A(vLocal_59, unk_0xAC14F6E4B17D7835(Local_229[iVar0].f_3), true);
								fVar3 = unk_0x0EB28750412C3A5A(Local_229[iVar0], unk_0xAC14F6E4B17D7835(Local_229[iVar0].f_3), true);
								if (fVar3 == 0f || fVar2 < fVar3)
								{
									if (fVar2 < 2f)
									{
										Local_229[iVar0] = { vLocal_59 };
									}
								}
								if (fVar2 < fVar4)
								{
							...
							if (iLocal_52 != -1)
							{
								...
								if (unk_0x51D1D19912234EA0((iLocal_53 - iVar5)) < 3 && unk_0x51D1D19912234EA0((iLocal_53 - iVar5)) > 0)
								{
									if (iLocal_53 < iVar5)
									{
										...
										while (iVar6 <= (iVar5 - 1))
										{
											if (unk_0xE4EDC4B0E92C078B(Local_229[iVar6].f_3))
											{
												if (unk_0x4FA921CB56EDB0F8(Local_229[iVar6].f_3) > 0)
												{
													unk_0x7F010F50CE03A8AF(Local_229[iVar6].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (unk_0xE4EDC4B0E92C078B(Local_229[iVar5].f_3))
									{
										if (unk_0x4FA921CB56EDB0F8(Local_229[iVar5].f_3) > 0)
										{
											unk_0x7F010F50CE03A8AF(Local_229[iVar5].f_3, 0);
	...
	switch (iLocal_302)
	{
		case 0:
			...
			if ((unk_0xAE317D00A5A55DF6("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0xB4AE0788C1587752("re@construction")) && func_104(&Local_537))
			{
				...
				{
					iLocal_317 = unk_0x852A19533F896693(iLocal_319, 26, 349680864, -1, 1, true);
					...
					iLocal_340 = unk_0x7707E48765093646(94130617, -455,6561f, -985,8071f, 22,4868f, 1, true, false);
					unk_0x71199B01895C6202(94130617);
					unk_0x9F528B1B53FBC5D9(iLocal_340, iLocal_317, unk_0x4A089F2B762B8D33(iLocal_317, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0xAFF39FB306F8E232(iLocal_317, 17, true);
					unk_0xCDFD15389C4C424B(iLocal_317, 1);
					unk_0x11AD11297DC58CC7(iLocal_317, true);
					unk_0x25C5402CC10F76CD(iLocal_317, false);
					func_103(&uLocal_358, 3, iLocal_317, "RECONACWorker", 0, 1);
					unk_0x4F39CC3882DD074E(iLocal_317, "S_M_Y_GENERICWORKER_01_WHITE_01");
					iLocal_318 = unk_0x36F2404464202779(26, 349680864, -462,2982f, -978,3272f, 65f, 221,4041f, 1, true);
					unk_0x11AD11297DC58CC7(iLocal_318, true);
					unk_0xE8832A9E16A57A1F(iLocal_318, true, 1);
					unk_0x1E9649458B15960F(iLocal_318, true);
					unk_0xC53F47E66DDFA561(iLocal_317, -1143637011);
					...
					iLocal_339 = unk_0x7707E48765093646(-415509317, vLocal_526.x, (vLocal_526.y + 0,5f), (vLocal_526.z - 0,25f), 1, true, false);
					unk_0xD8F6A53F4799FAFE(iLocal_339, 75f);
					unk_0xAA6B3A4292417750(iLocal_339, false, true, true, false, false, false, 0, false);
					iLocal_533 = unk_0xC1879030EB463216("scr_sparking_generator", iLocal_339, 0f, 0f, 0,2f, 0f, 0f, 0f, 1f, 0, 0, 0);
					unk_0x1E9649458B15960F(iLocal_339, true);
			...
			if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
			{
				if (!iLocal_342)
				{
					if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
					{
						...
						if (unk_0xB87D13D0C064E9D1(iLocal_317, unk_0x16F2683693E537C9(), 1) || unk_0xB87D13D0C064E9D1(iLocal_319, unk_0x16F2683693E537C9(), 1))
						{
							...
							unk_0xDD353D0E9C789D0E(&iLocal_357);
							unk_0x75CDA8644CD3B5F5(0, 0, 0);
							unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 150f, -1, 0, 0);
							unk_0x75ABDC5F81978924(iLocal_357);
							unk_0x78ADC381772E3D54(iLocal_317, iLocal_357);
							unk_0xF82EA857DA10E0CD(&iLocal_357);
							func_95();
						}
						unk_0x523BCC9DC80CD82F(525797972);
						if ((((unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), -473,1686f, -984,6405f, 22,487f, 40f, 40f, 5f, false, true, 0) && !unk_0x398B22FA3FCBDFA9(unk_0x16F2683693E537C9())) && !unk_0x5EDB8AD1D9CB1AC8(unk_0x16F2683693E537C9())) && func_94(1, 0, 1)) && unk_0xB87F6CF6E5628C67(525797972))
						{
							if (!func_134())
							{
				...
				else
				{
					if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
					{
						...
						{
							if (!unk_0x437347B10A200C4B(iLocal_319, 0) && !unk_0xE4EDC4B0E92C078B(iLocal_324))
							{
								iLocal_324 = func_96(iLocal_319, 0, 0);
							}
						}
						else if (!unk_0xE4EDC4B0E92C078B(iLocal_323))
						{
							if (unk_0xE4EDC4B0E92C078B(iLocal_324))
							{
								unk_0x142CC44DB769B57E(&iLocal_324);
					...
					if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
					{
						if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_317, vLocal_311, 0, 1, 0))
						{
							if (!bLocal_343)
							{
								func_48();
				...
				if (unk_0xDF1306B443CD3D15(iLocal_320, 0))
				{
					if (iLocal_353 >= 3)
					{
						if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0) && unk_0xF94CCE643440E68B(unk_0x16F2683693E537C9(), 1886712733))
						{
							if (unk_0xE4EDC4B0E92C078B(iLocal_325))
							{
								unk_0x142CC44DB769B57E(&iLocal_325);
								if (!unk_0xEB6A8945D1AC98A1(iLocal_317) && !unk_0x437347B10A200C4B(iLocal_319, 0))
								{
									if (unk_0x405E212DDE472467(iLocal_317, 0) && !unk_0xE4EDC4B0E92C078B(iLocal_324))
									{
										iLocal_324 = func_96(iLocal_319, 0, 0);
									}
								}
				...
				if (!unk_0x437347B10A200C4B(iLocal_319, 0))
				{
					if (unk_0x4E861BC5B1EDA7BD(iLocal_319))
					{
						...
						if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
						{
							...
							{
								unk_0x11AD11297DC58CC7(iLocal_317, true);
								unk_0x4E885A246A9D983A(iLocal_317, 116, false);
								unk_0x4E885A246A9D983A(iLocal_317, 29, false);
								if (!bLocal_345)
								{
									func_46();
									wait(0);
				...
				if ((unk_0x1C0640BA9A7327B3() - iLocal_351) > 5000 && !func_23())
				{
					...
					if (unk_0x405E212DDE472467(iLocal_317, 0))
					{
						if (unk_0xDF1306B443CD3D15(iLocal_320, 0))
						{
							...
							else if (!unk_0xE4EDC4B0E92C078B(iLocal_325))
							{
								iLocal_325 = func_96(iLocal_320, 0, 0);
								if (unk_0xE4EDC4B0E92C078B(iLocal_324))
								{
...
void func_49()
{
	...
	{
		case 0:
			unk_0x76710B4A168654A3(vLocal_526 + Vector(0f, 1f, 0f), 1f, 1f, 1f);
			wait(0);
			unk_0x55D86AAC00607BDD(1f);
			unk_0xC940C10E2534CB72(vLocal_523, 1f);
			wait(0);
			unk_0xC940C10E2534CB72(vLocal_523 - Vector(0f, 4f, 0f), 1f);
			wait(0);
			unk_0xC940C10E2534CB72(vLocal_523 - Vector(0f, 8f, 0f), 1f);
			wait(0);
			unk_0xC940C10E2534CB72(vLocal_526, 1f);
		...
		case 2:
			...
			{
				if (unk_0x83A8177D302E1A7E(iLocal_533))
				{
					unk_0xF7E25143642732EA(iLocal_533, 0);
				}
				func_50();
				if (!bLocal_345)
				{
					if (!unk_0xEB6A8945D1AC98A1(iLocal_317) && !unk_0x437347B10A200C4B(iLocal_319, 0))
					{
						if (!unk_0x3CAA763EEC01ADF7(iLocal_317, iLocal_319, -1, 0, false) && !unk_0x3CAA763EEC01ADF7(iLocal_317, iLocal_319, 0, 0, false))
						{
							func_46();
							wait(0);
							func_24(&uLocal_358, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
	...
	switch (iLocal_348)
	{
		case 0:
			if (iLocal_353 >= 2)
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_317) && !unk_0x437347B10A200C4B(iLocal_319, 0))
				{
					...
					if (unk_0x3CAA763EEC01ADF7(iLocal_317, iLocal_319, -1, 0, false) || unk_0x3CAA763EEC01ADF7(iLocal_317, iLocal_319, 0, 0, false))
					{
						if (unk_0x3CAA763EEC01ADF7(iLocal_317, iLocal_319, -1, 0, false))
						{
							bLocal_344 = true;
							vLocal_314 = { unk_0x68F4C0EC296D3901(iLocal_319, false) + Vector(0f, -1f, -3f) };
						}
						else
						{
							vLocal_314 = { unk_0x68F4C0EC296D3901(iLocal_319, false) + Vector(0f, 1,5f, -3f) };
						}
						if (unk_0x5A91F08DF773C39D(unk_0x728870EB733D12A1(), vLocal_314, 4,2f, 4f, 5f, false, true, 0))
						{
							if (!bLocal_343)
							{
								func_46();
		...
		case 1:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317) && !unk_0x437347B10A200C4B(iLocal_319, 0))
			{
				...
				{
					unk_0xAA6B3A4292417750(iLocal_320, false, true, true, false, false, false, 0, false);
				}
				unk_0xAA6B3A4292417750(iLocal_317, false, true, false, false, false, false, 0, false);
				unk_0x1E9649458B15960F(iLocal_319, false);
				unk_0xDD353D0E9C789D0E(&iLocal_357);
				if (bLocal_344)
				{
				...
				unk_0x78ADC381772E3D54(iLocal_317, iLocal_357);
				unk_0xF82EA857DA10E0CD(&iLocal_357);
				unk_0xFADC0A217229F6B5(iLocal_317, true);
				iLocal_351 = unk_0x1C0640BA9A7327B3();
				iLocal_348++;
			}
			break;
		...
		case 3:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
			{
				if (unk_0x5A91F08DF773C39D(iLocal_317, -464,7217f, -989,7214f, 22,4867f, 3f, 10f, 3f, false, true, 0) || (unk_0x1C0640BA9A7327B3() - iLocal_351) > 10000)
				{
		...
		case 4:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
			{
				if (unk_0x5A91F08DF773C39D(iLocal_317, -472,7056f, -991,105f, 22,4867f, 3f, 30f, 3f, false, true, 0) || (unk_0x1C0640BA9A7327B3() - iLocal_351) > 10000)
				{
					if (!unk_0x437347B10A200C4B(iLocal_319, 0))
					{
						unk_0x1E9649458B15960F(iLocal_319, false);
		...
		case 5:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_351) > 3000)
			{
				...
				if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
				{
					...
					if (!unk_0x437347B10A200C4B(iLocal_320, 0))
					{
						unk_0xAA6B3A4292417750(iLocal_320, false, false, false, false, false, false, 0, false);
					}
					unk_0xAA6B3A4292417750(iLocal_317, false, false, false, false, false, false, 0, false);
					unk_0x46CB381A452EF99D(iLocal_317, 1);
					unk_0x25C5402CC10F76CD(iLocal_317, true);
					unk_0xCDFD15389C4C424B(iLocal_317, 0);
					unk_0x11AD11297DC58CC7(iLocal_317, false);
					unk_0xC53F47E66DDFA561(iLocal_317, -455129387);
					unk_0xA3BF0AA5A2608191(unk_0x16F2683693E537C9());
					unk_0xDD353D0E9C789D0E(&iLocal_357);
					unk_0xC6EB89C59F2AF6B8(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0, 0, 0, 0);
					unk_0x25644C31B4B6E9F3(iLocal_357, 1);
					unk_0x75ABDC5F81978924(iLocal_357);
					unk_0x78ADC381772E3D54(iLocal_317, iLocal_357);
					unk_0xF82EA857DA10E0CD(&iLocal_357);
				}
		...
		case 6:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
			{
				if ((unk_0x1C0640BA9A7327B3() - iLocal_351) > 6400)
				{
					...
					{
						if (unk_0x5A91F08DF773C39D(iLocal_322, -477,2774f, -990,0638f, 23,5497f, 3f, 3f, 3f, false, true, 0))
						{
							vVar0 = { -477,7884f, -996,3974f, 23,5503f };
						}
					}
					...
					{
						if (unk_0x5A91F08DF773C39D(iLocal_320, -477,2774f, -990,0638f, 23,5497f, 3f, 3f, 3f, false, true, 0))
						{
							vVar0 = { -477,7884f, -996,3974f, 23,5503f };
						}
					}
...
void func_97()
{
	...
	switch (iLocal_303)
	{
		case 0:
			...
			unk_0x745CE398A4B0A3C6(vLocal_308, 50f, 0);
			unk_0x28F5E4DA506AC0CA(vLocal_308, 30f, 0, 0, 0, 0, false, 0);
			unk_0x679C321F8CAA2CFA(vLocal_308, 100f, 0);
			if (!unk_0x437347B10A200C4B(unk_0x728870EB733D12A1(), 0))
			{
				if (unk_0x5A91F08DF773C39D(unk_0x728870EB733D12A1(), vLocal_308, 8f, 8f, 8f, false, true, 0))
				{
					iLocal_321 = unk_0x728870EB733D12A1();
					unk_0x73270B3C9CC833FD(iLocal_321, true, 0);
			...
			iLocal_530 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -462,711f, -992,5728f, 23,8729f, -0,1371f, -0,0346f, -29,6605f, 28f, 1, 2);
			iLocal_531 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -462,711f, -992,5728f, 23,8729f, 69,4831f, -0,0346f, -40,8884f, 28f, 1, 2);
			unk_0x91F5B0244AAE6222(iLocal_530, "HAND_SHAKE", 0,3f);
			unk_0x91F5B0244AAE6222(iLocal_531, "HAND_SHAKE", 0,3f);
			func_99();
			unk_0xE3BB8E05FCEB3FBE(iLocal_530, true);
			unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
			wait(500);
			unk_0xF1E4C781086FABC1(iLocal_531, iLocal_530, 3500, 1, 1);
		...
		case 1:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_354) > 3500)
			{
				...
				unk_0x4D7F4CC43D4D0DE3(iLocal_350, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				unk_0x272295383B6513AB(iLocal_327[0], 1);
				func_98(iLocal_530);
				func_98(iLocal_531);
				iLocal_530 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -455,4617f, -990,631f, 61,6885f, -89,0761f, -0,0146f, -49,881f, 80,5355f, 1, 2);
				iLocal_531 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -455,4543f, -990,6208f, 61,012f, -89,0759f, -0,0146f, -47,8226f, 80,5355f, 1, 2);
				unk_0x91F5B0244AAE6222(iLocal_530, "HAND_SHAKE", 0,3f);
				unk_0x91F5B0244AAE6222(iLocal_531, "HAND_SHAKE", 0,3f);
				unk_0xF1E4C781086FABC1(iLocal_531, iLocal_530, 4000, 1, 0);
				if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
				{
					unk_0xA3BF0AA5A2608191(iLocal_317);
				...
				{
					unk_0x15AFB6CBDE990FB6(iLocal_340, 1, true);
					unk_0xF690C84DADBB3551(&iLocal_340);
				}
				iLocal_354 = unk_0x1C0640BA9A7327B3();
				iLocal_303 = 2;
		...
		case 3:
			...
			{
				if (unk_0xC844350D5D58C99A(iLocal_327[0]))
				{
					unk_0x1E9649458B15960F(iLocal_327[0], false);
					unk_0xDFC6BA855748EB10(iLocal_327[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, 1, 1, 1, 0, 1);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 11, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 18, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 19, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 23, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 9, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 12, 0);
					unk_0xCAE0593CC7FB3D42(iLocal_327[0], 17, 0);
					unk_0xE81656B429E5C4B5("scr_reconstruct_pipefall_debris", iLocal_327[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
				}
				iLocal_354 = unk_0x1C0640BA9A7327B3();
				iLocal_303 = 4;
			}
		...
		case 4:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_354) > 2000)
			{
				func_98(iLocal_530);
				func_98(iLocal_531);
				iLocal_530 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -470,5648f, -976,951f, 24,2657f, 25,437f, -0,0087f, -118,3831f, 34f, 1, 2);
				iLocal_531 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -470,5648f, -976,951f, 24,2657f, 2,0695f, -0,0087f, -120,2811f, 34f, 1, 2);
				unk_0x91F5B0244AAE6222(iLocal_530, "HAND_SHAKE", 0,3f);
				unk_0x91F5B0244AAE6222(iLocal_531, "HAND_SHAKE", 0,3f);
				unk_0xF1E4C781086FABC1(iLocal_531, iLocal_530, 1000, 3, 3);
		...
		case 5:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_354) > 500)
			{
				if (!unk_0x437347B10A200C4B(iLocal_319, 0))
				{
					...
					unk_0xC6EB89C59F2AF6B8(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0, 0, 0, 0);
					...
					if (unk_0x9F4FE516EAACCFC5(iLocal_530) && unk_0x9F4FE516EAACCFC5(iLocal_531))
					{
						unk_0x91F5B0244AAE6222(iLocal_530, "HAND_SHAKE", 1,5f);
						unk_0x91F5B0244AAE6222(iLocal_531, "HAND_SHAKE", 1,5f);
					}
					iLocal_354 = unk_0x1C0640BA9A7327B3();
					iLocal_303 = 6;
				}
		...
		case 6:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_354) > 500)
			{
				func_98(iLocal_530);
				func_98(iLocal_531);
				iLocal_530 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -459,2609f, -987,5602f, 24,2611f, 0,583f, 0,2617f, -32,7532f, 49,9914f, 1, 2);
				iLocal_531 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -459,0622f, -987,2584f, 24,2661f, 5,0301f, 0,2617f, -36,7308f, 49,9914f, 1, 2);
				unk_0x91F5B0244AAE6222(iLocal_530, "HAND_SHAKE", 0,5f);
				unk_0x91F5B0244AAE6222(iLocal_531, "HAND_SHAKE", 0,5f);
				unk_0xF1E4C781086FABC1(iLocal_531, iLocal_530, 2500, 3, 3);
				if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
				{
					unk_0xDBE4EC9C88839074(iLocal_317, unk_0x68F4C0EC296D3901(iLocal_317, true) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_354 = unk_0x1C0640BA9A7327B3();
				iLocal_303 = 7;
			}
		...
		case 7:
			...
			if ((unk_0x1C0640BA9A7327B3() - iLocal_354) > 2500)
			{
				if (unk_0xDF1306B443CD3D15(iLocal_319, 0))
				{
					unk_0x1E9649458B15960F(iLocal_319, true);
				}
				iLocal_303 = 8;
			}
			break;
		...
		case 8:
			...
			if (unk_0xC844350D5D58C99A(iLocal_327[0]))
			{
				unk_0xF690C84DADBB3551(&(iLocal_327[0]));
			}
			if (unk_0xDF1306B443CD3D15(iLocal_319, 0))
			{
				unk_0x5DAB50E08C3C504A(iLocal_319, 250f);
				unk_0xA47B46945FF6DE74(iLocal_319, vLocal_308, 1, false, 0, 1);
				unk_0xD8F6A53F4799FAFE(iLocal_319, 80f);
				unk_0x75CFD6AD66ADFDD1(vLocal_308, 50f, 0);
			}
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
			{
				unk_0xA3BF0AA5A2608191(iLocal_317);
				unk_0xBC43ED9FE28DB191(iLocal_317);
				unk_0xC6EB89C59F2AF6B8(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			unk_0xE3BB8E05FCEB3FBE(iLocal_530, false);
			unk_0xB3A1B75CB59FEB56(false, false, 3000, 1, 0, 0);
			unk_0x9A8DDC7C522F5BF5(iLocal_530, 0);
			unk_0x9A8DDC7C522F5BF5(iLocal_531, 0);
			unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), true, 0);
			unk_0x2FB9A57162E54BAB(0f);
			unk_0xBFE31971E49FA500(true);
			unk_0x8BCB70EB440DED83(true);
			...
			iLocal_327[1] = unk_0xB0BE3DFBBB59A620(525797972, -457,8815f, -988,9059f, 22,9554f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[1], -0,1939f, 105,0058f, 77,3964f, 2, 1);
			iLocal_327[2] = unk_0xB0BE3DFBBB59A620(525797972, -451,5131f, -986,8079f, 24,6947f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[2], 24,3941f, 32,5423f, 80,6862f, 2, 1);
			iLocal_327[3] = unk_0xB0BE3DFBBB59A620(525797972, -450,8099f, -985,9972f, 24,7104f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[3], 24,1841f, 110,287f, 78,4357f, 2, 1);
			iLocal_327[4] = unk_0xB0BE3DFBBB59A620(525797972, -456,6558f, -987,3979f, 22,9537f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[4], -0,0264f, 29,5754f, 79,1811f, 2, 1);
			iLocal_327[5] = unk_0xB0BE3DFBBB59A620(525797972, -456,1279f, -988,4162f, 22,9889f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[5], -0,6337f, 108,4339f, 77,9539f, 2, 1);
			iLocal_327[6] = unk_0xB0BE3DFBBB59A620(525797972, -457,0807f, -987,3059f, 23,7564f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[6], 0,0929f, 74,2657f, 79,3839f, 2, 1);
			iLocal_327[7] = unk_0xB0BE3DFBBB59A620(525797972, -456,6558f, -983,7804f, 22,9712f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[7], -0,0264f, 29,5754f, 80,9061f, 2, 1);
			iLocal_327[8] = unk_0xB0BE3DFBBB59A620(525797972, -455,3279f, -983,1712f, 22,9564f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[8], -0,1087f, 109,7339f, 80,9789f, 2, 1);
			iLocal_327[9] = unk_0xB0BE3DFBBB59A620(525797972, -456,1632f, -983,9359f, 23,7964f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[9], -0,3321f, 74,1907f, 81,6089f, 2, 1);
			iLocal_327[10] = unk_0xB0BE3DFBBB59A620(525797972, -454,644f, -994,1709f, 23,3329f, 1, true, false);
			unk_0xC023D1C4BF532815(iLocal_327[10], 5,7811f, 104,6058f, 104,6964f, 2, 1);
			iLocal_347 = 0;
			while (iLocal_347 < 11)
			{
				if (unk_0xC844350D5D58C99A(iLocal_327[iLocal_347]))
				{
					unk_0xEF190091B5B9F5EB(iLocal_327[iLocal_347], 1);
					unk_0x1E9649458B15960F(iLocal_327[iLocal_347], true);
				}
				iLocal_347++;
			}
			if (bLocal_536)
...
void func_115()
{
	...
	{
		unk_0xAB8E2DDC7AF955E0(887537515, true);
		unk_0x51B096AAC60548C1(0,1f);
		unk_0x15EA7F4313456B1D(3, false);
		unk_0x7D6CA5F52B3748BF(vLocal_305 + Vector(50f, 50f, 50f), vLocal_305 - Vector(50f, 50f, 50f), 0, 1, 1, 1);
		vLocal_308 = { -455,6561f, -985,8071f, 22,4868f };
		iLocal_319 = unk_0x122AAB0B1D6F55AD(887537515, vLocal_308, 80f, true, true, false);
		unk_0x56FDC9ADE35F7DB0(iLocal_319, false, true, 0);
		unk_0x71EDC33E5A423750(iLocal_319, 3);
		unk_0xD3421E391490133B(iLocal_319, 1, true);
		unk_0xD3421E391490133B(iLocal_319, 2, true);
		unk_0xD3421E391490133B(iLocal_319, 3, false);
		unk_0xD3421E391490133B(iLocal_319, 4, true);
		unk_0xD3421E391490133B(iLocal_319, 5, true);
		unk_0xD3421E391490133B(iLocal_319, 6, false);
		unk_0xD3421E391490133B(iLocal_319, 7, true);
		unk_0x1E9649458B15960F(iLocal_319, true);
		unk_0xAA6B3A4292417750(iLocal_319, false, false, false, true, false, false, 0, false);
		unk_0x25BD67336EA4AECE(iLocal_319, 10000);
		unk_0xF8CF67C6E39C23A9(iLocal_319, 5f);
		iLocal_320 = unk_0x122AAB0B1D6F55AD(1886712733, -472,9444f, -966,671f, 22,5534f, 181,8365f, true, true, false);
		unk_0x536F1BE96C726C4B(vLocal_308, 10f, 1, 0, 0, false);
		iLocal_327[0] = unk_0xB0BE3DFBBB59A620(1668676931, -453,2f, -986,1f, 59,45f, 1, true, false);
		unk_0xD8F6A53F4799FAFE(iLocal_327[0], 90f);
		unk_0x1E9649458B15960F(iLocal_327[0], true);
		unk_0xAA6B3A4292417750(iLocal_327[0], true, true, true, true, false, false, 0, false);
		unk_0x25BD67336EA4AECE(iLocal_327[0], 10000000);
		Local_229[0] = { vLocal_526 };
		Local_229[1] = { vLocal_526 + Vector(0f, 0,5f, 0f) };
		Local_229[2] = { vLocal_526 + Vector(0f, 1f, 0f) };
		Local_229[3] = { vLocal_526 + Vector(0f, 2,5f, 0f) };
		Local_229[4] = { vLocal_526 + Vector(0f, 3f, 0f) };
		Local_229[5] = { vLocal_526 + Vector(0f, 3,5f, 0f) };
		Local_229[6] = { vLocal_526 + Vector(0f, 4f, 0f) };
		Local_229[7] = { vLocal_526 + Vector(0f, 4,5f, 0f) };
		Local_229[8] = { vLocal_526 + Vector(0f, 5f, 0f) };
		Local_229[9] = { vLocal_526 + Vector(0f, 5,5f, 0f) };
		Local_229[10] = { vLocal_526 + Vector(0f, 6f, 0f) };
		Local_229[11] = { vLocal_526 + Vector(0f, 6,5f, 0f) };
		Local_229[12] = { vLocal_526 + Vector(0f, 7f, 0f) };
		Local_229[13] = { vLocal_523 };
		iVar0 = 0;
		while (iVar0 < Local_229)
		{
			Local_229[iVar0].f_4 = 1;
...
void func_180()
{
	if (iLocal_534)
	{
		if (!iLocal_535)
		{
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_317))
			{
				unk_0x4E885A246A9D983A(iLocal_317, 317, true);
			}
