	...
	while (true)
	{
		...
		if (iLocal_365 == 1)
		{
			...
			else
			{
				...
				unk_0x5F3CBA6EB9341C90(Local_294, unk_0x835730A2D89F6093(unk_0x16F2683693E537C9(), 2) + Local_294.f_14, 2);
			}
		}
		wait(0);
	}
...
void func_15(bool bParam0)
{
	if (func_30(unk_0x16F2683693E537C9()))
	{
		...
		if (bLocal_292)
		{
			...
			func_18(&Local_294, vVar0, unk_0x835730A2D89F6093(unk_0x16F2683693E537C9(), 2), 50f, Local_294.f_20, Local_294.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
			unk_0x9730E2596B7BB6FF(Local_294, unk_0x16F2683693E537C9(), 31086, 0f, -0,25f, 0f, 1);
		}
		else
		{
...
{
	vVar0.x = (sin(fParam0) * vLocal_281.x);
	vVar0.y = (cos(fParam0) * vLocal_281.y);
...
void func_24()
{
	...
	{
		unk_0xA47B46945FF6DE74(iLocal_161, vLocal_278, 1, 0, 0, 1);
	...
	if (unk_0x562F77A7F33D2E46("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		...
		unk_0x58350770D73D313A("FAIRGROUND_RIDES_FERRIS_WHALE", "HEIGHT", (vVar1.z - fLocal_284));
	}
	iVar0 = 0;
	while (iVar0 < 16)
	{
...
void func_31()
{
	...
	unk_0x679C321F8CAA2CFA(vLocal_278, 60f, 0);
	unk_0x7800CEC090C01D4D(vLocal_278, 60f);
	if (!unk_0x9F4FE516EAACCFC5(iLocal_293))
	{
		iLocal_293 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", -1659,446f, -1120,833f, 12,9255f, -3,6667f, 0f, 56,0716f, 50,1098f, 1, 2);
		unk_0x86F44313DFA8F00C(iLocal_293, -1659,446f, -1120,833f, 12,9255f, -3,6667f, 0f, 56,0716f, 50,1098f, 0, 1, 1, 2);
		unk_0xE3BB8E05FCEB3FBE(iLocal_293, true);
		unk_0x86F44313DFA8F00C(iLocal_293, -1659,11f, -1120,752f, 12,9489f, -5,5053f, 0f, 56,0716f, 50,1098f, 7000, 1, 1, 2);
		unk_0xB3A1B75CB59FEB56(true, 0, 3000, 1, 0, 0);
		iLocal_291 = unk_0x1C0640BA9A7327B3() + 6000;
	}
	if (func_30(unk_0x728870EB733D12A1()))
	{
		if (func_67(unk_0x728870EB733D12A1(), -2140431165))
		{
			func_52(-1663,74f, -1111,472f, 11,59135f, -1663,512f, -1139,948f, 24,01722f, 16,5f, -1673,816f, -1133,745f, 12,0226f, 92,5556f, 1, 1, 1, 0, 0);
		}
		else if (func_67(unk_0x728870EB733D12A1(), -1189015600))
		{
	...
	unk_0xCEAA091B490F8407(iLocal_290, "SLOW_SQUEAK", Local_162[1].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_288 = unk_0xD68EA767274B7444();
	unk_0xCEAA091B490F8407(iLocal_288, "CARRIAGE", Local_162[1].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
}
...
{
	func_43(64, 1, 0, 1, 0);
	iLocal_161 = unk_0x7707E48765093646(iLocal_158, 0f, 1f, 2f, 1, true, false);
	unk_0xA47B46945FF6DE74(iLocal_161, vLocal_278, 1, 0, 0, 1);
...
void func_34(var uParam0, int iParam1, bool bParam2)
{
	func_38(uParam0);
	uParam0->f_2 = iParam1;
	uParam0->f_3 = unk_0x7707E48765093646(iLocal_159, 0f, 1f, 2f, 1, true, false);
	func_25(uParam0);
	if (bParam2 == 1)
	{
...
int func_63(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		if (((((((((((((((func_64(vVar18[0], vVar18[1], vVar6, vVar9) || func_64(vVar18[0], vVar18[1], vVar9, vVar15)) || func_64(vVar18[0], vVar18[1], vVar12, vVar15)) || func_64(vVar18[0], vVar18[1], vVar6, vVar12)) || func_64(vVar18[1], vVar18[3], vVar6, vVar9)) || func_64(vVar18[1], vVar18[3], vVar9, vVar15)) || func_64(vVar18[1], vVar18[3], vVar12, vVar15)) || func_64(vVar18[1], vVar18[3], vVar6, vVar12)) || func_64(vVar18[3], vVar18[2], vVar6, vVar9)) || func_64(vVar18[3], vVar18[2], vVar9, vVar15)) || func_64(vVar18[3], vVar18[2], vVar12, vVar15)) || func_64(vVar18[3], vVar18[2], vVar6, vVar12)) || func_64(vVar18[2], vVar18[0], vVar6, vVar9)) || func_64(vVar18[2], vVar18[0], vVar9, vVar15)) || func_64(vVar18[2], vVar18[0], vVar12, vVar15)) || func_64(vVar18[2], vVar18[0], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_81(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_81(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_81(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_113(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_81(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_81(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_81(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_72(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_186(iParam0, Global_111638.f_2358.f_539[iVar0].f_64, Global_111638.f_2358.f_539[iVar0].f_63))
		{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_186(iParam0, Global_111638.f_2358.f_539[iVar0].f_61, Global_111638.f_2358.f_539[iVar0].f_60) || iParam3 == 1)
		{
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_125(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0x1A5A491D253EA7BA(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_125(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0x1A5A491D253EA7BA(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_186(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == unk_0x36C584991B4C183F(iParam0, func_81(iParam1)) && Global_76434[1].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_81(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_224(int iParam0)
{
	...
	else if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_20559.f_471, iParam0) || unk_0xEAE0D21A50E6C7F4(Global_2097152[func_226()].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x0674E58A79778E99(&(Global_111638.f_20559.f_471), iParam0);
		unk_0x0674E58A79778E99(&(Global_2097152[func_226()].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_228(int iParam0)
{
	...
	return unk_0xEAE0D21A50E6C7F4(Global_2097152[func_226()].f_6174.f_10, iParam0);
}
