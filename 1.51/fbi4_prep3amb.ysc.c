...
int func_188(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_93883[iVar0].f_7 != 263)
		{
			...
			{
				fVar1 = unk_0x0EB28750412C3A5A(vParam0, Global_93883[iVar0].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_205()
{
	if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 855,7258f, -2344,491f, 29,33145f) <= 52900f)
	{
		if (func_13())
		{
			func_69(28);
	...
	else if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 1383,21f, -2068,02f, 51,87057f) <= 160000f)
	{
		if (func_13())
		{
			func_69(29);
