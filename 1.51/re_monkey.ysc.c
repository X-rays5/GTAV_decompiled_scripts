...
void func_40(int iParam0)
{
	...
	while (iVar15 < Global_111638.f_7683.f_198)
	{
		...
		{
			func_41(Global_111638.f_7683.f_137[iVar15].f_6);
			iVar16 = iVar15;
...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_64[iVar1] = unk_0x7707E48765093646(1032540746, -335,66f, -95,24f, 46,16f, 1, true, false);
				unk_0x08841CDB215AE18F(iLocal_64[iVar1], -335,66f, -95,24f, 46,16f, 0, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_64[iVar1], -2,32f, 0,66f, -0,8f, 2, 1);
				break;
			
			case 2:
				iLocal_64[iVar1] = unk_0x7707E48765093646(976586037, -336,04f, -94,9f, 46,02f, 1, true, false);
				unk_0x08841CDB215AE18F(iLocal_64[iVar1], -336,04f, -94,9f, 46,02f, 0, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_64[iVar1], 0,01f, 3,85f, 2,72f, 2, 1);
				break;
			
			case 3:
				iLocal_64[iVar1] = unk_0x7707E48765093646(-1788911489, -336,34f, -95,66f, 46,02f, 1, true, false);
				unk_0x08841CDB215AE18F(iLocal_64[iVar1], -336,34f, -95,66f, 46,02f, 0, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_64[iVar1], -2,86f, 0,76f, 28,89f, 2, 1);
				break;
		}
		iVar0++;
	}
		...
		switch (iLocal_49)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (unk_0xC51336386034AC83(30f, 31086, 0,8f, 0,7f, 0,25f, 1090519040, 1051361018, 31086, 24818) == iLocal_50)
						{
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_50 = unk_0x36F2404464202779(26, 1813637474, vLocal_51, fLocal_54, 1, true);
			unk_0x71199B01895C6202(1813637474);
			iLocal_64[0] = unk_0x7707E48765093646(1749718958, vLocal_69, 1, true, false);
			unk_0x9F528B1B53FBC5D9(iLocal_64[0], iLocal_50, unk_0x4A089F2B762B8D33(iLocal_50, 28422), 0f, -0,01f, -0,02f, vLocal_78, 1, 1, 0, 0, 2, 1);
			unk_0xFADC0A217229F6B5(iLocal_50, true);
			unk_0x4E885A246A9D983A(iLocal_50, 42, true);
			iLocal_57 = func_68(iLocal_50, 0, 145);
			func_58(1);
			unk_0x6DF7BF67E86AAE86(iLocal_50, 1862763509);
...
void func_72()
{
	if (func_50(iLocal_50))
	{
		...
		vVar2 = { unk_0x68F4C0EC296D3901(iLocal_50, false) };
		fVar8 = 7,5f;
		...
		if (iLocal_55 < 3)
		{
			if (unk_0xD3DCEC81D13AAFB1(vVar2, fVar8, 0) || unk_0x723EE7F83DF1497D(vVar2 - vVar9, vVar2 + vVar9, 0))
			{
				iLocal_55 = 3;
			}
		}
		switch (iLocal_55)
		{
			...
			case 1:
				...
				if (func_82(unk_0x16F2683693E537C9(), iLocal_50, 35f))
				{
					...
					unk_0x78ADC381772E3D54(iLocal_50, iLocal_82);
			...
			case 4:
				...
				unk_0xBAFED2F6486F771A(iLocal_50, 32, true);
				unk_0xDD353D0E9C789D0E(&iLocal_82);
			...
			case 5:
				...
				if (!unk_0x0A059E0DB9253280(iLocal_50) && vdist2(vVar2, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false)) > 2500f)
				{
					iLocal_81 = unk_0xCD02F8660C47B801(vVar5, vVar2, 1, 0, 7);
					iLocal_55++;
				}
				break;
			...
			case 6:
				...
				iVar23 = unk_0x1EC301670B54C6DE(iLocal_81, &iVar15, &uVar16, &uVar19, &uVar22);
				if (iVar23 == 2)
				{
					if (iVar15 == 1)
					{
...
int func_73()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			else if (unk_0xB4ECF989E2C1DAC8(iLocal_50, sLocal_74, sLocal_76, 3))
			{
				...
				if (fLocal_58 != 0,2f)
				{
					...
					vLocal_61 = { unk_0x68F4C0EC296D3901(iLocal_50, false) - Vector(1f, 0f, 0f) };
					iLocal_60 = 1;
				}
				else
				{
		...
		case 1:
			...
			func_76(&iLocal_57);
			func_75();
			if (unk_0xC844350D5D58C99A(iLocal_64[0]))
			{
				unk_0x15AFB6CBDE990FB6(iLocal_64[0], 1, true);
			}
			iLocal_60++;
			break;
		...
		case 2:
			if (unk_0xB4ECF989E2C1DAC8(iLocal_50, sLocal_74, sLocal_76, 3))
			{
				...
				unk_0xA47B46945FF6DE74(iLocal_50, vVar11, 0, true, 0, 1);
				if (fVar9 == 0,161f)
				{
					unk_0x1E9649458B15960F(iLocal_50, false);
					return 1;
...
void func_79()
{
	if (iLocal_72 == 0)
	{
		iLocal_72 = unk_0xC1879030EB463216(sLocal_73, iLocal_64[0], vLocal_78, vLocal_78, 1f, 0, 0, 0);
