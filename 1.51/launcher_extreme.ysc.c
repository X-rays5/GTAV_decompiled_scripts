void __EntryFunction__()
{
	...
	iLocal_93 = 882848737;
	iLocal_94 = -1;
	iLocal_96 = unk_0xD68EA767274B7444();
	...
	if (Var0 == 17)
	{
		iLocal_97 = unk_0x7D6CA5F52B3748BF(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0xCD7D80FD792F9954("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		iLocal_97 = unk_0x7D6CA5F52B3748BF(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		{
			func_196(&Var0);
			if (unk_0x8AA6DC470ABA63A2(iLocal_96))
			{
				func_191(&Var0, vVar61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !unk_0x7DECE00E09F41C95(Var0.f_28[0])) && unk_0x8AA6DC470ABA63A2(iLocal_96)) && unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_A", false, -1)) && unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_B", false, -1)) && unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_C", false, -1))
			{
				unk_0xCEAA091B490F8407(iLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
			}
			if ((iLocal_95 == 0 && func_189(unk_0x16F2683693E537C9())) && unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, false, false, 0))
			{
				vVar69 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true) };
				if (vVar69.z < 100f)
				{
					iLocal_95 = 1;
		...
		if (func_173(&Var0, 0) || func_171(&Var0))
		{
			...
			{
				unk_0x55D0A2DB35045A35(iLocal_96);
			}
			if (func_1(&Var0))
			{
				func_272(&Var0, 0);
...
{
	if ((((func_189(unk_0x16F2683693E537C9()) && func_189(iParam0->f_28[0])) && !func_190()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_195(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_220(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_225(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 52, -63,8f, -809,5f, 321,8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					unk_0x262EF6C6306BEA6C(uParam0->f_28[0], -72657034, 1, false, false);
...
void func_256(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_257(iParam0);
...
void func_272(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 17)
	{
		unk_0x2952D66A502EA873(iLocal_97, 0);
