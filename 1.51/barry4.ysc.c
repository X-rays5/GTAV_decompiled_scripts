...
void func_248(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	iVar0 = 1;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_324(vParam1, iParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_315(iParam12, 0);
			while (!func_249(iParam0, iParam12, vParam1, iParam4, 1, 0))
			{
				wait(0);
			}
		}
...
int func_249(int iParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, int iParam7)
{
	if (func_152(iParam1))
	{
		Var5.f_11 = 12;
...
int func_255(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	{
		if ((func_256(iParam0) && unk_0x134B62B726CEC8E6(iParam0) != 873639469) && unk_0x134B62B726CEC8E6(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_327(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_329(iParam0, uVar1[iVar6], 1) && func_328(unk_0x68F4C0EC296D3901(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_323(vParam1, 0f, 0f, 0f, 0)) || unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(uVar1[iVar6], true), true) < 10f)
					{
