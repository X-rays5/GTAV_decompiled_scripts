void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_310(&(Global_110725[Var0].f_9));
			}
		}
		func_293(&Var0, 1);
	}
	...
	while (true)
	{
		...
		if (func_205(Var0.f_28[0]))
		{
			...
			{
				func_188(&uLocal_105, unk_0x68F4C0EC296D3901(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_187(Var0))
...
int func_203(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	if ((((func_205(unk_0x16F2683693E537C9()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_201(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_214(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 10)
	{
		if (unk_0x681F21BF9F7B449B(-1, iParam0->f_17[0], 8f))
		{
...
bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_229(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_37[iVar4].f_3) < iParam4);
}

int func_229(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_205(iParam4))
	{
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_234(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_252()
{
	...
	if (func_205(unk_0x16F2683693E537C9()))
	{
		if (func_253(unk_0x16F2683693E537C9(), vVar0, fVar3))
		{
			func_150();
		}
	}
...
int func_262(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -480,9929f, -1712,65f, 17,4524f };
			uParam0->f_17[1] = { -443,6129f, -1705,886f, 27,62214f };
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
			iVar18 = 0;
		...
		case 2:
			...
			{
				func_264(&(uParam0->f_35[0]), iVar0[0], vVar4, iVar16);
				if (unk_0xC844350D5D58C99A(uParam0->f_35[0]))
				{
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[0]))
			{
				...
				{
					unk_0x9F528B1B53FBC5D9(uParam0->f_41[0], uParam0->f_35[0], 0, vVar10, vVar13, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar19 = false;
			...
			{
				func_264(&(uParam0->f_35[1]), iVar0[2], vVar7, iVar17);
...
void func_264(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_265(iParam0);
...
int func_267(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 1198,367f, -1326,095f, 33,9683f };
			uParam0->f_17[1] = { 1202,237f, -1235,374f, 43,97641f };
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
			iVar16 = 0;
		...
		case 2:
			bVar17 = true;
			func_264(&(uParam0->f_35[0]), iVar0[0], vVar5, iVar14);
			if (unk_0xC844350D5D58C99A(uParam0->f_35[0]))
			{
				unk_0xC6A6B4DDD6DC073A(uParam0->f_35[0], 1);
				unk_0xAACF4BD59CB35944(uParam0->f_35[0], 0);
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[0]))
			{
				...
				if (unk_0xC844350D5D58C99A(uParam0->f_41[0]) && unk_0xC844350D5D58C99A(uParam0->f_35[0]))
				{
					unk_0x9F528B1B53FBC5D9(uParam0->f_41[0], uParam0->f_35[0], 0, vVar8, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar17 = false;
...
int func_271(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
int func_291(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
