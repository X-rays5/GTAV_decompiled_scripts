void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_259(&(Global_110725[Var0].f_9));
			}
		}
		func_246(&Var0, 1);
	}
	...
	func_231(&Var0);
	iLocal_92 = unk_0x7D6CA5F52B3748BF(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		...
		if (func_169(&Var0, 0))
		{
			if (Var0 == 35)
			{
				if (iLocal_93 == 0)
				{
					...
					{
						unk_0x8010B3127F058F0F(1736361794, 132154435, 1972,77f, 3815,37f, 33,66f, 1, 1, 0);
					}
					if (unk_0x76395FF5E8D5E643(1736361794))
					{
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_208(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_37[iVar4].f_3) < iParam4);
}

int func_208(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_127(iParam4))
	{
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_213(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	iParam0->f_16 = 5;
	iParam0->f_17[0] = { 1973,324f, 3815,594f, 31,42936f };
	iParam0->f_17[1] = { 1974,936f, 3812,747f, 34,438f };
	iParam0->f_24 = 6,5f;
	iParam0->f_27 = 0;
...
int func_244(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
