...
int func_17(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_18(iParam1)];
...
void func_49(int iParam0)
{
	...
	if (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_4 <= 0)
	{
...
int func_249()
{
	if (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_4 > 0 || func_250(5))
	{
		return 1;
	}
	return 0;
...
{
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SHOW_OVERLAY");
...
void func_254(int iParam0)
{
	...
	{
		iLocal_129 = iParam0;
		unk_0x7E60C62A7CE58FC8(iLocal_309, "SHOW_SCREEN");
...
int func_255()
{
	if (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_4 == 1 && !func_250(5))
	{
		return 1;
	}
	return 0;
	...
	switch (func_458())
	{
		...
		case 15:
			...
			else
			{
				...
				func_299();
				unk_0x7E60C62A7CE58FC8(iLocal_309, "ACTIVATE_FAST_TRACK");
				unk_0x7E60D21B163E9D56();
...
void func_258(bool bParam0)
{
	...
	switch (iVar1)
	{
		...
		case 23:
			unk_0x5D96D8530B3D0904(&(Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_263), 10);
			break;
		
		default:
			unk_0x5D96D8530B3D0904(&(Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_263), 11);
			break;
	}
	if (func_38())
	{
...
int func_260()
{
	...
	if (func_25() < 7)
	{
		...
		if (fVar56 > unk_0x79833B02DBD2A244(0f, 1f))
		{
			iVar55 = 1;
		}
	}
	...
	fVar54 = unk_0x79833B02DBD2A244(0f, fVar53);
	iVar57 = 0;
	while (iVar57 < 51)
	{
...
void func_271(int iParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			func_273(iParam0, (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[iParam0].f_2 - (func_275(iVar2, bParam2) / 2)));
		}
...
void func_285(int iParam0, int iParam1)
{
	...
	if (func_53())
	{
		...
		Global_4263954[iVar5] = iVar4;
		Global_4263954[iVar5].f_1 = 5;
		Global_4263954[iVar5].f_9 = iVar2;
	}
	else
	{
...
void func_299()
{
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_BUTTON_STATES");
...
int func_302()
{
	...
	if (func_53())
	{
		if (iVar1 > 0)
		{
			...
			if (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_2 < 0)
			{
				func_273(5, 0);
			}
		}
	...
	{
		iVar3 = Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_256 + 1;
		func_273(5, (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_2 - iVar1));
		if (Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_2 < 0)
		{
			func_273(5, 0);
		}
		func_284(5442, iVar3, -1, 1, 0);
		func_284(func_324(5), Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[5].f_2, -1, 1, 0);
		func_303(unk_0xD803B885F5E47A62(), iLocal_128, 0, 1);
		func_271(5, 0, 1);
		func_319(&Global_2513483);
...
int func_320(int iParam0, int iParam1, bool bParam2)
{
	...
	fVar5 = to_float(func_275(iParam1, bParam2));
...
int func_333(int iParam0)
{
	...
	iVar21 = unk_0x12AB0310C2281427(&sVar2);
	if (func_53())
	{
		bVar0 = false;
	...
	if (bVar0)
	{
		if (iVar18 > 0)
		{
			vVar22.x = unk_0x12AB0310C2281427(func_298(iLocal_128));
			vVar22.y = 5;
			vVar22.z = iParam0;
			unk_0x5C7093CF7F23CC47(iVar18, &vVar22, 0, 1);
		}
		if (func_53())
		{
			func_289(func_316());
...
{
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_RESEARCH");
	unk_0x3CAEA85DA607305E(iParam0);
...
void func_345()
{
	...
	iVar3 = func_13(unk_0xD803B885F5E47A62(), iLocal_128);
	iVar4 = func_35(unk_0xD803B885F5E47A62(), iLocal_128);
	iVar5 = Global_1370164[5];
	iVar6 = func_371(iLocal_128);
	sVar7 = func_298(iLocal_128);
	StringCopy(&cVar8, "UA_BUNKER_TXD_", 24);
	iVar14 = func_34(unk_0xD803B885F5E47A62(), iLocal_128);
	...
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_STATS");
	...
	unk_0x3CAEA85DA607305E((iVar17 + iVar19));
...
char* func_347(int iParam0)
{
	if (iParam0 == unk_0xD803B885F5E47A62())
	{
		sVar0 = func_355(&(Global_1628237[iParam0].f_11.f_104));
		return sVar0;
	}
	...
	if (iVar1 != func_5())
	{
		sVar0 = func_355(&(Global_1628237[iVar1].f_11.f_104));
...
{
	iVar0 = func_241(iParam0);
	iVar1 = Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[iVar0].f_11;
	if (((iVar0 > -1 && func_33(iParam0) == 5) && func_7(unk_0xD803B885F5E47A62(), iParam0)) && iVar1 != iParam1)
	{
		...
		Global_1590535[unk_0xD803B885F5E47A62()].f_274.f_183[iVar0].f_11 = iParam1;
...
void func_424(int iParam0)
{
	...
	unk_0x7E60C62A7CE58FC8(iLocal_309, "ADD_RESEARCH_UNLOCKABLE");
...
void func_427()
{
	...
	iVar4 = round(fVar2);
	iVar5 = round(fVar3);
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_SELL_PRICES");
	unk_0x3CAEA85DA607305E(iVar5);
	unk_0x3CAEA85DA607305E(iVar4);
	unk_0x7E60D21B163E9D56();
}
...
int func_428(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_6(iParam1))
	{
		switch (iVar1)
		{
			...
			case 5:
				iVar0 = Global_262145.f_21060; // Bunker profit
				if (func_55(iParam0, iParam1, 0))
				{
...
void func_429()
{
	...
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_UPGRADES");
	unk_0x3CAEA85DA607305E(iVar0);
...
void func_430()
{
	...
	unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_RESUPPLIES");
	unk_0x3CAEA85DA607305E(iVar0);
	unk_0x3CAEA85DA607305E(2);
	unk_0x3CAEA85DA607305E(2);
	unk_0x3CAEA85DA607305E(iVar1);
...
void func_459()
{
	unk_0x7E60C62A7CE58FC8(iLocal_309, "HIDE_OVERLAY");
	unk_0x7E60D21B163E9D56();
	func_252(0);
...
void func_463()
{
	if (unk_0xEAE0D21A50E6C7F4(iLocal_116, 11))
	{
		...
		{
			unk_0x7E60C62A7CE58FC8(iLocal_309, "APP_IS_DEACTIVATED");
...
void func_464()
{
	if (func_465())
	{
		if (!unk_0xEAE0D21A50E6C7F4(iLocal_116, 0))
		{
			unk_0x7E60C62A7CE58FC8(iLocal_309, "GET_CURRENT_SELECTION");
			uLocal_310 = unk_0x7A8BB56B212464AC();
			unk_0x7E60C62A7CE58FC8(iLocal_309, "GET_CURRENT_SCREEN_ID");
...
void func_469()
{
	...
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 206, 1);
	if (unk_0xBFC0798A6E3417F9(2, 206))
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x9E6C8D8976DA0ECD(2))
	{
		...
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0xBFC0798A6E3417F9(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xB9132A06AE472728(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xB9132A06AE472728(2, 188))
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0xBFC0798A6E3417F9(2, 188))
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_471(2, 187, 1);
		if (unk_0xBFC0798A6E3417F9(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_471(2, 189, 1);
	if (unk_0xBFC0798A6E3417F9(2, 189))
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 190, 1);
	if (unk_0xBFC0798A6E3417F9(2, 190))
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 201, 1);
	if (unk_0xBFC0798A6E3417F9(2, 201))
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 202, 1);
	...
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_471(2, 204, 1);
	if (unk_0xBFC0798A6E3417F9(2, 204))
	{
		unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x9E6C8D8976DA0ECD(2))
	{
		unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			unk_0x7E60C62A7CE58FC8(iLocal_309, "SET_ANALOG_STICK_INPUT");
			iLocal_313 = iVar0;
			iLocal_314 = iVar1;
...
void func_470()
{
	...
	unk_0x1FF2BF40EEFA5ABC(iLocal_309, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_473()
{
	...
	unk_0xD9ACBBA59FD5A09E(1);
	unk_0x6567AE843FADBA94(iLocal_309, 255, 255, 255, 255, 0);
	func_484();
	func_477(0);
	func_474(1);
...
void func_528()
{
	...
	while (!unk_0x83D8570832F172A7(iLocal_309))
	{
		wait(0);
	}
	func_478(1);
...
{
	unk_0xE17FDF9E3068281B(&iLocal_309);
	func_535(iParam0);
	func_537(0);
	func_545();
