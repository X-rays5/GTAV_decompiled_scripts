...
int func_9(int iParam0, bool bParam1, int iParam2)
{
	...
	if (iVar0 != func_6() && Global_1628237[iVar0].f_11.f_450 == iParam2)
	{
		return 1;
	}
	return 0;
...
int func_10(int iParam0, int iParam1)
{
	if (iParam0 != func_6())
	{
		if (Global_1628237[iParam0].f_11 != func_6())
		{
...
void func_13(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		...
		else if (unk_0xE4EDC4B0E92C078B(Global_2416079[iVar0]))
		{
			...
			unk_0xF412DD40DE84CE72(Global_2416079[iVar0], true);
	...
	if (!bParam1)
	{
		...
		{
			func_14(iParam0);
			unk_0xF412DD40DE84CE72(Global_2416079[iVar0], false);
		}
	}
}
...
int func_16(int iParam0)
{
	if (iParam0 != func_6())
	{
		if (func_5(iParam0, 1, 1))
		{
			...
			{
				return func_17(Global_2425662[iParam0].f_310.f_5) == 16;
			}
		}
	}
	return 0;
...
bool func_41(int iParam0, bool bParam1)
{
	...
	return Global_1628237[iParam0].f_11 != func_6();
}
