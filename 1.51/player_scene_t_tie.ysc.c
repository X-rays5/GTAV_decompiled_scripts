...
int func_2()
{
	...
	fVar0 = vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_20()
{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = unk_0x36F2404464202779(26, iLocal_77[iVar0], vLocal_82 + vLocal_86[iVar0], 0f, 1, true);
			unk_0xC023D1C4BF532815(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0], 2, 1);
			...
			unk_0x25C5402CC10F76CD(iLocal_72[iVar0], false);
			unk_0x3E8E48829F3C7624(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0]), vLocal_82 + vLocal_86[iVar0], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0], 1000f, -8f, -1, iLocal_158, 0f, 2, 0);
			unk_0xF895E10BF4C72645(iLocal_72[iVar0], 0, 0);
			unk_0xFADC0A217229F6B5(iLocal_72[iVar0], true);
			unk_0x9DD8618CA5BF832D(iLocal_72[iVar0], 55, true);
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = unk_0x1776B2F0999C29AC(iLocal_166[iVar0], vLocal_82 + vLocal_173[iVar0], vVar3, vVar6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			wait(0);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			StringCopy(&(Local_125[0]), "Dead_A", 32);
			StringCopy(&(Local_125[1]), "Dead_D", 32);
			StringCopy(&(Local_125[2]), "Dead_E", 32);
			StringCopy(&(Local_125[3]), "Dead_G", 32);
			vLocal_86[0] = { 14,613f, 8,4563f, 0,9751f };
			vLocal_86[1] = { 10,6489f, 8,6708f, 0,7701f };
			vLocal_86[2] = { 6,3982f, 1,4604f, 1,1f };
			vLocal_86[3] = { 4,2327f, 5,864f, (0,9f - 0,15f) };
			vLocal_99[0] = { 0f, 0f, 23,047f };
			vLocal_99[1] = { 0f, 0f, 97,2582f };
			vLocal_99[2] = { 0f, 0f, 34,2158f };
			vLocal_99[3] = { 0f, 0f, 61,2158f };
			iLocal_77[0] = 1330042375;
			iLocal_77[1] = 1330042375;
			iLocal_77[2] = 1032073858;
			iLocal_77[3] = 850468060;
			iLocal_158 = 2621440;
			iLocal_112[0] = 1;
			iLocal_112[1] = 1;
			iLocal_112[2] = 1;
			...
			iLocal_166[2] = 1110;
			iLocal_166[3] = 1110;
			vLocal_173[0] = { Vector(0,37364f, -1445,534f, 2803,76f) - vLocal_82 + Vector(0,1f, 0f, 0f) };
			vLocal_173[1] = { Vector(0,28778f, -1444,863f, 2800,022f) - vLocal_82 + Vector(0,1f, 0f, 0f) };
			vLocal_173[2] = { Vector(0,6045f, -1452,404f, 2795,934f) - vLocal_82 + Vector(0,1f, 0f, 0f) };
			vLocal_173[3] = { Vector(0,28483f, -1448,033f, 2794,301f) - vLocal_82 + Vector(0,1f, 0f, 0f) };
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			vLocal_173[4] = { vLocal_173[0] + vLocal_173[2] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x79833B02DBD2A244(0,5f, 0,5f), unk_0x79833B02DBD2A244(0,5f, 0,5f)) };
			vLocal_173[5] = { vLocal_173[1] + vLocal_173[2] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x79833B02DBD2A244(0,5f, 0,5f), unk_0x79833B02DBD2A244(0,5f, 0,5f)) };
			break;
		
		default:
			StringCopy(&cLocal_117, "", 32);
			StringCopy(&(Local_125[0]), "", 32);
			StringCopy(&(Local_125[1]), "", 32);
			StringCopy(&(Local_125[2]), "", 32);
			StringCopy(&(Local_125[3]), "", 32);
			iLocal_77[0] = 0;
			vLocal_86[0] = { 0f, 0f, 0f };
			vLocal_99[0] = { 0f, 0f, 0f };
			iLocal_77[1] = 0;
			vLocal_86[1] = { 0f, 0f, 0f };
			vLocal_99[1] = { 0f, 0f, 0f };
			iLocal_77[2] = 0;
			vLocal_86[2] = { 0f, 0f, 0f };
			vLocal_99[2] = { 0f, 0f, 0f };
			iLocal_77[3] = 0;
			vLocal_86[3] = { 0f, 0f, 0f };
			vLocal_99[3] = { 0f, 0f, 0f };
			iLocal_158 = 0;
			iLocal_112[0] = -1;
			iLocal_112[1] = -1;
			iLocal_112[2] = -1;
