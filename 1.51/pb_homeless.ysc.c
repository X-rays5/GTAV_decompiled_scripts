...
int func_3(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6)
{
	...
	{
		if ((((unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(iParam0, vParam1), vVar1, false, true, 0) && unk_0xBFDF2644D7CBD7C5(unk_0x16F2683693E537C9(), unk_0x68F4C0EC296D3901(iParam0, true), fParam4)) && func_5(bParam6)) && !unk_0x869EFD0BC0868856(iParam0)) && !unk_0xA48EBBEA418ADC94(iParam0))
		{
			func_4(iParam0, 1);
			return 1;
		}
...
void func_7()
{
	...
	{
		unk_0x523BCC9DC80CD82F(390939205);
		unk_0x523BCC9DC80CD82F(-48477765);
		unk_0x3F423BF5B8125A50("amb@drug_dealer");
		while ((!unk_0xB87F6CF6E5628C67(390939205) || !unk_0xB87F6CF6E5628C67(-48477765)) || !unk_0xB4AE0788C1587752("amb@drug_dealer"))
		{
			wait(0);
		}
		unk_0xF63400DBE3303D26("homeless", &iLocal_53);
		vLocal_50.z = (vLocal_47.z - 1f);
		iLocal_54 = unk_0x36F2404464202779(19, 390939205, vLocal_47.x, vLocal_47.y, vLocal_50.z, 0f, 1, true);
		unk_0x6DF7BF67E86AAE86(iLocal_54, iLocal_53);
		if (iLocal_44 == 1)
		{
			vLocal_50 = { unk_0x68E4ADDDDCD7BDDE(iLocal_54, 0,8f, 0,8f, -1f) };
			iLocal_55 = unk_0x36F2404464202779(5, -48477765, vLocal_50, 0f, 1, true);
			unk_0xF63400DBE3303D26("homeless", &iLocal_53);
			unk_0x6DF7BF67E86AAE86(iLocal_55, iLocal_53);
			if (!unk_0x437347B10A200C4B(iLocal_54, 0))
			{
				unk_0xDD353D0E9C789D0E(&uLocal_57);
				unk_0x796BDF31572BB055(0, vLocal_50, 0);
