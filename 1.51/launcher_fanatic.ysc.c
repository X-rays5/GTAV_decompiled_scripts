...
{
	if ((((func_198(unk_0x16F2683693E537C9()) && func_198(iParam0->f_28[0])) && !func_145()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_194(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(unk_0x16F2683693E537C9()) && func_198(iParam0->f_28[0])) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam8) && func_194(unk_0x16F2683693E537C9(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
...
bool func_221(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_222(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_37[iVar4].f_3) < iParam4);
}

int func_222(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_198(iParam4))
	{
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_227(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_272(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
