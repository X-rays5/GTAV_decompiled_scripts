...
void func_44(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, var uParam23, bool bParam24, int iParam25, int iParam26, int iParam27, int iParam28, int iParam29, int iParam30, bool bParam31, int iParam32, int iParam33, var uParam34, int iParam35, int iParam36)
{
	...
	if (func_107())
	{
		...
		iVar342 = 1;
		iVar343 = 1;
		func_80(&iParam18, &Var9, &cVar149, &cVar239, &iVar329, &iParam13, &uVar144, &Var18, &vVar155, &cVar245, &iVar330, iParam11, iParam25);
		func_80(&iParam19, &Var36, &cVar167, &cVar257, &iVar332, &iParam14, &uVar145, &Var45, &vVar173, &cVar263, &iVar333, iParam11, iParam26);
		func_80(&iParam20, &Var63, &cVar185, &cVar275, &iVar335, &iParam15, &uVar146, &Var72, &vVar191, &cVar281, &iVar336, iParam11, iParam27);
		func_80(&iParam21, &Var90, &cVar203, &cVar293, &iVar338, &iParam16, &uVar147, &Var99, &vVar209, &cVar299, &iVar339, iParam11, iParam28);
		func_80(&iParam22, &Var117, &cVar221, &cVar311, &iVar341, &iParam17, &uVar148, &Var126, &vVar227, &cVar317, &iVar342, iParam11, iParam29);
		unk_0x0D3BE1DE0262A012("TimerBars", false);
		if (func_78(&cVar149, &vVar155, &cVar167, &vVar173, &cVar185, &vVar191, &cVar203, &vVar209, &cVar221, &vVar227) && unk_0x27117E2CDD4D67C3("TimerBars"))
		{
			iVar344 = func_77();
			...
			if (uParam34 && unk_0x95662AB5B1A3C2F9())
			{
				if (bVar345)
				{
					...
					{
						func_63(iParam18, &Var9, &Var18, &cVar149, &cVar239, iVar329, &vVar155, &cVar245, iVar330);
					}
					if (iParam33 == iParam14 && iParam36 == 4)
					{
						func_63(iParam19, &Var36, &Var45, &cVar167, &cVar257, iVar332, &vVar173, &cVar263, iVar333);
					}
					if (iParam33 == iParam15 && iParam36 == 3)
					{
						func_63(iParam20, &Var63, &Var72, &cVar185, &cVar275, iVar335, &vVar191, &cVar281, iVar336);
					}
					if (iParam33 == iParam16 && iParam36 == 2)
					{
						func_63(iParam21, &Var90, &Var99, &cVar203, &cVar293, iVar338, &vVar209, &cVar299, iVar339);
					}
					if (iParam33 == iParam17 && iParam36 == 1)
					{
						func_63(iParam22, &Var117, &Var126, &cVar221, &cVar311, iVar341, &vVar227, &cVar317, iVar342);
					}
				}
				if (iParam33 == iParam13 && iParam36 != 5)
				{
...
void func_109(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, int iParam19)
{
	...
	if (func_107())
	{
		...
		if (unk_0x27117E2CDD4D67C3("TimerBars"))
		{
			...
			iVar189 = 1;
			iVar190 = 1;
			func_80(&iParam11, &Var11, &cVar87, &cVar135, &iVar183, &uParam7, &uVar83, &Var20, &vVar93, &cVar141, &iVar184, uParam5, 0);
			func_80(&iParam12, &Var29, &cVar99, &cVar147, &iVar185, &uParam8, &uVar84, &Var38, &vVar105, &cVar153, &iVar186, uParam5, 0);
			func_80(&iParam13, &Var47, &cVar111, &cVar159, &iVar187, &uParam9, &uVar85, &Var56, &vVar117, &cVar165, &iVar188, uParam5, 0);
			func_80(&iParam14, &Var65, &cVar123, &cVar171, &iVar189, &uParam10, &uVar86, &Var74, &vVar129, &cVar177, &iVar190, uParam5, 0);
			if (bParam15)
			{
				if (bVar9)
				{
					func_110(iParam11, &Var11, &Var20, &cVar87, &cVar135, iVar183, &vVar93, &cVar141, iVar184);
				}
			}
			else
			{
			...
			if (bParam16)
			{
				if (bVar9)
				{
					func_110(iParam12, &Var29, &Var38, &cVar99, &cVar147, iVar185, &vVar105, &cVar153, iVar186);
				}
			}
			else
			{
			...
			if (bParam17)
			{
				if (bVar9)
				{
					func_110(iParam13, &Var47, &Var56, &cVar111, &cVar159, iVar187, &vVar117, &cVar165, iVar188);
				}
			}
			else
			{
			...
			if (bParam18)
			{
				if (bVar9)
				{
					func_110(iParam14, &Var65, &Var74, &cVar123, &cVar171, iVar189, &vVar129, &cVar177, iVar190);
				}
			}
			else
			{
		...
		if (unk_0x27117E2CDD4D67C3("TimerBars"))
		{
			...
			if (bVar36)
			{
				if (iParam21 != 0)
				{
					...
					{
						unk_0x0D3BE1DE0262A012(sVar85, false);
					...
					if (iParam21 == 18)
					{
						...
						{
							unk_0x0D3BE1DE0262A012(sVar82, false);
...
void func_176(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, int iParam5, var uParam6, var uParam7, int iParam8, int iParam9, bool bParam10, int iParam11, float fParam12, float fParam13, int iParam14, int iParam15, bool bParam16, int iParam17, float fParam18, bool bParam19, int iParam20, int iParam21)
{
	...
	if (unk_0x27117E2CDD4D67C3("TimerBars"))
	{
		...
		*uParam2[3] = { *uParam2[0] };
		...
		{
			fVar19 = ((fParam12 / to_float(iParam1)) * 100f);
		}
		else if (fParam12 == -1f && fParam13 != -1f)
		{
			fVar19 = ((to_float(iParam0) / fParam13) * 100f);
		}
		unk_0xD9ACBBA59FD5A09E(iParam5);
		uParam2[3]->f_7 = 51;
		func_69("TimerBars", "DamageBarFill_128", uParam2[3], 0, 0, iParam5, 0);
		...
		{
			func_88(uParam2[1], 6);
			func_117(*uParam2[0], to_float(iParam8), uParam2[1], 1, 1, uParam4);
			unk_0xD9ACBBA59FD5A09E(iParam5);
			func_69("TimerBars", "DamageBarFill_128", uParam2[1], 0, 0, iParam5, 0);
			unk_0xD9ACBBA59FD5A09E(iParam5);
		}
...
void func_178(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, int iParam5, int iParam6, var uParam7, var uParam8, float fParam9, float fParam10, int iParam11, int iParam12, bool bParam13, int iParam14, float fParam15, bool bParam16, int iParam17, int iParam18)
{
	...
	if (unk_0x27117E2CDD4D67C3("TimerBars"))
	{
		...
		*uParam2[3] = { *uParam2[0] };
		...
		{
			fVar19 = ((fParam9 / to_float(iParam1)) * 100f);
		}
		else if (fParam9 == -1f && fParam10 != -1f)
		{
			fVar19 = ((to_float(iParam0) / fParam10) * 100f);
		}
		unk_0xD9ACBBA59FD5A09E(iParam5);
		uParam2[3]->f_7 = 51;
		func_69("TimerBars", "DamageBarFill_128", uParam2[3], 0, 0, iParam5, 0);
...
int func_234()
{
	...
	if (func_221() == 0)
	{
		...
		{
			if (((unk_0xB7DDF77EF860941D() == 0 && Global_1574401 == 0) && !unk_0xEAE0D21A50E6C7F4(Global_2439138.f_1894.f_756, 11)) && Global_1590535[unk_0xD803B885F5E47A62()] != 0)
			{
				return 0;
			}
		}
