void __EntryFunction__()
{
	...
	if (unk_0xC844350D5D58C99A(iScriptParam_0))
	{
		...
		vLocal_2 = { unk_0x68E4ADDDDCD7BDDE(iScriptParam_0, 0f, 0f, 0f) };
		fLocal_5 = unk_0xD9522BA9E27E1349(iScriptParam_0);
		unk_0x20641932E5104B25(iScriptParam_0, false, 0);
	}
	while (true)
	{
		wait(0);
			...
			if (unk_0x63D2C15453688621(iScriptParam_0))
			{
				switch (iLocal_0)
				{
					...
					case 2:
						...
						if (func_2())
						{
							unk_0x20641932E5104B25(iScriptParam_0, true, 0);
							iLocal_0 = 3;
						}
						break;
...
void func_3()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_1))
	{
		...
		{
			unk_0xC6EB89C59F2AF6B8(iLocal_1, sLocal_8, sLocal_6, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		else if (unk_0xFCCE56DAE67AA889(iLocal_1, sLocal_8, sLocal_6, 3))
		{
			unk_0xC6EB89C59F2AF6B8(iLocal_1, sLocal_8, sLocal_6, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		else if (!iLocal_9)
		{
			if (unk_0xB4ECF989E2C1DAC8(iLocal_1, sLocal_8, sLocal_6, 3))
			{
				unk_0x4E6D1F54D3FBC5B1(iLocal_1, sLocal_8, sLocal_6, unk_0x79833B02DBD2A244(0, 1065353216));
				iLocal_9 = 1;
			}
		}
	}
...
void func_4()
{
	if (unk_0x437347B10A200C4B(iLocal_1, 0))
	{
		iLocal_1 = unk_0x36F2404464202779(5, iLocal_7, vLocal_2.x, vLocal_2.y, vLocal_2.z, fLocal_5, 1, true);
