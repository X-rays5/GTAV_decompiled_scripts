void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_110725[Var0].f_9 != -1)
			{
				...
				func_271(&(Global_110725[Var0].f_9));
			}
		}
		func_259(&Var0, 1);
	}
	...
	iLocal_94 = unk_0x7D6CA5F52B3748BF(-103,0011f, -1281,636f, 26,3686f, -23,246f, -1241,361f, 30,335f, 0, 1, 1, 1);
...
int func_113(var uParam0)
{
	if (func_143(&(uParam0->f_1)))
	{
		...
		func_114(*uParam0);
		iVar0 = start_new_script_with_args(&(uParam0->f_1), uParam0, 61, 35000);
...
{
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - uParam0->f_60) > iParam8) && func_187(unk_0x16F2683693E537C9(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_199(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_213(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_214(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_219(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_237(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -72,13491f, -1256,712f, 27,68361f };
			uParam0->f_17[1] = { -72,18015f, -1267,587f, 29,24852f };
			uParam0->f_24 = 25f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
			uParam0->f_26 = 0;
		...
		case 3:
			...
			{
				iVar9 = unk_0xF653B9B22DA806A9(uParam0->f_35[0], "chassis_dummy");
				vVar10 = { unk_0xBF584557291FDD31(uParam0->f_35[0], iVar9) };
				iVar6 = unk_0xE9744DB7B8CA6965(vVar10, unk_0x835730A2D89F6093(uParam0->f_35[0], 2), 2);
				unk_0xC90224D9E95E5E3A(iVar6, true);
				unk_0xEFC3DF9D33E248D8(iVar6, false);
				unk_0x915804B434753CBD(uParam0->f_28[0], iVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_239(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	func_240(iParam0);
...
int func_257(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
...
void func_259(int iParam0, bool bParam1)
{
	...
	unk_0x2952D66A502EA873(iLocal_94, 0);
	if (bParam1)
	{
		func_195(*iParam0);
	}
