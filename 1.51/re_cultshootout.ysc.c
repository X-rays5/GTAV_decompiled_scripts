void __EntryFunction__()
{
	...
	{
		wait(0);
		if ((unk_0x338D6FF72D84D90F() || iLocal_100) || (func_111() && unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_48, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_111())
			{
				if (func_110())
...
void func_1()
{
	...
	if (vdist(func_2(unk_0xD803B885F5E47A62()), vLocal_48) > 150f)
	{
		func_142();
	}
}
...
void func_24()
{
	...
	{
		case 0:
			if (unk_0x762119754C50557A(iLocal_113))
			{
				if (unk_0xE4EDC4B0E92C078B(iLocal_114))
				{
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0))
					{
						func_67();
						if (!bLocal_101)
						{
		...
		case 1:
			...
			else if (!unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_48, 100f, 100f, 100f, false, true, 0))
			{
				func_25();
			}
			break;
...
void func_70()
{
	if (unk_0xEB751B41BC4080D4(iLocal_113))
	{
		if (unk_0xE4EDC4B0E92C078B(iLocal_114))
		{
			unk_0x142CC44DB769B57E(&iLocal_114);
			...
			switch (iLocal_127)
			{
				case 0:
					if (!iLocal_90[iLocal_125])
					{
						...
						{
							if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), 2205,918f, 5633,455f, 55,7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_56())
								{
								...
								while (iVar0 < iLocal_103)
								{
									...
									unk_0xDD353D0E9C789D0E(&iLocal_124);
									...
									unk_0x75ABDC5F81978924(iLocal_124);
									unk_0x78ADC381772E3D54(iLocal_103[iVar0], iLocal_124);
									unk_0xF82EA857DA10E0CD(&iLocal_124);
									unk_0xD5EF6A937E06E46F(iLocal_103[iVar0], true, -1, 0);
									iVar0++;
								}
				...
				case 1:
					...
					while (iVar1 < iLocal_103)
					{
						if (!iLocal_90[iVar1])
						{
							...
							unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), -1, 0);
							unk_0x75ABDC5F81978924(iLocal_124);
							unk_0x78ADC381772E3D54(iLocal_103[iVar1], iLocal_124);
							unk_0xF82EA857DA10E0CD(&iLocal_124);
							unk_0xD5EF6A937E06E46F(iLocal_103[iVar1], true, -1, 0);
							iLocal_90[iVar1] = 1;
						}
						iVar1++;
					}
					if (!unk_0xEB6A8945D1AC98A1(iLocal_103[iLocal_125]))
					{
						if (!unk_0x7069CC4DE1EA3FAA(iLocal_103[iLocal_125], unk_0x16F2683693E537C9(), 50f))
						{
							...
							unk_0xFADC0A217229F6B5(iLocal_103[iLocal_125], true);
						}
					}
					...
					if (iLocal_90[iLocal_125])
					{
						...
						{
							if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || unk_0x12DE711B1C681E9E(iLocal_103[iLocal_125], unk_0x16F2683693E537C9(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_93();
								wait(0);
								if (func_92())
							...
							else
							{
								if (!unk_0x4734A6196B611C3B(iLocal_103[iLocal_125], 0))
								{
									...
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[0]))
									{
										...
										unk_0x25644C31B4B6E9F3(iLocal_124, 1);
										unk_0x75ABDC5F81978924(iLocal_124);
										unk_0x78ADC381772E3D54(iLocal_103[0], iLocal_124);
										unk_0xF82EA857DA10E0CD(&iLocal_124);
										unk_0xD5EF6A937E06E46F(iLocal_103[0], false, -1, 0);
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[1]))
									{
										...
										unk_0x25644C31B4B6E9F3(iLocal_124, 1);
										unk_0x75ABDC5F81978924(iLocal_124);
										unk_0x78ADC381772E3D54(iLocal_103[1], iLocal_124);
										unk_0xF82EA857DA10E0CD(&iLocal_124);
										unk_0xD5EF6A937E06E46F(iLocal_103[1], false, -1, 0);
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[2]))
									{
										...
										unk_0x25644C31B4B6E9F3(iLocal_124, 1);
										unk_0x75ABDC5F81978924(iLocal_124);
										unk_0x78ADC381772E3D54(iLocal_103[2], iLocal_124);
										unk_0xF82EA857DA10E0CD(&iLocal_124);
										unk_0xD5EF6A937E06E46F(iLocal_103[2], false, -1, 0);
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[3]) && !unk_0xEB6A8945D1AC98A1(iLocal_103[4]))
									{
										...
										unk_0x75ABDC5F81978924(iLocal_124);
										unk_0x78ADC381772E3D54(iLocal_103[3], iLocal_124);
										unk_0xF82EA857DA10E0CD(&iLocal_124);
										unk_0xD5EF6A937E06E46F(iLocal_103[3], false, -1, 0);
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[4]))
									{
										...
										unk_0x509B8296EBA9B408(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0x75ABDC5F81978924(iLocal_124);
										unk_0x78ADC381772E3D54(iLocal_103[4], iLocal_124);
										unk_0xF82EA857DA10E0CD(&iLocal_124);
										unk_0xD5EF6A937E06E46F(iLocal_103[4], false, -1, 0);
									}
									if (!unk_0xEB6A8945D1AC98A1(iLocal_103[5]))
									{
										unk_0x3243DF4B5D918A01(iLocal_103[5], 0f, 3f, 1);
										unk_0xD5EF6A937E06E46F(iLocal_103[5], false, -1, 0);
									}
								}
								iVar1 = 0;
...
int func_95()
{
	...
	while (iVar0 < iLocal_103)
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_103[iVar0]))
		{
			...
			if ((((((unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true), 5f, 1) || unk_0xB87D13D0C064E9D1(iLocal_103[iVar0], unk_0x16F2683693E537C9(), 1)) || unk_0x1B3D109B39CC2C89(unk_0x16F2683693E537C9(), iLocal_103[iVar0])) || unk_0xBBE430A566D01EF3(unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), -37975472, 1)) || unk_0xBBE430A566D01EF3(unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), -1813897027, 1)) || unk_0xBBE430A566D01EF3(unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), -1568386805, 1)) || unk_0xBBE430A566D01EF3(unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), unk_0x68F4C0EC296D3901(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), 741814745, 1))
			{
				return 1;
			}
		}
	...
	if (unk_0x6AD0ABEEDDABA1F8(-1, vLocal_73, vLocal_76, fLocal_79))
	{
		return 1;
	}
	if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0))
...
void func_96()
{
	...
	unk_0x523BCC9DC80CD82F(1603932804);
	if ((unk_0xB87F6CF6E5628C67(663522487) && unk_0xB87F6CF6E5628C67(1069929536)) && unk_0xB87F6CF6E5628C67(1603932804))
	{
		unk_0x7D6CA5F52B3748BF(vLocal_48 - Vector(20f, 50f, 50f), vLocal_48 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		unk_0xAB8E2DDC7AF955E0(1069929536, true);
		unk_0x51B096AAC60548C1(0f);
		unk_0x15EA7F4313456B1D(3, false);
		iLocal_110[0] = unk_0x122AAB0B1D6F55AD(1069929536, 2209,17f, 5572,897f, 52,7565f, 255,5161f, true, true, false);
		unk_0x73270B3C9CC833FD(iLocal_110[0], true, 0);
		unk_0xB9FD7450C0DAB575(iLocal_110[0], 1084227584);
		unk_0xD3421E391490133B(iLocal_110[0], 1, true);
		iLocal_110[1] = unk_0x122AAB0B1D6F55AD(1069929536, 2195,473f, 5607,506f, 52,5648f, 168,4012f, true, true, false);
		unk_0x73270B3C9CC833FD(iLocal_110[1], true, 0);
		unk_0xD3421E391490133B(iLocal_110[1], 1, false);
		iVar0 = 0;
		unk_0x5D96D8530B3D0904(&iVar0, 1);
		iLocal_113 = unk_0x2D7B5CDDF12654D2(-831529621, vLocal_51, -1,368082f, 0,230633f, 176,8749f, iVar0, unk_0x09AC81E49EA267F7(40000, 100000), 2, 1, 1603932804);
		vLocal_54[0] = { 2205,769f, 5631,985f, 55,553f };
		fLocal_80[0] = 352,2203f;
		vLocal_54[1] = { 2210,584f, 5580,684f, 52,8132f };
		fLocal_80[1] = 300,5012f;
		vLocal_54[2] = { 2201,302f, 5589,279f, 52,9354f };
		fLocal_80[2] = 53,1602f;
		vLocal_54[3] = { 2202,535f, 5613,367f, 52,6781f };
		fLocal_80[3] = 70f;
		vLocal_54[4] = { 2200,764f, 5614,076f, 52,6852f };
		fLocal_80[4] = 53f;
		vLocal_54[5] = { 2193,714f, 5595,456f, 52,7615f };
		fLocal_80[5] = 338,8346f;
		unk_0xF63400DBE3303D26("DrugCult", &iLocal_123);
		unk_0x0E2400AB9174FA81(3, iLocal_123, -1533126372);
		unk_0x0E2400AB9174FA81(3, -1533126372, iLocal_123);
		unk_0x0E2400AB9174FA81(5, iLocal_123, 1862763509);
		iLocal_125 = 0;
		while (iLocal_125 < 6)
		{
			iLocal_103[iLocal_125] = unk_0x36F2404464202779(26, 663522487, vLocal_54[iLocal_125], fLocal_80[iLocal_125], 1, true);
			unk_0x11AD11297DC58CC7(iLocal_103[iLocal_125], true);
			unk_0x3CC33E4E9CE523F4(iLocal_103[iLocal_125], 2);
			unk_0xAFF39FB306F8E232(iLocal_103[iLocal_125], 50, true);
			...
			if (iLocal_126 == 0)
			{
				unk_0x262EF6C6306BEA6C(iLocal_103[iLocal_125], 2017895192, -1, true, true);
			}
			else if (iLocal_126 == 1)
			{
				unk_0x262EF6C6306BEA6C(iLocal_103[iLocal_125], 324215364, -1, true, true);
			}
			else
			{
				unk_0x262EF6C6306BEA6C(iLocal_103[iLocal_125], -1074790547, -1, true, true);
			}
			unk_0x4E885A246A9D983A(iLocal_103[iLocal_125], 42, true);
			func_91(&uLocal_131, 3, iLocal_103[iLocal_125], "SalvadorGang", 0, 1);
			iLocal_125++;
		}
		if (!unk_0xEB6A8945D1AC98A1(iLocal_103[0]))
		...
		unk_0xBC8E0A7390523199(iLocal_114, 140);
