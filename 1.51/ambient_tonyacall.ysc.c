void __EntryFunction__()
{
	...
	if (unk_0x8A22C4C08282BF26(777193410) > 1)
	{
...
int func_1()
{
	...
	if ((vdist2(vVar0, vVar3) > 10000f || unk_0x437347B10A200C4B(iLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0xC844350D5D58C99A(iLocal_38) && !unk_0x437347B10A200C4B(iLocal_38, 0))
			{
				if (unk_0x5A91F08DF773C39D(iLocal_38, vLocal_57, 1f, 1f, 1f, 0, true, 0))
				{
					...
					unk_0x78ADC381772E3D54(iLocal_38, uVar6);
					unk_0xF82EA857DA10E0CD(&uVar6);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0xC844350D5D58C99A(iLocal_38) && !unk_0x437347B10A200C4B(iLocal_38, 0))
			{
				if (unk_0x4F1B602325013CC2(iLocal_38) == 1)
				{
					if (!unk_0xC844350D5D58C99A(iLocal_39))
					{
						...
						{
							fVar7 = unk_0x8CA9406E01C7EE58(iLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0,157f)
							{
