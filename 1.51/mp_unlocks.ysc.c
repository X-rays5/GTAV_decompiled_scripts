...
int func_28(int iParam0)
{
	switch (iParam0)
	{
		...
		case 36:
			if (func_31(-1678617733) > 0 || func_31(-1609664002) > 0)
			{
				return 1;
			}
			else
...
{
	iVar0 = Global_2585280[iParam0][func_14(iParam1)];
	if (unk_0x6FB46C25CCB7E6D5(iVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
int func_48()
{
	...
	while (iVar0 < 1200)
	{
		if (unk_0xEAE0D21A50E6C7F4(Global_794709.f_4[iVar0].f_76, 14))
		{
			if (Global_794709.f_4[iVar0].f_65 < 13 && Global_794709.f_4[iVar0].f_70 <= 1000)
			{
				Global_794709.f_123083[Global_794709.f_4[iVar0].f_65]++;
			}
		}
		iVar0++;
	}
