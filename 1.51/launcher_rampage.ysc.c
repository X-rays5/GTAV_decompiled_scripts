		...
		if (iLocal_288 != -1)
		{
			if (!func_220())
			{
				*iParam0 = func_219(iLocal_288);
				...
				unk_0x0674E58A79778E99(&(Global_111638.f_18569[*iParam0]), 3);
...
void func_28(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	*uParam0 = func_227();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_58())
		{
			func_51(unk_0x16F2683693E537C9(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_52(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_2548434[iParam0][func_53(iParam1)];
...
int func_79(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	fVar2 = 1000000f;
	iVar3 = -1;
	iVar0 = 0;
...
bool func_163(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_164(&(Local_37[iVar4]), vVar1, iParam1, &(Local_37[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_37[iVar4].f_3) < iParam4);
}

int func_164(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_128(iParam4))
	{
...
int func_167(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_169(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		vVar1 = { Global_31146[(iLocal_286 + iVar0)][0] };
		if (unk_0x0EB28750412C3A5A(vVar4, vVar1, true) <= fParam0 && unk_0x755FF954DAE327E1((vVar4.z - vVar1.z)) < 1,5f)
		{
			return iVar0;
		}
		iVar0++;
	...
	switch (iLocal_114)
	{
		...
		case 2:
			...
			if (func_128(iParam0->f_28[0]))
			{
				...
				unk_0x915804B434753CBD(iParam0->f_28[0], iLocal_115[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 4:
			...
			if (func_128(iParam0->f_28[0]))
			{
				...
				unk_0x915804B434753CBD(iParam0->f_28[0], iLocal_115[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
			}
		...
		case 6:
			...
			if (func_128(iParam0->f_28[0]))
			{
				unk_0x915804B434753CBD(iParam0->f_28[0], iLocal_115[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
			}
			...
			if (func_128(uParam0->f_28[0]))
			{
				if (!func_147())
				{
					if (func_230(&uLocal_119, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_3", 8, 0, 0))
					{
						...
						unk_0x915804B434753CBD(uParam0->f_28[0], iLocal_285, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
...
void func_275(var uParam0)
{
	...
	unk_0x3F423BF5B8125A50(sVar0);
	unk_0x6D0C93EE4FBA9307(-1568386805, 31, 0);
	...
	while (unk_0x1C0640BA9A7327B3() < iVar8)
	{
		if (unk_0xB87F6CF6E5628C67(iVar0))
		{
			*iParam0 = unk_0x5ACD4E66C7BF0F49(iParam1, -1, vParam2, 1, 1065353216, 0, 0, 1);
			...
			{
				if (unk_0xD59C425D3CEABECE(*iParam0, func_277(&uVar1, iParam1, 962500902, 0)))
				{
					unk_0x78FB27E299143AC1(*iParam0, func_277(&uVar1, iParam1, 962500902, 0));
				}
				else if (unk_0xD59C425D3CEABECE(*iParam0, func_277(&uVar1, iParam1, 962500902, 1)))
				{
					unk_0x78FB27E299143AC1(*iParam0, func_277(&uVar1, iParam1, 962500902, 1));
				}
			}
			if (unk_0xC844350D5D58C99A(*iParam0))
			{
...
int func_279(int iParam0, int iParam1)
{
	...
	if (unk_0x8CD06866876216F2() && func_312())
	{
		...
		func_306(&sVar128, Var144, unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()), 3, 1, func_308(iParam0), func_307(iParam0), -1, 0, 0);
...
int func_333(int iParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (unk_0xC844350D5D58C99A(*iParam0))
	{
...
void func_338(var uParam0)
{
	...
	unk_0x64F9F278AB9DCA2C(uParam0->f_28[1], 11, 0, 0, 0);
	unk_0x262EF6C6306BEA6C(uParam0->f_28[1], -1074790547, 100, true, true);
...
void func_339(var uParam0)
{
	...
	unk_0x523BCC9DC80CD82F(iVar0);
	unk_0x3F423BF5B8125A50(sVar1);
	unk_0x6D0C93EE4FBA9307(324215364, 31, 10);
	while ((!unk_0xB87F6CF6E5628C67(iVar0) || !unk_0x1787731C4D1D6B19(324215364)) || !unk_0xB4AE0788C1587752(sVar1))
	{
		wait(0);
	}
	...
	{
		unk_0x3599C729CF725E87(uParam0->f_41[0], -1657815255);
		unk_0x3599C729CF725E87(uParam0->f_41[0], 283556395);
	}
...
void func_342(var uParam0)
{
	...
	func_346(&uLocal_112);
	while ((((!unk_0xB87F6CF6E5628C67(iVar0) || !unk_0xB87F6CF6E5628C67(iVar1)) || !unk_0xB87F6CF6E5628C67(iVar2)) || !unk_0xB4AE0788C1587752(sVar3)) || !func_345(&uLocal_112))
	{
		wait(0);
	}
	unk_0x75CFD6AD66ADFDD1(1180,021f, -401,7374f, 66,8767f, 0,75f, 0);
	uParam0->f_41[2] = unk_0x4B72871A3BE7B474(1179,778f, -401,7374f, 66,8697f, 1f, 525667351, 1, 0, 1);
	...
	unk_0x9F528B1B53FBC5D9(uParam0->f_41[1], uParam0->f_28[0], unk_0x4A089F2B762B8D33(uParam0->f_28[0], iVar4), vVar8, vVar5, 1, 0, 0, 0, 2, 1);
	func_343(&uLocal_112, 0, 3);
	if (!unk_0x69DF961355195C3C(uParam0->f_59))
	{
		uParam0->f_59 = unk_0xE9744DB7B8CA6965(vLocal_106, vLocal_109, 2);
		if (func_128(uParam0->f_28[0]))
		{
	...
	if (unk_0x83D8570832F172A7(*uParam0))
	{
		...
		else
		{
			if (!unk_0xE6CD5C6925050049("npcphone"))
			{
				...
				unk_0x064E7408AD6E15E5(-1038739674);
			}
...
void func_349(var uParam0)
{
	...
	iVar12 = 146905321;
	iVar13 = 1172836182;
	unk_0x523BCC9DC80CD82F(iVar11);
	unk_0x523BCC9DC80CD82F(iVar12);
	unk_0x523BCC9DC80CD82F(iVar13);
	unk_0x3F423BF5B8125A50(sVar3);
	unk_0x6D0C93EE4FBA9307(-1074790547, 31, 0);
	while ((((!unk_0xB87F6CF6E5628C67(iVar11) || !unk_0xB87F6CF6E5628C67(iVar12)) || !unk_0xB87F6CF6E5628C67(iVar13)) || !unk_0xB4AE0788C1587752(sVar3)) || !unk_0x1787731C4D1D6B19(-1074790547))
	{
		wait(0);
	}
	...
	if (func_128(uParam0->f_28[0]))
	{
		...
		unk_0x64F9F278AB9DCA2C(uParam0->f_28[0], 10, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(uParam0->f_28[0], 11, 0, 0, 0);
		vVar0 = { unk_0x64430C979F516F7A(uParam0->f_28[0], iVar4, 0f, 0f, 0f) };
		unk_0x5F2AA9E2843E9403(uParam0->f_28[0], "RAMP:PED 0");
		func_344(&(uParam0->f_41[1]), iVar13, vVar0, 0f);
		unk_0x9F528B1B53FBC5D9(uParam0->f_41[1], uParam0->f_28[0], unk_0x4A089F2B762B8D33(uParam0->f_28[0], iVar4), vVar8, vVar5, 1, 1, 0, 0, 2, 1);
	...
	if (func_128(uParam0->f_28[1]))
	{
		...
		unk_0x64F9F278AB9DCA2C(uParam0->f_28[1], 10, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(uParam0->f_28[1], 11, 0, 0, 0);
		vVar0 = { unk_0x64430C979F516F7A(uParam0->f_28[1], iVar4, 0f, 0f, 0f) };
		unk_0x5F2AA9E2843E9403(uParam0->f_28[1], "RAMP:PED 1");
		func_344(&(uParam0->f_41[2]), iVar13, vVar0, 0f);
		unk_0x9F528B1B53FBC5D9(uParam0->f_41[2], uParam0->f_28[1], unk_0x4A089F2B762B8D33(uParam0->f_28[1], iVar4), vVar8, vVar5, 1, 1, 0, 0, 2, 1);
	...
	if (!unk_0x69DF961355195C3C(uParam0->f_59))
	{
		...
		if (func_128(uParam0->f_28[0]))
		{
			unk_0x915804B434753CBD(uParam0->f_28[0], uParam0->f_59, sVar3, "redneck_idle_a", 8f, -8f, 513, 0, 1148846080, 0);
		}
		if (func_128(uParam0->f_28[1]))
		{
			unk_0x915804B434753CBD(uParam0->f_28[1], uParam0->f_59, sVar3, "redneck_idle_b", 8f, -8f, 513, 0, 1148846080, 0);
		}
		unk_0xC90224D9E95E5E3A(uParam0->f_59, true);
	}
	...
	unk_0x71199B01895C6202(iVar11);
	unk_0x71199B01895C6202(iVar12);
...
int func_352(int iParam0, var uParam1, vector3 vParam2, float fParam5)
{
	if (*iParam0 == 1)
	{
...
int func_353(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	iVar0 = 0;
