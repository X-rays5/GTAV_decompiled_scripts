...
void func_1()
{
	...
	if ((unk_0xC844350D5D58C99A(iLocal_448) && !unk_0x437347B10A200C4B(iLocal_448, 0)) && !unk_0x437347B10A200C4B(iLocal_240, 0))
	{
		if (!iLocal_449)
		{
			if (unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iLocal_240, true), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), true) < 15f)
			{
				...
				unk_0xE7B255741D794FB8(iLocal_448, 1f, 0);
				iLocal_449 = 1;
			}
		}
		else
		{
			unk_0x50155CDC2C5335FC(iLocal_448, 1, iLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
			if (unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iLocal_448, true), 377,4565f, 154,6708f, 102,0838f, true) > 25f)
			{
				unk_0x6DAD7906B73F064D(&iLocal_448);
				iLocal_450 = 1;
			}
			else if (unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iLocal_448, true), unk_0x68F4C0EC296D3901(iLocal_240, true), true) < 3f && iLocal_451 == 0)
			{
				iLocal_451 = 1;
			}
		}
...
void func_9()
{
	if (!unk_0x437347B10A200C4B(iLocal_240, 0))
	{
		unk_0x06FF977AA95DCCE3(iLocal_240, 0);
	}
}
...
void func_104()
{
	...
	unk_0x523BCC9DC80CD82F(2120901815);
	while (!unk_0xB87F6CF6E5628C67(2120901815))
	{
		wait(0);
	}
	iLocal_448 = unk_0x36F2404464202779(4, 2120901815, 396,8498f, 143,3195f, 101,4659f, 360f, 1, true);
	if ((unk_0xC844350D5D58C99A(iLocal_448) && !unk_0x437347B10A200C4B(iLocal_448, 0)) && !unk_0x437347B10A200C4B(iLocal_240, 0))
	{
		unk_0x50155CDC2C5335FC(iLocal_448, 1, iLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
	}
	if (!unk_0x437347B10A200C4B(iLocal_240, 0))
	{
		unk_0x2E1E5367A885F9B7(iLocal_240, "MAG_2_PAM_PED_GROUP", 0);
	}
}
