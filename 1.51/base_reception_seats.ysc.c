...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 2:
			if (func_50(unk_0x16F2683693E537C9(), uParam0[uParam0->f_85.f_2]))
			{
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = unk_0xF958843510932FF6(uParam0->f_85.f_1);
		...
		case 8:
			iVar43 = unk_0xF958843510932FF6(uParam0->f_85.f_1);
...
{
	vVar0 = { uParam0[uParam0->f_85.f_2]->f_8.f_3 };
...
int func_47(var uParam0)
{
	...
	while (iVar0 < unk_0x54EABC0DD106045B())
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iVar0)))
		{
			...
			if ((iVar1 != unk_0xD803B885F5E47A62() && func_48(iVar1, 1, 1)) && func_50(unk_0x9539D44F3E4492F6(iVar1), uParam0[uParam0->f_85.f_2]))
			{
				return 1;
			}
		}
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar4 < 2)
	{
		...
		uParam1[(*iParam2)[iVar4]]->f_8 = { func_80(func_81(iVar4), fVar3) + vVar0 };
		uParam1[(*iParam2)[iVar4]]->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		uParam1[(*iParam2)[iVar4]]->f_1 = { func_80(func_79(iVar4), fVar3) + vVar0 };
		uParam1[(*iParam2)[iVar4]]->f_1.f_3 = { func_80(func_78(iVar4), fVar3) + vVar0 };
