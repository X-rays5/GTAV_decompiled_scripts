...
int func_2()
{
	...
	{
		if (unk_0xC844350D5D58C99A(iLocal_239))
		{
			if (unk_0xB4ECF989E2C1DAC8(Global_98465, &sLocal_245, &cLocal_277, 3))
			{
				...
				else if (fVar0 < 0,4778f)
				{
					if (iLocal_294 == 0)
					{
						iLocal_294 = unk_0xC1879030EB463216("scr_lamgraff_paint_spray", iLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
		...
		if (unk_0xC844350D5D58C99A(iLocal_239))
		{
			if (unk_0xB4ECF989E2C1DAC8(Global_98465, &sLocal_245, &cLocal_261, 3))
			{
				...
				else
				{
					...
					{
						iLocal_293 = unk_0xE9744DB7B8CA6965(vLocal_241, 0f, 0f, fLocal_244, 2);
...
void func_37()
{
	...
	iLocal_239 = unk_0x7707E48765093646(iLocal_240, unk_0x68F4C0EC296D3901(Global_98465, true), true, true, false);
	unk_0x9F528B1B53FBC5D9(iLocal_239, Global_98465, unk_0x4A089F2B762B8D33(Global_98465, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
