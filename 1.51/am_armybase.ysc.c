					...
					if (!unk_0xEAE0D21A50E6C7F4(Global_2537071.f_4555, 0))
					{
						if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0))
						{
							...
							else
							{
								...
								if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0 && !iLocal_558)
								{
									iLocal_558 = 1;
								}
								if (Global_262145.f_21456 && !func_9(unk_0xD803B885F5E47A62()))
								{
									if ((!bLocal_554 && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) != 0) && iLocal_558)
									{
...
{
	iVar110 = 0;
	vVar0[0] = { -1877,436f, 2783,151f, 31,80618f };
	vVar46[0] = { -1797,873f, 2924,37f, (307,1106f + IntToFloat(iParam3)) };
	fVar92[0] = 88f;
	vVar0[1] = { -1761,116f, 2834,651f, 31,80622f };
	vVar46[1] = { -1720,887f, 2906,419f, (281,8062f + IntToFloat(iParam3)) };
	fVar92[1] = 88f;
	vVar0[2] = { -1761,493f, 2817,68f, 32,37125f };
	vVar46[2] = { -1769,704f, 2913,734f, (281,8066f + IntToFloat(iParam3)) };
	fVar92[2] = 88f;
	vVar0[3] = { -1879,297f, 2772,653f, 29,57795f };
	vVar46[3] = { -1864,521f, 2825,472f, (281,8062f + IntToFloat(iParam3)) };
	fVar92[3] = 88f;
	vVar0[4] = { -2676,74f, 3366,988f, 29,92394f };
	vVar46[4] = { -2744,79f, 3340,347f, (37,80379f + IntToFloat(iParam3)) };
	fVar92[4] = 9f;
	vVar0[5] = { -2676,74f, 3366,988f, 29,92394f };
	vVar46[5] = { -2744,79f, 3340,347f, (37,80379f + IntToFloat(iParam3)) };
	fVar92[5] = 9,5f;
	vVar0[6] = { -2807,397f, 3264,226f, 29,92764f };
	vVar46[6] = { -2879,805f, 3309,01f, (37,57864f + IntToFloat(iParam3)) };
	fVar92[6] = 9,5f;
	vVar0[7] = { -2808,236f, 3264,634f, 29,92764f };
	vVar46[7] = { -2747,55f, 3187,8f, (37,45682f + IntToFloat(iParam3)) };
	fVar92[7] = 9,5f;
	vVar0[8] = { -2530,996f, 3064,151f, 29,71081f };
	vVar46[8] = { -2748,557f, 3189,939f, (37,45682f + IntToFloat(iParam3)) };
	fVar92[8] = 9,5f;
	vVar0[9] = { -2533,902f, 3062,491f, 29,70715f };
	vVar46[9] = { -2520,674f, 2996,817f, (37,45715f + IntToFloat(iParam3)) };
	fVar92[9] = 9,5f;
	vVar0[10] = { -2500,716f, 2927,103f, 29,45663f };
	vVar46[10] = { -2445,696f, 2896,657f, (37,68009f + IntToFloat(iParam3)) };
	fVar92[10] = 9,5f;
	vVar0[11] = { -2020,543f, 2810,747f, 29,45658f };
	vVar46[11] = { -1927,949f, 2785,779f, (37,67057f + IntToFloat(iParam3)) };
	fVar92[11] = 9,5f;
	vVar0[12] = { -2261,899f, 3376,549f, 29,77859f };
	vVar46[12] = { -2141,067f, 3376,773f, (37,90019f + IntToFloat(iParam3)) };
	fVar92[12] = 9,5f;
	iVar108 = 13;
	iVar109 = 0;
...
int func_41()
{
	switch (Local_369.f_6)
	{
		case 0:
			...
			func_120(&(Local_112[unk_0x57270EE11514DC67()]), 1);
			Local_369.f_176 = 1;
			Local_369.f_6 = 1;
			break;
		...
		case 1:
			if (func_119())
			{
				func_120(&(Local_112[unk_0x57270EE11514DC67()]), 2);
				Local_369.f_6 = 2;
			}
			break;
...
{
	if (Local_85.f_3[iParam0].f_2 > 2 && unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0]))
	{
		if (unk_0x437347B10A200C4B(unk_0xB177666FAB6F4417(Local_85.f_3[iParam0]), 0))
		{
		...
		{
			Local_369.f_172[iParam0] = unk_0x5C3B41825F6AC5A0(unk_0xA5FBBC2F619A4DE2(Local_85.f_3[iParam0]));
			unk_0x61755AC17D8F538E(Local_369.f_172[iParam0], 1);
		}
	}
	...
	{
		case 0:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0], 16))
			{
				Local_112[unk_0x57270EE11514DC67()].f_4[iParam0] = 0;
				func_47(&(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0]), 16);
			}
			break;
		
		case 1:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0], 1))
			{
				if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0))
				{
					if (unk_0x5EDB8AD1D9CB1AC8(unk_0x16F2683693E537C9()) || unk_0x398B22FA3FCBDFA9(unk_0x16F2683693E537C9()))
					{
						if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) >= 4)
						{
							...
							{
								func_47(&(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0]), 1);
							}
						}
					}
				}
		...
		case 3:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0], 2))
			{
				if (func_46(iParam0))
				{
					iVar2 = unk_0x9539D44F3E4492F6(Local_85.f_3[iParam0].f_4);
					iVar0 = unk_0x1B50683925F00106(Local_85.f_3[iParam0].f_1);
					iVar1 = unk_0xB177666FAB6F4417(Local_85.f_3[iParam0]);
					if (!unk_0x437347B10A200C4B(iVar2, 0))
					{
						if (unk_0x5EDB8AD1D9CB1AC8(iVar2))
						{
							...
							if ((!unk_0x437347B10A200C4B(iVar0, 0) && !unk_0x437347B10A200C4B(iVar1, 0)) && !unk_0x437347B10A200C4B(iVar3, 0))
							{
								...
								unk_0x40B4CC38578A6E32(iVar0, -123497569);
				...
				{
					func_47(&(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0]), 2);
				}
			}
			break;
		...
		case 5:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0], 8))
			{
				if (func_46(iParam0))
				{
					iVar0 = unk_0x1B50683925F00106(Local_85.f_3[iParam0].f_1);
				...
				{
					func_47(&(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0]), 8);
				}
			}
			break;
		
		case 6:
			if (unk_0xE9F78D191AD5EDBA(Local_85.f_3[iParam0]) || unk_0xE9F78D191AD5EDBA(Local_85.f_3[iParam0].f_1))
			{
				if (!unk_0x8E28E832BEAC3DCE(unk_0x68F4C0EC296D3901(unk_0xA5FBBC2F619A4DE2(Local_85.f_3[iParam0]), 0), 10f) && !unk_0xE8F26853385214AB(unk_0x68F4C0EC296D3901(unk_0xA5FBBC2F619A4DE2(Local_85.f_3[iParam0]), 0), 10f))
				{
					if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0].f_1) && unk_0x526BC32A660C89E6(Local_85.f_3[iParam0].f_1))
					{
						iVar4 = unk_0xA5FBBC2F619A4DE2(Local_85.f_3[iParam0].f_1);
						unk_0x2ABAFAE29D459CE5(&iVar4);
					}
					if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0]) && unk_0x526BC32A660C89E6(Local_85.f_3[iParam0]))
					{
						iVar5 = unk_0xA5FBBC2F619A4DE2(Local_85.f_3[iParam0]);
						unk_0x2ABAFAE29D459CE5(&iVar5);
					}
				}
			}
			else if (func_48(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0], 16))
			{
				func_43(&(Local_112[unk_0x57270EE11514DC67()].f_4[iParam0]), 16);
			}
			break;
	}
}
...
{
	if (!unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0]))
	{
		return 1;
	}
	iVar0 = unk_0xB177666FAB6F4417(Local_85.f_3[iParam0]);
...
{
	if (!unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0].f_1))
	{
		return 0;
	}
	iVar0 = unk_0x1B50683925F00106(Local_85.f_3[iParam0].f_1);
...
int func_97(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		if (!Local_369.f_178)
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 1))
			{
...
void func_107()
{
	if (unk_0x93B62D155C014521(unk_0xD803B885F5E47A62()))
	{
		...
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 0))
			{
				...
				{
					if (!unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 1) && !unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 3))
					{
						unk_0x5D96D8530B3D0904(&(Local_369.f_182), 1);
					}
				}
				unk_0x5D96D8530B3D0904(&(Local_369.f_182), 0);
			}
		}
		else
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 0))
			{
				unk_0x0674E58A79778E99(&(Local_369.f_182), 0);
			}
			if (unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 1))
			{
				unk_0x0674E58A79778E99(&(Local_369.f_182), 1);
			}
			if (unk_0xEAE0D21A50E6C7F4(Local_369.f_182, 3))
			{
...
{
	if (!unk_0xE5DBF9B6126856CA(Local_85[iParam0]))
	{
		return;
	}
	iVar0 = unk_0x1B50683925F00106(Local_85[iParam0]);
	if (unk_0x437347B10A200C4B(iVar0, 0))
	{
		return;
	}
	...
	{
		case 0:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 64))
			{
				Local_112[unk_0x57270EE11514DC67()].f_1[iParam0] = 0;
				func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 64);
			}
			break;
		
		case 1:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 1))
			{
				if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0))
				{
					if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iVar0, 1)) <= 900f)
					{
						func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 1);
					}
				}
			}
			break;
		...
		case 2:
			if ((!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 2) && vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iVar0, 1)) <= 900f) && !func_22(unk_0xD803B885F5E47A62()))
			{
				func_91(&(Local_369.f_7), 4, iVar0, "ARMY_Guard01", 0, 1);
				func_117(&(Local_369.f_7), "ARMYAUD", "ARMY_WRN1", 12, 0, 0, 0);
				func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 2);
			}
			break;
		
		case 3:
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 4))
			{
				if (func_116(iParam0))
				{
				...
				{
					func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 4);
				}
			}
			break;
		
		case 4:
			if ((!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 8) && vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), unk_0x68F4C0EC296D3901(iVar0, 1)) <= 900f) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) < 1)
			{
				...
				{
					func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 8);
			...
			if (!func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 16))
			{
				if (func_113(iParam0) && vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), unk_0x68F4C0EC296D3901(iVar0, 1)) <= 900f)
				{
					func_47(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 16);
					if (!func_158())
					{
			...
			if (func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 1))
			{
				if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0))
				{
					if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), unk_0x68F4C0EC296D3901(iVar0, 1)) > 900f)
					{
						func_43(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 1);
					}
				}
			}
			break;
		...
		case 7:
			if (func_48(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0], 4))
			{
				...
				{
					func_43(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 4);
					func_43(&(Local_112[unk_0x57270EE11514DC67()].f_1[iParam0]), 64);
				}
			}
			break;
	}
...
int func_115(int iParam0)
{
	...
	while (iVar0 < unk_0x54EABC0DD106045B())
	{
		if (unk_0x81A93C8315C28F58(unk_0xF4FB3A22FC4991C8(iVar0)))
		{
			...
			if (!unk_0x437347B10A200C4B(iVar2, 0))
			{
				fVar4 = vdist2(unk_0x68F4C0EC296D3901(iVar2, 1), unk_0x68F4C0EC296D3901(unk_0xA5FBBC2F619A4DE2(Local_85[iParam0]), 1));
				if (fVar4 < fVar3)
				{
					iVar1 = iVar2;
					fVar3 = fVar4;
...
int func_119()
{
	if (!unk_0xB87F6CF6E5628C67(1702441027))
	{
		return 0;
	}
	if (!unk_0xB87F6CF6E5628C67(-1281684762))
	{
		return 0;
	}
	if (!unk_0xB87F6CF6E5628C67(-1422914553))
	{
		return 0;
	}
	return 1;
...
void func_127()
{
	...
	unk_0x523BCC9DC80CD82F(-1422914553);
}
...
void func_130()
{
	...
	while (iVar0 < 2)
	{
		if (unk_0xE5DBF9B6126856CA(Local_85[iVar0]))
		{
			iVar1 = unk_0x1B50683925F00106(Local_85[iVar0]);
	...
	while (iVar0 < 3)
	{
		if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iVar0].f_1))
		{
			iVar1 = unk_0x1B50683925F00106(Local_85.f_3[iVar0].f_1);
			if (!unk_0x437347B10A200C4B(iVar1, 0))
			{
				unk_0x6DAD7906B73F064D(&iVar1);
			}
		}
		if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iVar0]))
		{
			iVar2 = unk_0xB177666FAB6F4417(Local_85.f_3[iVar0]);
			if (!unk_0x437347B10A200C4B(iVar2, 0))
			{
...
void func_131(int iParam0)
{
	if (Local_85.f_3[iParam0].f_2 > 2)
	{
		if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0].f_1))
		{
			if (!unk_0x437347B10A200C4B(unk_0x1B50683925F00106(Local_85.f_3[iParam0].f_1), 0))
			{
				iVar0 = unk_0x1B50683925F00106(Local_85.f_3[iParam0].f_1);
				...
				if (vVar1.z <= -150f)
				{
					...
					if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam0]))
					{
						if (!unk_0x437347B10A200C4B(unk_0xB177666FAB6F4417(Local_85.f_3[iParam0]), 0))
						{
							iVar4 = unk_0xB177666FAB6F4417(Local_85.f_3[iParam0]);
	...
	switch (Local_85.f_3[iParam0].f_2)
	{
		...
		case 2:
			...
			if (!func_139(vVar5))
			{
				...
				{
					if (func_134(vVar5, unk_0xD9522BA9E27E1349(unk_0x9539D44F3E4492F6(Local_85.f_3[iParam0].f_4)), iParam0))
					{
		...
		case 4:
			iVar8 = unk_0x9539D44F3E4492F6(Local_85.f_3[iParam0].f_4);
			if (!unk_0xC844350D5D58C99A(iVar8))
			{
				Local_85.f_3[iParam0].f_2 = 5;
			}
			else if (unk_0x437347B10A200C4B(iVar8, 0))
			{
				Local_85.f_3[iParam0].f_2 = 5;
			}
			else if (unk_0x5EDB8AD1D9CB1AC8(iVar8) || unk_0x398B22FA3FCBDFA9(iVar8))
			{
				if (func_133(unk_0x6937EA2286828455(iVar8, 0)))
				{
					Local_85.f_3[iParam0].f_2 = 5;
				}
			}
...
int func_134(vector3 vParam0, int iParam3, int iParam4)
{
	if (!unk_0xBFF81ED3B99522C7())
	{
		return 1;
	...
	iVar0 = 1;
	if (!unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam4]))
	{
		if (!func_136(&(Local_85.f_3[iParam4]), -1281684762, vParam0, iParam3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			iVar0 = 0;
		}
		else
		{
			unk_0xB58CA658A628ED02(unk_0xB177666FAB6F4417(Local_85.f_3[iParam4]), 3);
		}
	}
	if (unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam4]))
	{
		if (!unk_0xE5DBF9B6126856CA(Local_85.f_3[iParam4].f_1))
		{
			...
			{
				unk_0x40B4CC38578A6E32(unk_0x1B50683925F00106(Local_85.f_3[iParam4].f_1), -123497569);
				unk_0xE69C5AEBE90D20B1(unk_0x1B50683925F00106(Local_85.f_3[iParam4].f_1), false);
			}
		}
	}
	else
...
int func_136(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, int iParam14, bool bParam15)
{
	...
	if (unk_0xC844350D5D58C99A(iVar1))
	{
		*uParam0 = unk_0xFBA927257CA38E95(iVar1);
		...
		if (unk_0xE9F78D191AD5EDBA(*uParam0))
		{
			...
			func_137(vParam2, iParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_137(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	if (func_138(unk_0xD803B885F5E47A62(), vParam0, iParam4) > -1)
	{
...
{
	iVar0 = unk_0x9539D44F3E4492F6(Local_85.f_3[iParam0].f_4);
	if (unk_0x437347B10A200C4B(iVar0, 0))
	{
		return 0f, 0f, 0f;
	}
			...
			if (!func_142(unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iVar0))))
			{
				if (unk_0x5EDB8AD1D9CB1AC8(iVar1) || unk_0x398B22FA3FCBDFA9(iVar1))
				{
					if (unk_0x179932739160BA96(unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iVar0))) >= 4)
					{
						...
						{
							Local_85.f_3[iParam0].f_4 = unk_0x4B2BFE4A3BC248ED(unk_0xF4FB3A22FC4991C8(iVar0));
							return 1;
						}
					}
				}
...
int func_142(int iParam0)
{
	...
	while (iVar1 < 3)
	{
		iVar2 = unk_0x9539D44F3E4492F6(Local_85.f_3[iVar1].f_4);
...
int func_147()
{
	...
	else if (unk_0xE5DBF9B6126856CA(Local_85[0]))
	{
		unk_0x262EF6C6306BEA6C(unk_0x1B50683925F00106(Local_85[0]), -1074790547, 200, true, true);
	}
	if (!func_148(&(Local_85[1]), 29, 1702441027, -1588,9f, 2792,9f, 16,1385f, 229,437f, 1, 1, 1))
	{
		iVar0 = 0;
	}
	else if (unk_0xE5DBF9B6126856CA(Local_85[1]))
	{
		unk_0x262EF6C6306BEA6C(unk_0x1B50683925F00106(Local_85[1]), -1074790547, 200, true, true);
	}
	return iVar0;
}

int func_148(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, int iParam8, bool bParam9)
{
	if (!unk_0xA3FA8B6D2780D661(1))
	{
		return 0;
...
var func_153(int iParam0)
{
	...
	{
		case 0:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1773,944f, 3287,334f, 30f, -2029,776f, 2845,083f, 1250f, 255f);
			break;
		
		case 1:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2725,889f, 3291,099f, 30f, -2009,182f, 2879,835f, 1250f, 180f);
			break;
		
		case 2:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2442,026f, 3326,699f, 30f, -2033,928f, 3089,049f, 1250f, 205f);
			break;
		
		case 3:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1917,165f, 3374,209f, 30f, -2016,791f, 3195,058f, 1250f, 86,25f);
			break;
		
		case 4:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2192,753f, 3373,278f, 30f, -2191,544f, 3150,417f, 1250f, 150f);
			break;
		
		case 5:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2077,663f, 3344,514f, 30f, -2191,544f, 3150,417f, 1250f, 140,5f);
			break;
		
		case 6:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2861,755f, 3352,661f, 30f, -2715,871f, 3269,916f, 1250f, 90f);
			break;
		
		case 7:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2005,574f, 3364,533f, 30f, -1977,569f, 3330,888f, 1250f, 100f);
			break;
		
		case 8:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1682,235f, 3004,285f, 30f, -1942,747f, 2947,441f, 1250f, 248,75f);
			break;
		
		case 9:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2393,295f, 2936,406f, 31,6801f, -2453,037f, 3006,863f, 52,31003f, 128f);
			break;
		
		case 10:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2347,185f, 3023,83f, 31,56573f, -2517,33f, 2989,063f, 49,95644f, 127,25f);
			break;
		
		case 11:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2259,922f, 3358,04f, 29,99972f, -2299,772f, 3385,79f, 38,06014f, 16f);
			break;
		
		case 12:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2476,309f, 3363,914f, 31,67933f, -2431,981f, 3287,669f, 39,97826f, 214,25f);
			break;
		
		case 13:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2103,081f, 2797,783f, 29,37864f, -2096,821f, 2874,423f, 57,80989f, 65,75f);
			break;
		
		case 14:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1877,436f, 2783,151f, 31,80618f, -1797,873f, 2924,37f, 1307,111f, 88f);
			break;
		
		case 15:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1761,116f, 2834,651f, 31,80622f, -1720,887f, 2906,419f, 1281,806f, 88f);
			break;
		
		case 16:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1761,493f, 2817,68f, 32,37125f, -1769,704f, 2913,734f, 1281,807f, 88f);
			break;
		
		case 17:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -1879,297f, 2772,653f, 29,57795f, -1864,521f, 2825,472f, 1281,806f, 88f);
			break;
		
		case 18:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2676,74f, 3366,988f, 29,92394f, -2744,79f, 3340,347f, 1037,804f, 9f);
			break;
		
		case 19:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2676,74f, 3366,988f, 29,92394f, -2744,79f, 3340,347f, 1037,804f, 9,5f);
			break;
		
		case 20:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2807,397f, 3264,226f, 29,92764f, -2744,79f, 3340,347f, 1037,804f, 9,5f);
			break;
		
		case 21:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2808,236f, 3264,634f, 29,92764f, -2747,55f, 3187,8f, 1037,457f, 9,5f);
			break;
		
		case 22:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2530,996f, 3064,151f, 29,71081f, -2748,557f, 3189,939f, 1037,457f, 9,5f);
			break;
		
		case 23:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2533,902f, 3062,491f, 29,70715f, -2520,674f, 2996,817f, 1037,457f, 9,5f);
			break;
		
		case 24:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2500,716f, 2927,103f, 29,45663f, -2445,696f, 2896,657f, 1037,68f, 9,5f);
			break;
		
		case 25:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2020,543f, 2810,747f, 29,45658f, -1927,949f, 2785,779f, 1037,671f, 9,5f);
			break;
		
		case 26:
			uVar0 = unk_0xB2840BBCAFBC1E5D(iLocal_560, -2261,899f, 3376,549f, 29,77859f, -2141,067f, 3376,773f, 1037,9f, 9,5f);
			break;
	}
	return uVar0;
}
...
void func_186()
{
	...
	if (unk_0xB87F6CF6E5628C67(1702441027))
	{
		unk_0x71199B01895C6202(1702441027);
	}
	if (unk_0xB87F6CF6E5628C67(-1281684762))
	{
		unk_0x71199B01895C6202(-1281684762);
	}
	if (unk_0xB87F6CF6E5628C67(-1422914553))
	{
		unk_0x71199B01895C6202(-1422914553);
	}
}
...
void func_187(struct<21> Param0)
{
	...
	unk_0x0BEC04ECA8485A3A(5);
	unk_0x28E5F00F131890E3(3);
	unk_0x9752E7BAEABA939E(&Local_85, 27);
