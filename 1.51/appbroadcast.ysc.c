...
void func_35()
{
	...
	if (func_16())
	{
		if (Global_2460602)
		{
			func_42(Global_19467, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_46, 0, 0, 0, 0);
		}
		else
		{
	...
	{
		func_42(Global_19467, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_50, 0, 0, 0, 0);
	}
