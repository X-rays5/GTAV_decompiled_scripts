...
void func_105(var uParam0, vector3 vParam1, var uParam4)
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}
	...
	if (unk_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (unk_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_186(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_183(unk_0x68F4C0EC296D3901(Global_102203.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_187(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
...
int func_190(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		if (((((((((((((((func_191(vVar18[0], vVar18[1], vVar6, vVar9) || func_191(vVar18[0], vVar18[1], vVar9, vVar15)) || func_191(vVar18[0], vVar18[1], vVar12, vVar15)) || func_191(vVar18[0], vVar18[1], vVar6, vVar12)) || func_191(vVar18[1], vVar18[3], vVar6, vVar9)) || func_191(vVar18[1], vVar18[3], vVar9, vVar15)) || func_191(vVar18[1], vVar18[3], vVar12, vVar15)) || func_191(vVar18[1], vVar18[3], vVar6, vVar12)) || func_191(vVar18[3], vVar18[2], vVar6, vVar9)) || func_191(vVar18[3], vVar18[2], vVar9, vVar15)) || func_191(vVar18[3], vVar18[2], vVar12, vVar15)) || func_191(vVar18[3], vVar18[2], vVar6, vVar12)) || func_191(vVar18[2], vVar18[0], vVar6, vVar9)) || func_191(vVar18[2], vVar18[0], vVar9, vVar15)) || func_191(vVar18[2], vVar18[0], vVar12, vVar15)) || func_191(vVar18[2], vVar18[0], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_211(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_211(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_211(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_243(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_211(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_211(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_211(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_211(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_211(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_260(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_254(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0x1A5A491D253EA7BA(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_254(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0x1A5A491D253EA7BA(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_211(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_315(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == unk_0x36C584991B4C183F(iParam0, func_211(iParam1)) && Global_76434[1].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_211(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				iLocal_476 = unk_0x7F6DC62EA9922664(Local_112.f_9);
...
int func_329(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)
{
	if (func_23(iParam0))
	{
		...
		if (iLocal_253 == 0)
		{
			...
			if (func_374())
			{
				if (iLocal_448 || iLocal_98 == 7)
				{
					if (bLocal_454)
					{
						unk_0x79C43E2BAC7C696F(Local_112.f_9, func_373(), 1048576000);
						iLocal_253 = 2;
					}
					else
					{
		...
		if (!unk_0xE9B814896D415EDD(unk_0x16F2683693E537C9()))
		{
			switch (Local_112.f_10)
			{
				...
				case 13:
					if ((!unk_0x92444005288A72ED(Local_112.f_9) && !unk_0x869EFD0BC0868856(Local_112.f_9)) && !unk_0x15D0A3E61766C539(Local_112.f_9, 0))
					{
						if (func_124(Local_112.f_18, unk_0x09AC81E49EA267F7(250, 500)))
						{
							...
							{
								unk_0x96167B03C5A77156(0, Local_112.f_13, 1f, 20000, 0,25f, 512, 1193033728);
							}
				...
				case 18:
					...
					{
						unk_0xD458AC1C1D29C3B4(Local_112.f_9, 0, 0);
					}
					if ((!unk_0x92444005288A72ED(Local_112.f_9) && !unk_0x869EFD0BC0868856(Local_112.f_9)) && !unk_0x15D0A3E61766C539(Local_112.f_9, 0))
					{
				...
				case 22:
					if (func_124(Local_112.f_18, unk_0x09AC81E49EA267F7(0, 500)))
					{
						if (unk_0xACCBB8E1BDF4D6BE(Local_112.f_9))
						{
				...
				case 24:
					...
					{
						if ((!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_254[0], 0) && func_116(Local_254[0], Local_254[0].f_1, 3f)) && func_371(unk_0xD9522BA9E27E1349(Local_254[0]), Local_254[0].f_4, 20f))
						{
				...
				case 25:
					...
					else if (((unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_254[0], 0) || unk_0x36646919F20EAFFC(Local_112.f_9)) || !func_116(Local_254[0], Local_254[0].f_1, 3f)) || !func_371(unk_0xD9522BA9E27E1349(Local_254[0]), Local_254[0].f_4, 20f))
					{
						Local_112.f_10 = 22;
					}
				...
				case 30:
					...
					else if (unk_0x7AEFFBD77F2CF1EC(func_367()))
					{
						...
						unk_0x18E279963C2FCEF4(func_367(), 1,5f, 3,5f, -1f);
					...
					else
					{
						if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
						{
							if (func_366())
							{
								...
								{
									fVar8 = unk_0x9C66D99E63E8E24C(iVar1);
...
bool func_377(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_378(&(Local_56[iVar4]), vVar1, iParam1, &(Local_56[iVar4].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1C0640BA9A7327B3() - Local_56[iVar4].f_3) < iParam4);
}

int func_378(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	iVar7 = 0;
	if (!func_429(iParam4))
	{
...
int func_381(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	{
		vVar3 = { func_192(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_385()
{
	if (func_59(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_677, 100f))
	{
		if (!func_386())
		{
			unk_0xAE1670DD12E839C3(&vLocal_671, 8);
			func_67();
			iLocal_452 = 1;
		}
	}
...
void func_400()
{
	if (func_23(Local_132[0]))
	{
		if (Local_132[0].f_14 == 0)
		{
			...
			{
				if (unk_0xC844350D5D58C99A(Local_340[0]))
				{
					if (unk_0xD59B17D2DFF98E26(Local_340[0]))
					{
						unk_0x15AFB6CBDE990FB6(Local_340[0], 1, 1);
					}
				}
				Local_132[0].f_14 = 4;
			}
			else if (unk_0xC844350D5D58C99A(Local_340[0]))
			{
				if (!unk_0xD59B17D2DFF98E26(Local_340[0]))
				{
					unk_0x9F528B1B53FBC5D9(Local_340[0], Local_132[0], unk_0x4A089F2B762B8D33(Local_132[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					if (!unk_0xB4ECF989E2C1DAC8(Local_132[0], "oddjobs@bailbond_mountain", "Idle_Camman", 3))
					{
						unk_0xC6EB89C59F2AF6B8(Local_132[0], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49, 0, 0, 0, 0);
					}
					if (!func_64(Local_132[0], -875674219))
					{
						if (func_429(Local_112.f_9))
						{
							unk_0x0C8C0C840C2D1AD2(Local_132[0], Local_112.f_9, -1, 2060, 3);
							unk_0xF96A174EE26D7588(Local_132[0], Local_112.f_9, -1);
						}
					}
				}
			}
...
void func_428(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
...
void func_443(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	iVar0 = 1;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_490(vParam1, iParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_107(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_485(iParam12, 0);
			while (!func_444(iParam0, iParam12, vParam1, iParam4, 1, 0))
			{
				wait(0);
			}
		}
...
int func_444(int iParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, int iParam7)
{
	if (func_89(iParam1))
	{
		Var5.f_11 = 12;
...
int func_449(int iParam0, bool bParam1, var uParam2)
{
	*uParam2 = 0;
	...
	if (!unk_0x8CD06866876216F2())
	{
		if ((func_151(iParam0) && unk_0x134B62B726CEC8E6(iParam0) != 873639469) && unk_0x134B62B726CEC8E6(iParam0) != -1177863319)
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_493(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case -644710429:
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_495(iParam0, uVar1[iVar6], 1) && func_494(unk_0x68F4C0EC296D3901(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_107(vParam1, 0f, 0f, 0f, 0)) || unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(uVar1[iVar6], true), true) < 10f)
					{
						unk_0xA954465BA6FDEFE2(&iParam0);
						return 1;
					}
...
void func_518()
{
	...
	unk_0x0E2400AB9174FA81(5, 1862763509, iLocal_664);
	unk_0x0E2400AB9174FA81(5, iLocal_664, 1862763509);
	vVar0 = { func_525(Local_103) };
	vVar3 = { func_524(Local_103) };
	unk_0x10F3BFFADF2CE3DA(vVar0, vVar3);
...
void func_519()
{
	if (func_23(Local_112.f_9))
	{
		...
		Local_112.f_10 = 0;
		unk_0x262EF6C6306BEA6C(Local_112.f_9, -72657034, 1, false, true);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 0, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 2, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 3, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 4, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 8, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 10, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(Local_112.f_9, 8, 3, 0, 0);
		unk_0xDD353D0E9C789D0E(&uLocal_484);
		if (func_23(Local_132[0]))
		{
			unk_0xF96A174EE26D7588(0, Local_132[0], 0);
		}
		...
		if (func_23(Local_132[0]))
		{
			...
			{
				unk_0x262EF6C6306BEA6C(Local_132[0], Local_132[0].f_5, -1, true, true);
			}
			func_520(Local_132[0], "BACKUP_", 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 0, 1, 1, 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 2, 1, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 3, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 4, 1, 1, 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 8, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_132[0], 10, 0, 0, 0);
			if (unk_0xC844350D5D58C99A(Local_340[0]))
			{
				if (!unk_0xD59B17D2DFF98E26(Local_340[0]))
				{
					unk_0x9F528B1B53FBC5D9(Local_340[0], Local_132[0], unk_0x4A089F2B762B8D33(Local_132[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					unk_0x1E9649458B15960F(Local_340[0], false);
					unk_0x0C8C0C840C2D1AD2(Local_132[0], Local_112.f_9, -1, 2060, 3);
					unk_0xC6EB89C59F2AF6B8(Local_132[0], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49, 0, 0, 0, 0);
					unk_0xF96A174EE26D7588(Local_132[0], Local_112.f_9, -1);
				}
...
int func_523(var uParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6)
{
	if (!unk_0xC844350D5D58C99A(*uParam0))
	{
		if (func_56(iParam1))
...
void func_526()
{
	...
	unk_0x5D96D8530B3D0904(&(Local_377[0].f_6), 3);
	unk_0x5D96D8530B3D0904(&(Local_377[0].f_6), 4);
	unk_0x5D96D8530B3D0904(&(Local_377[0].f_6), 1);
	iLocal_470 = 1;
