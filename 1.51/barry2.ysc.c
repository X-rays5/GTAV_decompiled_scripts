void __EntryFunction__()
{
	...
	iLocal_545 = 71929310;
	iLocal_546 = 728614474;
	iLocal_547 = 1716800000;
	iLocal_548 = -494615257;
	iLocal_571 = 500;
	iLocal_572 = 2000;
	iLocal_573 = 1500;
	iLocal_574 = 3000;
	...
	iLocal_808 = 2120901815;
	iLocal_809 = -1606864033;
	iLocal_811 = -1;
	...
	while (true)
	{
		...
		if (func_37())
		{
			...
			{
				unk_0x58350770D73D313A(sLocal_344, "DrugsEffect", ((sin((((to_float(unk_0x1C0640BA9A7327B3()) / 1000f) * 45f) % 360f)) * 0,25f) + 0,25f));
			}
			func_32();
			func_1();
		}
...
void func_32()
{
	if (bLocal_210)
	{
		if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_186[0], Local_186[1], Local_186.f_7, 0, true, 0))
		{
	...
	else if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_194[0], Local_194[1], Local_194.f_7, 0, true, 0))
	{
		func_36("B2_PRIME", 7500, 1);
		func_35(&iLocal_212);
		bLocal_210 = true;
	}
	else if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_178[0], Local_178[1], Local_178.f_7, 0, true, 0))
	{
...
int func_39(int iParam0)
{
	...
	switch (iLocal_160)
	{
		...
		case 1:
			...
			iVar4 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", unk_0x07DAF5424BC6779A(), unk_0x3B276DB863622D2E(2), unk_0xE758B7099799F42F(), 1, 2);
			vVar0 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true) - unk_0x07DAF5424BC6779A() };
			unk_0xC5940439E4EB9A33(iVar4, unk_0x16F2683693E537C9(), -vVar0, 1);
			if (unk_0x9F4FE516EAACCFC5(iVar4))
			{
		...
		case 5:
			if (unk_0x1C0640BA9A7327B3() > iLocal_157)
			{
				if (iParam0 == 1)
				{
					...
					if (unk_0x9F4FE516EAACCFC5(iVar4))
					{
						unk_0xE3BB8E05FCEB3FBE(iVar4, false);
						unk_0x9A8DDC7C522F5BF5(iVar4, 0);
					}
					...
					unk_0x28F5E4DA506AC0CA(vLocal_173, 200f, 0, 0, 0, 0, false, 0);
					unk_0x58B5D6A0F1D7754D(vLocal_173, 500f);
					if (func_50(unk_0x16F2683693E537C9()))
					{
...
int func_42(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_46(iVar2, iVar8) != 0)
	{
		if (!unk_0x437347B10A200C4B(iParam0, 0))
		{
			if (unk_0xAFB8387ED2D7213E(iParam0, iVar2, func_46(iVar2, iVar8)))
			{
				...
				{
					iVar9 = unk_0xE8213142E3A84F79(func_46(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_46(iVar2, iVar8) != 0)
	{
		if (!unk_0x437347B10A200C4B(iParam0, 0))
		{
			if (unk_0xAFB8387ED2D7213E(iParam0, iVar2, func_46(iVar2, iVar8)))
			{
				unk_0x3599C729CF725E87(iVar1, func_46(iVar2, iVar8));
...
void func_66(var uParam0, vector3 vParam1, var uParam4)
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}
...
void func_72(int iParam0)
{
	...
	{
		func_73(&(Local_346[iVar0]), iParam0);
		iVar0++;
	}
}
...
void func_77()
{
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		...
		while (iVar0 < Local_346)
		{
			if (func_78(&(Local_346[iVar0])))
			{
				Local_346[iVar0].f_2 = 0;
				unk_0xEEB67C3D0A71A47B(Local_346[iVar0].f_3, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
...
void func_79(int iParam0)
{
	...
	{
		func_80(&(Local_834[iVar0]), iParam0);
		iVar0++;
	}
}
...
void func_81(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			func_51("bar_4_rcm", 0);
			func_388(vLocal_173, 1112014848, 12, 5000, 0, 0);
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0) && unk_0x1FBF08B001C4788A("postRC_Barry1and2"))
			{
				...
				func_303();
				iLocal_345 = 0;
				unk_0x28F5E4DA506AC0CA(vLocal_173, 250f, 0, 0, 0, 0, false, 0);
				unk_0x745CE398A4B0A3C6(vLocal_173, 50f, 0);
				unk_0x75CFD6AD66ADFDD1(vLocal_173, 30f, 0);
				unk_0x58B5D6A0F1D7754D(vLocal_173, 500f);
				unk_0x29E8331978B73E7F(0, sLocal_335, 2, func_648(49), 0);
				unk_0x29E8331978B73E7F(0, sLocal_337, 2, 974300346, 0);
				unk_0x29E8331978B73E7F(0, sLocal_336, 2, 1281480215, 0);
				if (func_62(unk_0x16F2683693E537C9()))
				{
		...
		case 2:
			...
			else
			{
				...
				if (unk_0x3148AE92ED70DC30("Trevor", 0))
				{
					...
					unk_0xBD453909DC26A85D(unk_0x16F2683693E537C9(), -530524, false, 1, 0);
		...
		case 3:
			...
			func_63(1, 1, 1, 1);
			func_294(unk_0x16F2683693E537C9(), vLocal_173);
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (unk_0xD2C792E5A65B6BF1(iParam0, func_153(iParam1)) > 0 && unk_0x0F84621831DD8D8A(iParam0, func_153(iParam1), Global_76434[1].f_3) > 0)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, 0);
		}
	}
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xEAE0D21A50E6C7F4(Global_76434[1].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_153(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_153(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_153(iVar0), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
						}
						func_144(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, unk_0xAA973E78065E07A0(iParam0, func_153(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1].f_3, Global_76434[1].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_164(&(Global_76434[0]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, unk_0x1A5A491D253EA7BA(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_164(&(Global_76434[0]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, unk_0x1A5A491D253EA7BA(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_225(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1].f_3 == unk_0x36C584991B4C183F(iParam0, func_153(iParam1)) && Global_76434[1].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_153(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_232(int iParam0, int iParam1, int iParam2)
{
	if (iParam0 != -1)
	{
		...
		func_233(&sVar32, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_275(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_276(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
							...
							if (unk_0xEAE0D21A50E6C7F4(uParam1[iVar5]->f_2, iVar6))
							{
								if (!unk_0xAFB8387ED2D7213E(iParam0, iVar3, iVar4))
								{
									...
									if (func_280(iVar4))
									{
										...
										func_279(iParam0, iVar3, iVar4, uParam1[iVar5]->f_4);
									}
								}
							}
									...
									if (unk_0xEAE0D21A50E6C7F4(uParam1->f_221[iVar70].f_2, iVar71))
									{
										if (!unk_0xAFB8387ED2D7213E(iParam0, iVar3, Var48.f_3))
										{
											...
											if (func_280(Var48.f_3))
											{
												...
												func_279(iParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70].f_4);
											}
										}
									}
...
void func_288(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		while (iVar1 < 44)
		{
			Global_111638.f_2358.f_539.f_298[iVar0][iVar1] = { uParam0->f_812[iVar0][iVar1] };
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 51)
		{
			Global_111638.f_2358.f_539.f_298[iVar0].f_221[iVar1] = { uParam0->f_812[iVar0].f_221[iVar1] };
			iVar1++;
		}
		iVar0++;
	}
...
void func_289(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			case 0:
				unk_0xCDC520E5E48E63D9(-1142440288, uParam0->f_2244[iVar0][0], 1);
				unk_0xCDC520E5E48E63D9(-1123368730, uParam0->f_2244[iVar0][1], 1);
				unk_0xCDC520E5E48E63D9(1081345962, uParam0->f_2244[iVar0].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(-1371118771, uParam0->f_2244[iVar0].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(-765547619, uParam0->f_2244[iVar0].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(-1080850937, uParam0->f_2244[iVar0].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(-2022861412, uParam0->f_2244[iVar0].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(-2018548694, uParam0->f_2244[iVar0].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(1323790999, uParam0->f_2244[iVar0].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(760098661, uParam0->f_2244[iVar0].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(-260459075, uParam0->f_2244[iVar0].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(1085789752, uParam0->f_2244[iVar0].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(334003354, uParam0->f_2244[iVar0].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(-500524769, uParam0->f_2244[iVar0].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(-1456330957, uParam0->f_2244[iVar0].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(-142720058, uParam0->f_2244[iVar0].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(-855707956, uParam0->f_2244[iVar0].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(-1539506602, uParam0->f_2244[iVar0].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(1915755069, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
			
			case 1:
				unk_0xCDC520E5E48E63D9(-126492964, uParam0->f_2244[iVar0][0], 1);
				unk_0xCDC520E5E48E63D9(190514318, uParam0->f_2244[iVar0][1], 1);
				unk_0xCDC520E5E48E63D9(-739329202, uParam0->f_2244[iVar0].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(-1185380830, uParam0->f_2244[iVar0].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(1030852186, uParam0->f_2244[iVar0].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(1801284145, uParam0->f_2244[iVar0].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(-1873234909, uParam0->f_2244[iVar0].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(-1315299114, uParam0->f_2244[iVar0].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(-2073999771, uParam0->f_2244[iVar0].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(1865030647, uParam0->f_2244[iVar0].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(-419525730, uParam0->f_2244[iVar0].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(-121557213, uParam0->f_2244[iVar0].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(-1021590567, uParam0->f_2244[iVar0].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(-732338604, uParam0->f_2244[iVar0].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(758650912, uParam0->f_2244[iVar0].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(1090437037, uParam0->f_2244[iVar0].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(164057391, uParam0->f_2244[iVar0].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(1607797744, uParam0->f_2244[iVar0].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(-1852248201, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
			
			case 2:
				unk_0xCDC520E5E48E63D9(177632919, uParam0->f_2244[iVar0][0], 1);
				unk_0xCDC520E5E48E63D9(-464115177, uParam0->f_2244[iVar0][1], 1);
				unk_0xCDC520E5E48E63D9(111865610, uParam0->f_2244[iVar0].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(-194950537, uParam0->f_2244[iVar0].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(-378588013, uParam0->f_2244[iVar0].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(-626223346, uParam0->f_2244[iVar0].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(-848331628, uParam0->f_2244[iVar0].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(226994293, uParam0->f_2244[iVar0].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(-1921832882, uParam0->f_2244[iVar0].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(1934357500, uParam0->f_2244[iVar0].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(1106022718, uParam0->f_2244[iVar0].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(1478409634, uParam0->f_2244[iVar0].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(-863918486, uParam0->f_2244[iVar0].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(-1699495217, uParam0->f_2244[iVar0].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(-1327567067, uParam0->f_2244[iVar0].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(2133068720, uParam0->f_2244[iVar0].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(-7828357, uParam0->f_2244[iVar0].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(-4568869, uParam0->f_2244[iVar0].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(-225202546, uParam0->f_2244[iVar0].f_16[11], 1);
				break;
		}
		iVar0++;
	}
...
void func_304()
{
	if (unk_0x9F4FE516EAACCFC5(iLocal_807))
	{
		unk_0xE3BB8E05FCEB3FBE(iLocal_807, false);
		unk_0x9A8DDC7C522F5BF5(iLocal_807, 0);
	}
}
...
void func_320(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	*uParam0 = func_14();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_342())
		{
			func_338(unk_0x16F2683693E537C9(), &(uParam0->f_616[iVar1]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
{
	uVar0 = Global_2583656[iParam0][func_147(iParam1)];
...
void func_343(int iParam0, bool bParam1)
{
	...
	if (func_16(iVar0) && !unk_0xEB6A8945D1AC98A1(iParam0))
	{
		if (iParam0 == unk_0x16F2683693E537C9())
		{
			func_344(iParam0, &(Global_111638.f_2358.f_539.f_298[iVar0]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_388(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
...
void func_391(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_414(&iVar0))
			{
				if (func_408(&(Local_346[iVar0]), 195,1091f, -933,9568f, 29,6918f, 325f, 1, 0))
				{
				}
			}
			*iParam0 = 2;
...
void func_392(bool bParam0)
{
	if (!*bParam0)
	{
		if (iLocal_582 == 1)
		{
			...
			if (iVar0 != -1)
			{
				func_393(&(Local_346[iVar0]), 1, 1);
				Local_346[iVar0].f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_601, (iLocal_601 + iLocal_600)));
				unk_0xB3F77607A42FF835(Local_346[iVar0].f_3, 0);
			}
			*bParam0 = 1;
		}
	}
...
void func_407()
{
	...
	while (iVar0 < Local_346)
	{
		if (!func_68(Local_346[iVar0].f_16, 0f, 0f, 0f, 0))
		{
			iLocal_585 = 1;
			vLocal_587 = { Local_346[iVar0].f_16 };
			Local_346[iVar0].f_16 = { 0f, 0f, 0f };
			iVar0 = (Local_346 - 1);
		}
		iVar0++;
	}
...
int func_408(var uParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	uParam0->f_3 = unk_0x36F2404464202779(26, iLocal_545, vParam1, fParam4, 1, true);
	if (!unk_0xC844350D5D58C99A(uParam0->f_3))
	{
		return 0;
	}
	...
	if (!bParam6)
	{
		if (!bParam5)
		{
			...
			if (iVar0 == 0)
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, 736523883, -1, true, true);
			}
			else
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, 453432689, -1, true, true);
			}
		}
		else
		{
...
void func_409(int iParam0, var uParam1, bool bParam2)
{
	...
	unk_0xAFF39FB306F8E232(iParam0, 13, unk_0x79833B02DBD2A244(0, 1065353216) < uParam1->f_20);
	unk_0xAFF39FB306F8E232(iParam0, 42, unk_0x79833B02DBD2A244(0, 1065353216) < uParam1->f_8);
	unk_0xAFF39FB306F8E232(iParam0, 11, unk_0x79833B02DBD2A244(0, 1065353216) < uParam1->f_9);
	if (uParam1->f_19 != -1)
	{
		iVar0 = uParam1->f_19;
	}
...
{
	fVar0 = func_413(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), 1);
	unk_0xD8F6A53F4799FAFE(iParam0, fVar0);
}

float func_413(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)
{
	fVar1 = (Param3 - Param0);
...
void func_417(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_430(&iVar0))
			{
				func_429(&(Local_499[iVar0]), 247,8f, -880,3f, 33f, 129,46f, 1, 6000, 600, 2000);
			}
			if (func_430(&iVar0))
			{
				func_429(&(Local_499[iVar0]), 218,4f, -868,5f, 33f, 228,6f, -1, 14000, 1100, 2000);
			}
			func_404(&iLocal_1108);
...
void func_418(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_424(iParam0, &iVar3, !bParam3))
	{
		if (bParam3)
		{
			if (func_414(&iVar2))
			{
				if (func_408(&(Local_346[iVar2]), Local_1000[iVar3].f_1, Local_1000[iVar3].f_4, 1, 1))
				{
					func_411(&(Local_346[iVar2]), 2);
					func_419(&(Local_1000[iVar3]), iVar1, 0);
				}
			}
		}
		else
		{
			func_419(&(Local_1000[iVar3]), iVar1, !bParam3);
		}
	}
}
...
void func_419(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < iParam1)
	{
		if (func_423(&iVar1))
		{
			vVar3 = { unk_0x8A5E176FF719A014(uParam0->f_1, uParam0->f_4, vLocal_818[iVar0]) };
			if (bParam2)
			{
			...
			{
				unk_0xCEAA091B490F8407(iLocal_811, "CROWD_WATCHING", Local_834[iVar1], 0, false, 0);
			}
			Local_834[iVar1].f_10 = bParam2;
		}
		iVar0++;
	}
}
...
{
	if (unk_0xE82754C349C7B581(Local_834[iParam0].f_2, &uVar0, 0, 0))
	{
		Local_834[iParam0].f_2.f_2 = uVar0;
	}
	if (Local_834[iParam0].f_2.f_2 < 28f)
	{
		return 0;
	}
	Local_834[iParam0] = unk_0x36F2404464202779(26, Local_834[iParam0].f_1, Local_834[iParam0].f_2, Local_834[iParam0].f_5, 1, true);
	if (!unk_0xC844350D5D58C99A(Local_834[iParam0]))
	{
		return 0;
	}
	unk_0xFBAC0F6D4E00C891(Local_834[iParam0]);
	unk_0x33CE5A9E32EA10B2(Local_834[iParam0], true);
	unk_0x1365063FA6365BE8(Local_834[iParam0], true);
	unk_0x11AD11297DC58CC7(Local_834[iParam0], true);
	unk_0x6D80F1AEBA734886(Local_834[iParam0], 0);
	unk_0xD458AC1C1D29C3B4(Local_834[iParam0], 100, 0);
	Local_834[iParam0].f_6 = 0;
	Local_834[iParam0].f_7 = 1;
	Local_834[iParam0].f_10 = 0;
	return 1;
}
...
void func_421(int iParam0, vector3 vParam1, var uParam4)
{
	if (func_410())
	{
		Local_834[iParam0].f_1 = iLocal_809;
	}
	else
	{
		Local_834[iParam0].f_1 = iLocal_808;
	}
	Local_834[iParam0].f_2 = { vParam1 };
	Local_834[iParam0].f_5 = uParam4;
	Local_834[iParam0].f_7 = 0;
}
...
int func_424(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar0 < 15)
	{
		if (Local_894[iVar0] == iParam0)
		{
			if (Local_894[iVar0].f_6 == bParam2)
			{
				if (iVar1 < Local_1000)
				{
					if (!unk_0xEA19D5D9230DBB67(Local_894[iVar0].f_1, 7f))
					{
...
{
	Local_1000[iParam1] = Local_894[iParam0];
	Local_1000[iParam1].f_1 = { Local_894[iParam0].f_1 };
	Local_1000[iParam1].f_4 = Local_894[iParam0].f_4;
	Local_1000[iParam1].f_6 = Local_894[iParam0].f_6;
}
...
void func_426()
{
	...
	{
		Local_1000[iVar0] = 3;
		Local_1000[iVar0].f_1 = { 0f, 0f, 0f };
		Local_1000[iVar0].f_4 = -1f;
		Local_1000[iVar0].f_5 = -1;
		Local_1000[iVar0].f_6 = 0;
		iVar0++;
	}
}
...
int func_427()
{
	...
	while (iVar0 < Local_834)
	{
		if (unk_0xC844350D5D58C99A(Local_834[iVar0]))
		{
			if (!unk_0xEB6A8945D1AC98A1(Local_834[iVar0]))
			{
				iVar1++;
			}
		}
...
int func_429(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	uParam0->f_3 = unk_0x122AAB0B1D6F55AD(iLocal_546, vParam1, iParam4, 1, 1, 0);
	if (!unk_0xC844350D5D58C99A(uParam0->f_3))
	{
		return 0;
	}
	...
	unk_0x1E9649458B15960F(uParam0->f_3, true);
	unk_0xAA6B3A4292417750(uParam0->f_3, false, true, false, false, false, false, 0, false);
...
void func_431(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_430(&iVar0))
			{
				func_429(&(Local_499[iVar0]), 173,7f, -918,9f, 32,2f, 235,72f, -1, 1250, 1150, 1750);
			}
			if (func_430(&iVar0))
			{
				func_429(&(Local_499[iVar0]), 214,2f, -947,3f, 32,2f, 53,64f, -1, 8250, 850, 2000);
			}
			func_404(&iLocal_1108);
			*iParam0 = 2;
			break;
		...
		case 2:
			if (iLocal_582 > 1)
			{
				if (func_428(&iLocal_1108, unk_0x79833B02DBD2A244(9f, 12f)))
				{
					func_418(1, 5, 5, 0);
				}
			}
...
void func_433(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_414(&iVar0))
			{
				func_408(&(Local_346[iVar0]), 202,1f, -999,3f, 30,6f, 0, 0, 0);
			}
			if (func_414(&iVar0))
			{
				func_408(&(Local_346[iVar0]), 200,6f, -989,3f, 30,6f, 0, 0, 0);
			}
			if (func_414(&iVar0))
			{
				func_408(&(Local_346[iVar0]), 192,3f, -994,7f, 30,6f, 0, 0, 0);
			}
			func_418(0, 2, 5, 1);
			*iParam0 = 2;
			break;
...
void func_434(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_430(&iVar0))
			{
				if (func_429(&(Local_499[iVar0]), 151,2f, -962,3f, 30,1f, 213,2f, 1, 0, 1250, 2500))
				{
					*iParam0 = 2;
				}
			}
...
void func_436()
{
	...
	if (func_414(&iVar0))
	{
		if (func_408(&(Local_346[iVar0]), 181,1f, -951,9f, 30,1f, 0, 0, 0))
		{
		}
	}
	if (func_414(&iVar0))
	{
		if (func_408(&(Local_346[iVar0]), 173f, -956,9f, 30,1f, 0, 0, 0))
		{
			Local_346[iVar0].f_11 = 0;
		}
	}
	if (func_414(&iVar0))
	{
		if (func_408(&(Local_346[iVar0]), 174,7f, -948,1f, 30,1f, 0, 0, 0))
		{
			Local_346[iVar0].f_11 = 0;
		}
	}
...
int func_453()
{
	func_50(Local_346[iLocal_803].f_3);
	func_50(Local_346[iLocal_804].f_3);
	func_50(Local_346[iLocal_805].f_3);
	...
	switch (iLocal_890)
	{
		case 0:
			...
			if ((func_460(&(Local_346[iLocal_803]), "clown_idle_0", 0) && func_460(&(Local_346[iLocal_804]), "clown_idle_6", 0,1f)) && func_460(&(Local_346[iLocal_805]), "clown_idle_3", 0,1f))
			{
				iLocal_890 = 1;
			}
			break;
		...
		case 1:
			if (!unk_0x65636D4556D82155(Local_346[iLocal_805].f_3))
			{
				func_458(Local_346[iLocal_805].f_3, "CLOWN_LAUGH", "CLOWNS", 10);
			}
			if (unk_0x9F4FE516EAACCFC5(iLocal_807))
			{
				if (unk_0xFBB4F23D534EB790(iLocal_807))
				{
		...
		case 6:
			func_456(&(Local_346[iLocal_804]));
			func_456(&(Local_346[iLocal_805]));
			if (func_456(&(Local_346[iLocal_803])))
			{
				func_455();
				unk_0xEF6276132B396452(0f, 1065353216);
				unk_0x2FB9A57162E54BAB(0f);
				...
				{
					unk_0xB3A1B75CB59FEB56(false, false, 2000, 1, 0, 0);
				}
				else
				{
					unk_0xB3A1B75CB59FEB56(false, true, 2000, 1, 0, 0);
				}
				unk_0xE3BB8E05FCEB3FBE(iLocal_807, false);
				iLocal_890 = 7;
			}
		...
		case 8:
			func_456(&(Local_346[iLocal_804]));
			func_456(&(Local_346[iLocal_805]));
			if (func_454(&(Local_346[iLocal_803])))
			{
		...
		case 9:
			func_454(&(Local_346[iLocal_803]));
			func_454(&(Local_346[iLocal_804]));
			func_454(&(Local_346[iLocal_805]));
			if (iLocal_582 == 0)
			{
				iLocal_890 = 10;
				return 1;
...
void func_455()
{
	if (func_62(unk_0x16F2683693E537C9()))
	{
		if (!unk_0x440C646F2F11A2A1(unk_0x16F2683693E537C9(), iLocal_548, 0))
		{
			unk_0x262EF6C6306BEA6C(unk_0x16F2683693E537C9(), iLocal_548, -1, true, true);
		}
		else if (!unk_0xCAE036C45E7FC720(unk_0x16F2683693E537C9(), &iVar0, 1) || iVar0 != iLocal_548)
		{
			unk_0x5745EA6329A91E29(unk_0x16F2683693E537C9(), iLocal_548, true);
		}
		...
		if (unk_0x2399B47AC91F054A(iLocal_548, -2034401422))
		{
			unk_0x1F6FCCC72D02C71A(unk_0x16F2683693E537C9(), iLocal_548, -2034401422);
		}
...
int func_457(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bVar0 = false;
	if (func_62(iParam0))
	{
...
void func_461()
{
	if (func_414(&iVar0))
	{
		if (func_408(&(Local_346[iVar0]), 163,9249f, -956,996f, 29,09192f, 262,4564f, 1, 0))
		{
			iLocal_803 = iVar0;
			func_411(&(Local_346[iLocal_803]), 1);
		}
	}
	if (func_414(&iVar0))
	{
		func_408(&(Local_346[iVar0]), 166,4477f, -955,0585f, 29,09192f, 263,4564f, 0, 0);
		iLocal_804 = iVar0;
		func_411(&(Local_346[iLocal_804]), 1);
	}
	if (func_414(&iVar0))
	{
		func_408(&(Local_346[iVar0]), 168,952f, -960,7564f, 29,07847f, 265,4564f, 0, 0);
		iLocal_805 = iVar0;
		func_411(&(Local_346[iLocal_805]), 1);
	}
}
...
int func_463(var uParam0, int iParam1)
{
	...
	if (unk_0x1C0640BA9A7327B3() > uParam0[iParam1]->f_6)
	{
		uParam0->f_117 = 1;
		return 1;
	}
	switch ((*uParam0)[iParam1])
	{
		...
		case 4:
			if (!unk_0xAE317D00A5A55DF6(uParam0[iParam1]->f_3, false, -1))
			{
				return 0;
			}
			break;
		...
		case 5:
			if (!unk_0xE3934829A331AF92(uParam0[iParam1]->f_3, 0))
			{
				return 0;
			}
			break;
...
int func_464(var uParam0, int iParam1)
{
	...
	{
		case 1:
			unk_0xCBE9833C2148CAFF(uParam0[iParam1]->f_3);
			break;
		
		case 2:
			unk_0x3F423BF5B8125A50(uParam0[iParam1]->f_3);
			break;
		
		case 3:
			unk_0x4942FBD1EF896E39(uParam0[iParam1]->f_3);
			break;
		
		case 4:
			unk_0xAE317D00A5A55DF6(uParam0[iParam1]->f_3, false, -1);
			break;
		
		case 5:
			unk_0xE3934829A331AF92(uParam0[iParam1]->f_3, uParam0[iParam1]->f_4);
			break;
		
		case 6:
			unk_0x523BCC9DC80CD82F(uParam0[iParam1]->f_1);
			break;
		...
		case 8:
			unk_0xD7992BEF7A9D109E(uParam0[iParam1]->f_3, uParam0[iParam1]->f_5);
			break;
		
		case 9:
			unk_0x0D3BE1DE0262A012(uParam0[iParam1]->f_3, false);
			break;
		
		case 10:
			unk_0x36187931D29E5BBE(uParam0[iParam1]->f_5, uParam0[iParam1]->f_3);
			break;
		
		case 11:
			unk_0x29398344B9E5B8A7(uParam0[iParam1]->f_3);
			break;
		
		case 12:
			unk_0x6D0C93EE4FBA9307(uParam0[iParam1]->f_2, 31, 0);
			break;
	...
	uParam0->f_117 = 0;
	uParam0[iParam1]->f_6 = unk_0x1C0640BA9A7327B3() + 10000;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0))
			{
				...
				{
					unk_0x29E8331978B73E7F(Local_96.f_41[0], sLocal_337, 2, 974300346, 0);
				}
				if (func_62(Local_96.f_41[1]))
				{
				...
				{
					unk_0x29E8331978B73E7F(Local_96.f_41[1], sLocal_336, 2, 1281480215, 0);
				}
				...
				iLocal_807 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", 188,1366f, -957,7827f, 30,6514f, -5,5067f, -8f, 92,8053f, 40f, 0, 2);
				func_522();
				unk_0x4C902758BEA97C68(0);
				unk_0x420FE818E70BB523(1);
		...
		case 2:
			...
			else
			{
				...
				if (unk_0xEABED1927EFB48CA(0))
				{
					...
					if (unk_0x9F4FE516EAACCFC5(iLocal_807))
					{
						unk_0xE3BB8E05FCEB3FBE(iLocal_807, true);
						unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
						unk_0x91F5B0244AAE6222(iLocal_807, "DRUNK_SHAKE", 1f);
					}
				}
				if (unk_0x3148AE92ED70DC30("Trevor", 0))
				{
...
void func_483()
{
	...
	if (unk_0xAFB8495D36825275(iVar0) || unk_0xC41A9202669A24C4(iVar0))
	{
		...
		fLocal_168 = 206,45f;
		func_514(Local_202[0], Local_202[1], Local_202.f_7, vLocal_165, fLocal_168, 0f, 0f, 0f, 1, 0, 1, 0, 0);
		func_487(vLocal_165, fLocal_168, 0, 145);
	}
	else
	{
		func_514(Local_202[0], Local_202[1], Local_202.f_7, vLocal_165, fLocal_168, func_486(), 1, 0, 1, 0, 0);
	...
	if (unk_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (unk_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_513(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_510(unk_0x68F4C0EC296D3901(Global_102203.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_489(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_505(&(Global_75441.f_555[0]), iParam0))
	{
		return;
	}
...
int func_505(var uParam0, int iParam1)
{
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_68(Global_111638.f_32744.f_1864[uParam0->f_14], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_68(Global_111638.f_2358.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_68(Global_111638.f_2358.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, 0))
		{
...
void func_506(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	if (func_505(&(Global_75441.f_555[0]), iParam0))
	{
		...
		{
			func_508(iParam0);
			func_507(uParam1, &(Global_111638.f_32744.f_69[Global_75441.f_555[0].f_14]));
...
void func_514(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_515(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}
...
int func_517(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		if (((((((((((((((func_518(vVar18[0], vVar18[1], vVar6, vVar9) || func_518(vVar18[0], vVar18[1], vVar9, vVar15)) || func_518(vVar18[0], vVar18[1], vVar12, vVar15)) || func_518(vVar18[0], vVar18[1], vVar6, vVar12)) || func_518(vVar18[1], vVar18[3], vVar6, vVar9)) || func_518(vVar18[1], vVar18[3], vVar9, vVar15)) || func_518(vVar18[1], vVar18[3], vVar12, vVar15)) || func_518(vVar18[1], vVar18[3], vVar6, vVar12)) || func_518(vVar18[3], vVar18[2], vVar6, vVar9)) || func_518(vVar18[3], vVar18[2], vVar9, vVar15)) || func_518(vVar18[3], vVar18[2], vVar12, vVar15)) || func_518(vVar18[3], vVar18[2], vVar6, vVar12)) || func_518(vVar18[2], vVar18[0], vVar6, vVar9)) || func_518(vVar18[2], vVar18[0], vVar9, vVar15)) || func_518(vVar18[2], vVar18[0], vVar12, vVar15)) || func_518(vVar18[2], vVar18[0], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_529()
{
	...
	if (func_408(&(Local_346[iVar0]), vVar1, 0, 0, 0))
	{
		if (iLocal_159 == 9)
		{
...
int func_530(var uParam0)
{
	...
	if (iLocal_159 != 9)
	{
		if (unk_0x0EB28750412C3A5A(vVar0, vLocal_169, true) > fLocal_172)
		{
			return 0;
		}
	}
	if (func_532(unk_0x16F2683693E537C9(), vVar0, 1) < fLocal_575)
	{
		return 0;
	}
	if (bLocal_596)
	{
		if (func_531(vVar0, fVar4, unk_0x16F2683693E537C9(), 1))
		{
			return 0;
		}
	}
	else if (unk_0xEA19D5D9230DBB67(vVar0, fVar4))
	{
		return 0;
	}
	if (iLocal_159 == 9)
	{
		vVar5 = { vVar0 };
		if (!unk_0xB885EF0389689E54(vVar0, 0, &vVar5, 14))
		{
			return 0;
		}
	}
	if (unk_0x0399732A9EBC368E(vVar0, 211,8852f, -931,1685f, 29,6915f, 220,7504f, -918,6229f, 32,44152f, 2f, 0, true))
	{
		return 0;
	}
	if (vVar0.z < 28,58f)
...
{
	return unk_0xF65264B66E133BD8(vParam0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}
...
Vector3 func_533(vector3 vParam0, int iParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_534(vVar0, unk_0x79833B02DBD2A244(0f, iParam3)) };
...
int func_536(var uParam0)
{
	...
	if (uParam0->f_2 < 15)
	{
		vVar3 = { unk_0x68F4C0EC296D3901(uParam0->f_3, true) };
		if (vVar3.z < 21f)
		{
		}
	...
	if (bLocal_213)
	{
		if (uParam0->f_9 == 0)
		{
			func_545(unk_0x68F4C0EC296D3901(uParam0->f_3, true), fLocal_581, 255, 0, 0, 255, 32);
		}
		else
		{
			func_545(unk_0x68F4C0EC296D3901(uParam0->f_3, true), fLocal_581, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2)
	{
		case 1:
			if (unk_0x1C0640BA9A7327B3() >= uParam0->f_6)
			{
				...
				uParam0->f_2 = 2;
				uParam0->f_5 = 0f;
				func_544(uParam0->f_3, floor(uParam0->f_5), &iLocal_214);
		...
		case 10:
			...
			{
				uParam0->f_14 = iVar0;
				if (func_541(&(Local_346[uParam0->f_14]), uParam0->f_3, 1))
				{
					Local_346[uParam0->f_14].f_2 = 0;
					func_35(&(Local_346[uParam0->f_14].f_4));
					unk_0xA3BF0AA5A2608191(Local_346[uParam0->f_14].f_3);
					...
					unk_0x78ADC381772E3D54(Local_346[uParam0->f_14].f_3, uVar2);
		...
		case 11:
			if (func_62(Local_346[uParam0->f_14].f_3))
			{
				if (unk_0xD1960163A3042274(Local_346[uParam0->f_14].f_3, 242628503) == 7)
				{
					...
					unk_0x78ADC381772E3D54(Local_346[uParam0->f_14].f_3, uVar7);
					unk_0xF82EA857DA10E0CD(&uVar7);
					Local_346[uParam0->f_14].f_4 = func_540(Local_346[uParam0->f_14].f_3, 1, 0, 5);
					Local_346[uParam0->f_14].f_2 = 14;
					uParam0->f_2 = 12;
				}
			}
			else
		...
		case 12:
			...
			vVar8 = { unk_0x68E4ADDDDCD7BDDE(uParam0->f_3, 0f, -3,3f, -0,7f) };
			if (bLocal_213)
			{
			...
			if (func_414(&iVar0))
			{
				if (func_541(&(Local_346[iVar0]), uParam0->f_3, 0))
				{
					unk_0xE81656B429E5C4B5("scr_clown_appears", uParam0->f_3, vLocal_590, 0f, 0f, 0f, fLocal_593, 0, 0, 0);
					Local_346[iVar0].f_2 = 14;
					func_411(&(Local_346[iVar0]), 4);
					uParam0->f_8 = 1;
					uParam0->f_10++;
					uParam0->f_5 = 0f;
					unk_0x4A4806F9D471E491(Local_346[iVar0].f_3, false, 0);
					vVar8 = { unk_0x68E4ADDDDCD7BDDE(uParam0->f_3, unk_0x79833B02DBD2A244(-2,5f, 2,5f), unk_0x79833B02DBD2A244(-6,5f, -10f), -0,7f) };
					unk_0xDD353D0E9C789D0E(&uVar11);
					unk_0x9294582561BECEE7(0, 1);
					unk_0x45F014B3D0466974(0, uParam0->f_3, 256);
					unk_0xE20F700AC2AFCA92(0, vVar8, unk_0x16F2683693E537C9(), 1f, true, 1,5f, 2f, 1, 0, 0, -957453492, 20000);
					unk_0x75ABDC5F81978924(uVar11);
					unk_0x78ADC381772E3D54(Local_346[iVar0].f_3, uVar11);
		...
		case 16:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_6)
			{
				unk_0xBA3209FB359D3EA4("scr_clown_death", unk_0x68F4C0EC296D3901(uParam0->f_3, false), unk_0x835730A2D89F6093(uParam0->f_3, 2), 3f, 0, 0, 0);
		...
		case 17:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_6)
			{
				...
				if (uParam0->f_5 <= 0f)
				{
					unk_0x7800CEC090C01D4D(unk_0x68F4C0EC296D3901(uParam0->f_3, true), 2f);
					unk_0x8B4C4CA774181102(4f, 2f, 3);
					func_467(uParam0);
					return 0;
				}
			}
...
int func_538(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < Local_346)
	{
		if (unk_0xC844350D5D58C99A(Local_346[iVar0].f_3))
		{
			if (func_532(Local_346[iVar0].f_3, vParam0, 1) < fParam3)
			{
				return 1;
			}
		}
...
int func_541(var uParam0, int iParam1, int iParam2)
{
	...
	uParam0->f_3 = unk_0x852A19533F896693(iParam1, 26, iLocal_545, iVar1, 1, true);
	func_35(&(uParam0->f_4));
	...
	*uParam0 = 1;
	...
	uParam0->f_2 = 0;
	func_411(uParam0, 0);
	uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(round((IntToFloat(iLocal_600) * 1,5f)), iLocal_601));
	unk_0x554BF1F380170E11(uParam0->f_3, 0);
	unk_0xAADFCECF0BE76858(uParam0->f_3, 1);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 1, false);
	unk_0x20EC6650986ACDC7(uParam0->f_3, 1);
...
void func_551(var uParam0)
{
	...
	if (!func_562(uParam0))
	{
		if ((unk_0x437347B10A200C4B(uParam0->f_3, 0) || unk_0xEB6A8945D1AC98A1(uParam0->f_3)) || unk_0x28072FDD60CE3A6E(uParam0->f_3, 0))
		{
			...
			func_561("CLOWN_DEATH", "CLOWNS", unk_0x68F4C0EC296D3901(uParam0->f_3, true), 10);
			uParam0->f_2 = 15;
			...
			if (!unk_0x437347B10A200C4B(uParam0->f_3, 0))
			{
				unk_0xBC3E304ACAF897E2(uParam0->f_3, 100416529);
			}
			...
			if (iLocal_159 == 9)
			{
				uParam0->f_16 = { unk_0x68F4C0EC296D3901(uParam0->f_3, true) };
			}
			func_35(&(uParam0->f_4));
			iLocal_578++;
		}
	...
	switch (uParam0->f_2)
	{
		case 1:
			if (unk_0x1C0640BA9A7327B3() >= uParam0->f_12 || iLocal_159 == 9)
			{
				...
				vVar0 = { unk_0x68F4C0EC296D3901(uParam0->f_3, true) };
				uParam0->f_2 = 2;
			}
			break;
		...
		case 3:
			...
			unk_0x1E9649458B15960F(uParam0->f_3, true);
			unk_0xE121AE1BBF90E186(uParam0->f_3, true);
			unk_0xBA3209FB359D3EA4("scr_clown_appears", unk_0x68F4C0EC296D3901(uParam0->f_3, true), unk_0x835730A2D89F6093(uParam0->f_3, 2), 1,5f, 0, 0, 0);
		...
		case 12:
			...
			if (unk_0x3D1053F9EB43B7AD(uParam0->f_3, 220,5318f, -918,4567f, 27,53389f, 211,7581f, -931,4215f, 39,6918f, 2,5f, 0, true, 0))
			{
				uParam0->f_2 = 4;
				return;
			}
		...
		case 9:
			...
			{
				func_411(&(Local_346[iLocal_803]), 3);
				uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_600, iLocal_601));
				uParam0->f_2 = 12;
			}
			break;
		...
		case 14:
			...
			else
			{
				...
				{
					func_552(uParam0->f_3, floor(uParam0->f_6), &iLocal_214);
				}
				else
				{
					unk_0x672BED15BAF1B335(uParam0->f_3);
...
int func_553(var uParam0, char* sParam1, float fParam2, float fParam3, int iParam4)
{
	if (unk_0xB4ECF989E2C1DAC8(uParam0->f_3, sParam1, &(uParam0->f_7), 3))
	{
		if (!*iParam4)
		{
			if (unk_0x8CA9406E01C7EE58(uParam0->f_3, sParam1, &(uParam0->f_7)) >= fParam2 && !unk_0x440C646F2F11A2A1(uParam0->f_3, 736523883, 0))
			{
		...
		{
			if (!unk_0x440C646F2F11A2A1(uParam0->f_3, 736523883, 0))
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, 736523883, -1, true, true);
			}
			*iParam4 = 0;
...
int func_558(int iParam0, var uParam1, float fParam2)
{
	...
	*uParam1 = 0;
	...
	while (iVar0 <= (Local_834 - 1))
	{
		if (unk_0xC844350D5D58C99A(Local_834[iVar0]))
		{
			if (!unk_0x437347B10A200C4B(Local_834[iVar0], 0))
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_834[iVar0]) && !unk_0x28072FDD60CE3A6E(Local_834[iVar0], 1))
				{
					fVar1 = func_556(iParam0, Local_834[iVar0]);
					if (fVar1 < fVar2)
					{
						fVar2 = fVar1;
						*uParam1 = Local_834[iVar0];
					}
				}
			}
		}
...
{
	unk_0xCAB39E12D9493B73(sParam0, sParam1, vParam2, func_459(iParam5));
}
...
void func_564(int iParam0)
{
	...
	if (!Local_834[iParam0].f_7)
	{
		return;
	}
	if (unk_0x437347B10A200C4B(Local_834[iParam0], 0) || unk_0x28072FDD60CE3A6E(Local_834[iParam0], 1))
	{
		if (Local_834[iParam0].f_6 < 5)
		{
			if (unk_0x0361981EE62202D8(Local_834[iParam0], iLocal_548, 0))
			{
			}
			func_75(&iLocal_811);
			Local_834[iParam0].f_8 = unk_0x1C0640BA9A7327B3() + 500;
			Local_834[iParam0].f_6 = 5;
		}
	}
	switch (Local_834[iParam0].f_6)
	{
		case 0:
			Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 + (unk_0x6117725E0134737F() * 512f));
			if (Local_834[iParam0].f_9 < 2f)
			{
				unk_0x4A4806F9D471E491(Local_834[iParam0], false, 0);
			}
			else
			{
				unk_0x4A4806F9D471E491(Local_834[iParam0], true, 0);
				if (Local_834[iParam0].f_9 > 255f)
				{
					Local_834[iParam0].f_9 = 255f;
					unk_0x672BED15BAF1B335(Local_834[iParam0]);
					Local_834[iParam0].f_6 = 1;
				}
				else if (unk_0x0A059E0DB9253280(Local_834[iParam0]))
				{
					func_552(Local_834[iParam0], floor(Local_834[iParam0].f_9), &iLocal_810);
				}
				else
				{
					unk_0x672BED15BAF1B335(Local_834[iParam0]);
		...
		case 1:
			if (unk_0x688A90832774AB83(Local_834[iParam0]))
			{
				Local_834[iParam0].f_6 = 4;
				if (unk_0x0361981EE62202D8(Local_834[iParam0], iLocal_548, 0))
				{
				}
				func_75(&iLocal_811);
		...
		case 2:
			if (func_62(unk_0x16F2683693E537C9()))
			{
				if (func_62(Local_834[iParam0]))
				{
					if (Local_834[iParam0].f_10)
					{
						vVar0 = { 0f, -2,5f, 0f };
					}
					else
					...
					unk_0xEEB67C3D0A71A47B(0, unk_0x68E4ADDDDCD7BDDE(Local_834[iParam0], vVar0), 200f, -1, 0, 0);
					unk_0x75ABDC5F81978924(uVar3);
					unk_0xA3BF0AA5A2608191(Local_834[iParam0]);
					unk_0x78ADC381772E3D54(Local_834[iParam0], uVar3);
					unk_0xF82EA857DA10E0CD(&uVar3);
					Local_834[iParam0].f_6 = 3;
				}
			}
			break;
		
		case 3:
			if (!unk_0x3D1053F9EB43B7AD(Local_834[iParam0], Local_178[0], Local_178[1], Local_178.f_7, 0, true, 0))
			{
				Local_834[iParam0].f_8 = unk_0x1C0640BA9A7327B3() + 500;
				Local_834[iParam0].f_6 = 4;
			}
		...
		case 4:
			unk_0xBC3E304ACAF897E2(Local_834[iParam0], 100416529);
			unk_0xCEE7E5D42799D65A(Local_834[iParam0], 1000, 1, 0);
			Local_834[iParam0].f_8 = unk_0x1C0640BA9A7327B3() + 500;
			Local_834[iParam0].f_6 = 5;
			break;
		
		case 5:
			if (unk_0x1C0640BA9A7327B3() > Local_834[iParam0].f_8)
			{
				if (unk_0x437347B10A200C4B(Local_834[iParam0], 0) || unk_0xEB6A8945D1AC98A1(Local_834[iParam0]))
				{
					Local_834[iParam0].f_8 = unk_0x1C0640BA9A7327B3() + 500;
					Local_834[iParam0].f_9 = 255f;
					Local_834[iParam0].f_6 = 6;
				}
			}
			break;
		...
		case 6:
			if (unk_0x1C0640BA9A7327B3() > Local_834[iParam0].f_8)
			{
				Local_834[iParam0].f_9 = (Local_834[iParam0].f_9 - (unk_0x6117725E0134737F() * 1024f));
				if (Local_834[iParam0].f_9 < 0f)
				{
					Local_834[iParam0].f_9 = 0f;
				}
				func_552(Local_834[iParam0], floor(Local_834[iParam0].f_9), &iLocal_810);
				if (Local_834[iParam0].f_9 <= 0f || !unk_0x0A059E0DB9253280(Local_834[iParam0]))
				{
					Local_834[iParam0].f_7 = 0;
					func_471(&(Local_834[iParam0]));
					Local_834[iParam0].f_6 = 7;
				}
			}
			break;
...
{
	if (Local_834[iParam0].f_1 == iLocal_808)
	{
		if (!unk_0xB4ECF989E2C1DAC8(Local_834[iParam0], sLocal_814, sLocal_815, 3))
		{
			unk_0xC6EB89C59F2AF6B8(Local_834[iParam0], sLocal_814, sLocal_815, 8f, -8f, -1, 1, unk_0x79833B02DBD2A244(0f, 0,5f), 0, 0, 0);
		}
	}
	else if (!unk_0xB4ECF989E2C1DAC8(Local_834[iParam0], sLocal_812, sLocal_813, 3))
	{
		unk_0xC6EB89C59F2AF6B8(Local_834[iParam0], sLocal_812, sLocal_813, 8f, -8f, -1, 1, unk_0x79833B02DBD2A244(0f, 0,5f), 0, 0, 0);
	}
}
...
int func_566(int iParam0)
{
	...
	vVar0 = { unk_0x68F4C0EC296D3901(Local_834[iParam0], false) };
	if (Local_834[iParam0].f_10)
	{
		return 1;
	}
	...
	while (iVar3 < Local_834)
	{
		if (iVar3 != iParam0)
		{
			if (unk_0xC844350D5D58C99A(Local_834[iVar3]))
			{
				if (unk_0x28072FDD60CE3A6E(Local_834[iVar3], 1) || unk_0xEB6A8945D1AC98A1(Local_834[iVar3]))
				{
					if (unk_0x0EB28750412C3A5A(vVar0, unk_0x68F4C0EC296D3901(Local_834[iVar3], false), false) < 20f)
					{
						return 1;
					}
				}
...
void func_593()
{
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		...
		iLocal_799 = unk_0x34460709B9A5160B(unk_0x16F2683693E537C9());
	}
	func_619(0);
	func_617(1);
	...
	switch (iLocal_82)
	{
		...
		case 3:
			if (func_62(uParam0->f_28[0]))
			{
				...
				unk_0xA47B46945FF6DE74(uParam0->f_28[0], vVar6, 1, false, 0, 1);
...
void func_615()
{
	vLocal_818[0] = { 0f, 2f, 0f };
	vLocal_818[1] = { -1f, 1,75f, 0f };
	vLocal_818[2] = { 1,25f, 1,75f, 0f };
	vLocal_818[3] = { 2f, 2,25f, 0f };
	vLocal_818[4] = { -2,25f, 2,5f, 0f };
}
...
void func_616()
{
	...
	while (iVar0 < 15)
	{
		Local_894[iVar0].f_6 = 0;
		iVar0++;
	}
	Local_894[0] = 0;
	Local_894[0].f_1 = { 174,1163f, -979,6599f, 30,0923f };
	Local_894[0].f_4 = 341,3244f;
	Local_894[1] = 0;
	Local_894[1].f_1 = { 184,8053f, -980,3381f, 30,0923f };
	Local_894[1].f_4 = 50,2065f;
	Local_894[2] = 0;
	Local_894[2].f_1 = { 192,9764f, -972,7697f, 30,0923f };
	Local_894[2].f_4 = 32,8447f;
	Local_894[3] = 0;
	Local_894[3].f_1 = { 195,3397f, -989,392f, 30,0923f };
	Local_894[3].f_4 = 2,9484f;
	Local_894[4] = 1;
	Local_894[4].f_1 = { 185,1147f, -917,48f, 29,6923f };
	Local_894[4].f_4 = 146,3272f;
	Local_894[5] = 1;
	Local_894[5].f_1 = { 212,4505f, -945,4181f, 30,6921f };
	Local_894[5].f_4 = 64,489f;
	Local_894[6] = 1;
	Local_894[6].f_1 = { 209,6497f, -926,5642f, 30,6921f };
	Local_894[6].f_4 = 119,3868f;
	Local_894[7] = 1;
	Local_894[7].f_1 = { 197,8188f, -916,9774f, 30,6929f };
	Local_894[7].f_4 = 248,16f;
	Local_894[8] = 1;
	Local_894[8].f_1 = { 168,9134f, -916,1412f, 30,6921f };
	Local_894[8].f_4 = 245,16f;
	Local_894[8].f_6 = 1;
	Local_894[9] = 1;
	Local_894[9].f_1 = { 220,6332f, -952,7892f, 30,0924f };
	Local_894[9].f_4 = 63,294f;
	Local_894[9].f_6 = 1;
	Local_894[10] = 1;
	Local_894[10].f_1 = { 226,5618f, -909,9656f, 30,6922f };
	Local_894[10].f_4 = 119,7046f;
	Local_894[10].f_6 = 1;
	Local_894[11] = 2;
	Local_894[11].f_1 = { 229,2508f, -904,2552f, 30,6922f };
	Local_894[11].f_4 = 56,9046f;
	Local_894[12] = 2;
	Local_894[12].f_1 = { 205,4078f, -898,1343f, 30,1166f };
	Local_894[12].f_4 = 144,7924f;
	Local_894[13] = 2;
	Local_894[13].f_1 = { 222,5962f, -855,839f, 30,1816f };
	Local_894[13].f_4 = 204,4446f;
	Local_894[13].f_6 = 1;
	Local_894[14] = 2;
	Local_894[14].f_1 = { 182,0917f, -886,959f, 30,1164f };
	Local_894[14].f_4 = 236,4387f;
	Local_894[14].f_6 = 1;
}
...
{
	Var0 = 2;
	vVar8 = { func_519(Param0[1] - Param0[0]) * Vector(fParam8, fParam8, fParam8) };
...
void func_626()
{
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		unk_0x0B42C743EF171FF5(unk_0x16F2683693E537C9(), iLocal_799);
	}
	func_35(&iLocal_212);
	func_72(1);
	unk_0xADCFE13F048E110C(unk_0x16F2683693E537C9());
...
int func_629(var uParam0, int iParam1)
{
	...
	switch ((*uParam0)[iParam1])
	{
		...
		case 8:
			if (unk_0x67C1D9E5B91B2E37(uParam0[iParam1]->f_5))
			{
				unk_0x11CCD0ACA866C6C5(uParam0[iParam1]->f_5, false);
			}
			break;
