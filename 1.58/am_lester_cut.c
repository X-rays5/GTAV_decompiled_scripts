		...
		case 0:
			...
			if (unk_0x0347CCBD719C8ADC(uLocal_438) && func_193())
			{
				...
				if (!unk_0xF68107C40359970C(uLocal_260))
				{
					...
					unk_0xA8685678DDA27FC3(uLocal_260, -668482597, 0, 0, 0);
...
int func_197()
{
	...
	if (bLocal_429)
	{
		if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 1274.547f, -1720.694f, 53.6807f) > 500f)
		{
			if (unk_0xE5965CDF24F93A9F(iLocal_260))
			{
				uVar0 = iLocal_260;
...
{
	func_255(func_256(Param0), Param0);
	func_253(0, -1, 0);
