		...
		if (unk_0xC92F9F18E020B461() || iLocal_60 > 1)
		{
			...
			if (iLocal_60 > 0)
			{
				...
				if (unk_0x55B23FE400FCEA6B(iLocal_87, 0))
				{
					...
					{
						if (SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x70453F7DF40780A5(uLocal_588)) > 100f)
						{
							func_400();
						}
					}
					...
					{
						unk_0x9972EFADA7A2A47D(2, uLocal_578, 1862763509);
						if (func_1(iLocal_82))
						{
		...
		while (iVar36 < Var1.f_4)
		{
			if (unk_0xA5404CDF63BADF48(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					...
					{
						(*uParam0)[func_135(Var16.f_2)] = Var16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_135(Var16.f_2)] = func_128(iParam1, Var16.x, func_135(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_228()
{
	if (func_1(iLocal_87))
	{
		...
		{
			if (SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_62) > (fLocal_196 + 120f))
			{
				func_2(2);
				func_420();
			}
...
void func_237()
{
	if (iLocal_71 == 0 && func_1(iLocal_87))
	{
		if (iLocal_68 == 1)
		{
			if ((!func_214() && SYSTEM::TIMERA() > 8000) && unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), iLocal_87, 12f, 12f, 5f, 0, 0, 0))
			{
				unk_0xA888F8CC04F25CC8(&uLocal_186);
...
void func_240()
{
	if (unk_0x803592456AE579B3(uLocal_588))
	{
		...
		bLocal_69 = true;
		fLocal_196 = SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_62);
	...
	{
		func_242(2);
		if (SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_240) > 150f)
		{
			func_241();
		}
	}
	...
	switch (iLocal_61)
	{
		case 0:
			if ((func_1(iLocal_82) && func_1(iLocal_83)) && unk_0x55A0C756C4A8220C(iLocal_92, 0))
			{
				...
				unk_0xA8685678DDA27FC3(iLocal_82, -1115154469, 0, 0, 0);
				iLocal_61 = 1;
			}
			else
			{
...
int func_321()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_329())
		{
			return 0;
		}
	}
...
void func_334()
{
	...
	unk_0x9972EFADA7A2A47D(5, uLocal_578, 1862763509);
	switch (iLocal_203)
	{
		case 1:
...
int func_345()
{
	...
	{
		if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_56) < (75f * 75f))
		{
			return 1;
		}
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_329())
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_371(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_421(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_403(iParam0))
	{
		...
		{
			func_422(func_426(iParam0, iParam1), Local_56.x, Local_56.f_1);
		}
