...
void func_1()
{
	...
	if (iLocal_29 != -1 && func_20(iLocal_29))
	{
		...
		if (SYSTEM::VDIST2(Var3, Var0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			if (bVar6)
			{
				unk_0x7886A9E2DC3CF65B(unk_0x2E87280918B16506(func_13(iLocal_29)), Var3.x, Var3.f_1, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
