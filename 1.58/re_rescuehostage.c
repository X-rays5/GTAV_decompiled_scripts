			...
			switch (iLocal_47)
			{
				...
				case 3:
					...
					else
					{
						...
						if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_48) > 5625f && !unk_0x0318E2EE6FB4563F(Local_48, 10f))
						{
							func_28();
						}
					}
...
int func_58(int iParam0)
{
	...
	if (bVar1)
	{
		...
		{
			if (SYSTEM::VDIST(unk_0x6B62510F212526DC(iParam0, 1), func_59(unk_0x9E2D6C50374FCFA9())) < 8f)
			{
				return 1;
			}
		}
...
bool func_64()
{
	...
	if (bVar1)
	{
		...
		fVar11 = unk_0xD12EFCAB87804BED(Var2.x, Var2.f_1);
...
int func_89()
{
	...
	{
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_96())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_135(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
