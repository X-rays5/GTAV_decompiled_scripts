...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
		{
			...
			unk_0x2EE5FFF3E1E3400D((Var0.x - 2000f), (Var0.f_1 - 2000f), (Var0.x + 2000f), (Var0.f_1 + 2000f));
...
int func_34()
{
	...
	if (!func_55())
	{
		...
		while (iVar0 < 3)
		{
			if (!unk_0xF68107C40359970C(uLocal_85[iVar0]))
			{
				if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), unk_0x6B62510F212526DC(uLocal_85[iVar0], 0)) < 400f)
				{
					if (!iLocal_62)
					{
						if (iLocal_83 == 2)
					...
					else if (!iLocal_64)
					{
						...
						{
							unk_0x9972EFADA7A2A47D(5, uLocal_97, 1862763509);
					...
					else if (!func_55())
					{
						...
						if (SYSTEM::TIMERA() > 5000 && !unk_0x645F244ECDDEF6CF(uLocal_85[iVar0]))
						{
							func_54(&uLocal_99, 1);
							func_53(&uLocal_99, 1, uLocal_85[iVar0], "BorderPatrol", 0, 1);
							if (func_35() == 0)
...
int func_56()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0xF68107C40359970C(uLocal_85[iVar0]))
		{
			if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), unk_0x6B62510F212526DC(uLocal_85[iVar0], 0)) < 62500f)
			{
				return 1;
			}
			else
			...
			if (iLocal_64 || iLocal_65)
			{
				if (unk_0xD5C6B5E3B93A5EDC(uLocal_85[iVar0], 0))
				{
					if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0) && !iLocal_67[iVar0])
					{
						...
						if (!iLocal_65)
						{
							SYSTEM::WAIT(unk_0x5853B15F78E1A265(400, 800));
						}
						else
						{
							SYSTEM::WAIT(0);
		...
		else
		{
			if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				if (!unk_0x0318E2EE6FB4563F(Var0, 5f))
				{
					...
					unk_0x9972EFADA7A2A47D(3, uLocal_97, 1862763509);
					iVar4 = 0;
					while (iVar4 < 3)
					{
...
int func_73()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_80())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_105(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
