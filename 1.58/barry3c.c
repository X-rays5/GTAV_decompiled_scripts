...
void func_276(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_281(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_315(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
			...
			switch (iLocal_424)
			{
				...
				case 3:
					if (unk_0x320D1840B6DAA1CC() > iLocal_421)
					{
						...
						{
							unk_0x979FC7400A5D0CD2(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0x57973ADDF2BFAA90(uLocal_426, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_425 * 250)) / 1000f));
