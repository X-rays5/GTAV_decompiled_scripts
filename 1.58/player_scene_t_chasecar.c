...
int func_2()
{
	...
	if (!unk_0xACC32B78196FBC2A(&Local_507))
	{
		...
		fVar3 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(uLocal_451[iVar1], 0), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0));
...
int func_3(char[4] cParam0, var uParam1, int iParam2)
{
	...
	fVar5 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(uLocal_451[*iParam2], 0));
	if (fVar5 > (30f * 30f))
	{
		if (fVar5 > (150f * 150f))
		{
...
var func_72(int iParam0, int iParam1)
{
	...
	if (!unk_0x55B23FE400FCEA6B(uParam1, 0))
	{
		...
		if (unk_0xD5C6B5E3B93A5EDC(iParam1, 0))
		{
			...
			Var9.x = unk_0x760B4486916D9B39(uVar13);
...
void func_89()
{
	...
	unk_0x9972EFADA7A2A47D(3, uLocal_491, 1862763509);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_467[iVar0] != 0)
...
void func_90()
{
	...
	switch (iLocal_272)
	{
		...
		default:
			...
			Local_472[0 /*3*/] = { Vector(0f, SYSTEM::COS(fVar12), SYSTEM::SIN(fVar12)) * FtoV(unk_0xC4EAB25A108C2429(15f, 25f)) };
			fLocal_485[0] = unk_0xC4EAB25A108C2429(-5f, 5f);
			iLocal_490 = 0;
			iLocal_456[0] = joaat("a_m_y_genstreet_01");
			iLocal_456[1] = 0;
