...
void func_39(int iParam0, struct<3> Param1)
{
	...
	if (!func_42(Param1))
	{
		...
		{
			unk_0xA99AD9DEE4794C48(iParam0, Param1, -1, -687903391);
		}
	}
...
void func_54()
{
	...
	unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_305);
	unk_0x9972EFADA7A2A47D(5, iLocal_305, 1862763509);
	unk_0x9972EFADA7A2A47D(5, iLocal_305, joaat("COP"));
	switch (iVar0)
	{
		case 0:
			unk_0x9972EFADA7A2A47D(5, 1862763509, 296331235);
			unk_0x9972EFADA7A2A47D(1, iLocal_305, 296331235);
			unk_0x9972EFADA7A2A47D(1, 296331235, iLocal_305);
			break;
		
		case 1:
			unk_0x9972EFADA7A2A47D(5, 1862763509, -1033021910);
			unk_0x9972EFADA7A2A47D(1, iLocal_305, -1033021910);
			unk_0x9972EFADA7A2A47D(1, -1033021910, iLocal_305);
			break;
		
		case 2:
			unk_0x9972EFADA7A2A47D(5, 1862763509, 1782292358);
