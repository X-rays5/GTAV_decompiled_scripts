...
void func_38()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_42() < 2)
		{
			if (unk_0xE2D0C323A1AE5D85(Local_101[iVar2 /*4*/].f_1, 1))
			{
				func_39(unk_0xA1087A6350CD9244(iVar2));
				unk_0xCED9E32812D6C7C7(&(Local_90.f_1), 1);
			}
			if (unk_0xE2D0C323A1AE5D85(Local_101[iVar2 /*4*/].f_1, 4))
			{
				func_39(func_11());
				unk_0xCED9E32812D6C7C7(&(Local_90.f_1), 7);
			}
			if (unk_0xE2D0C323A1AE5D85(Local_101[iVar2 /*4*/].f_1, 0))
			{
				unk_0xCED9E32812D6C7C7(&(Local_90.f_1), 0);
			}
			if (unk_0xE2D0C323A1AE5D85(Local_101[iVar2 /*4*/].f_1, 2))
			{
				unk_0xCED9E32812D6C7C7(&(Local_90.f_1), 4);
			}
		}
		...
		{
			if (unk_0xE2D0C323A1AE5D85(Local_101[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
...
void func_105()
{
	switch (func_705())
	{
		...
		case 2:
			if (!unk_0xE2D0C323A1AE5D85(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1, 3))
			{
				func_474(0, func_10());
				func_377();
				func_106();
...
void func_106()
{
	...
	if (!unk_0xE2D0C323A1AE5D85(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1, 3))
	{
		...
		{
			unk_0xCED9E32812D6C7C7(&(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1), 3);
			return;
		}
		if (func_376())
		{
		...
		{
			func_107(151, unk_0xE2D0C323A1AE5D85(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1, 1), &Var0, 0);
		}
		unk_0xCED9E32812D6C7C7(&(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1), 3);
	}
}
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = unk_0xA188D1127A77C942(uVar1, 10, -1, 0, -1, func_136(iParam0));
			if (iVar57 > iVar56)
			{
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_202())
			{
				...
				iVar7 = func_336(unk_0x9E2D6C50374FCFA9(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
			...
			else if (func_285(0))
			{
				...
				iVar22 = func_336(func_11(), Var15, *uParam3);
				if (Var15.f_1 == 1)
				{
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 28)
						{
							...
							while (iVar52 < 32)
							{
								if (func_9(unk_0xA1087A6350CD9244(iVar52), 0, 1))
								{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_535(iVar35) && func_531(iVar35, iParam2)) && func_9(iVar35, 0, 1))
							{
								...
								*(uParam4[iVar52 /*13*/]) = { func_255(iVar35) };
								...
								if (func_512(iParam5))
								{
									func_511(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
								else
								{
									func_511(iVar35, uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
						...
						{
							iVar35 = unk_0xA1087A6350CD9244(iVar52);
							if (func_9(iVar35, 0, 1) && !unk_0xE2D0C323A1AE5D85(iVar49, iVar35))
							{
								iVar35 = unk_0xA1087A6350CD9244(iVar52);
							}
							else
							...
							if (func_535(iVar35))
							{
								if (func_9(unk_0xA1087A6350CD9244(iVar52), 0, 1))
								{
									...
									*(uParam4[iVar52 /*13*/]) = { func_255(iVar35) };
									...
									uParam3->f_38[iVar44 /*2*/].f_1 = iVar53;
									func_491(iVar35, unk_0x61042CA2A97BBB69(iVar35), uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
	...
	if (func_479(&(uParam2->f_19)) || bParam5)
	{
		...
		else
		{
			...
			if (!unk_0xE2D0C323A1AE5D85(uParam2->f_33, 0))
			{
				...
				unk_0x7ED668FC4CB0F4C4(fVar7);
				if (func_579(bVar6, uParam0, 0))
				{
					func_544(uParam0, 0, 0);
					uVar4 = func_576(iParam1, &(Global_4718592.f_86757), bParam4);
					Var0 = { func_574(iParam1) };
					if (bParam4)
					{
						func_571(uParam0, uVar4, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 27)
					{
					...
					else if (iParam1 == 28)
					{
						...
						func_558(uParam0, sVar9, func_559(), -1);
					}
					else if (func_497())
					{
						uParam2->f_34 = Global_1836354;
						func_571(uParam0, uVar4, &Var0, 1, -1, Global_1836354, 1);
					}
					else if (bVar5)
					{
						iVar8 = func_553(iParam1);
						uParam2->f_34 = Global_1836354;
						func_571(uParam0, uVar4, "", 0, iVar8, func_552(), 1);
					}
					else
					{
						iVar8 = func_553(iParam1);
						func_571(uParam0, uVar4, &Var0, 1, iVar8, -1, 1);
					}
...
void func_604(int iParam0, struct<3> Param1, var uParam4, float fParam5, float fParam6, int iParam7)
{
	...
	fVar0 = SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), Param1);
	...
	if (fVar0 < fParam5)
	{
		...
		if (!*uParam4 && func_9(unk_0x9E2D6C50374FCFA9(), 1, 1))
		{
			*uParam4 = 1;
			if (func_640(iParam0))
			{
	...
	else
	{
		...
		if (*uParam4 && func_9(unk_0x9E2D6C50374FCFA9(), 1, 1))
		{
			*uParam4 = 0;
			...
			if (iParam7 && !func_506(unk_0x9E2D6C50374FCFA9()))
			{
		...
		if ((unk_0xE5965CDF24F93A9F(Var0) && unk_0x9044EDB8A7BF67B4(Var0)) && unk_0x28AA31872A651BC7(Var0) == unk_0x407E03586628E458(func_37()))
		{
			if (Var0.f_5)
			{
				if (unk_0xE5965CDF24F93A9F(Var0.f_1) && unk_0x9044EDB8A7BF67B4(Var0.f_1))
				{
					...
					{
						unk_0xCED9E32812D6C7C7(&(Local_101[unk_0xF1354995C6159A78() /*4*/].f_1), 1);
					}
				}
			}
		}
...
{
	Local_101[unk_0xF1354995C6159A78() /*4*/].f_2 = iParam0;
}
...
int func_705()
{
	return Local_101[unk_0xF1354995C6159A78() /*4*/].f_2;
}
