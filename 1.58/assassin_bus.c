...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_142(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_324(var uParam0, int iParam1)
{
	...
	if (!unk_0xF68107C40359970C(iVar3))
	{
		...
		unk_0xC64B6E13A6A7F517(iVar3, Var0.x, Var0.f_1, fVar8, 1, 0, 0, 1);
...
void func_325(var uParam0, int iParam1)
{
	...
	if (unk_0xE5965CDF24F93A9F(iVar0) && !unk_0x55B23FE400FCEA6B(iVar0, 0))
	{
		...
		if (iParam1 == 0)
		{
			...
			unk_0xA8685678DDA27FC3(iVar0, -668482597, 0, 0, 0);
		}
		else if (iParam1 == 1)
		{
			unk_0xABFC84F5C4943D7B(iVar0, "move_m@casual@d", 1048576000);
...
int func_334(int iParam0)
{
	...
	fVar0 = unk_0x82FE2343F8BDFF0B(unk_0xE2D3D51028F0428A());
	fVar1 = (Local_2250[iParam0 /*30*/].f_4 - 180f);
	if (SYSTEM::COS(unk_0x48053974ED6F63CE((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1704 = false;
		iVar2 = 0;
	}
...
void func_395(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_400(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
void func_453(var uParam0, var uParam1)
{
	...
	unk_0x84A65E2E9CFB6A77((Local_1780.x - 40f), (Local_1780.f_1 - 40f), (Local_1780.f_2 - 40f), (Local_1780.x + 40f), (Local_1780.f_1 + 40f), (Local_1780.f_2 + 40f), 0, 1);
	if (unk_0xE5965CDF24F93A9F(uParam1->f_1))
	{
		if (!bLocal_1707)
		{
