	...
	switch (iLocal_55)
	{
		...
		case 4:
					...
					case 5:
						if (func_149())
						{
							if (!unk_0xF68107C40359970C(uLocal_91[0]))
							{
								...
								unk_0x9972EFADA7A2A47D(255, uLocal_100, 1862763509);
								func_146();
							}
							if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
							{
				...
				switch (iLocal_170)
				{
					...
					case 2:
						...
						if (!func_4())
						{
							if (!unk_0xF68107C40359970C(uLocal_91[0]))
							{
								if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), uLocal_91[0], 20f, 20f, 20f, 0, 1, 0) && SYSTEM::TIMERA() > 9500)
								{
			...
			if (iLocal_54 == 1)
			{
				if (!unk_0xF68107C40359970C(uLocal_91[0]) && !unk_0x55B23FE400FCEA6B(iLocal_94, 0))
				{
					if (SYSTEM::TIMERA() > 50000 || unk_0xAB793EA186AB8DAA(iLocal_94, -1, 0) == uLocal_91[0])
					{
...
void func_172()
{
	if (!iLocal_61)
	{
		...
		unk_0x9972EFADA7A2A47D(5, uLocal_100, 1862763509);
...
int func_181()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_192())
		{
			return 0;
		}
	}
