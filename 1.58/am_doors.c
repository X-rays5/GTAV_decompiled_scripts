		...
		if (unk_0x987A5F1E1A67E3C0(func_33(unk_0x9E2D6C50374FCFA9()), Var3.f_1, 1) < 150f)
		{
			...
			if (bVar2)
			{
				if (fLocal_425[iVar0] != 1f)
				{
					...
					unk_0x99C46337F53EECAD(Var3, 1);
					unk_0x1B3E1454BD86FCE6(Var3, fLocal_425[iVar0], 0, 0);
					unk_0x7E15597AA5F53F9A(Var3, 0, 0, 1);
				}
			}
			else if (fLocal_425[iVar0] != 0f)
			{
				...
				unk_0x99C46337F53EECAD(Var3, 1);
				unk_0x1B3E1454BD86FCE6(Var3, fLocal_425[iVar0], 0, 0);
				unk_0x7E15597AA5F53F9A(Var3, 1, 0, 1);
			}
		}
		iVar0++;
	}
...
int func_47(int iParam0, int iParam1)
{
	...
	while (iVar15 < 40)
	{
		if (*iParam0 < 315)
		{
			...
			{
				if (!unk_0xEC32121F2E3875C8(Var0))
				{
					return 0;
				}
			}
...
void func_50(struct<15> Param0, int iParam15)
{
	if (Param0 != 0)
	{
		unk_0x5DD86AC785D8E188(Param0, Param0.f_2, Param0.f_3, 0, iParam15, Param0.f_11);
		if (Param0.f_9)
		{
			unk_0x240EFBC99404843A(Param0, 1);
		}
		if (Param0.f_12 != 0f)
		{
			unk_0x1B3E1454BD86FCE6(Param0, Param0.f_12, 0, iParam15);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
			{
				unk_0x7E15597AA5F53F9A(Param0, Param0.f_8, iParam15, 0);
			}
		}
		if (Param0.f_10)
		{
			unk_0xEEFF17C042A8CB2C(Param0, 1);
		}
		if (Param0.f_14 != 0f)
		{
			unk_0x1F0B6D1966E55DDB(Param0, Param0.f_14, iParam15, 0);
		}
		if (Param0.f_13 != 0f)
		{
			unk_0x32DBCEB580393767(Param0, Param0.f_13, iParam15, 0);
		}
	}
}
