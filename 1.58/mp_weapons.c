...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	unk_0x0EAC086D816D5CB1(iParam0, &Var13);
	Var13.f_2 = unk_0x982237EB68628E6A(iParam0);
	bVar31 = false;
	iVar30 = 0;
	while (iVar30 <= 8)
	{
		if (uParam1->f_1[iVar30] == 0 && unk_0x072699BD07AF0086(iParam0))
		{
			if (func_94(iParam0))
			{
			...
			while (iVar29 <= 35)
			{
				...
				if (iVar28 != 0)
				{
					...
					{
						if (unk_0x8DC1B37FAB5462C2(iVar28, &Var18))
						{
							Var23 = (Var23 + Var18);
