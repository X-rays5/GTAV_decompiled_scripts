...
void func_36()
{
	...
	else if (!iLocal_246 && !bLocal_244)
	{
		...
		{
			unk_0x9972EFADA7A2A47D(5, uLocal_68, 1862763509);
			if (!unk_0xF68107C40359970C(iLocal_70))
			{
				unk_0x03A927199A2DFE46(iLocal_70);
		...
		if (unk_0x8F41785F110B0DA0(unk_0xE2D3D51028F0428A(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			if (!unk_0x5007A91D57C39FFC(unk_0xE2D3D51028F0428A(), 6))
			{
				...
				else
				{
					...
					unk_0x0B47872E9D74882C(0, unk_0xE2D3D51028F0428A(), unk_0xE2D3D51028F0428A(), 2f, 0, 2.3f, 4f, 1, 1, -957453492);
				...
				if (!unk_0xF68107C40359970C(iLocal_69))
				{
					...
					unk_0xA888F8CC04F25CC8(&uLocal_75);
					unk_0x98DB2ABD53B8D70B(0, Local_64, unk_0xE2D3D51028F0428A(), 2f, 0, 0f, 4f, 1, 512, 0, -957453492, 20000);
...
int func_120()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_131())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_151(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
