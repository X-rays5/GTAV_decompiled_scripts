...
int func_66(float fParam0)
{
	...
	if (iLocal_1035 < 10)
	{
		...
		while (iVar4 <= 4)
		{
			...
			{
				fVar6 = SYSTEM::VDIST2(Var1, unk_0x6B62510F212526DC(Local_1207[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else if (iLocal_1035 < 12)
	{
		...
		while (iVar4 <= 5)
		{
			...
			{
				fVar6 = SYSTEM::VDIST2(Var1, unk_0x6B62510F212526DC(Local_1361[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
	...
	else
	{
		...
		while (iVar4 <= 3)
		{
			...
			{
				fVar6 = SYSTEM::VDIST2(Var1, unk_0x6B62510F212526DC(Local_1515[iVar4 /*19*/], 1));
				if (fVar6 < fVar5)
				{
					fVar5 = fVar6;
...
void func_142(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_162();
		unk_0xCA4C0AD3CAFF651E(0.5f, (fVar1 - (func_165((2f - 0.5f)) - 0.001388889f)), fVar6, func_156(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_141((fVar11 / (0.6f * func_165(25f))), 0f, 1f);
					func_162();
					unk_0xCA4C0AD3CAFF651E(0.5f, (fVar1 + func_165((2f * 0.5f))), fVar6, func_156(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_165((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_165((25f * 0.2f)));
...
int func_146(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (unk_0x2E87280918B16506(&cVar16) != 0)
	{
		...
		Var37.x = (Var37.x * (func_147(iParam0) / fVar34));
...
void func_209(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	if (unk_0xE5965CDF24F93A9F(iParam0))
	{
		...
		if (bParam5)
		{
			unk_0xC64B6E13A6A7F517(iParam0, Var0.x, Var0.f_1, (Var0.f_2 + fParam3), 1, 0, 0, 1);
		}
		else
		{
			unk_0xC64B6E13A6A7F517(iParam0, Var0.x, Var0.f_1, (Var0.f_2 - fParam3), 1, 0, 0, 1);
			...
			if (bLocal_1756)
			{
				if (!unk_0xF68107C40359970C(Local_1515[3 /*19*/]))
				{
					if (!unk_0x301C07463034C65F(Local_1515[3 /*19*/]))
					{
						...
						{
							unk_0x913E191F1F726271(Local_1515[3 /*19*/], iLocal_1806, -1, -957453492);
						}
					}
				}
		...
		if (iVar1 == 0)
		{
			if (!unk_0xF68107C40359970C(Local_1515[iVar1 /*19*/]))
			{
				if (unk_0xE9E8955A780DDA01())
				{
					...
					unk_0x98DB2ABD53B8D70B(0, -141.3603f, -946.2284f, 268.135f, iLocal_1806, 2f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
					unk_0xC1A74225341AA9FB(0, iLocal_1806, 0, 16);
					unk_0xC963A45B50851768(uVar0);
...
void func_270(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_275(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_309(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_333()
{
	...
	while (iVar0 <= 1)
	{
		if (!unk_0xF68107C40359970C(Local_1476[iVar0 /*19*/]))
		{
			...
			unk_0x98DB2ABD53B8D70B(0, Var2, iLocal_1806, 2f, 0, 0.5f, 0f, 1, 0, 0, -957453492, 20000);
			unk_0xC1A74225341AA9FB(0, iLocal_1806, 0, 16);
	...
	while (iVar0 <= 5)
	{
		if (!unk_0xF68107C40359970C(Local_1361[iVar0 /*19*/]))
		{
			if (unk_0x174CED88B97C78D9(Local_1361[iVar0 /*19*/], 242628503) != 1)
			{
				...
				if (iVar0 == 0)
				{
					unk_0x98DB2ABD53B8D70B(0, -162.7042f, -999.0336f, 113.1382f, unk_0xE2D3D51028F0428A(), 2f, 0, 1.5f, 1.5f, 0, 0, 0, -957453492, 20000);
				}
				unk_0xC1A74225341AA9FB(0, iLocal_1806, 0, 16);
				unk_0xC963A45B50851768(uVar1);
			...
			if (!func_30(&uLocal_1990))
			{
				...
				if (!unk_0xF68107C40359970C(iLocal_1815))
				{
					...
					if (!unk_0xD5C6B5E3B93A5EDC(iLocal_1815, 0))
					{
						...
						{
							unk_0x0B47872E9D74882C(iLocal_1815, iLocal_1806, iLocal_1806, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
						}
						else
						{
...
void func_393()
{
	...
	unk_0x9972EFADA7A2A47D(5, iLocal_1980, 1862763509);
	unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_1980);
}
