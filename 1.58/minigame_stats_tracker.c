...
void __EntryFunction__()
{
	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				unk_0x2B7E260B913761AA(uLocal_46, "SET_MISSION_TITLE", ScriptParam_0, ScriptParam_0.f_1, 0, 0, 0);
				...
				{
					unk_0x2E6FA6BFC49A1AA8(uLocal_46, "SET_TOTAL", SYSTEM::TO_FLOAT(ScriptParam_0.f_5), ScriptParam_0.f_5.f_1, -1f, -1f, -1f, ScriptParam_0.f_5.f_2, 0, 0, 0, 0);
				}
				unk_0x3C6414EC6636D573(uLocal_46, "SET_MEDAL", SYSTEM::TO_FLOAT(ScriptParam_0.f_5), -1082130432, -1082130432, -1082130432, -1082130432);
				...
				while (iVar0 < ScriptParam_0.f_66 + 1)
				{
					...
					if (ScriptParam_0.f_9[iVar0 /*7*/].f_2 == 4)
					{
						...
						unk_0x28594D0D61DB1278(SYSTEM::FLOOR((ScriptParam_0.f_9[iVar0 /*7*/].f_3 * 1000f)), 6);
