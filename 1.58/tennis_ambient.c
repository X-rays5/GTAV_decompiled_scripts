...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Var0.f_189.f_55) < 5625f || ScriptParam_0.f_1)
			{
		...
		if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
		{
			if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Var0.f_189.f_55) > (fVar1712 * fVar1712))
			{
				func_306(&Var0);
			}
		}
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_164(uParam0);
				func_172(uParam0, (SYSTEM::TO_FLOAT(iVar0) * unk_0x51109C28352EC9A3()));
			}
		}
		if (!func_171(*uParam2))
		{
...
void func_236(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((func_75(uParam0) == 75 && unk_0xE5965CDF24F93A9F(uParam1->f_247)) && unk_0x5C5B446AD691DEA2(uParam1->f_247)) && SYSTEM::VDIST2(uParam0->f_37, func_283(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_58(uParam0, 256);
	...
	switch (func_146(&(uParam0->f_4)))
	{
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				...
				if (((!unk_0xF68107C40359970C(func_265(uParam0)) && !SYSTEM::VDIST2(uParam0->f_37, Var3) <= (0f * 0f)) && !func_228(&(uParam0->f_4), 4)) && !func_104(uParam0, 1024))
				{
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, Var3) <= (0f * 0f) || unk_0x174CED88B97C78D9(func_265(uParam0), 2106541073) == 7)
				{
