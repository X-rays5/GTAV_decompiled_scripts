...
void func_40()
{
	...
	iVar1 = SYSTEM::CEIL((unk_0x51109C28352EC9A3() * 1000f));
...
int func_107()
{
	...
	{
		fVar0 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_94976 = -1;
			return 1;
...
int func_118()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (SYSTEM::VDIST2(func_108(181, 0), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > 40000f)
		{
			return 1;
		}
	}
