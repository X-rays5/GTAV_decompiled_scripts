...
void func_30()
{
	...
	if (unk_0x876B1078E90C91CB(uLocal_328))
	{
		...
		func_32();
		iVar10 = SYSTEM::FLOOR((unk_0x3BF65CF27F6CFBBE(2, 218) * 127f));
		iVar11 = SYSTEM::FLOOR((unk_0x3BF65CF27F6CFBBE(2, 219) * 127f));
		iVar12 = SYSTEM::FLOOR((unk_0x3BF65CF27F6CFBBE(2, 220) * 127f));
		iVar13 = SYSTEM::FLOOR((unk_0x3BF65CF27F6CFBBE(2, 221) * 127f));
		...
		unk_0x3FB84450A94CB528(uLocal_328, unk_0xE2D3D51028F0428A(), Var7.x, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
	}
	else
	{
...
void func_36(struct<3> Param0, float fParam3)
{
	...
	if (unk_0x55A0C756C4A8220C(iLocal_306, 0))
	{
		...
		unk_0xC64B6E13A6A7F517(iLocal_306, Param0.x, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
		...
		switch (iLocal_50)
		{
			...
			case 1:
				...
				if (unk_0x55A0C756C4A8220C(iLocal_306, 0))
				{
					...
					if (unk_0xF8805443C3DB6256(Local_320.x, Local_320.f_1, Local_323.x, Local_323.f_1))
					{
...
int func_142()
{
	...
	if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_149())
		{
			return 0;
		}
	}
...
void func_182()
{
	if (iLocal_318)
	{
		unk_0x2EE5FFF3E1E3400D(Local_320.x, Local_320.f_1, Local_323.x, Local_323.f_1);
	}
}
...
void func_185()
{
	...
	unk_0x9972EFADA7A2A47D(1, uLocal_309, 1862763509);
}
