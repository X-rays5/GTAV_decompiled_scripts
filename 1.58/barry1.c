...
void func_70(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 4:
			...
			func_80(unk_0xE2D3D51028F0428A(), SYSTEM::FLOOR(fLocal_208), &iLocal_186);
			break;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_311(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_344(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (unk_0xA37204C64473B324(sLocal_340))
			{
				unk_0x9364FA34F6E72A61(sLocal_340, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(unk_0x320D1840B6DAA1CC()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_436(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_438(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
	...
	switch (uParam0->f_1)
	{
		case 1:
			if (unk_0x320D1840B6DAA1CC() > uParam0->f_7)
			{
				...
				uParam0->f_1 = 2;
				uParam0->f_15 = 0f;
				unk_0x8B9AD14C7D42CC13(uParam0->f_2, SYSTEM::FLOOR(uParam0->f_15), 0);
			}
			break;
		...
		case 5:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0x320D1840B6DAA1CC()) * 255) / SYSTEM::TO_FLOAT(450));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
		...
		case 8:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0x320D1840B6DAA1CC()) * 255) / SYSTEM::TO_FLOAT(1000));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
				...
				if (unk_0x987A5F1E1A67E3C0(uParam0->f_27, Var2, 1) <= 0.7f)
				{
					...
					if (unk_0x48053974ED6F63CE((uParam0->f_27.f_2 - Var2.f_2)) < 1f)
					{
						...
						if (unk_0x320D1840B6DAA1CC() > uParam0->f_8)
						{
							...
							uParam0->f_8 = (unk_0x320D1840B6DAA1CC() + SYSTEM::ROUND((IntToFloat(iLocal_854) * 1.25f)));
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!unk_0x1B5C8EE302FC0D1E(Var9) && !func_437(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
int func_572(int iParam0)
{
	...
	while (iVar0 < unk_0x501053EBAB36DB66())
	{
		if (unk_0x4CD88D794E108BEC(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0x1B5C8EE302FC0D1E(Var1) || func_437(Var1.f_1))
				{
					return 0;
				}
			}
