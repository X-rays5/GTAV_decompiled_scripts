								...
								if (Global_2688985.f_87[iVar14] == 0)
								{
									if (!unk_0xE2D0C323A1AE5D85(*uParam1, iVar1))
									{
										if (!unk_0xF68107C40359970C(uVar11))
										{
											...
											{
												Var7 = { func_10(iVar1) };
												fVar4 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(uVar11, 1), Var7);
												if (fVar4 > fVar6)
												{
													fVar5 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(uVar13, 1), Var7);
													if (fVar5 > fVar6)
													{
														iVar2 = iVar1;
														bVar0 = true;
		...
		case 1:
			...
			else
			{
				...
				if (!unk_0xE2D0C323A1AE5D85(Global_1853128[iVar3 /*888*/].f_143, 2))
				{
					if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
					{
						if ((SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), func_10(iVar1)) < (15f * 15f) || (iVar0 == -1 && func_142(25f))) || func_141(1101004800, 1117126656))
						{
							if (unk_0x12DD4A0B247D9B4D(uParam0->f_4))
							{
				...
				else
				{
					if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
					{
						if (!unk_0xE2D0C323A1AE5D85(uParam0->f_1, 2))
						{
							if ((!unk_0xE2D0C323A1AE5D85(iLocal_202, 18) && SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), func_10(iVar1)) > (35f * 35f)) || (unk_0xE2D0C323A1AE5D85(iLocal_202, 18) && SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), func_10(iVar1)) > (90f * 90f)))
							{
								unk_0xB0550BC91B0159D6(&(uParam0->f_1), 0);
								unk_0xB0550BC91B0159D6(&(Global_1853128[iVar3 /*888*/].f_143), 2);
		...
		while (iVar0 < 32)
		{
			...
			if (func_305(iVar1, 1, 1))
			{
				if (iVar1 != unk_0x9E2D6C50374FCFA9())
				{
					if (func_289(iVar1))
					{
						if (SYSTEM::VDIST2(Var2, unk_0x6B62510F212526DC(unk_0x407E03586628E458(iVar1), 1)) < (fParam0 * fParam0))
						{
							return 1;
						}
					}
