...
{
	return unk_0xD132EDDA78FF4A51(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1852971 != func_60())
	{
		if (unk_0x7B0A672B0283F03E("base_corridor_seats", Global_1852971, 1, 0))
		{
			return 0;
		}
