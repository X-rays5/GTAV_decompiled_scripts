...
void func_18()
{
	if (unk_0xE2D0C323A1AE5D85(iLocal_105, 2) && unk_0xE2D0C323A1AE5D85(iLocal_105, 0))
	{
		if (func_85(iLocal_109))
		{
			...
			{
				if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(iLocal_109, 1), Local_110) >= 100f)
				{
					func_68(0);
				}
			}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_47(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_136()
{
	if (!func_77(Local_110, 0f, 0f, 0f, 0) && func_135() != func_137())
	{
		if (func_76(unk_0xE2D3D51028F0428A(), Local_110, 60f))
		{
			if (func_85(func_74(25)))
			{
				if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(func_74(25), 1), Local_110) >= 100f)
				{
					func_68(0);
				}
			}
...
void func_160(int iParam0, var uParam1)
{
	...
	func_161(&uLocal_1273, Local_44, unk_0xE2D3D51028F0428A(), Local_44.f_1, 0, 1);
...
int func_184()
{
	...
	while (iVar6 <= 4)
	{
		...
		{
			if (SYSTEM::VDIST2(Local_106, unk_0x6B62510F212526DC(uVar0[iVar6], 1)) <= 16f)
			{
				return 1;
			}
		}
...
int func_201()
{
	...
	fVar1 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Global_95012[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_13())
		{
...
int func_205()
{
	if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_13())
		{
			func_69(28);
	...
	else if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_13())
		{
			func_69(29);
