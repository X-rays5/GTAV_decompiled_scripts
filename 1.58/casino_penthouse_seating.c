...
int func_41(int iParam0)
{
	switch (iParam0)
	{
		...
		case 6:
		case 7:
			if (Global_100026.f_374 == 486476725)
			{
				return 1;
			}
			break;
...
int func_66()
{
	...
	if (func_82(unk_0x9E2D6C50374FCFA9()) && unk_0xA829C9A2767AC8EF())
	{
		return 1;
	}
	if (func_80() != 0)
...
void func_89(var uParam0)
{
	...
	if (uParam0->f_13 > 2)
	{
		...
		func_90(unk_0x9E2D6C50374FCFA9(), 1, 0, 0);
	}
	...
	else
	{
		...
		if (unk_0x0D01086B38EC256F(iParam0) && (unk_0x3583A42587543334(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_99(unk_0x9E2D6C50374FCFA9(), 0) && !func_98()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_94(uVar27) && !unk_0xE2ED785E8DB4D3FF(uVar27))
				{
					if (!bVar22)
					{
...
void func_103()
{
	unk_0xD9B114A8D3A8319F(32, 0, func_114());
	func_112(0, -1, 0);
	func_111();
	func_104();
	if (unk_0x9315DBF7D972F07A())
