	...
	while (iVar19 < 2)
	{
		switch (iVar19)
		{
			case 0:
				...
				fVar14 = unk_0xD12EFCAB87804BED(Var10.x, Var10.f_1);
				fVar15 = (fVar16 + 180f);
				if (fVar15 > 360f)
				{
					fVar15 = (fVar15 - 360f);
				...
				if (SYSTEM::VDIST(unk_0x6DB7FBD602C51670(*uParam1, *uParam2, fVar17, 0f, 0f), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) > SYSTEM::VDIST(unk_0x6DB7FBD602C51670(*uParam1, *uParam2, -fVar17, 0f, 0f), unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)))
				{
					fVar17 = -fVar17;
				}
