	...
	while (true)
	{
		...
		if ((unk_0x320D1840B6DAA1CC() - iVar6) > 100)
		{
			if (!unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
			{
				...
				{
					if (SYSTEM::VDIST2(Var0, unk_0x6B62510F212526DC(iLocal_79[iVar3], 0)) >= IntToFloat((iVar5 * iVar5)) && unk_0x4D21C9FB671ED18F(iLocal_79[iVar3]))
					{
...
void func_19()
{
	...
	unk_0x9972EFADA7A2A47D(5, 1862763509, iLocal_145);
	unk_0x9972EFADA7A2A47D(5, iLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
...
void func_20()
{
	...
	unk_0x33B3A4723D5DBD35(5, 1862763509, iLocal_145);
	unk_0x33B3A4723D5DBD35(5, iLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
