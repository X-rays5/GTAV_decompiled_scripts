...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		unk_0x84A65E2E9CFB6A77(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0x06B8FBA220C6488C(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x7A997A0A971D305F(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0 == 34)
	{
		uLocal_97 = func_245();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, unk_0x6B62510F212526DC(Var0.f_35[1], 1), 1056964608))
				{
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_191(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			if (!func_146())
			{
				if (((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_191(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f)
				{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_127(unk_0xE2D3D51028F0428A())) && func_191(unk_0xE2D3D51028F0428A(), Param1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(unk_0xE2D3D51028F0428A(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!unk_0xACC32B78196FBC2A(sParam1))
		{
			...
			{
				if (func_191(unk_0xE2D3D51028F0428A(), Param2, 1) <= 100f)
				{
					func_199(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_191(unk_0xE2D3D51028F0428A(), Param2, 1) > 120f)
				{
					func_201(iParam0);
				}
			}
...
int func_207(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	...
	if (unk_0x48053974ED6F63CE((Param0 - Param3)) <= fParam6)
	{
...
void func_209()
{
	...
	{
		unk_0x6D690024C2BB1053("Joe", 1, 0, 0, 0);
		unk_0x6D690024C2BB1053("Josef", 0, 0, 0, 0);
		unk_0x6D690024C2BB1053("Josef", 1, 0, 0, 0);
	}
}
...
void func_211(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !unk_0xFCF559C8631ABED7(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_212(iParam2) && !unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 25f))
					{
						unk_0x529D306014D3C29A(iParam0, unk_0xE2D3D51028F0428A(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_212(iParam2) || unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x49D97B076E3590AC(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xE5965CDF24F93A9F(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0xE2D3D51028F0428A(), uParam0->f_35[iVar0]))
							{
...
int func_220(int iParam0, float fParam1)
{
	...
	{
		if (func_231(iParam0) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iParam0))
		{
...
{
	return func_222(iParam0, unk_0xE2D3D51028F0428A(), fParam1, 1, 250, 7);
}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0x6B62510F212526DC(iParam1, 1) - unk_0x6B62510F212526DC(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0x6B62510F212526DC(uParam0, 1)) };
...
var func_245()
{
	return unk_0x2915D98110F23A29(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, 0, 1, 1, 1);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_35[1]))
			{
				...
				unk_0xD584204572DF0440(uParam0->f_35[1], 0);
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_41[1]))
			{
				...
				unk_0x9A97DC6DBC7B223D(uParam0->f_41[1], uParam0->f_28[0], unk_0xB897FCFCFA664B38(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (unk_0xE5965CDF24F93A9F(uParam0->f_35[0]))
			{
				...
				unk_0x2EC6505629D78CCE(uParam0->f_35[0], 14f);
				unk_0x7CD708DEB04F8474(iVar0[0], 1);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x8FB472886552D737("rcmminute1");
			unk_0x7A997A0A971D305F(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			unk_0x7A997A0A971D305F(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_255(&iVar0) || !unk_0x6F940C2636C076AD("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_28[1]))
			{
				if (func_250(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0xD9D122A54FFE62B8(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
			...
			if (!unk_0xE5965CDF24F93A9F(uParam0->f_35[1]))
			{
				...
				unk_0xF838539C61C30896(uParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (unk_0x6F940C2636C076AD("rcmminute1"))
			{
				if (func_127(uParam0->f_28[0]))
				{
					if (!unk_0xFCF559C8631ABED7(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x03A927199A2DFE46(uParam0->f_28[0]);
						unk_0x49D97B076E3590AC(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_127(uParam0->f_28[1]))
				{
					...
					unk_0x49D97B076E3590AC(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xD6A76BAB45A4B460(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_259(int iParam0, var uParam1)
{
	if (unk_0xE5965CDF24F93A9F(uParam0))
	{
		unk_0x909FF2867C7E0CAE(iParam0, 0);
		unk_0x3B2646B62E7BBE11(iParam0, 2);
		unk_0x7CD708DEB04F8474(uParam1, 1);
		unk_0x2EABFF5EFCB7E6CF(iParam0, 0, 0);
		unk_0x1B3814E11B085F5E(iParam0, 1);
	}
}
...
void func_273(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0x84A65E2E9CFB6A77(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
