...
char* func_46()
{
	...
	StringCopy(&cVar0, unk_0x717DD0ABF4A97737(func_47(Local_43.x)), 32);
...
void func_121()
{
	iLocal_105 = (iLocal_105 + SYSTEM::ROUND((unk_0x51109C28352EC9A3() * 1000f)));
	if (iLocal_105 > 5000)
	{
	...
	if (iLocal_103 != iLocal_104)
	{
		...
		unk_0x6F06CF0E9AB02847();
		fLocal_85 = SYSTEM::VDIST(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0), Global_111953);
...
void func_180()
{
	...
	if (unk_0x12DD4A0B247D9B4D(Local_43.x))
	{
		Var0 = { unk_0x1A3931A61B3223A2(Local_43.x) };
