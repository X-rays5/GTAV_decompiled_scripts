			...
			if (unk_0xE5965CDF24F93A9F(iLocal_68))
			{
				if (!unk_0x55B23FE400FCEA6B(iLocal_68, 0))
				{
					if (unk_0xF6F5D18EF8EAB859(unk_0xE2D3D51028F0428A(), iLocal_68, 0))
					{
						...
						unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Var0.x, Var0.f_1, (Var0.f_2 + 4f), 1, 0, 0, 1);
						bVar4 = true;
					}
				}
...
int func_18(int iParam0, struct<3> Param1, float fParam4)
{
	...
	Var34.x = (unk_0x48053974ED6F63CE((Var31.x - Var28.x)) / 2f);
	Var34.f_1 = (unk_0x48053974ED6F63CE((Var31.f_1 - Var28.f_1)) / 2f);
	Var34.f_2 = (unk_0x48053974ED6F63CE((Var31.f_2 - Var28.f_2)) / 2f);
	Var0[0 /*3*/] = { Param1 };
	Var0[1 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, -Var34.x, -Var34.f_1, -Var34.f_2) };
	Var0[2 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, Var34.x, -Var34.f_1, -Var34.f_2) };
	Var0[3 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, Var34.x, Var34.f_1, -Var34.f_2) };
	Var0[4 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, -Var34.x, Var34.f_1, -Var34.f_2) };
	Var0[5 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, -Var34.x, -Var34.f_1, Var34.f_2) };
	Var0[6 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, Var34.x, -Var34.f_1, Var34.f_2) };
	Var0[7 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, Var34.x, Var34.f_1, Var34.f_2) };
	Var0[8 /*3*/] = { unk_0x6DB7FBD602C51670(Param1, fParam4, -Var34.x, Var34.f_1, Var34.f_2) };
...
void func_36()
{
	...
	switch (iLocal_64)
	{
		...
		case 2:
			...
			fVar4 = (fVar4 + 500f);
			unk_0xC64B6E13A6A7F517(unk_0xE2D3D51028F0428A(), Var0.x, Var0.f_1, fVar4, 1, 0, 0, 1);
