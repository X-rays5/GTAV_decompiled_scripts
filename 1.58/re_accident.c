...
void func_14()
{
	...
	if (iLocal_222 == 1)
	{
		...
		fVar9 = (SYSTEM::TO_FLOAT((unk_0x320D1840B6DAA1CC() - iLocal_224)) / fLocal_300);
		...
		case 0:
			...
			if ((unk_0x70F555A7CCF10659("CONSTRUCTION_ACCIDENT_1", false, -1) && unk_0x6F940C2636C076AD("re@construction")) && func_104(&Local_537))
			{
				if (unk_0x55A0C756C4A8220C(iLocal_319, 0))
				{
					...
					unk_0x0EC3A788F361170A(iLocal_317, -1143637011);
					unk_0x5458163CF0744E90(-1143637011, 24);
					unk_0x5458163CF0744E90(-1143637011, 47);
					unk_0x5458163CF0744E90(-1143637011, 62);
					unk_0x5458163CF0744E90(-1143637011, 138);
					unk_0x5458163CF0744E90(-1143637011, 56);
					iLocal_339 = unk_0x0E536D72AB30F4C8(joaat("prop_generator_01a"), Local_526.x, (Local_526.f_1 + 0.5f), (Local_526.f_2 - 0.25f), 1, 1, 0);
...
int func_121()
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()) && !unk_0xF68107C40359970C(unk_0xE2D3D51028F0428A()))
	{
		...
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_132())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_152(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
