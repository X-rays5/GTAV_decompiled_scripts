...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_31(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		if (!func_45(35))
		{
			if (unk_0xE2D0C323A1AE5D85(Global_112915.f_18574[iParam0 /*6*/], 2) && !unk_0xE2D0C323A1AE5D85(Global_112915.f_18574[iParam0 /*6*/], 3))
			{
				...
				{
					if (SYSTEM::VDIST2(Var0.f_6, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1)) < 81f)
					{
						sVar64 = "";
