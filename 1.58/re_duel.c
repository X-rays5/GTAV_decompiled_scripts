			...
			switch (iLocal_155)
			{
				...
				case 2:
					if ((func_225(Local_90[3 /*4*/]) && func_225(Local_49[0 /*5*/])) && func_94())
					{
						...
						if (Var0.x <= 0f && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 953.5052f, 2665.587f, 38.61237f, 955.0941f, 2716.872f, 50.67046f, 71f, 0, 1, 0))
						{
					...
					if (((!func_152(8) && func_225(Local_90[4 /*4*/])) && func_225(Local_49[1 /*5*/])) && func_94())
					{
						...
						if (Var0.x >= 0f && unk_0xD132EDDA78FF4A51(unk_0xE2D3D51028F0428A(), 1110.712f, 2695.67f, 36.77993f, 1109.166f, 2665.531f, 48.50355f, 71f, 0, 1, 0))
						{
				...
				case 8:
					...
					if (SYSTEM::TIMERA() > 20000 && func_80(unk_0xE2D3D51028F0428A(), Local_129, 1) >= 150f)
					{
						iLocal_155++;
					}
					break;
...
void func_110()
{
	...
	unk_0x9972EFADA7A2A47D(255, 1862763509, iLocal_171);
	unk_0x9972EFADA7A2A47D(1, iLocal_171, iLocal_171);
	unk_0x9972EFADA7A2A47D(255, iLocal_171, 1862763509);
...
int func_138()
{
	...
	{
		if (SYSTEM::VMAG2(unk_0xC35FBD95659582C4(unk_0xE2D3D51028F0428A())) > 1369f && !func_146())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_169(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
