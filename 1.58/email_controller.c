...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!Global_43783 && unk_0x320D1840B6DAA1CC() > Global_43147)
		{
			iVar127 = 0;
			while (iVar127 < 122)
			{
...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(unk_0x3B81B9627E7885CF(&cVar2, &cVar2, 0, 2, unk_0xAEF70623D03F7B02(func_4(iParam1)), 0));
		}
		else
		{
			func_3(unk_0x3B81B9627E7885CF("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, unk_0xAEF70623D03F7B02(func_4(iParam1)), 0));
		}
		switch (Global_19954)
		{
			case 0:
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_28(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		...
		{
			if (unk_0xE2D0C323A1AE5D85(iParam0, func_55()) && !unk_0xE2D0C323A1AE5D85(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!unk_0xE2D0C323A1AE5D85(iParam0, func_55()))
		{
			return 0;
		}
	}
	...
	if (iParam3 != -1)
	{
		if (func_36(unk_0xE2D3D51028F0428A(), iParam3, 0))
		{
			return 0;
		}
	}
...
float func_38(var uParam0)
{
	if (func_41(uParam0))
	{
		...
		{
			return (func_39(unk_0xE2D0C323A1AE5D85(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
