...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_177(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
int func_199()
{
	...
	switch (iLocal_410)
	{
		...
		case 4:
			...
			{
				fVar0 = (1f - func_203((SYSTEM::TO_FLOAT((unk_0x320D1840B6DAA1CC() - iLocal_2135 + 1500)) / 3000f), 0f, 1f));
...
void func_325()
{
	...
	unk_0x9972EFADA7A2A47D(5, iLocal_395, 1862763509);
	unk_0x9972EFADA7A2A47D(1, 1862763509, iLocal_394);
	unk_0x9972EFADA7A2A47D(1, iLocal_394, 1862763509);
