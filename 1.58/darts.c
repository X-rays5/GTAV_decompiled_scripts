...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0xA8505DB724F74B62(Var477, Var477.f_18, Var477.f_21, Var477.f_24, Var477.f_24, 2);
		}
		...
		if (!unk_0xF68107C40359970C(uLocal_263[0]))
		{
			...
			switch (Var0)
			{
				...
				case 1:
					if (SYSTEM::TIMERA() > 500 && !unk_0x32DCDA1B2F8A0694(unk_0xE2D3D51028F0428A()))
					{
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_35();
		unk_0xCA4C0AD3CAFF651E(0.5f, (fVar1 - (func_39((2f - 0.5f)) - 0.001388889f)), fVar6, func_29(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_560 == 4)
		{
			if (iVar17 == (uParam0->f_580 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_39(25f))), 0f, 1f);
					func_35();
					unk_0xCA4C0AD3CAFF651E(0.5f, (fVar1 + func_39((2f * 0.5f))), fVar6, func_29(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_39((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_39((25f * 0.2f)));
...
void func_249(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			else if (SYSTEM::TIMERA() > unk_0x5853B15F78E1A265(1250, 2500))
			{
				func_292(&(uParam0->f_422), &(uParam0->f_249));
				func_289(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), 0);
			}
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else
	{
		...
		*uParam0 = unk_0x0E536D72AB30F4C8(uParam0->f_1, Local_79, 0, 0, 0);
		...
		fVar2 = unk_0xD12EFCAB87804BED((Var7.x - Var10.x), (Var7.f_1 - Var10.f_1));
		fVar2 = (fVar2 - 180f);
...
int func_305(var uParam0, var uParam1, bool bParam2)
{
	...
	fVar11 = unk_0xD12EFCAB87804BED((Var3.x - Var6.x), (Var3.f_1 - Var6.f_1));
	fVar11 = (fVar11 - 180f);
	fVar9 = 90f;
...
int func_308(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch (*uParam2)
	{
		...
		case 1:
			if (SYSTEM::TIMERB() > 3000 || unk_0xF09A4F413B0D30EB(2, 201))
			{
				func_309();
				*uParam2 = 0;
				return 1;
