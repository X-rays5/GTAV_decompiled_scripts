...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_173())
		{
			...
			{
				fLocal_31 = SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_32);
			}
			func_171(&iVar1);
			func_31(&iVar2);
			if (iLocal_47 > 3)
		...
		case 4:
			...
			if (!unk_0x55B23FE400FCEA6B(iLocal_54, 0) && !unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
			{
				if (unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 0))
				{
					...
					if (iVar2 == iLocal_54)
					{
						if (SYSTEM::VDIST2(Local_55, unk_0x6B62510F212526DC(iLocal_28, 1)) < 100f)
						{
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_40(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
void func_96(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_101(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
void func_161()
{
	...
	if (!unk_0xE5965CDF24F93A9F(iLocal_29))
	{
		if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
		{
			if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), Local_32) < 2500f)
			{
