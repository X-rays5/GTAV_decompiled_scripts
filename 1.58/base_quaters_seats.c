...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 1:
			if (func_51(uParam0))
			{
				uParam0->f_29.f_6 = unk_0x320D1840B6DAA1CC();
				func_52(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_50(unk_0xE2D3D51028F0428A(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				...
				{
					if ((unk_0x320D1840B6DAA1CC() - uParam0->f_29.f_6) > 150)
					{
		...
		case 5:
			...
			{
				uParam0->f_29.f_1 = unk_0x497E09037A63D346(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_29.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1.5f, 0);
				unk_0x60E9DD146055C13E(uParam0->f_29.f_1);
				uParam0->f_29.f_8.f_4 = unk_0x320D1840B6DAA1CC();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = unk_0x57736A7B8965A88A(uParam0->f_29.f_1);
			if (unk_0xCE2C78E9FC0B01E3(uVar42))
			{
				if (unk_0x54DE1614490C2A83(uVar42) >= 1f)
				{
					...
					func_40(uParam0, &sVar16);
					uParam0->f_29.f_1 = unk_0x497E09037A63D346(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_29.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					unk_0x60E9DD146055C13E(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 7:
			unk_0x0B92578FB47DA084(uParam0->f_29.f_1);
			func_52(uParam0, 8);
			break;
		
		case 8:
			uVar43 = unk_0x57736A7B8965A88A(uParam0->f_29.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((unk_0x320D1840B6DAA1CC() - uParam0->f_29.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_29.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		if ((uParam0->f_29.f_4 == 6 && !unk_0xD9E56EC8ED04E45E(unk_0xE2D3D51028F0428A(), -1322051853)) && !func_8(&(uParam0->f_29), 12))
		{
			if (fVar3 >= 0.35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!unk_0xF1EC2C71FD1371B8() && !func_8(&(uParam0->f_29), 0)) && !func_8(&(uParam0->f_29), 4)) && !func_21()) && !func_19(1)) && uParam0->f_29.f_8.f_2 != 3)
			{
...
void func_24(var uParam0)
{
	...
	uParam0->f_29.f_1 = unk_0x497E09037A63D346(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
	func_41(uParam0, &sVar0);
	unk_0xFF47C397A9269A1A(unk_0xE2D3D51028F0428A(), uParam0->f_29.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	unk_0x60E9DD146055C13E(uParam0->f_29.f_1);
	func_9(&(uParam0->f_29.f_5));
	func_52(uParam0, 8);
}
...
int func_43(var uParam0)
{
	...
	switch (uParam0->f_29.f_8)
	{
		...
		default:
			iVar0 = unk_0x5853B15F78E1A265(0, func_14(uParam0->f_29.f_8));
	}
	return iVar0;
}
...
int func_47(var uParam0)
{
	...
	while (iVar0 < unk_0x5D79167FED95F0B0())
	{
		if (unk_0x81F82FFBED0CACCA(unk_0x54F800F95142C750(iVar0)))
		{
			...
			if ((iVar1 != unk_0x9E2D6C50374FCFA9() && func_48(iVar1, 1, 1)) && func_50(unk_0x407E03586628E458(iVar1), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		uParam0->f_29.f_7 = unk_0x8142A6539DDC180F();
	}
	...
	else if ((unk_0x8142A6539DDC180F() - uParam0->f_29.f_7) < 5)
	{
		unk_0x54E818A233B540D4(unk_0xE2D3D51028F0428A(), func_55(uParam0));
	}
}
...
void func_56(var uParam0)
{
	...
	func_57(&(uParam0->f_29), 1, unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0));
	func_57(&(uParam0->f_29), 3, unk_0xD5C6B5E3B93A5EDC(unk_0xE2D3D51028F0428A(), 1));
	func_57(&(uParam0->f_29), 0, func_36(0));
	func_57(&(uParam0->f_29), 2, unk_0x81BBCAF9FE3B469D(unk_0xE2D3D51028F0428A()));
}
...
{
	return unk_0xD132EDDA78FF4A51(uParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1852971 != func_60())
	{
		if (unk_0x7B0A672B0283F03E("base_quaters_seats", Global_1852971, 1, 0))
		{
			return 0;
		}
...
{
	return unk_0xE2D0C323A1AE5D85(Global_1853128[iParam0 /*888*/].f_267.f_281.f_1, 0);
}
