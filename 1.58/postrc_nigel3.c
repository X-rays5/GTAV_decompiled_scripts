...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x320D1840B6DAA1CC() - iLocal_187) > 5000 && unk_0x0747E45CFF1F74AA(uLocal_188, unk_0xE2D3D51028F0428A(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0xE68645525D451A8B(uLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0x320D1840B6DAA1CC() - iLocal_187) > 12000 && SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
{
	iLocal_187 = unk_0x320D1840B6DAA1CC();
	func_21(&uLocal_22, 2, unk_0xE2D3D51028F0428A(), "TREVOR", 0, 1);
...
int func_22()
{
	...
	fVar0 = 200f;
	if (SYSTEM::VDIST2(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xBC7D3EDF3455BC35(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_24()
{
	if (unk_0xE5965CDF24F93A9F(uLocal_188))
	{
		if (!unk_0xF68107C40359970C(uLocal_188))
		{
			return 1;
		}
	}
...
int func_31()
{
	...
	{
		iVar17 = unk_0x46951D3186547C7A(unk_0xE2D3D51028F0428A(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0xE5965CDF24F93A9F(uVar0[iVar18]))
			{
				if (unk_0x15CAA6D7B11F1A7C(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0x2D58A6131679D82C(uVar0[iVar18], 1, 1);
...
void func_32()
{
	...
	if (unk_0xE5965CDF24F93A9F(uLocal_188))
	{
		unk_0xB3822DB3D538C8F3(&uLocal_188);
	}
