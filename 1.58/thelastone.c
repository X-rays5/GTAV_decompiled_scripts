...
void func_2(bool bParam0)
{
	if (Local_286.f_4 == 1)
	{
		...
		{
			if (unk_0xE5965CDF24F93A9F(Local_286))
			{
				if (func_469(Local_286))
				{
					unk_0x50274A7EACA3133A(Local_286, 0);
					unk_0x0407CF7EFEE35240(Local_286, 0);
				}
...
void func_279(int iParam0, var uParam1)
{
	...
	if (!unk_0xF68107C40359970C(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xCB497F652ACB2DD3(iParam0, func_284(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_318(unk_0xE2D0C323A1AE5D85(iParam0, 31), -1, 1)) + 2011;
}
...
int func_367()
{
	...
	else
	{
		...
		{
			Local_291 = unk_0x0A7322C6D0E1A985(iLocal_1069, Local_1085, 1, 1, 0);
			if (unk_0xE5965CDF24F93A9F(Local_291))
			{
				unk_0x8CE3D365F064F69E(Local_291, Local_1088, 2, 1);
				unk_0xF1A23B343DFEDFD0(iLocal_1069);
				unk_0x5C65DDDC219B3AA5(Local_291, true);
			}
			else
			{
				return 0;
...
void func_411()
{
	...
	if (Local_215.f_1 == 0)
	{
		...
		if (func_448())
		{
			...
			if (func_469(Local_286))
			{
				unk_0xD6A76BAB45A4B460(Local_286, 185, 1);
				unk_0x3F990964E4A5669A(Local_286, 0);
			}
	...
	if (Local_215.f_1 == 1)
	{
		...
		else if ((func_432(Local_286, 0, 70f, 170f, 1, 0, 0, 0) || !func_385(Local_286, Local_1108, 1.5f)) || unk_0x32DCDA1B2F8A0694(Local_286))
		{
			unk_0xFF4BEB6CFF55A013(Local_286, -2065892691);
			unk_0xC1A74225341AA9FB(Local_286, unk_0xE2D3D51028F0428A(), 0, 16);
			func_403();
			func_251(6);
			Local_215.f_9 = 3;
			Local_215.f_1 = 3;
		...
		else
		{
			...
			else if (iLocal_864 == 0)
			{
				...
				{
					func_238(&uLocal_888, 4, Local_286, "HUNTER", 0, 1);
					if (unk_0x77A43AFA9AAEC041(unk_0xE2D3D51028F0428A(), Local_286, 25f, 25f, 25f, 0, 1, 0))
					{
			...
			else if (iLocal_856 == 0)
			{
				...
				if (func_18())
				{
					if (func_413(unk_0xE2D3D51028F0428A(), Local_286) > 25f)
					{
						func_403();
					}
				}
...
void func_415()
{
	if (iLocal_862)
	{
		if (!func_335(Local_225.f_35[0]) && func_413(unk_0xE2D3D51028F0428A(), Local_286) < 25f)
		{
			func_403();
...
void func_419()
{
	if (func_469(Local_286) && func_469(unk_0xE2D3D51028F0428A()))
	{
		if (func_392(unk_0xE2D3D51028F0428A(), Local_286, 50f, 1))
		{
			...
			if (unk_0x72F6AE51B7E34865(unk_0xE2D3D51028F0428A(), Local_286))
			{
...
void func_439()
{
	...
	{
		if (unk_0xFCF559C8631ABED7(Local_286, sLocal_1072, "hunter_leadout", 3))
		{
			if (unk_0xD01FAFCE275C94F3(Local_286, sLocal_1072, "hunter_leadout") > 0.9f)
			{
				if (unk_0x6F940C2636C076AD(sLocal_1072))
				{
					...
					unk_0x8ACADA903FCAA42F(Local_286, uVar0);
	...
	if (Local_286.f_4 == 0)
	{
		if (bParam0)
		{
			...
			if (func_469(Local_225.f_28[0]))
			{
				...
				unk_0xC64B6E13A6A7F517(Local_286, Local_1104, 1, 0, 0, 1);
				unk_0xBBF86885619695CE(Local_286, fLocal_1107);
			}
			else
			{
				Local_286 = unk_0xA8D58C3AADA2C41C(26, iLocal_1064, Local_1104, fLocal_1107, 1, 1);
			...
			if (func_447(Local_286, 1862763509, iLocal_1061))
			{
				if (func_469(unk_0xE2D3D51028F0428A()))
				{
					unk_0xF30F15F203736DE4(Local_286, unk_0xE2D3D51028F0428A(), -1, 1024, 2);
				}
			}
		}
		func_446();
		...
		if (func_469(Local_225.f_28[0]))
		{
			if (unk_0x6F2E1326DB60D575("Hunter", 0))
			{
				...
				if (func_447(Local_286, 1862763509, iLocal_1061))
				{
					if (unk_0x6F940C2636C076AD(sLocal_1072))
					{
						unk_0x49D97B076E3590AC(Local_286, sLocal_1072, "hunter_leadout", 1000f, -8f, -1, iLocal_1075, 0, 0, 0, 0);
					}
				}
			}
		}
