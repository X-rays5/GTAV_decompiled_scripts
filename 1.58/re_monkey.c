...
int func_57()
{
	...
	else
	{
		...
		if (unk_0x0152AA00FA3130F1(joaat("u_m_m_streetart_01")))
		{
			...
			func_58(1);
			unk_0xFF4BEB6CFF55A013(iLocal_50, 1862763509);
	...
	if (func_50(iLocal_50))
	{
		...
		switch (iLocal_55)
		{
			...
			case 5:
				...
				if (!unk_0xBC7D3EDF3455BC35(iLocal_50) && SYSTEM::VDIST2(Var2, unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0)) > 2500f)
				{
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xE5965CDF24F93A9F(uParam0) && unk_0xE5965CDF24F93A9F(uParam1))
	{
		...
		return SYSTEM::VDIST2(unk_0x6B62510F212526DC(iParam0, 0), unk_0x6B62510F212526DC(iParam1, 0)) <= fVar0;
	}
	return 0;
}
