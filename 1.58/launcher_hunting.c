...
void __EntryFunction__()
{
	...
	iLocal_94 = unk_0xB8DEE91181C30E65(joaat("weapon_sniperrifle"));
	iLocal_95 = unk_0x2597F123290B0413(joaat("component_at_scope_large"));
	iLocal_96 = unk_0x2597F123290B0413(joaat("component_at_ar_supp_02"));
	...
	if (unk_0x4B34601C5C56F3EE(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_112002[Var0 /*10*/].f_9 != -1)
			{
				...
				func_272(&(Global_112002[Var0 /*10*/].f_9));
			}
		}
		func_260(&Var0, 1);
	}
	...
	unk_0x7A997A0A971D305F(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_197(&Var0, 1))
		...
		{
			Var67 = { unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 0) };
		}
		if (Var0 == 25)
		{
			...
			{
				unk_0xCAC4D1050F2E6899(unk_0xE2D3D51028F0428A(), 3f);
			}
		}
		if (func_169(&Var0, 0) && unk_0x48053974ED6F63CE((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0xE2D3D51028F0428A()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x320D1840B6DAA1CC() - iParam0->f_60) > iParam8) && func_188(unk_0xE2D3D51028F0428A(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_198(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
					...
					if (unk_0x6F940C2636C076AD(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_200(uParam1))
								{
									unk_0x246C656F8E525DC7(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									unk_0x246C656F8E525DC7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								unk_0x246C656F8E525DC7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
						...
						{
							unk_0x246C656F8E525DC7(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_200(uParam1) || !unk_0xFCF559C8631ABED7(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_199(iParam2) && !unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 25f))
					{
						unk_0x529D306014D3C29A(iParam0, unk_0xE2D3D51028F0428A(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x987A5F1E1A67E3C0(unk_0x6B62510F212526DC(unk_0xE2D3D51028F0428A(), 1), unk_0x6B62510F212526DC(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				{
					unk_0x246C656F8E525DC7(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					unk_0x246C656F8E525DC7(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_199(iParam2) || unk_0x2E7F5417D4F4DD69(iParam0, unk_0xE2D3D51028F0428A(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x49D97B076E3590AC(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					...
					{
						unk_0x246C656F8E525DC7(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
			...
			if (unk_0xE5965CDF24F93A9F(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_206(unk_0xE2D3D51028F0428A(), uParam0->f_35[iVar0]))
							{
...
int func_209(int iParam0, float fParam1)
{
	...
	{
		if (func_220(iParam0) || unk_0x8BF92A6D56A911EB(unk_0x9E2D6C50374FCFA9(), iParam0))
		{
...
{
	return func_211(iParam0, unk_0xE2D3D51028F0428A(), fParam1, 1, 250, 7);
}
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_217(unk_0x6B62510F212526DC(iParam1, 1) - unk_0x6B62510F212526DC(iParam0, 1)) };
	...
	{
		Var3 = { func_217(unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 5f, 0f) - unk_0x6EA486FF6D815B4B(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_217(Param1 - unk_0x6B62510F212526DC(uParam0, 1)) };
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_243(&iVar0) || !unk_0x6F940C2636C076AD("rcmhunting2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!unk_0xE5965CDF24F93A9F(uLocal_100))
			{
				iLocal_100 = unk_0xBF59603E8A18FEB0(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
				unk_0x0B46DBCE80AD9DE5(iLocal_100, joaat("component_at_scope_large"));
				unk_0x0B46DBCE80AD9DE5(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0x574E2A23F0F76E35(Local_97, 1f, iLocal_94, 0))
			{
				unk_0x8CE3D365F064F69E(iLocal_100, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
int func_244(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_243(&iVar0) || !func_245(&(uParam0->f_48))) || !unk_0x6F940C2636C076AD("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
