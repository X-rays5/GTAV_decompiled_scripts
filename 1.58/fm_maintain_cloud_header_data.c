...
void func_63(var uParam0, bool bParam1)
{
	...
	else if (unk_0x1D0D99ADC275C523(iVar2, "cam") == 6)
	{
		...
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59 = SYSTEM::TO_FLOAT(unk_0xE6A0AFEBB87CC96C(iVar95, "x"));
		}
		else
		{
		...
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_1 = SYSTEM::TO_FLOAT(unk_0xE6A0AFEBB87CC96C(iVar95, "y"));
		}
		else
		{
		...
		{
			Global_1036842.f_33[iVar3 /*88*/].f_59.f_2 = SYSTEM::TO_FLOAT(unk_0xE6A0AFEBB87CC96C(iVar95, "z"));
		}
		else
		{
...
void func_227(var uParam0, bool bParam1)
{
	...
	if (Global_794709.f_4[uParam0->f_9 /*88*/].f_65 == 6 && !bParam1)
	{
		if (Global_1039641.f_684 < 85)
		{
			...
			{
				Global_1039641.f_512[Global_1039641.f_684] = SYSTEM::TO_FLOAT(unk_0xE6A0AFEBB87CC96C(iVar2, "rad"));
			}
			else
			{
