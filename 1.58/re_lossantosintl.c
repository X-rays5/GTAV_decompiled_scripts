	...
	switch (iLocal_83)
	{
		...
		case 2:
			...
			if (unk_0xE5965CDF24F93A9F(uLocal_54) && !unk_0x55B23FE400FCEA6B(uLocal_54, 0))
			{
				if (!unk_0xE896049AD1887FF0(uLocal_54))
				{
					if ((unk_0x4D21C9FB671ED18F(uLocal_54) && !unk_0x0318E2EE6FB4563F(-1602.086f, -2674.039f, 12.9444f, 50f)) && SYSTEM::VDIST2(Var0, unk_0x6B62510F212526DC(uLocal_54, 1)) > 62500f)
					{
						iLocal_83 = 1;
					}
				}
