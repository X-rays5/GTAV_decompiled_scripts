...
void func_12(char* sParam0, var uParam1, char* sParam2)
{
	...
	if (!func_53(uParam1->f_22, 0f, 0f, 0f, 0))
	{
		...
		unk_0x02B222EADC9DC566(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 0, 0, 0, 0, 0, 0, 0);
		unk_0x7A997A0A971D305F(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 1, 0, 0, 0);
	}
	if (!unk_0x55B23FE400FCEA6B(unk_0xE2D3D51028F0428A(), 0))
	{
...
int func_57(struct<3> Param0, var uParam3, int iParam4, int iParam5)
{
	if (unk_0x3583A42587543334(unk_0x9E2D6C50374FCFA9()))
	{
		...
		while ((!unk_0xC13E0CBA57F5B9D6() && !func_58()) && SYSTEM::TIMERA() < 1500)
		{
			SYSTEM::WAIT(0);
		}
