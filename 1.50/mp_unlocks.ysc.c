...
void func_3(int iParam0, bool bParam1)//Position - 0x5EF
{
    ...
    if (iParam0 == 2)
    {
        if (bParam1)
        {
            unk_0x3B76114EC84D5812(&Global_140800, iParam0);
        }
        else
        {
            unk_0xA1E7A40E1F56E511(&Global_140800, iParam0);
        }
    }
}
...
void func_5(int iParam0, int iParam1, int iParam2, char* sParam3, bool bParam4)//Position - 0x651
{
...
int func_12(int iParam0)//Position - 0xA27
{
    if (Global_1406D3.f_9 == 0)
    {
        if (iParam0 > -1)
        {
            ...
            {
                return Global_151F57[func_14(-1)];
            }
...
int func_26(int iParam0, int iParam1)//Position - 0xF7B
{
    ...
    uVar0 = Global_274F55[iParam0 /*3*/][func_14(iParam1)];
...
int func_32(int iParam0, int iParam1)//Position - 0x13B3
{
    ...
    iVar0 = Global_2755A7[iParam0 /*3*/][func_14(iParam1)];
    if (unk_0x367DA79FE620711B(iVar0, &uVar1, -1))
    {
        return uVar1;
    }
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x13DF
{
    ...
    iVar0 = Global_26CBBF[iParam0 /*3*/][func_14(iParam1)];
    if (unk_0x367DA79FE620711B(iVar0, &uVar1, -1))
    {
        return uVar1;
    }
    ...
    switch (iParam0)
    {
        ...
        case 6:
            if ((unk_0x55056A10BA1BA85A() || func_41()) || func_40())
            {
                ...
                iVar0 += 19;
                iVar0 += 8;
                return (Global_40001.f_5377 + iVar0);
            }
            else
            {
                return Global_40001.f_5377;
            }
            break;
...
int func_48()//Position - 0x209D
{
    ...
    while (iVar0 < 1200)
    {
        if (unk_0xA2BC31158C8CEFD2(Global_C2055.f_4[iVar0 /*88*/].f_4C, 14))
        {
...
int func_49(int iParam0)//Position - 0x2147
{
    ...
    iVar1 = func_52(iVar0);
    iVar2 = func_51(iVar0);
    if ((unk_0x1EB14C6F68B8F915(2, iParam0) || unk_0x38CEC20C56D8586B(2, iParam0)) || func_50(iParam0, &(Global_14F53C.f_424), 1))
    {
