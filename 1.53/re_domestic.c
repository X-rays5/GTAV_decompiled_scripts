...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if ((unk_0x1116855A2A7A342C() || iLocal_49 == 4) || iLocal_68 > 18)
		{
			if (!func_181())
			{
				if (func_180())
					...
					case 1:
						...
						switch (iLocal_49)
						{
							...
							case 1:
								if (!iLocal_99)
								{
									if ((unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, 0, 1, 0) && unk_0x9A70B1BD2A5BA09C(Local_106, 1f)) || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_106, 20f, 20f, 20f, 0, 1, 0))
									{
										func_151();
										func_142(1);
										iLocal_99 = 1;
								...
								{
									if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_106, 50f, 50f, 50f, 0, 1, 0))
									{
										func_140();
									}
									if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
									{
										if (!unk_0xC2169C00B643278B(iLocal_58, Local_63, 30f, 30f, 30f, 0, 1, 0))
										{
											iLocal_49 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_89)
								{
									if (func_52())
									{
										if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_112, 23f, 60f, 20f, 0, 1, 0))
										{
											func_57(0);
											func_55();
											SYSTEM::WAIT(0);
						...
						{
							if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "f_attack_end", 3))
							{
						...
						if ((func_48() && !func_47()) && iLocal_48 != 2)
						{
							if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
							{
								if (unk_0xC2169C00B643278B(iLocal_58, Local_118, 5f, 5f, 5f, 0, 1, 0))
								{
									if (!unk_0xAE06B9E39EBDE049(iLocal_121[8]))
									{
										iLocal_121[8] = unk_0x79CC07752E7432A1(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
										unk_0xF8A652CE310FFC53(iLocal_121[8], iLocal_58, unk_0xE6B87C42793036AA(iLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
									}
									func_46(0);
									SYSTEM::WAIT(0);
									func_55();
...
void func_1()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (unk_0xAE06B9E39EBDE049(iLocal_121[8]))
		{
			uLocal_133 = unk_0xB1C0B7CD03D4467D(joaat("pickup_weapon_golfclub"), unk_0x3E4D3CCC220BDFB1(iLocal_121[8], 1), unk_0x090239DEAF625B17(iLocal_121[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			unk_0x315F7D8C33F0AB37(&(iLocal_121[8]));
		}
		unk_0xAF7D4BF357E8B79E(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 1, 1);
		unk_0xEFBCE8F8316F89EA(255, uLocal_152, 1862763509);
		if (bLocal_59)
		{
		...
		if (unk_0x8F678487EEBD8CE4(uLocal_102[0]))
		{
			unk_0x93370FA10F15BE44(&(uLocal_102[0]));
		}
		if (unk_0xAE06B9E39EBDE049(iLocal_58))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (!unk_0x47DBF174A0CB9D55(iLocal_58, 0))
				{
					unk_0x9EC7E133F41FCEB6(iLocal_58);
				}
				unk_0x59478CBBF96AF7D1(iLocal_58);
				unk_0x4E65320BC9AD521C(iLocal_58, 0);
				unk_0x0DC39BE87E4C5599(iLocal_58, 1);
			}
		}
		iVar0 = 0;
		while (iVar0 < iLocal_121)
		{
			...
			{
				unk_0x1F8106DB8796859F(iLocal_121[iVar0], 1, 1);
			}
			iVar0++;
		}
	...
	if ((!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_63, 80f, 80f, 80f, 0, 1, 0) || unk_0x73DBD7E437DA0553(uLocal_133)) || !(unk_0xAE06B9E39EBDE049(iLocal_121[8]) && !unk_0xF10E878C0879E7E9(uLocal_133)))
	{
		func_228();
	}
}
...
int func_52()
{
	...
	{
		iLocal_151 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
		if (unk_0x80FF6C016CDB0FAF(iLocal_151, 0))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0xACBCFA3095C5A434(iLocal_58, iLocal_151))
				{
					return 1;
				}
			}
...
void func_57(bool bParam0)
{
	...
	else if ((!iLocal_71 && unk_0x6A5CC4A2C9D9ED8D()) && !func_62())
	{
		Local_78 = { func_61() };
		Local_72 = { func_60() };
		func_58();
...
void func_81()
{
	switch (iLocal_70)
	{
		case 0:
			...
			else if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				unk_0x94D1A5176CE89859(iLocal_58, 1f);
				if (unk_0x910DFF8E55ABB8EC(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (iLocal_68 < 19)
					{
		...
		case 1:
			...
			if (unk_0xAE06B9E39EBDE049(iLocal_58))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
				{
					...
					{
						if (unk_0x11B7C25143EE2F29(iLocal_58))
						{
							unk_0x315F7D8C33F0AB37(&(iLocal_121[8]));
						}
					}
					if (unk_0x6E0C5E7AAF8B6214(iLocal_58))
					{
						func_127();
						func_121();
		...
		case 2:
			...
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_112, 10f, 10f, 10f, 0, 1, 0))
			{
			...
			if (unk_0xAE06B9E39EBDE049(iLocal_58))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
				{
					if (unk_0xC2169C00B643278B(iLocal_58, Local_112, Global_19, 1, 1, 0) && func_117(1, 0, 1))
					{
						if (unk_0x8F678487EEBD8CE4(uLocal_100))
						{
							unk_0x93370FA10F15BE44(&uLocal_100);
						}
						...
						if (unk_0x47DBF174A0CB9D55(iLocal_58, 0))
						{
							unk_0xD4C86DEC93F19FB0(unk_0xA5D5B1042E8F47BD(iLocal_58, 0), 10.5f, 3, 0);
							iLocal_70++;
						}
						else
						{
	...
	switch (iLocal_143)
	{
		...
		case 2:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				...
				unk_0x3C1B180EE30D36EF(0, Local_115, 1f, -1, 0.25f, 0, 311.3569f);
				unk_0x3964C1CAAE858CB1(0, "WORLD_HUMAN_SMOKING", 0, 1);
				unk_0x19F29730874AD6F1(uLocal_95);
				unk_0x9B6EC2CECE1010EF(iLocal_58, uLocal_95);
				unk_0x4F83FEE4454169D4(&uLocal_95);
				unk_0xCBA6B2B569DCAFD8(iLocal_58, 1);
				iLocal_144 = unk_0x578C4EF320340AF7() + 4000;
				iLocal_143++;
			}
			break;
		
		case 3:
			if (iLocal_144 < unk_0x578C4EF320340AF7())
			{
				unk_0xF6D7145773FE3ADD();
				iLocal_143++;
			}
	...
	switch (iLocal_143)
	{
		...
		case 3:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				...
				iLocal_144 = unk_0x578C4EF320340AF7() + 1000;
				iLocal_143++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_144 < unk_0x578C4EF320340AF7())
			{
				...
				{
					unk_0xDDEDC06C88DA4E04(unk_0x460153A63B9477BC(), 1, 0);
					iLocal_144 = unk_0x578C4EF320340AF7() + 3000;
					iLocal_143++;
				}
			}
			break;
...
void func_118()
{
	...
	if (!func_157())
	{
		switch (iLocal_141)
		{
			...
			case 6:
				iLocal_142 = unk_0x578C4EF320340AF7() + 1000;
				iLocal_141++;
				break;
			
			case 7:
				if (iLocal_142 < unk_0x578C4EF320340AF7())
				{
					if (func_54() == 0)
					{
			...
			case 13:
				iLocal_142 = unk_0x578C4EF320340AF7() + 600;
				iLocal_141++;
				break;
			...
			case 17:
				iLocal_142 = unk_0x578C4EF320340AF7() + 800;
				iLocal_141++;
				break;
...
void func_119()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
	{
		if (!iLocal_84)
		{
			...
			{
				if (!unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), unk_0xA5D3CD332CD10EE9(), 1) && unk_0xE0B3BC41DDA88DF0(iLocal_58, unk_0xA5D3CD332CD10EE9(), 0))
				{
					func_57(0);
					func_55();
					SYSTEM::WAIT(0);
		...
		{
			if (unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), unk_0xA5D3CD332CD10EE9(), 0) && unk_0xE0B3BC41DDA88DF0(iLocal_58, unk_0xA5D3CD332CD10EE9(), 0))
			{
				iLocal_84 = 0;
			}
		}
...
void func_120()
{
	...
	if ((iLocal_137 - iLocal_136) > 60000)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
		{
			if (unk_0xC2169C00B643278B(iLocal_58, Local_115, 200f, 200f, 200f, 0, 1, 0))
			{
				unk_0x3C1B180EE30D36EF(iLocal_58, Local_115, 1f, -1, 0.25f, 0, 1193033728);
			}
			else
			{
...
void func_121()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
	{
		...
		{
			if ((unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x47DBF174A0CB9D55(iLocal_58, 0)) && !unk_0x07404C7FE024EC4F(unk_0x9B0761B4C3EB8BC7()))
			{
				if (!unk_0x8F678487EEBD8CE4(uLocal_102[0]))
				{
			...
			else
			{
				...
				if (func_54() == 2 && !func_47())
				{
					if (!unk_0x8F678487EEBD8CE4(uLocal_101))
					{
						...
						unk_0xE7B8403ABCA0391D(uLocal_101, 269);
						func_122();
					}
				}
			}
...
var func_123(struct<3> Param0, int iParam3)
{
	...
	unk_0xFA81E0FBD7F5ACA0(uVar0, func_124(unk_0x25DDB354A40FFCDB(), 1f, 1f));
...
int func_126(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(uVar0, func_124(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(uVar0, bParam1);
	}
...
void func_127()
{
	...
	while (iVar0 < iLocal_121)
	{
		unk_0x95178967C65CAD85(&(iLocal_121[iVar0]));
		iVar0++;
	}
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1))
		{
			if (!func_132())
			{
				...
				if (unk_0x16BC17A8EDC701A2(iLocal_58, 1227113341) != 1 && unk_0x16BC17A8EDC701A2(iLocal_58, 1227113341) != 0)
				{
					unk_0xE021DCE1063D5DC2(iLocal_58, unk_0x9B0761B4C3EB8BC7(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (unk_0x47DBF174A0CB9D55(iLocal_58, 0))
				{
					unk_0x0AB756271BADC8DF(iLocal_58, 0, 0);
				}
				if (!iLocal_91)
				{
					func_57(0);
		...
		else if (!unk_0x7DA97DBB7F7D2DE5(iLocal_58))
		{
			unk_0xE19B69814D61BBA5(iLocal_58, func_130());
...
void func_133()
{
	switch (iLocal_69)
	{
		...
		case 2:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 12f, 12f, 5f, 0, 1, 2))
				{
					if (func_132())
					{
						unk_0xEFBCE8F8316F89EA(255, uLocal_152, 1862763509);
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && unk_0xAE06B9E39EBDE049(iLocal_121[8]))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_95);
				if (iLocal_68 > 18)
				{
				}
				unk_0x3C1B180EE30D36EF(0, unk_0x3E4D3CCC220BDFB1(iLocal_121[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_135(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iLocal_121[8], 1)));
		...
		case 4:
		case 5:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0xA59F96B50B97E63C(iLocal_121[8], 0))
			{
				if (unk_0x9934470AA0A08B57(iLocal_58, "random@domestic", "pickup_low", 3))
				{
					unk_0x9498922886494CFC(iLocal_58, iLocal_121[8], 0);
					if (unk_0x4C06B15B376AA145(iLocal_58, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_69 = 7;
					}
				}
				else if (SYSTEM::TIMERB() > 10000 || unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), unk_0x3E4D3CCC220BDFB1(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
					if (!unk_0xB77B1396EAA80D8F(iLocal_121[8]))
					{
						unk_0x9DC06E2A59C5AEBB(&uLocal_95);
						unk_0x756D74A3EF0AB788(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0, 0, 0, 0);
						unk_0x756D74A3EF0AB788(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0, 0, 0, 0);
		...
		case 7:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xF8A652CE310FFC53(iLocal_121[8], iLocal_58, unk_0xE6B87C42793036AA(iLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
...
void func_137()
{
	if (!iLocal_98)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
		{
			if (unk_0x910DFF8E55ABB8EC(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 12f, 12f, 5f, 0, 1, 0))
			{
				unk_0x9B94F6169B0DAEFD(iLocal_58);
				unk_0x9DC06E2A59C5AEBB(&uLocal_95);
				...
				unk_0x9B6EC2CECE1010EF(iLocal_58, uLocal_95);
				unk_0x4F83FEE4454169D4(&uLocal_95);
				unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 15000, 0, 2);
				iLocal_98 = 1;
			}
		}
	}
			...
			if (bLocal_138)
			{
				if (bLocal_54)
				{
					...
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
					{
						if (!func_157())
						{
							if (unk_0x04055E36623F131B(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 90f))
							{
...
void func_140()
{
	switch (iLocal_68)
	{
		case 0:
			...
			{
				if (unk_0x9A70B1BD2A5BA09C(unk_0x3E4D3CCC220BDFB1(iLocal_57, 1), 3f))
				{
					if (!func_157())
					{
						if (func_156(&uLocal_155, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							unk_0x756D74A3EF0AB788(iLocal_58, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							unk_0x756D74A3EF0AB788(iLocal_57, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							iLocal_68++;
						}
					}
				}
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[8]))
			{
				unk_0xF8A652CE310FFC53(iLocal_121[8], iLocal_57, unk_0xE6B87C42793036AA(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				iLocal_68++;
			}
			break;
		...
		case 2:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[8]))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.335f)
					{
						unk_0x1F8106DB8796859F(iLocal_121[8], 0, 1);
						unk_0x8B77B020136E915A(iLocal_121[8], 1, 0f, 6f, 4f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 3:
			if (!iLocal_88 && unk_0xAE06B9E39EBDE049(iLocal_121[8]))
			{
				if (unk_0x4162501391EDB9BF(iLocal_121[8]))
				{
					unk_0x2DB2D4C3CB88500D(-1, "CLOTHES_THROWN", iLocal_121[8], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_88 = 1;
				}
			}
		...
		case 4:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[9]))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.473f)
					{
						unk_0xF8A652CE310FFC53(iLocal_121[9], iLocal_57, unk_0xE6B87C42793036AA(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 6:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[9]))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.55f)
					{
						unk_0x1F8106DB8796859F(iLocal_121[9], 0, 1);
						unk_0x8B77B020136E915A(iLocal_121[9], 1, 1f, 2f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 7:
			if (!iLocal_88 && unk_0xAE06B9E39EBDE049(iLocal_121[9]))
			{
				if (unk_0x4162501391EDB9BF(iLocal_121[9]))
				{
					unk_0x2DB2D4C3CB88500D(-1, "CLOTHES_THROWN", iLocal_121[9], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_88 = 1;
				}
			}
			if (!func_157() || func_139())
		...
		case 8:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[10]))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.705f)
					{
						unk_0xF8A652CE310FFC53(iLocal_121[10], iLocal_57, unk_0xE6B87C42793036AA(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 9:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && unk_0xAE06B9E39EBDE049(iLocal_121[10]))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.838f)
					{
						unk_0x1F8106DB8796859F(iLocal_121[10], 0, 1);
						unk_0x8B77B020136E915A(iLocal_121[10], 1, 1f, 3f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 10:
			if (!iLocal_88 && unk_0xAE06B9E39EBDE049(iLocal_121[10]))
			{
				if (unk_0x4162501391EDB9BF(iLocal_121[10]))
				{
					unk_0x2DB2D4C3CB88500D(-1, "CLOTHES_THROWN", iLocal_121[10], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_88 = 1;
				}
			}
			if (!func_157() || func_139())
		...
		case 11:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57) && !unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x9934470AA0A08B57(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (unk_0x4C06B15B376AA145(iLocal_57, "random@domestic", "balcony_fight_female") > 0.94f)
					{
						unk_0xD08E9EAF091A1AAB(iLocal_57, iLocal_58, 0);
					}
				}
			}
			if (!func_157() || func_139())
		...
		case 16:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				...
				unk_0xB53E642F4F50E7C0(0, Local_109, 0);
				unk_0x19F29730874AD6F1(uLocal_95);
				unk_0x9B6EC2CECE1010EF(iLocal_58, uLocal_95);
				unk_0x4F83FEE4454169D4(&uLocal_95);
				iLocal_68++;
		...
		case 17:
			if (unk_0xAE06B9E39EBDE049(iLocal_57))
			{
				...
				{
					if (unk_0xC2169C00B643278B(iLocal_57, Local_109, 1f, 1f, 5f, 0, 1, 0) && unk_0x1D88F87079AF2FA7(iLocal_57))
					{
						unk_0x586DDC617E714637(&iLocal_57);
					}
				}
			}
			if (iLocal_93 < unk_0x578C4EF320340AF7())
			{
				if (!func_157())
				{
					if (func_156(&uLocal_155, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_93 = unk_0x578C4EF320340AF7() + 5000;
						iLocal_94++;
					}
				}
			}
	...
	if (!bLocal_54)
	{
		if (iLocal_68 > 2 && iLocal_68 < 8)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 6f, 4f, 5f, 0, 1, 0) || (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 12f, 12f, 5f, 0, 1, 2) && unk_0x99BF74E1D085CEA6(unk_0x460153A63B9477BC())))
				{
					unk_0x9B94F6169B0DAEFD(iLocal_58);
					func_141();
					if (iLocal_68 > 18)
		...
		else if (iLocal_68 > 7)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 6f, 8f, 5f, 0, 1, 0))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_102[0]))
					{
						unk_0x3DBD102E8C35EA16(uLocal_102[0], 1);
					}
					unk_0x9B94F6169B0DAEFD(iLocal_58);
					func_141();
					if (iLocal_68 > 18)
...
void func_141()
{
	...
	{
		unk_0x9DC06E2A59C5AEBB(&uLocal_95);
		unk_0x83CAF206A9B8748C(0, Local_109, 1f, -1, 1193033728, 1056964608);
		unk_0x756D74A3EF0AB788(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
		unk_0x19F29730874AD6F1(uLocal_95);
		unk_0x9B6EC2CECE1010EF(iLocal_57, uLocal_95);
		unk_0x4F83FEE4454169D4(&uLocal_95);
...
void func_151()
{
	...
	{
		uLocal_102[0] = func_125(iLocal_58, 0, 145);
		unk_0x3DBD102E8C35EA16(uLocal_102[0], 0);
	}
}
...
void func_152()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	unk_0x555EE41D7C7078E6(Local_63, 2f, 1, 0, 0, 0);
	unk_0x555EE41D7C7078E6(Local_60, 2f, 1, 0, 0, 0);
	unk_0xAF7D4BF357E8B79E(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1);
	unk_0x01A2F6B26EAAEAC5(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, 0, 1);
	unk_0xC08A186299DFDA0A(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	unk_0xC08A186299DFDA0A(Local_112 - Vector(3f, 2f, 2f), Local_112 + Vector(3f, 2f, 2f), 0, 1, 1, 1);
	...
	unk_0xDE8F8016287F771F("rghDomestic", &uLocal_152);
	unk_0xEFBCE8F8316F89EA(5, uLocal_152, 1862763509);
	iLocal_57 = unk_0xB3116B49FE00E2F1(26, iLocal_96, Local_60, fLocal_66, 1, 1);
	unk_0x4E65320BC9AD521C(iLocal_57, 1);
	unk_0x6673CC701BC8E9C1(iLocal_57, 17, 1);
	unk_0x6673CC701BC8E9C1(iLocal_57, 8, 0);
	unk_0x6AC7395A8E313A46(iLocal_57, 1, 0);
	unk_0x6AC7395A8E313A46(iLocal_57, 2, 0);
	unk_0x6AC7395A8E313A46(iLocal_57, 128, 1);
	unk_0x6AC7395A8E313A46(iLocal_57, 8, 0);
	unk_0x756D74A3EF0AB788(iLocal_57, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0xD3D9D7C84656DAE5(iLocal_57, uLocal_152);
	func_155(iLocal_57, "GENERIC_WHATEVER", 24);
	unk_0x74528AC0906CBABE(iLocal_96);
	unk_0x694113444F21E39F(iLocal_57, 185, 1);
	iLocal_58 = unk_0xB3116B49FE00E2F1(26, iLocal_97, Local_63, fLocal_67, 1, 1);
	unk_0x4E65320BC9AD521C(iLocal_58, 1);
	unk_0x6AC7395A8E313A46(iLocal_58, 1, 1);
	unk_0x6AC7395A8E313A46(iLocal_58, 2, 0);
	unk_0x6AC7395A8E313A46(iLocal_58, 128, 1);
	unk_0x6AC7395A8E313A46(iLocal_58, 8, 0);
	unk_0x6AC7395A8E313A46(iLocal_58, 65536, 1);
	unk_0x694113444F21E39F(iLocal_58, 185, 1);
	unk_0x694113444F21E39F(iLocal_58, 206, 1);
	unk_0x6A4846EF125EA7E6(iLocal_58, 0);
	unk_0x0DC39BE87E4C5599(iLocal_58, 0);
	unk_0x756D74A3EF0AB788(iLocal_58, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
	unk_0xD3D9D7C84656DAE5(iLocal_58, uLocal_152);
	func_155(iLocal_58, "GENERIC_WHATEVER", 24);
	unk_0x74528AC0906CBABE(iLocal_97);
	unk_0xA785552633ED203B(iLocal_58, iLocal_57, -1, 0, 2);
	unk_0xA785552633ED203B(iLocal_57, iLocal_58, -1, 0, 2);
	unk_0x45F588C0DD767737(iLocal_57, 0, 1, 0, 0);
	unk_0x45F588C0DD767737(iLocal_57, 2, 1, 1, 0);
	unk_0x45F588C0DD767737(iLocal_57, 3, 1, 1, 0);
	unk_0x45F588C0DD767737(iLocal_57, 4, 1, 2, 0);
	unk_0x45F588C0DD767737(iLocal_58, 0, 0, 0, 0);
	unk_0x45F588C0DD767737(iLocal_58, 2, 1, 0, 0);
	unk_0x45F588C0DD767737(iLocal_58, 3, 1, 2, 0);
	unk_0x45F588C0DD767737(iLocal_58, 4, 1, 1, 0);
	unk_0x45F588C0DD767737(iLocal_58, 8, 0, 0, 0);
	func_154();
	unk_0xBE20AB8238688965(&uLocal_134, 5);
	if (func_54() == 0)
	{
		func_153(&uLocal_155, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
	}
	if (func_54() == 1)
	{
		func_153(&uLocal_155, 1, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
	}
	if (func_54() == 2)
	{
		func_153(&uLocal_155, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
	}
	func_153(&uLocal_155, 3, iLocal_58, "REDOCastro", 0, 1);
	unk_0x3A2AAE59B4681DAF(iLocal_58, sLocal_153);
	func_153(&uLocal_155, 4, iLocal_57, "NATHALIA", 0, 1);
	unk_0x3A2AAE59B4681DAF(iLocal_57, sLocal_154);
	SYSTEM::SETTIMERA(0);
	iLocal_150 = 1;
}
...
void func_154()
{
	iLocal_121[0] = unk_0x79CC07752E7432A1(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[0], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_tshirt_02"));
	iLocal_121[1] = unk_0x79CC07752E7432A1(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[1], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_jeans_02"));
	iLocal_121[2] = unk_0x79CC07752E7432A1(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[2], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_shoe_01"));
	iLocal_121[3] = unk_0x79CC07752E7432A1(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[3], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_jeans_01"));
	iLocal_121[4] = unk_0x79CC07752E7432A1(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[4], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_shoe_02"));
	iLocal_121[5] = unk_0x79CC07752E7432A1(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[5], 1);
	unk_0x74528AC0906CBABE(joaat("prop_ld_shirt_01"));
	iLocal_121[6] = unk_0x79CC07752E7432A1(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[6], 1);
	unk_0x74528AC0906CBABE(joaat("prop_porn_mag_03"));
	iLocal_121[7] = unk_0x79CC07752E7432A1(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, 1, 1, 0);
	unk_0xC82085403E46A869(iLocal_121[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	unk_0x6A8F948698B360B4(iLocal_121[7], 1);
	unk_0x74528AC0906CBABE(joaat("prop_porn_mag_01"));
	iLocal_121[8] = unk_0x79CC07752E7432A1(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	iLocal_121[9] = unk_0x79CC07752E7432A1(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, 1, 1, 0);
	unk_0x74528AC0906CBABE(joaat("prop_cs_rub_binbag_01"));
	iLocal_121[10] = unk_0x79CC07752E7432A1(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	unk_0x74528AC0906CBABE(joaat("prop_golf_bag_01"));
}

void func_155(var uParam0, char* sParam1, int iParam2)
{
	unk_0xFDCFA91E51EDB61F(uParam0, sParam1, func_50(iParam2), 1);
}
...
void func_158()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58) && !unk_0x5AEB5DDFFAD43CA5(iLocal_57))
	{
		...
		{
			if (unk_0xD5E14AF69C7C4DA9(iLocal_58, unk_0x9B0761B4C3EB8BC7()) || unk_0xD5E14AF69C7C4DA9(iLocal_57, unk_0x9B0761B4C3EB8BC7()))
			{
				if (((unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_58) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_58)) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_57)) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_57))
				{
					if (iLocal_135 == -1)
					{
			...
			if ((iLocal_135 != -1 && unk_0x578C4EF320340AF7() > iLocal_135 + 500) || unk_0x7922FF28ED63354A(unk_0x9B0761B4C3EB8BC7()))
			{
				func_165();
			}
		}
	...
	if (unk_0xAE06B9E39EBDE049(iLocal_58))
	{
		if (func_161(iLocal_58) || unk_0xCDF860E56BBCC6B4(iLocal_58, unk_0x9B0761B4C3EB8BC7(), 1))
		{
			func_159();
		}
	}
	if (unk_0xAE06B9E39EBDE049(iLocal_57))
	{
		if (func_161(iLocal_57) || unk_0xCDF860E56BBCC6B4(iLocal_57, unk_0x9B0761B4C3EB8BC7(), 1))
		{
			func_159();
		}
	}
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
	{
		if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_58, 250f, 250f, 250f, 0, 1, 0) || unk_0xE72C9284B5143451(iLocal_58))
		{
			iLocal_49 = 11;
		}
	}
...
void func_160()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_57))
	{
		unk_0xAEC92B0DA8075AC9(iLocal_57, -1);
		unk_0xCBA6B2B569DCAFD8(iLocal_57, 1);
		iVar0 = 0;
		while (iVar0 < iLocal_121)
		{
...
void func_163()
{
	...
	{
		unk_0x9B94F6169B0DAEFD(iLocal_58);
		unk_0xD66FADEF7D42D49B(iLocal_58, unk_0x3E4D3CCC220BDFB1(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 1), 150f, -1, 0, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_58, 1);
	}
	iLocal_49 = 11;
}
...
int func_164(int iParam0)
{
	...
	{
		if (!unk_0x47DBF174A0CB9D55(iParam0, 0) && unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iParam0, 1.5f, 1.5f, 8f, 0, 1, 2))
		{
			if (unk_0xF3A639BEE7AADF55(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)) > 4f)
			{
				return 1;
			}
		}
...
int func_168()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_179())
		{
			return 0;
		}
	}
...
void func_228()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (unk_0xAE06B9E39EBDE049(iLocal_58))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_58))
			{
				unk_0x694113444F21E39F(iLocal_58, 317, 1);
				if (!unk_0x47DBF174A0CB9D55(iLocal_58, 0))
				{
					unk_0x9EC7E133F41FCEB6(iLocal_58);
				}
