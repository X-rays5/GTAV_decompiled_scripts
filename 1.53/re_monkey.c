...
int func_57()
{
	...
	else
	{
		...
		if (unk_0x7D167B9A0CCDA347(joaat("u_m_m_streetart_01")))
		{
			...
			func_58(1);
			unk_0xD3D9D7C84656DAE5(iLocal_50, 1862763509);
	...
	if (func_50(iLocal_50))
	{
		...
		switch (iLocal_55)
		{
			...
			case 5:
				...
				if (!unk_0xA38BFCB05DBE439D(iLocal_50) && SYSTEM::VDIST2(Var2, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0)) > 2500f)
				{
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xAE06B9E39EBDE049(uParam0) && unk_0xAE06B9E39EBDE049(uParam1))
	{
		...
		return SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(iParam0, 0), unk_0x3E4D3CCC220BDFB1(iParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_149())
			{
				return 0;
			}
		}
