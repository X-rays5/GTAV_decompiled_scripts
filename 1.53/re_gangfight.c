...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (iLocal_59 > unk_0x578C4EF320340AF7())
			{
			...
			if (!func_99())
			{
				...
				switch (iLocal_46)
				{
					...
					case 1:
						...
						{
							if ((!unk_0x5AEB5DDFFAD43CA5(uLocal_68) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[1]))
							{
								if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 969.2191f, 3608.665f, 41.8758f, 100f, 80f, 20f, 0, 1, 0))
								{
									uLocal_60 = func_80(uLocal_68, 0, 145);
									unk_0xE346A71235BB8065(uLocal_60, 9);
									uLocal_61[0] = func_80(iLocal_69[0], 1, 145);
									uLocal_61[1] = func_80(iLocal_69[1], 1, 145);
									unk_0x3DBD102E8C35EA16(uLocal_60, 0);
									unk_0x3DBD102E8C35EA16(uLocal_61[0], 0);
									unk_0x3DBD102E8C35EA16(uLocal_61[1], 0);
									func_70(1);
								}
							}
						}
						else
						{
							...
							while (iVar0 < iLocal_69)
							{
								...
								{
									unk_0x8B18A80E8EB15510(iLocal_69[iVar0], unk_0x9B0761B4C3EB8BC7(), 150f, -1, 0, 0);
								}
								iVar0++;
							}
							if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
							{
								unk_0x8B18A80E8EB15510(uLocal_68, unk_0x9B0761B4C3EB8BC7(), 150f, -1, 0, 0);
							}
							func_69();
						}
						break;
			...
			else
			{
				...
				if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
				{
					if (unk_0xCDF860E56BBCC6B4(uLocal_68, unk_0x9B0761B4C3EB8BC7(), 1))
					{
						unk_0x8B18A80E8EB15510(uLocal_68, unk_0x9B0761B4C3EB8BC7(), 150f, -1, 0, 0);
						func_69();
					}
					if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_68, 150f, 150f, 50f, 0, 1, 0))
					{
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (iLocal_48 < 7 && !unk_0x5AEB5DDFFAD43CA5(uLocal_68))
								{
									if (unk_0x04055E36623F131B(unk_0x9B0761B4C3EB8BC7(), uLocal_68, 90f))
									{
										if (unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), uLocal_68) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), uLocal_68))
										{
											func_64();
										}
									}
				...
				else
				{
					...
					if (((!unk_0x5AEB5DDFFAD43CA5(iLocal_69[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[1])) && !unk_0xA59F96B50B97E63C(iLocal_77[0], 0)) && !unk_0xA59F96B50B97E63C(iLocal_77[1], 0))
					{
						func_69();
					}
					iVar1 = 0;
					...
					{
						if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar2]))
						{
							unk_0x8FF9CE1C0F94F59A(iLocal_69[iVar2], unk_0x9B0761B4C3EB8BC7(), 0, 16);
							unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar2], 1);
							if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_69[iVar2], 150f, 150f, 50f, 0, 1, 0))
							{
								func_69();
							}
							iVar1 = 1;
						}
						else if (unk_0x8F678487EEBD8CE4(uLocal_61[iVar2]))
						{
							unk_0x93370FA10F15BE44(&(uLocal_61[iVar2]));
						}
						iVar2++;
					}
					if (iVar1 == 0)
...
void func_1()
{
	...
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
		{
			unk_0xDAE36360F0F8C1ED(uLocal_68, 0);
			unk_0x4E65320BC9AD521C(uLocal_68, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_69)
		{
			if (unk_0x8F678487EEBD8CE4(uLocal_61[iVar0]))
			{
				unk_0x93370FA10F15BE44(&(uLocal_61[iVar0]));
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				if (iVar0 < 2)
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_77[iVar0], 0))
					{
						unk_0xBD204892D76E6303(iLocal_69[iVar0], iLocal_77[iVar0], unk_0x9B0761B4C3EB8BC7(), 8, 20f, 786469, 150f, 10f, 1);
						unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar0], 1);
					}
					else
					{
						unk_0x8B18A80E8EB15510(iLocal_69[iVar0], unk_0x9B0761B4C3EB8BC7(), 200f, -1, 0, 0);
					}
				}
				else
				{
				...
				unk_0x4E65320BC9AD521C(iLocal_69[iVar0], 0);
			}
			iVar0++;
		}
		iVar0 = 0;
	...
	if (unk_0x272784C60C397DB6(func_2(unk_0x460153A63B9477BC()), Local_50, 1) > 50f)
	{
		func_146();
	}
}
	...
	switch (iLocal_48)
	{
		case 0:
			if (SYSTEM::TIMERB() > 2000)
			{
				...
				while (iVar0 < iLocal_69)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]) && !unk_0xA59F96B50B97E63C(iLocal_77[iVar0], 0))
					{
						if (!unk_0x8F678487EEBD8CE4(uLocal_61[iVar0]))
						{
							uLocal_61[iVar0] = func_80(iLocal_69[iVar0], 1, 145);
							if (unk_0x47DBF174A0CB9D55(iLocal_69[iVar0], 0))
							{
								if (!bLocal_55)
								{
									unk_0x4E8B7920F3D6B9EE(iLocal_69[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
								}
								else
								{
									unk_0x9DC06E2A59C5AEBB(&uLocal_84);
									unk_0x8FF9CE1C0F94F59A(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
									unk_0x19F29730874AD6F1(uLocal_84);
									unk_0x9B6EC2CECE1010EF(iLocal_69[iVar0], uLocal_84);
									unk_0x4F83FEE4454169D4(&uLocal_84);
									unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar0], 1);
								}
							}
						}
		...
		case 1:
			...
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar1]))
				{
					if (unk_0xC2169C00B643278B(iLocal_69[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0))
					{
						if (!unk_0xA59F96B50B97E63C(iLocal_77[iVar1], 0))
						{
							unk_0xA880FA9C4E5BCA17(iLocal_77[iVar1], 0);
						}
						if (unk_0x47DBF174A0CB9D55(iLocal_69[iVar1], 0))
						{
							unk_0x9DC06E2A59C5AEBB(&uLocal_84);
							unk_0x0AB756271BADC8DF(0, 0, 0);
							unk_0x8FF9CE1C0F94F59A(0, unk_0x9B0761B4C3EB8BC7(), 0, 16);
							unk_0x19F29730874AD6F1(uLocal_84);
							unk_0x9B6EC2CECE1010EF(iLocal_69[iVar1], uLocal_84);
							unk_0x4F83FEE4454169D4(&uLocal_84);
							unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar1], 1);
						}
					}
					if (!unk_0x47DBF174A0CB9D55(iLocal_69[iVar1], 0))
					{
						unk_0x8FF9CE1C0F94F59A(iLocal_69[iVar1], unk_0x9B0761B4C3EB8BC7(), 0, 16);
						unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar1], 1);
					}
					if (!unk_0xA59F96B50B97E63C(iLocal_77[iVar1], 0))
					{
						if (unk_0x6EE9667C8666E4A8(iLocal_77[iVar1]))
						{
						}
					}
				}
				if (unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar1]))
				{
					if (unk_0x8F678487EEBD8CE4(uLocal_61[iVar1]))
					{
						unk_0x93370FA10F15BE44(&(uLocal_61[iVar1]));
					}
				}
				iVar1++;
			}
			if (((unk_0x5AEB5DDFFAD43CA5(iLocal_69[2]) && unk_0x5AEB5DDFFAD43CA5(iLocal_69[3])) && unk_0x5AEB5DDFFAD43CA5(iLocal_69[4])) && unk_0x5AEB5DDFFAD43CA5(iLocal_69[5]))
			{
				unk_0xFA07F8BEBDAAFBA8("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
				iLocal_48++;
			}
		...
		case 2:
			...
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
			{
				unk_0x9B94F6169B0DAEFD(uLocal_68);
				unk_0x9DC06E2A59C5AEBB(&uLocal_84);
				unk_0xA785552633ED203B(0, unk_0x9B0761B4C3EB8BC7(), -1, 2056, 2);
				unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), -1);
				unk_0x19F29730874AD6F1(uLocal_84);
				unk_0x9B6EC2CECE1010EF(uLocal_68, uLocal_84);
				unk_0x4F83FEE4454169D4(&uLocal_84);
			}
			if (!unk_0xA59F96B50B97E63C(uLocal_76, 0))
			{
				unk_0xBB7976F6FB9C9DD2(uLocal_76);
				if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_68, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_68, 6f, 6f, 6f, 0, 1, 0))
				{
					if (unk_0x04055E36623F131B(uLocal_68, unk_0x9B0761B4C3EB8BC7(), 60f))
					{
						if (!func_8())
						{
			...
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
			{
				if (!unk_0x910DFF8E55ABB8EC(uLocal_68, unk_0x9B0761B4C3EB8BC7(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!unk_0xA59F96B50B97E63C(uLocal_76, 0))
			{
				if (unk_0xCDF860E56BBCC6B4(uLocal_76, unk_0x9B0761B4C3EB8BC7(), 0))
				{
					func_69();
				}
			}
		...
		case 5:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68) && !unk_0xA59F96B50B97E63C(uLocal_76, 0))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_84);
				unk_0xD08E9EAF091A1AAB(0, unk_0x9B0761B4C3EB8BC7(), 1500);
				unk_0xC584E49FC3559A86(0, uLocal_76, -1, -1, 2f, 8, 0);
				unk_0xC67F9BF03C2472AB(0, 2000);
				unk_0x756D74A3EF0AB788(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
				unk_0xD8C1C38EE8BC2AC6(0, uLocal_76, 10f, 786603);
				unk_0x19F29730874AD6F1(uLocal_84);
				unk_0x9B6EC2CECE1010EF(uLocal_68, uLocal_84);
				unk_0x4F83FEE4454169D4(&uLocal_84);
				unk_0xCBA6B2B569DCAFD8(uLocal_68, 1);
				unk_0x756046956300306A(uLocal_76, 1);
				iLocal_48++;
			}
			break;
		...
		case 6:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
			{
				if (unk_0x9934470AA0A08B57(uLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (unk_0x4C06B15B376AA145(uLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && unk_0x47DBF174A0CB9D55(uLocal_68, 0))
					{
						unk_0x8F312E3891DDE6A0(unk_0x7EC595B99EA7C4B1(unk_0xA5D5B1042E8F47BD(uLocal_68, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_48++;
					}
				}
			}
...
void func_59()
{
	...
	switch (iLocal_48)
	{
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_68))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), uLocal_68, 20f, 20f, 20f, 0, 1, 0))
				{
					unk_0xA785552633ED203B(uLocal_68, unk_0x9B0761B4C3EB8BC7(), -1, 2060, 2);
		...
		case 2:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0xA59F96B50B97E63C(uLocal_76, 0))
			{
				unk_0x9DC06E2A59C5AEBB(&uLocal_84);
				unk_0x3C1B180EE30D36EF(0, 916.5764f, 3602.146f, 31.9262f, 1f, 40000, 1048576000, 0, 1193033728);
				unk_0x19F29730874AD6F1(uLocal_84);
				unk_0x9B6EC2CECE1010EF(iLocal_68, uLocal_84);
				unk_0x4F83FEE4454169D4(&uLocal_84);
				iLocal_48++;
			}
			break;
		...
		case 4:
			...
			{
				if (unk_0xC2169C00B643278B(iLocal_68, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
					if (!unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
							if (func_42(&uLocal_85, "RECGFAU", "RECGF_STASH", 4, 0, 0, 0))
							{
								unk_0xD08E9EAF091A1AAB(iLocal_68, unk_0x9B0761B4C3EB8BC7(), -1);
								if (!unk_0xA59F96B50B97E63C(uLocal_76, 0))
								{
									unk_0xBB7976F6FB9C9DD2(uLocal_76);
								}
			...
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) || unk_0xE4B70EFD14220305(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						{
							func_41(1000);
							if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[2])) && !unk_0xA59F96B50B97E63C(uLocal_76, 0))
							{
								unk_0x9DC06E2A59C5AEBB(&uLocal_84);
								unk_0xCC1E33530DF3B29A(0, uLocal_76, -1, -1, 1f);
								unk_0xA785552633ED203B(0, iLocal_69[2], 2000, 0, 2);
								unk_0xD08E9EAF091A1AAB(0, iLocal_69[2], 0);
								unk_0x19F29730874AD6F1(uLocal_84);
								unk_0x9B6EC2CECE1010EF(iLocal_68, uLocal_84);
								unk_0x4F83FEE4454169D4(&uLocal_84);
								func_41(2000);
								...
								if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0xA59F96B50B97E63C(uLocal_76, 0)) && unk_0x47DBF174A0CB9D55(iLocal_68, 0))
								{
									iLocal_48++;
								}
								else
								{
									if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[2]))
									{
										unk_0x9DC06E2A59C5AEBB(&uLocal_84);
		...
		case 7:
			if ((((!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0xA59F96B50B97E63C(uLocal_76, 0)) && !unk_0xE0B3BC41DDA88DF0(iLocal_68, uLocal_76, 0)) && !unk_0xB8DB6610D5815003(iLocal_68, 0)) && !unk_0xC4C70C30B8EC4946(iLocal_68))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]) && !unk_0xA59F96B50B97E63C(iLocal_77[iVar0], 0))
				{
					if (((((unk_0x183773B390B31AAA(unk_0x9B0761B4C3EB8BC7(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), 0, 1) || unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_69[iVar0], 5f, 5f, 5f, 0, 1, 0)) || unk_0xCDF860E56BBCC6B4(iLocal_69[iVar0], unk_0x9B0761B4C3EB8BC7(), 1)) || unk_0xCDF860E56BBCC6B4(iLocal_77[iVar0], unk_0x9B0761B4C3EB8BC7(), 1)) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_69[iVar0])) || unk_0xA65352E7FEA59881(unk_0x9B0761B4C3EB8BC7(), iLocal_77[iVar0]))
					{
						bLocal_55 = true;
			...
			if (unk_0xC2169C00B643278B(iLocal_69[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || SYSTEM::TIMERB() > 13000)
			{
				func_41(2000);
				iVar0 = 0;
				while (iVar0 < iLocal_69)
				{
					if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]))
					{
						if (!unk_0xA59F96B50B97E63C(iLocal_77[iVar0], 0))
						{
							if (unk_0xE0B3BC41DDA88DF0(iLocal_69[iVar0], iLocal_77[iVar0], 0))
							{
								unk_0xBD204892D76E6303(iLocal_69[iVar0], iLocal_77[iVar0], unk_0x9B0761B4C3EB8BC7(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
							}
						}
					}
					iVar0++;
				...
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
				{
					if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 15f, 15f, 15f, 0, 1, 0))
					{
						func_60();
						func_41(0);
...
int func_62()
{
	...
	if (((((((!unk_0xAE06B9E39EBDE049(iLocal_77[2]) && !unk_0xAE06B9E39EBDE049(iLocal_77[3])) && !unk_0xAE06B9E39EBDE049(iLocal_77[4])) && !unk_0xAE06B9E39EBDE049(iLocal_77[5])) && !unk_0xAE06B9E39EBDE049(iLocal_69[2])) && !unk_0xAE06B9E39EBDE049(iLocal_69[3])) && !unk_0xAE06B9E39EBDE049(iLocal_69[4])) && !unk_0xAE06B9E39EBDE049(iLocal_69[5]))
	{
		...
		{
			iLocal_77[2] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1, 0);
			iLocal_77[3] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1, 0);
			iLocal_77[4] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1, 0);
			iLocal_77[5] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1, 0);
			unk_0x74528AC0906CBABE(joaat("hexer"));
			unk_0xD9FF958283AAC601(iLocal_77[2], 3);
			unk_0xD9FF958283AAC601(iLocal_77[4], 3);
			iLocal_59 = unk_0x578C4EF320340AF7() + 1500;
		}
		...
		{
			iLocal_69[2] = unk_0x6A7A2C83BD302BA4(iLocal_77[2], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_69[3] = unk_0x6A7A2C83BD302BA4(iLocal_77[3], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			iLocal_69[4] = unk_0x6A7A2C83BD302BA4(iLocal_77[4], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
			iLocal_69[5] = unk_0x6A7A2C83BD302BA4(iLocal_77[5], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
			...
			while (iVar0 < iLocal_69)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]) && !unk_0xA59F96B50B97E63C(iLocal_77[iVar0], 0))
				{
					unk_0xD0C464B4E09878D6(iLocal_77[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					unk_0x694113444F21E39F(iLocal_69[iVar0], 137, 1);
					unk_0xD93D982926D0D8B3(iLocal_69[iVar0], 0);
					unk_0x73745F8F1D07995D(iLocal_69[iVar0], 2);
					unk_0x6673CC701BC8E9C1(iLocal_69[iVar0], 50, 1);
					unk_0x3EA9EB775DF15E76(iLocal_69[iVar0], 2);
					unk_0xD5AB681FC5D86FCC(iLocal_69[iVar0], 50f, 20);
					unk_0x54E3EF0852DA2CA4(iLocal_69[iVar0], 1);
					unk_0xF94DFEAE3DD1EE7E(iLocal_69[iVar0], 13);
					unk_0x567AB34DE5FDB30D(iLocal_69[iVar0], 100f);
					unk_0x6C08F93084C348FC(iLocal_69[iVar0], 100f);
					unk_0xD3D9D7C84656DAE5(iLocal_69[iVar0], uLocal_250);
					unk_0x4E65320BC9AD521C(iLocal_69[iVar0], 1);
					unk_0x911BA6A7B46C75BA(iLocal_69[iVar0], 3);
					unk_0x6A4846EF125EA7E6(iLocal_69[iVar0], 0);
					unk_0x0DC39BE87E4C5599(iLocal_69[iVar0], 1);
					unk_0x82FF25D1808866E5(iLocal_69[iVar0], 1, 1000f);
					if (iVar0 > 1 && iVar0 < 5)
					{
						unk_0x92BD213E6A0E666B(iLocal_69[iVar0], joaat("weapon_pistol"), -1, 1, 1);
					}
					else
					{
						unk_0x92BD213E6A0E666B(iLocal_69[iVar0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					}
					unk_0x9DC06E2A59C5AEBB(&uLocal_84);
					unk_0xDEFE57D3575A1A8A(0, iLocal_77[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0x439AF5D920F78274(0, Local_50, 5000, 0, 2);
					unk_0x19F29730874AD6F1(uLocal_84);
					unk_0x9B6EC2CECE1010EF(iLocal_69[2], uLocal_84);
					unk_0x4F83FEE4454169D4(&uLocal_84);
					unk_0x9DC06E2A59C5AEBB(&uLocal_84);
					unk_0xDEFE57D3575A1A8A(0, iLocal_77[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0x439AF5D920F78274(0, Local_50, 5000, 0, 2);
					unk_0x19F29730874AD6F1(uLocal_84);
					unk_0x9B6EC2CECE1010EF(iLocal_69[3], uLocal_84);
					unk_0x4F83FEE4454169D4(&uLocal_84);
					unk_0xCBA6B2B569DCAFD8(iLocal_69[3], 1);
					unk_0x9DC06E2A59C5AEBB(&uLocal_84);
					unk_0xDEFE57D3575A1A8A(0, iLocal_77[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0x439AF5D920F78274(0, Local_50, 5000, 0, 2);
					unk_0x19F29730874AD6F1(uLocal_84);
					unk_0x9B6EC2CECE1010EF(iLocal_69[4], uLocal_84);
					unk_0x4F83FEE4454169D4(&uLocal_84);
					unk_0x9DC06E2A59C5AEBB(&uLocal_84);
					unk_0xDEFE57D3575A1A8A(0, iLocal_77[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					unk_0x439AF5D920F78274(0, Local_50, 5000, 0, 2);
					unk_0x19F29730874AD6F1(uLocal_84);
					unk_0x9B6EC2CECE1010EF(iLocal_69[5], uLocal_84);
					unk_0x4F83FEE4454169D4(&uLocal_84);
				}
				iVar0++;
			}
...
void func_64()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
	{
		unk_0x8B18A80E8EB15510(iLocal_68, unk_0x9B0761B4C3EB8BC7(), 200f, -1, 0, 0);
		unk_0xCBA6B2B569DCAFD8(iLocal_68, 1);
		if (!unk_0xA59F96B50B97E63C(iLocal_69[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_69[1], 0))
		{
			unk_0x697DA7132EE43ABC(iLocal_68, 101, 0);
			unk_0xDAE36360F0F8C1ED(iLocal_68, 0);
			unk_0x2477E285E363F38F(iLocal_69[0], iLocal_68, 1000, 0);
			unk_0x2477E285E363F38F(iLocal_69[1], iLocal_68, 1000, 0);
		}
		else
		{
			func_4();
...
{
	unk_0xFDCFA91E51EDB61F(uParam0, sParam1, func_66(iParam2), 1);
}
...
void func_67()
{
	...
	{
		case 0:
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_54() == 0)
		...
		case 1:
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
			{
				if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[1]))
			{
				...
				{
					if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
					{
						if (((unk_0xD5E14AF69C7C4DA9(iLocal_69[0], unk_0x9B0761B4C3EB8BC7()) || unk_0xD5E14AF69C7C4DA9(iLocal_69[1], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_69[0], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_69[1], unk_0x9B0761B4C3EB8BC7()))
						{
							unk_0xA785552633ED203B(iLocal_69[0], unk_0x9B0761B4C3EB8BC7(), 4000, 2056, 4);
							unk_0xA785552633ED203B(iLocal_69[1], unk_0x9B0761B4C3EB8BC7(), 4000, 2056, 4);
							if (!iLocal_57)
							{
								func_4();
								func_41(0);
					...
					else if (!unk_0x9934470AA0A08B57(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3))
					{
						if (!unk_0x04055E36623F131B(iLocal_69[0], iLocal_68, 10f))
						{
							unk_0xDEA135D03FA041A8(iLocal_69[0], iLocal_68, -1, 0);
						}
					}
				}
				else if (!unk_0xA59F96B50B97E63C(iLocal_77[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_77[1], 0))
				{
					func_4();
					func_41(0);
		...
		case 4:
			...
			while (iVar0 < iLocal_69)
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[iVar0]))
				{
					unk_0x8342E6CB98CD545C(iLocal_69[iVar0], 156, 1);
					unk_0x8FF9CE1C0F94F59A(iLocal_69[iVar0], unk_0x9B0761B4C3EB8BC7(), 0, 16);
					unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar0], 1);
				}
				iVar0++;
			}
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
			{
				unk_0xAEC92B0DA8075AC9(iLocal_68, -1);
			}
			iLocal_48++;
			break;
		...
		case 5:
			...
			if (unk_0x5AEB5DDFFAD43CA5(iLocal_69[0]) && unk_0x5AEB5DDFFAD43CA5(iLocal_69[1]))
			{
				iLocal_48 = 0;
				iLocal_47 = 1;
			}
...
void func_68()
{
	if (!unk_0x9A70B1BD2A5BA09C(916.4631f, 3601.261f, 31.9327f, 3f))
	{
		...
		{
			if (unk_0xC2169C00B643278B(unk_0xA5D3CD332CD10EE9(), 916.4631f, 3601.261f, 31.9327f, 2f, 2f, 2f, 0, 1, 0))
			{
				unk_0x03D382CB0B44E2FC(unk_0xA5D3CD332CD10EE9(), 915.6531f, 3595.061f, 32.0774f, 1, 0, 0, 1);
			}
		}
	}
}
...
int func_81(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		unk_0xFA81E0FBD7F5ACA0(uVar0, func_82(unk_0x25DDB354A40FFCDB(), 0.7f, 0.7f));
		unk_0x3060C53EAE54BBE7(uVar0, bParam1);
	}
...
int func_83()
{
	...
	if (!bLocal_55)
	{
		unk_0xEFBCE8F8316F89EA(255, uLocal_250, 1862763509);
		if (!unk_0xA59F96B50B97E63C(iLocal_69[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_69[1], 0))
		{
			if (unk_0xCDF860E56BBCC6B4(iLocal_69[0], unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xCDF860E56BBCC6B4(iLocal_69[1], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				func_4();
				return 1;
			}
			if (!unk_0xA59F96B50B97E63C(unk_0xA5D3CD332CD10EE9(), 0))
			{
				if (unk_0xCDF860E56BBCC6B4(iLocal_69[0], unk_0xA5D3CD332CD10EE9(), 1) || unk_0xCDF860E56BBCC6B4(iLocal_69[1], unk_0xA5D3CD332CD10EE9(), 1))
				{
					func_4();
					return 1;
				}
		...
		if (!unk_0xA59F96B50B97E63C(iLocal_77[0], 0) && !unk_0xA59F96B50B97E63C(iLocal_77[1], 0))
		{
			if (((unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_77[0], 0) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_77[1], 0)) || unk_0xCDF860E56BBCC6B4(iLocal_77[0], unk_0x9B0761B4C3EB8BC7(), 1)) || unk_0xCDF860E56BBCC6B4(iLocal_77[1], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[0]) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[1]))
				{
					if (func_99())
		...
		Var0 = { 15f, 15f, 15f };
		Var3 = { -15f, -15f, -15f };
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69[0]))
		{
			if (unk_0xC7EB33BFDB436C87(unk_0x1D5C49FCA9BC5B02(iLocal_69[0], 31086, 0f, 0f, 0f), 5f, 1))
			{
				func_4();
				return 1;
			}
			Var0 = { Var0 + unk_0x1D5C49FCA9BC5B02(iLocal_69[0], 31086, 0f, 0f, 0f) };
			Var3 = { Var3 + unk_0x1D5C49FCA9BC5B02(iLocal_69[0], 31086, 0f, 0f, 0f) };
			if (((unk_0x261234EE652E3D8D(Var3, Var0, joaat("weapon_smokegrenade"), 1) || unk_0x261234EE652E3D8D(Var3, Var0, joaat("weapon_grenade"), 1)) || unk_0x261234EE652E3D8D(Var3, Var0, joaat("weapon_grenadelauncher"), 1)) || unk_0x261234EE652E3D8D(Var3, Var0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
			if (unk_0x1F9CD729737E8653(unk_0x1D5C49FCA9BC5B02(iLocal_69[0], 31086, 0f, 0f, 0f), 3f))
			{
				func_4();
				return 1;
			}
		...
		if ((!unk_0x5AEB5DDFFAD43CA5(iLocal_68) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[0])) && !unk_0x5AEB5DDFFAD43CA5(iLocal_69[1]))
		{
			if (iLocal_49 != -1)
			{
				if (((unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_69[0]) || unk_0x5E5402F6D3B26AFB(unk_0x460153A63B9477BC(), iLocal_69[1])) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_69[0])) || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_69[1]))
				{
					func_4();
					return 1;
				}
			...
			if (unk_0x910DFF8E55ABB8EC(unk_0x9B0761B4C3EB8BC7(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
			{
				if (((unk_0xD5E14AF69C7C4DA9(iLocal_69[0], unk_0x9B0761B4C3EB8BC7()) || unk_0xD5E14AF69C7C4DA9(iLocal_69[1], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_69[0], unk_0x9B0761B4C3EB8BC7())) || unk_0x67E2125E6EC33DB7(iLocal_69[1], unk_0x9B0761B4C3EB8BC7()))
				{
					if (!iLocal_54)
					{
						unk_0xDEA135D03FA041A8(iLocal_69[0], unk_0x9B0761B4C3EB8BC7(), -1, 0);
						iLocal_54 = 1;
					}
					if (unk_0x8F678487EEBD8CE4(uLocal_60))
					{
						unk_0x3DBD102E8C35EA16(uLocal_60, 1);
					}
					if (unk_0x8F678487EEBD8CE4(uLocal_61[0]))
					{
						unk_0x3DBD102E8C35EA16(uLocal_61[0], 1);
					}
					if (unk_0x8F678487EEBD8CE4(uLocal_61[1]))
					{
						unk_0x3DBD102E8C35EA16(uLocal_61[1], 1);
					}
			...
			if (iLocal_49 != -1 && unk_0x578C4EF320340AF7() > iLocal_49 + 10000)
			{
				func_4();
				func_41(0);
			...
			if (!unk_0xCDF860E56BBCC6B4(iLocal_69[0], unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xCDF860E56BBCC6B4(iLocal_69[1], unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (unk_0xCDF860E56BBCC6B4(iLocal_68, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					if (func_99())
					{
						func_4();
...
void func_84()
{
	if (unk_0x80FF6C016CDB0FAF(uLocal_76, 0))
	{
		if ((!unk_0xC2169C00B643278B(uLocal_76, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !unk_0xE0B3BC41DDA88DF0(iLocal_68, iLocal_76, 0)) || unk_0xE0B3BC41DDA88DF0(unk_0x9B0761B4C3EB8BC7(), iLocal_76, 1))
		{
			func_64();
		}
	}
...
int func_85()
{
	...
	if (((((!unk_0xAE06B9E39EBDE049(iLocal_68) && !unk_0xAE06B9E39EBDE049(iLocal_69[0])) && !unk_0xAE06B9E39EBDE049(iLocal_69[1])) && !unk_0xAE06B9E39EBDE049(iLocal_76)) && !unk_0xAE06B9E39EBDE049(iLocal_77[0])) && !unk_0xAE06B9E39EBDE049(iLocal_77[1]))
	{
		...
		{
			unk_0x410A1E7AD7D5C774(joaat("picador"), 1);
			unk_0x410A1E7AD7D5C774(joaat("hexer"), 1);
			unk_0x01A2F6B26EAAEAC5(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f, 40.1064f, 100.0625f, 0, 0, 1);
			unk_0xC08A186299DFDA0A(Local_50 - Vector(20f, 50f, 80f), Local_50 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
			unk_0x40ECEB892E6BDDDB(3, 0);
			unk_0x40ECEB892E6BDDDB(5, 0);
			unk_0xDE8F8016287F771F("rghLost", &uLocal_250);
			unk_0xEFBCE8F8316F89EA(5, uLocal_250, 1862763509);
			iLocal_68 = unk_0xB3116B49FE00E2F1(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
			unk_0x45F588C0DD767737(iLocal_68, 0, 0, 1, 0);
			unk_0x45F588C0DD767737(iLocal_68, 2, 1, 0, 0);
			unk_0x45F588C0DD767737(iLocal_68, 3, 1, 2, 0);
			unk_0x45F588C0DD767737(iLocal_68, 4, 0, 0, 0);
			unk_0x74528AC0906CBABE(joaat("a_m_m_skidrow_01"));
			unk_0x4E65320BC9AD521C(iLocal_68, 1);
			unk_0x6673CC701BC8E9C1(iLocal_68, 17, 1);
			unk_0x0DC39BE87E4C5599(iLocal_68, 0);
			unk_0xDAE36360F0F8C1ED(iLocal_68, 1);
			unk_0x694113444F21E39F(iLocal_68, 185, 1);
			unk_0x642738D0DCA36EBA(iLocal_68, 16);
			unk_0x3A2AAE59B4681DAF(iLocal_68, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_63(&uLocal_85, 1, iLocal_68, "RECGFDealer", 0, 1);
			unk_0x44225B42FE388400(iLocal_68, 1);
			unk_0x756D74A3EF0AB788(iLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0xA3AB9D48A7E8EA48(iLocal_68, "move_m@gangster@var_i", 1048576000);
			iLocal_76 = unk_0xCE4780E24AFDFBF9(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
			unk_0x38633C69DE516059(iLocal_76, 37, 0);
			unk_0x88FCE2696F59472E(iLocal_76, 4, 0);
			unk_0x15A6C88D3C7C1882(iLocal_76, 1);
			unk_0xC29A9E1088D83B1B(iLocal_76, "WDU 696");
			iLocal_69[0] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, 1);
			func_63(&uLocal_85, 3, iLocal_69[0], "RECGFLost2", 0, 1);
			iLocal_69[1] = unk_0xB3116B49FE00E2F1(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, 1);
			func_63(&uLocal_85, 2, iLocal_69[1], "RECGFLost1", 0, 1);
			unk_0x74528AC0906CBABE(joaat("g_m_y_lost_01"));
			unk_0x74528AC0906CBABE(joaat("g_m_y_lost_02"));
			iLocal_77[0] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1, 0);
			iLocal_77[1] = unk_0xCE4780E24AFDFBF9(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1, 0);
			unk_0x74528AC0906CBABE(joaat("hexer"));
			unk_0x756D74A3EF0AB788(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(iLocal_69[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			{
				if (iVar0 < 2)
				{
					...
					unk_0x73745F8F1D07995D(iLocal_69[iVar0], 2);
					unk_0x6673CC701BC8E9C1(iLocal_69[iVar0], 50, 1);
					unk_0x54E3EF0852DA2CA4(iLocal_69[iVar0], 0);
					unk_0x92BD213E6A0E666B(iLocal_69[0], joaat("weapon_pistol"), -1, 1, 1);
					unk_0x92BD213E6A0E666B(iLocal_69[1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
					unk_0xCBA6B2B569DCAFD8(iLocal_69[iVar0], 1);
					unk_0x4E65320BC9AD521C(iLocal_69[iVar0], 1);
					unk_0xA5EAD2ACE2C8BBB2(iLocal_69[iVar0], 1, 1);
				}
				iVar0++;
			}
			iLocal_59 = unk_0x578C4EF320340AF7() + 1500;
			if (func_54() == 0)
			{
				func_63(&uLocal_85, 0, unk_0x9B0761B4C3EB8BC7(), "MICHAEL", 0, 1);
			}
			else if (func_54() == 1)
			{
				func_63(&uLocal_85, 0, unk_0x9B0761B4C3EB8BC7(), "FRANKLIN", 0, 1);
			}
			else if (func_54() == 2)
			{
				func_63(&uLocal_85, 0, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
			}
			return 1;
		}
	}
...
int func_86()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_97())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_118(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_146()
{
	...
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!unk_0x5AEB5DDFFAD43CA5(iLocal_68))
		{
			unk_0x694113444F21E39F(iLocal_68, 317, 1);
			unk_0xDAE36360F0F8C1ED(iLocal_68, 0);
			unk_0x4E65320BC9AD521C(iLocal_68, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_69)
		{
