...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_173())
		{
			...
			{
				fLocal_31 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_32);
			}
			func_171(&iVar1);
			func_31(&iVar2);
			if (iLocal_47 > 3)
		...
		case 4:
			...
			if (!unk_0xA59F96B50B97E63C(iLocal_54, 0) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
			{
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					...
					if (iVar2 == iLocal_54)
					{
						if (SYSTEM::VDIST2(Local_55, unk_0x3E4D3CCC220BDFB1(iLocal_28, 1)) < 100f)
						{
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_40(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_161()
{
	...
	if (!unk_0xAE06B9E39EBDE049(iLocal_29))
	{
		if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_32) < 2500f)
			{
