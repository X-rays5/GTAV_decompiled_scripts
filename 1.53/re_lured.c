...
void func_36()
{
	...
	else if (!iLocal_246 && !bLocal_244)
	{
		...
		{
			unk_0xEFBCE8F8316F89EA(5, uLocal_68, 1862763509);
			if (!unk_0x5AEB5DDFFAD43CA5(iLocal_70))
			{
				unk_0x9B94F6169B0DAEFD(iLocal_70);
		...
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			if (!unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6))
			{
				...
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_69))
				{
					...
					unk_0x9DC06E2A59C5AEBB(&uLocal_75);
					unk_0x88AEDBE3A7557929(0, Local_64, unk_0x9B0761B4C3EB8BC7(), 2f, 0, 0f, 4f, 1, 512, 0, -957453492, 20000);
...
int func_122()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_133())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_153(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
