...
void func_38()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_42() < 2)
		{
			if (unk_0xCE990E643CD9D0E5(Local_95[iVar2 /*4*/].f_1, 1))
			{
				func_39(unk_0xF1110FE23C67293A(iVar2));
				unk_0xBE20AB8238688965(&(Local_84.f_1), 1);
			}
			if (unk_0xCE990E643CD9D0E5(Local_95[iVar2 /*4*/].f_1, 4))
			{
				func_39(func_11());
				unk_0xBE20AB8238688965(&(Local_84.f_1), 7);
			}
			if (unk_0xCE990E643CD9D0E5(Local_95[iVar2 /*4*/].f_1, 0))
			{
				unk_0xBE20AB8238688965(&(Local_84.f_1), 0);
			}
			if (unk_0xCE990E643CD9D0E5(Local_95[iVar2 /*4*/].f_1, 2))
			{
				unk_0xBE20AB8238688965(&(Local_84.f_1), 4);
			}
		}
		...
		{
			if (unk_0xCE990E643CD9D0E5(Local_95[iVar2 /*4*/].f_1, 3))
			{
				iVar0++;
			}
		}
	...
	if (((func_17(unk_0x460153A63B9477BC()) || (func_95() && func_94())) && !unk_0xCE990E643CD9D0E5(Global_2540384.f_4655, 31)) && !bParam4)
	{
		...
		if (unk_0xAE06B9E39EBDE049(uVar1))
		{
			if (unk_0xD0390A93AF3907B8(uVar1))
			{
				...
				{
					if (func_9(unk_0xE4400E48E081F17A(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && unk_0xFC559366953F62B3()) && iParam1 < 4)
						{
							...
							{
								return func_79(iParam0, unk_0xE4400E48E081F17A(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
void func_100()
{
	switch (func_630())
	{
		...
		case 1:
			if (!unk_0xCE990E643CD9D0E5(uLocal_82, 2))
			{
				func_610();
			}
		...
		case 2:
			if (!unk_0xCE990E643CD9D0E5(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1, 3))
			{
				func_401(0, func_10());
				func_307();
				func_101();
...
void func_101()
{
	...
	if (!unk_0xCE990E643CD9D0E5(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1, 3))
	{
		...
		{
			unk_0xBE20AB8238688965(&(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1), 3);
			return;
		}
		if (func_306())
		{
		...
		{
			func_102(151, unk_0xCE990E643CD9D0E5(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1, 1), &Var0, 0);
		}
		unk_0xBE20AB8238688965(&(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1), 3);
	}
}
...
void func_102(int iParam0, bool bParam1, var uParam2, bool bParam3)
{
	...
	if (iVar0 > 0)
	{
		...
		func_135(iParam0, iVar0, iVar7, uVar4, iVar5, uParam2);
...
void func_144(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	switch (iParam1)
	{
		case 1704445500:
...
int func_150(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6, var uParam7, var uParam8, int iParam9, int iParam10)
{
	int iVar0;
...
int func_159(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, char* sParam8, bool bParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_169(iParam0, uParam2, iParam3, iParam4, iParam5, iParam6, iParam7, bParam9);
...
var func_169(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
	
	uVar0 = func_170(iParam0, 0, uParam1, iParam4, iParam5, 0, iParam6, 1, iParam2, iParam3, bParam7);
	return uVar0;
}

int func_170(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_127())
			{
				...
				iVar7 = func_267(unk_0x460153A63B9477BC(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
...
void func_403(var uParam0, var uParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	{
		if (func_478(uParam1, iParam2, uParam3, Global_1574191, 0, func_521(), iParam7))
		{
			func_477(1);
				...
				else
				{
					...
					if (uParam3->f_27 == 0)
					{
						...
						if (iParam2 == 28)
						{
							...
							while (iVar52 < 32)
							{
								if (func_9(unk_0xF1110FE23C67293A(iVar52), 0, 1))
								{
						...
						{
							iVar35 = unk_0xF1110FE23C67293A(iVar52);
							if (func_9(iVar35, 0, 1) && !unk_0xCE990E643CD9D0E5(iVar49, iVar35))
							{
								iVar35 = unk_0xF1110FE23C67293A(iVar52);
							}
							else
							...
							if (func_462(iVar35))
							{
								if (func_9(unk_0xF1110FE23C67293A(iVar52), 0, 1))
								{
									...
									*(uParam4[iVar52 /*13*/]) = { func_180(iVar35) };
									...
									uParam3->f_38[iVar44 /*2*/].f_1 = iVar53;
									func_418(iVar35, unk_0x72C1D3A1AB8CAA5B(iVar35), uParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
						...
						{
							func_415(uParam3, uParam1, iParam2);
						}
		...
		if (iVar2 != func_10())
		{
			if (func_9(iVar2, 0, 1))
			{
				if (uParam0->f_38[iVar0 /*2*/].f_1 != -1)
				{
					...
					func_416(uParam1, uParam0->f_38[iVar0 /*2*/].f_1, iVar1, Global_1590682[iVar0 /*883*/].f_211.f_6);
				}
			}
		}
		iVar0++;
...
int func_478(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, char* sParam6)
{
	struct<4> Var0;
	var uVar4;
	bool bVar5;
		...
		else
		{
			...
			if (!unk_0xCE990E643CD9D0E5(uParam2->f_33, 0))
			{
				...
				if (func_505(bVar6, uParam0, 0))
				{
					...
					uVar4 = func_502(iParam1, &(Global_4456448.f_82715), bParam4);
					Var0 = { func_500(iParam1) };
					if (bParam4)
					{
						func_497(uParam0, uVar4, "", 0, -1, -1, 1);
					}
					else if (iParam1 == 27)
					{
						func_490(uParam0, func_494(uParam2), func_491(uParam2), -1);
					}
					else if (iParam1 == 28)
					{
						...
						func_484(uParam0, sVar9, func_485(), -1);
					}
					else if (func_424())
					{
						uParam2->f_34 = Global_1574192;
						func_497(uParam0, uVar4, &Var0, 1, -1, Global_1574192, 1);
					}
					else if (bVar5)
					{
						iVar8 = func_479(iParam1);
						uParam2->f_34 = Global_1574192;
						func_497(uParam0, uVar4, "", 0, iVar8, Global_1574192, 1);
					}
					else
					{
						iVar8 = func_479(iParam1);
						func_497(uParam0, uVar4, &Var0, 1, iVar8, -1, 1);
					}
...
void func_484(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	if (unk_0x95EF219D38B20CFF(*uParam0))
	{
...
void func_497(var uParam0, char* sParam1, char* sParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
char* func_502(int iParam0, char* sParam1, bool bParam2)
{
	...
	if (iParam0 == 20 && (!func_424() || unk_0x7BCC91F3C1CF24E8(uParam1)))
	{
		uVar0 = func_503();
		return uVar0;
	}
...
void func_529()
{
	...
	{
		func_530(151, unk_0x3E4D3CCC220BDFB1(unk_0x1FA7B77001D60F9D(func_37()), 1), &uLocal_83, 1140457472, 1144750080, 0);
	}
}
...
void func_530(int iParam0, struct<3> Param1, var uParam4, float fParam5, float fParam6, int iParam7)
{
	...
	if (fVar0 < fParam5)
	{
		...
		if (!*uParam4 && func_9(unk_0x460153A63B9477BC(), 1, 1))
		{
			*uParam4 = 1;
			if (func_566(iParam0))
			{
	...
	else
	{
		...
		if (*uParam4 && func_9(unk_0x460153A63B9477BC(), 1, 1))
		{
			*uParam4 = 0;
			...
			if (iParam7 && !func_433(unk_0x460153A63B9477BC()))
			{
		...
		if ((unk_0xAE06B9E39EBDE049(Var0) && unk_0xA1914E72A0EB31D0(Var0)) && unk_0x9048E8838E822F21(Var0) == unk_0x1FA7B77001D60F9D(func_37()))
		{
			if (Var0.f_5)
			{
				if (unk_0xAE06B9E39EBDE049(Var0.f_1) && unk_0xA1914E72A0EB31D0(Var0.f_1))
				{
					...
					{
						unk_0xBE20AB8238688965(&(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1), 1);
					}
				}
			}
		}
...
int func_585(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
void func_610()
{
	...
	if (unk_0x460153A63B9477BC() != func_63())
	{
		...
		else
		{
			...
			unk_0xBE20AB8238688965(&(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1), 0);
		}
	}
...
void func_612(char* sParam0, var uParam1, int iParam2, int iParam3)
{
...
{
	Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2 = iParam0;
}
...
int func_630()
{
	return Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2;
}
...
void func_681(int iParam0, int iParam1)
{
	...
	func_253(func_682(iParam0), iParam1, -1, 1);
...
void func_695(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		func_253(15384, iParam1, -1, 1);
		return;
	}
	func_253(func_694(iParam0), iParam1, -1, 1);
}
...
int func_702(struct<21> Param0)
{
	...
	unk_0xBB96A3ECD45D0317(&Local_95, 129);
...
void func_722()
{
	...
	if (func_732())
	{
		...
		{
			func_731(11);
			uVar0 = func_124(7227, -1, 0);
			unk_0xBE20AB8238688965(&uVar0, 2);
			func_122(7227, uVar0, -1, 1, 0);
		}
	}
	if (func_730(48))
	{
