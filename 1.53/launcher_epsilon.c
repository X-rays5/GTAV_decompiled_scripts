...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			func_392();
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 237.926f, 360.2992f, 103.6515f, 244.6899f, 357.8277f, 107.3224f, 4.75f, 0, 1, 0))
			{
		...
		else if (Var0 == 11)
		{
			if (func_391(Var0.f_28[0]))
			{
				...
				if (func_371(Var0.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					{
						unk_0x9DC06E2A59C5AEBB(&uLocal_267);
						...
						unk_0x19F29730874AD6F1(uLocal_267);
						unk_0x9B6EC2CECE1010EF(Var0.f_28[0], uLocal_267);
					}
					else
					{
						unk_0x8B18A80E8EB15510(Var0.f_28[0], unk_0x9B0761B4C3EB8BC7(), 200f, -1, 0, 0);
					}
					unk_0xCBA6B2B569DCAFD8(Var0.f_28[0], 1);
		...
		else if (Var0 == 12)
		{
			...
			func_370();
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
			{
...
void func_144()
{
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_145(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_218(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_264(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_258(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_258(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_218(iParam0));
			if (iVar57 > iVar56)
			{
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
				{
					if (func_391(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
...
void func_337(var uParam0, int iParam1)
{
	if (!*iParam1)
	{
		if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), uParam0->f_17[0 /*3*/], 1) > 25f)
				{
...
void func_347()
{
	...
	{
		case 0:
			if ((unk_0x578C4EF320340AF7() - iLocal_263) > 20000)
			{
				iLocal_97 = 1;
			}
			break;
	...
	if (func_391(iParam0->f_28[0]))
	{
		switch (iLocal_272)
		{
			...
			case 1:
				...
				{
					unk_0x3C1B180EE30D36EF(iParam0->f_28[0], Local_274[iLocal_273 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
...
int func_364(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_328(2))
	{
		if (!func_363())
		{
			if (((func_391(unk_0x9B0761B4C3EB8BC7()) && func_391(uParam0->f_28[0])) && (unk_0x578C4EF320340AF7() - uParam0->f_60) > iParam8) && func_342(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f)
			{
				uVar0 = 16;
...
void func_368()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_342(unk_0x9B0761B4C3EB8BC7(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_264 == 0)
			{
...
void func_370()
{
	unk_0x830F007E19C63E14(uLocal_268, "SET_COLOUR");
	...
	unk_0x830F007E19C63E14(uLocal_268, "SET_DISTANCE");
	unk_0x49B9B8101B158AEE(10f);
	unk_0xE1FDD153F5858534();
	unk_0xCA1F114B668562E5(uLocal_269);
	unk_0xE6A03BA84586E67B(uLocal_268, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	if ((unk_0x578C4EF320340AF7() - iLocal_270) > 1250)
	{
		unk_0x057194D526464DC0(uLocal_271, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
...
int func_378(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_380(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_380(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_388(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_380(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
...
int func_390(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_391(unk_0x9B0761B4C3EB8BC7()) && func_391(uParam0->f_28[0])) && !func_363()) && (unk_0x578C4EF320340AF7() - uParam0->f_60) > iParam8) && func_342(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_432(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_367(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_392()
{
	...
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 244.9669f, 374.6696f, 104.4579f, 239.6119f, 360.3045f, 107.7523f, 9.0625f, 0, 1, 0))
	{
		Global_7556 = 1;
	}
	else
...
int func_398(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
		{
			...
			{
				iVar0 = unk_0x36FE6D3220816ADA(func_399(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 1)));
				switch (iVar0)
				{
...
void func_409()
{
	unk_0xEFBCE8F8316F89EA(5, uLocal_94, 1862763509);
...
void func_410(int iParam0)
{
	...
	if (func_391(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			...
			{
				unk_0x6673CC701BC8E9C1(iParam0->f_28[iVar0], 1, 0);
				unk_0x4E65320BC9AD521C(iParam0->f_28[iVar0], 0);
				unk_0xCBA6B2B569DCAFD8(iParam0->f_28[iVar0], 1);
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_414(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_414(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
void func_423(int iParam0)
{
	...
	if (func_391(unk_0x9B0761B4C3EB8BC7()) && func_391(uParam0))
	{
...
void func_431()
{
	uLocal_268 = unk_0x5DEA4192B46CB99B("digiscanner");
	while (!unk_0x95EF219D38B20CFF(uLocal_268))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0xA9A353D835A7867C("digiscanner"))
	{
		uLocal_269 = unk_0x2BC38EC678978375("digiscanner");
	}
	uLocal_271 = unk_0x5E54B0823F46079E();
	iLocal_270 = unk_0x578C4EF320340AF7();
}
...
int func_437(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			unk_0xDE8F8016287F771F("gang", &uLocal_94);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[0], uLocal_94);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[1], uLocal_94);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[2], uLocal_94);
			unk_0xD3D9D7C84656DAE5(uParam0->f_28[3], uLocal_94);
...
int func_444(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_442(&iVar0) || !unk_0xC614DDE265D18415(sVar5))
			{
				return 0;
			}
			iLocal_91 = 2;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[0]))
			{
				...
				{
					uVar4 = unk_0x86FB3A0D4870FE62(unk_0x9B0761B4C3EB8BC7());
					unk_0xD3D9D7C84656DAE5(uParam0->f_28[0], uVar4);
					unk_0x694113444F21E39F(uParam0->f_28[0], 132, 1);
				}
				else
				{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[1]))
			{
				...
				{
					unk_0xD3D9D7C84656DAE5(uParam0->f_28[1], uVar5);
...
void func_478(int iParam0, bool bParam1)
{
	...
	if (unk_0x8F678487EEBD8CE4(uLocal_266))
	{
		unk_0x93370FA10F15BE44(&uLocal_266);
	}
	if (iLocal_96 != -1)
	{
