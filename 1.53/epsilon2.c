...
void func_1()
{
	...
	unk_0x4E1F6B7FE1AAF7A7(iLocal_149, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_148)
	{
		case 0:
			iLocal_153 = 0;
			...
			iLocal_150 = unk_0x578C4EF320340AF7();
			iLocal_148 = 1;
			break;
		...
		case 1:
			...
			{
				if (!iLocal_153 && (unk_0x578C4EF320340AF7() - iLocal_150) > 15000)
				{
				...
				if (!iLocal_155 && !unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
				{
					if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
					{
						if (!unk_0x9A70B1BD2A5BA09C(242.1f, 360.7f, 105.7f, 1.5f))
						{
							fVar1 = 0f;
						}
						if (unk_0x0D77CDCF403AEBD2(fVar1) <= 0.05f && !iLocal_155)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_154 = 1;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_26(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_83(unk_0x36FE6D3220816ADA(uParam0), 14, iVar0, unk_0xEAF476EEF924D2C9(iParam0, 0, iParam2, iParam3)))
			{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_72(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_72(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_210(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_217(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_286(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_287(&uVar32, Var0.f_3, Global_98992, iParam1, iParam2);
	}
}
...
int func_331(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_337())
	{
		...
		{
			iVar33 = func_332(unk_0x6C5C6B207AA78253());
			if (iVar33 > -1)
			{
