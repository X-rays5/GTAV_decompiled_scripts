...
void __EntryFunction__()
{
	...
	unk_0xBAA4D421B8B8A744("REPORT", 0);
	...
	while (true)
	{
		switch (iLocal_52)
		{
			...
			case 1:
				...
				uLocal_53 = unk_0x5DEA4192B46CB99B("PSYCHOLOGY_REPORT");
				while (!unk_0x95EF219D38B20CFF(uLocal_53))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
				unk_0xBAA4D421B8B8A744("REPORT", 3);
				while (!unk_0xF5EE205091CE6DB2(3))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
				unk_0x830F007E19C63E14(uLocal_53, "SET_PLAYER_NAME");
				unk_0xB23270F3D5E62FDE("STRING");
				unk_0x6A826E35A3096ED0("PATIENT");
				unk_0x2042E9CA4306F725();
				unk_0xB23270F3D5E62FDE("GAMERTAG");
				...
				{
					unk_0x6A826E35A3096ED0("ACCNA_MIKE");
				}
				unk_0x2042E9CA4306F725();
				unk_0xE1FDD153F5858534();
				unk_0x830F007E19C63E14(uLocal_53, "SET_LETTER_TEXT");
				func_42("HEADER_1");
				func_42("HEADER_2");
				...
				if (unk_0x03DB5C6AABF8DA46())
				{
					...
					while (!unk_0x87F0CB19476706C3())
					{
						...
						unk_0x37FC7E88C7659D33(uLocal_53, 255, 255, 255, 255, 0);
						SYSTEM::WAIT(0);
					}
				}
				func_43();
			...
			case 3:
				...
				unk_0x2E352DDBBF674246(&uLocal_53);
...
void func_1(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_6(uParam0->f_1, 256) || (func_6(uParam0->f_1, 8192) && unk_0x628AF533B14EF310(2)))
	{
		...
		if (unk_0xF8EDFF98A9C94C74())
		{
			...
			unk_0xF1B28F753235CE2A(func_6(uParam0->f_1, 4096));
			unk_0xE1FDD153F5858534();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_13(var uParam0, var uParam1, var uParam2)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			unk_0x196EF710ED0C1363(iVar0, "in", *uParam2);
			unk_0x357BF1136612718A(iVar0, "st", &(uParam2->f_1));
			unk_0x357BF1136612718A(iVar0, "mp", &(uParam2->f_2));
			unk_0x357BF1136612718A(iVar0, "ms", &(uParam2->f_3));
			unk_0x357BF1136612718A(iVar0, "sc", &(uParam2->f_5));
			unk_0x357BF1136612718A(iVar0, "pr", &(uParam2->f_6));
			unk_0x357BF1136612718A(iVar0, "fa", &(uParam2->f_7));
			unk_0x357BF1136612718A(iVar0, "sm", &(uParam2->f_8));
			unk_0x357BF1136612718A(iVar0, "kp", &(uParam2->f_9));
			unk_0x357BF1136612718A(iVar0, "sv", &(uParam2->f_10));
			unk_0x357BF1136612718A(iVar0, "yo", &(uParam2->f_11));
			unk_0x357BF1136612718A(iVar0, "fi", &(uParam2->f_12));
			unk_0x357BF1136612718A(iVar0, "rc", &(uParam2->f_13));
			unk_0x357BF1136612718A(iVar0, "co", &(uParam2->f_14));
			unk_0x196EF710ED0C1363(iVar0, "su", uParam2->f_15);
			unk_0x8AA009814739AD67("gta5/psych/index.json");
			*uParam0++;
			break;
...
{
	if (!unk_0x94F7712E49C86C6C(uParam0))
	{
		if (*uParam0)
		{
			if (unk_0xE52A8802193E5624() != 0 && iParam1)
			{
...
struct<4> func_20(var uParam0)
{
	...
	iVar4 = unk_0x344C570D6F8700DF(1, 24);
	uParam0->f_15 = iVar4;
...
struct<4> func_21(var uParam0)
{
	...
	if (((func_22(110) || func_22(95)) || func_22(106)) || func_22(107))
	{
		...
		iVar4 = unk_0x344C570D6F8700DF(1, 11);
	}
	else
	{
		StringCopy(&(uParam0->f_14), "N", 4);
		StringConCat(&Var0, "N", 16);
		iVar4 = unk_0x344C570D6F8700DF(1, 12);
	}
...
struct<4> func_23(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("NUM_RNDPEOPLE_COMPLETED"), &iVar5, -1);
	unk_0xD2F202166691EDB2(joaat("NUM_RNDEVENTS_COMPLETED"), &iVar6, -1);
	iVar7 = (iVar5 + iVar6);
	if (iVar7 > 10)
	{
	...
	iVar4 = unk_0x344C570D6F8700DF(1, 13);
...
struct<4> func_30(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_COP_VEHICLE"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_CARS"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_BIKES"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_BOATS"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_HELIS"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_QUADBIKES"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_NUMBER_STOLEN_BICYCLES"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_COP_VEHICLE"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_CARS"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_BIKES"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_BOATS"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_HELIS"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_QUADBIKES"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_NUMBER_STOLEN_BICYCLES"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_COP_VEHICLE"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_CARS"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_BIKES"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_BOATS"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_HELIS"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_QUADBIKES"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_NUMBER_STOLEN_BICYCLES"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	if (iVar6 >= 100)
	{
...
struct<4> func_31(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("SP0_KILLS_INNOCENTS"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_KILLS_INNOCENTS"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_KILLS_INNOCENTS"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	if (iVar6 >= 100)
	{
...
struct<4> func_32(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("TIME_SPENT_ON_STOCKMARKET"), &iVar5, 0);
	if (iVar5 >= 120000)
	{
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return unk_0xCE990E643CD9D0E5(Global_111858.f_18099.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
struct<4> func_37(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("SP0_LAP_DANCED_BOUGHT"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_LAP_DANCED_BOUGHT"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_LAP_DANCED_BOUGHT"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), &iVar7, 0);
	iVar8 = (iVar8 + iVar7);
	unk_0xD2F202166691EDB2(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), &iVar7, 1);
	iVar8 = (iVar8 + iVar7);
	unk_0xD2F202166691EDB2(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), &iVar7, 2);
	iVar8 = (iVar8 + iVar7);
...
struct<4> func_38(var uParam0)
{
	...
	unk_0xD2F202166691EDB2(joaat("SP0_MONEY_TOTAL_SPENT"), &iVar5, 0);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP1_MONEY_TOTAL_SPENT"), &iVar5, 1);
	iVar6 = (iVar6 + iVar5);
	unk_0xD2F202166691EDB2(joaat("SP2_MONEY_TOTAL_SPENT"), &iVar5, 2);
	iVar6 = (iVar6 + iVar5);
	if (iVar6 >= 1000000)
	{
		StringCopy(&(uParam0->f_3), "SP", 8);
		StringConCat(&Var0, "SP", 16);
		iVar4 = unk_0x344C570D6F8700DF(1, 14);
	}
	else
	{
...
struct<4> func_39(var uParam0)
{
	...
	iVar5 = 0;
	iVar7 = 0;
	unk_0xD2F202166691EDB2(joaat("SP0_TOTAL_PLAYING_TIME"), &iVar7, 0);
	unk_0xD2F202166691EDB2(joaat("SP1_TOTAL_PLAYING_TIME"), &iVar6, 1);
	if (iVar6 > iVar7)
	{
		iVar7 = iVar6;
		iVar5 = 1;
	}
	unk_0xD2F202166691EDB2(joaat("SP2_TOTAL_PLAYING_TIME"), &iVar6, 2);
	if (iVar6 > iVar7)
	{
		iVar7 = iVar6;
		iVar5 = 2;
...
struct<4> func_41(var uParam0)
{
	...
	iVar4 = unk_0x344C570D6F8700DF(1, 21);
	*uParam0 = iVar4;
	StringIntConCat(&Var0, iVar4, 16);
	return Var0;
}
