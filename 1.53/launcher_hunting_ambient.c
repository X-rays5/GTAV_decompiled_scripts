...
void __EntryFunction__()
{
	...
	if (unk_0x7B70881748D166CD(unk_0x02406178CDC27728()) > 1 && !func_87(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
		...
		if (unk_0xAE06B9E39EBDE049(uLocal_85) && !unk_0xA59F96B50B97E63C(iLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_73(3) && !Global_98989)
						{
							...
							{
								if ((!func_87(uLocal_94, 1) || !unk_0xAE06B9E39EBDE049(func_72())) && !Global_98989)
								{
									func_80(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_44(uLocal_86))
								{
									...
									else if (!func_87(uLocal_94, 2048) || !unk_0xDABD547F0DF2906C())
									{
										func_42(&iLocal_96);
				...
				case 6:
					...
					if (func_87(uLocal_94, 2097152))
					{
						if (!func_73(3) && !unk_0x7FD2BDF03806FD9D(uLocal_52))
						{
							func_80(10);
						}
					}
...
void func_23()
{
	if (bLocal_125)
	{
		if (bLocal_126)
		{
			...
			{
				unk_0xE730EAF558C97567(&iLocal_123);
			}
...
void func_38()
{
	...
	if ((unk_0xAE06B9E39EBDE049(iLocal_124) && !unk_0xA59F96B50B97E63C(iLocal_124, 0)) && !unk_0x0922C2E075A5F18C(iLocal_124))
	{
		unk_0x5DC21979EC6C531F(iLocal_124, 2);
		unk_0x1515637D39F697C4(iLocal_124, 1);
		unk_0x74172B5AFD503628(iLocal_124, 0, 0);
		unk_0x1AB8D7ECA49F6A6C(iLocal_124, 1);
		uLocal_122 = iLocal_124;
		if (unk_0xAE06B9E39EBDE049(iLocal_123) && !unk_0xA59F96B50B97E63C(iLocal_123, 0))
		{
			unk_0x1515637D39F697C4(iLocal_123, 1);
			unk_0x1AB8D7ECA49F6A6C(iLocal_123, 1);
			unk_0x74172B5AFD503628(iLocal_123, 0, 0);
			unk_0x289D342D7C2DA52A(iLocal_123, 1);
		}
	}
	else
	{
		if ((unk_0xAE06B9E39EBDE049(iLocal_124) && unk_0xA59F96B50B97E63C(iLocal_124, 0)) || !unk_0xAE06B9E39EBDE049(iLocal_124))
		{
			func_39(0);
		}
		if ((unk_0xAE06B9E39EBDE049(iLocal_123) && unk_0xA59F96B50B97E63C(iLocal_123, 0)) || !unk_0xAE06B9E39EBDE049(iLocal_123))
		{
			func_39(0);
		}
		if ((iLocal_128 && unk_0xC614DDE265D18415("oddjobs@hunterIntro")) && unk_0xC614DDE265D18415("oddjobs@hunterOutro"))
		{
	...
	else if ((iLocal_128 && unk_0xC614DDE265D18415("oddjobs@hunterIntro")) && unk_0xC614DDE265D18415("oddjobs@hunterOutro"))
	{
		unk_0x1082C25039B168F8("oddjobs@hunterIntro");
		unk_0x1082C25039B168F8("oddjobs@hunterOutro");
		iLocal_128 = 0;
...
void func_77()
{
	if (bLocal_125)
	{
		...
		if (!iLocal_127)
		{
			unk_0xF27E737981AFB47D(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, 0, 0);
			if (!unk_0xAE06B9E39EBDE049(iLocal_123))
			{
				iLocal_123 = unk_0xCE4780E24AFDFBF9(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
			}
			if (!unk_0xAE06B9E39EBDE049(iLocal_124))
			{
				iLocal_124 = unk_0xCE4780E24AFDFBF9(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
				unk_0x494ACC4552B7881B(iLocal_124, 1);
			}
			iLocal_127 = 1;
		}
	}
