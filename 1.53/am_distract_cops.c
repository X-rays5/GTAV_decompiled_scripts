	...
	while (true)
	{
		...
		switch (func_251(unk_0x59E2AD1A8ACEDA31()))
		{
			case 0:
				...
				{
					func_249();
					Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/] = 1;
				}
				else if (func_250() == 4)
				{
					Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/] = 4;
				}
				break;
...
void func_11()
{
	...
	if (Local_75 == 1)
	{
		if (unk_0xBD09DF93F957A0CF(unk_0x628A51AC66E80772(iLocal_230)))
		{
			iVar0 = unk_0x9019589211A13B02(unk_0x628A51AC66E80772(iLocal_230));
			if (func_278(iVar0, 1, 1))
			{
				if (!unk_0xCE990E643CD9D0E5(Local_75.f_1, 0))
				{
					if (unk_0xCE990E643CD9D0E5(Local_95[iLocal_230 /*4*/].f_1, 0))
					{
						iLocal_231 = 1;
	...
	iLocal_230++;
	if (iLocal_230 == unk_0xEFA28384DDD283E1())
	{
		if (iLocal_231 == 0)
		{
			if (unk_0xCE990E643CD9D0E5(Local_75.f_1, 0))
...
void func_14()
{
	...
	if (!unk_0xCE990E643CD9D0E5(iLocal_224, 1))
	{
		if ((unk_0xCE990E643CD9D0E5(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1, 0) && unk_0x1A3D0DF92BF7D8C4(unk_0x460153A63B9477BC()) >= (Local_75.f_16 - 1)) && Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2 < 10)
		{
			Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2++;
		}
		if (Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_2 * Global_262145.f_8102);
			...
			if (unk_0xCE990E643CD9D0E5(iLocal_224, 4))
			{
				if (!unk_0xCE990E643CD9D0E5(iLocal_224, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		unk_0xBE20AB8238688965(&iLocal_224, 1);
	}
}
...
int func_17(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2589533[iParam0 /*3*/][func_18(iParam1)];
	...
	if (((func_71(unk_0x460153A63B9477BC()) || (func_70() && func_69())) && !unk_0xCE990E643CD9D0E5(Global_2540384.f_4655, 31)) && !bParam4)
	{
		...
		if (unk_0xAE06B9E39EBDE049(uVar1))
		{
			if (unk_0xD0390A93AF3907B8(uVar1))
			{
				...
				{
					if (func_278(unk_0xE4400E48E081F17A(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && unk_0xFC559366953F62B3()) && iParam1 < 4)
						{
							...
							{
								return func_52(iParam0, unk_0xE4400E48E081F17A(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
void func_93(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	switch (iParam1)
	{
		case 1704445500:
...
int func_99(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6, var uParam7, var uParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_113(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	int iVar0;
...
void func_129()
{
	...
	if (unk_0x8F678487EEBD8CE4(uLocal_225))
	{
		...
		{
			unk_0x14C1B9C77E952C6F(uLocal_225, 0);
		}
		else
		{
			unk_0x14C1B9C77E952C6F(uLocal_225, 4);
		}
	}
	switch (Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_3)
	{
		case 0:
			if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_75.f_2, Local_75.f_5, Local_75.f_5, 1000f, 0, 1, 0))
			{
				...
				Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_3 = 1;
			}
			if (Local_75.f_7 > 1)
			{
				Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_3 = 2;
			}
			break;
...
void func_131()
{
	if (!unk_0xCE990E643CD9D0E5(iLocal_224, 5))
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_224, 4))
		{
			if (Local_75.f_17 == 0)
			{
				unk_0xBE20AB8238688965(&iLocal_224, 4);
			}
			else
			{
				unk_0xBE20AB8238688965(&iLocal_224, 5);
			}
		}
...
void func_141(int iParam0, int iParam1, char* sParam2, var uParam3)
{
	struct<3> Var0;
	...
	func_146(Var0, iParam1, 0, sParam2, uParam3);
}
...
void func_146(struct<3> Param0, int iParam3, int iParam4, char* sParam5, var uParam6)
{
	int iVar0;
	int iVar1;
...
void func_195()
{
	...
	{
		func_198();
		Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_3 = 0;
	}
	else if (!unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_75.f_2, Local_75.f_6, Local_75.f_6, 950f, 0, 1, 0))
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_224, 0) && unk_0xCE990E643CD9D0E5(iLocal_224, 3))
		{
			if (!unk_0xDABD547F0DF2906C() && !func_197())
			{
				...
				unk_0xBE20AB8238688965(&iLocal_224, 0);
			}
		}
	}
	else
	{
		if (!unk_0xCE990E643CD9D0E5(iLocal_224, 3))
		{
			unk_0xBE20AB8238688965(&iLocal_224, 3);
		}
		if (unk_0xCE990E643CD9D0E5(iLocal_224, 0))
		{
			unk_0xD2459066EA58CE43(&iLocal_224, 0);
		}
	}
}
...
void func_198()
{
	...
	func_5(&uLocal_228);
	func_199();
	unk_0xD2459066EA58CE43(&(Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/].f_1), 0);
	unk_0xD2459066EA58CE43(&iLocal_224, 3);
	unk_0xBE20AB8238688965(&(Global_2540384.f_4656), 0);
	if (!unk_0xCE990E643CD9D0E5(iLocal_224, 5))
	{
		unk_0xBE20AB8238688965(&iLocal_224, 5);
...
void func_199()
{
	if (unk_0xCE990E643CD9D0E5(iLocal_224, 2))
	{
		func_200(1, 1, 0);
		unk_0xD2459066EA58CE43(&iLocal_224, 2);
	}
}
...
void func_221()
{
	if (!unk_0xCE990E643CD9D0E5(iLocal_224, 2))
	{
		...
		unk_0xBE20AB8238688965(&iLocal_224, 2);
	}
}
...
void func_224(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9)
{
	...
	if (func_233(unk_0x460153A63B9477BC()) || uParam9)
	{
		if (Var0.f_10 == 1)
		{
...
bool func_246(int iParam0)
{
	...
	uVar0 = func_193(2481, -1, 0);
	return unk_0xCE990E643CD9D0E5(uVar0, iParam0);
}

void func_247()
{
	if (!unk_0xCE990E643CD9D0E5(iLocal_224, 6))
	{
		if (((((((func_248(60000) && func_250() == 1) && Local_75.f_7 <= 1) && !unk_0xDABD547F0DF2906C()) && !unk_0xF0C12886E5C1B20E()) && func_278(unk_0x460153A63B9477BC(), 1, 1)) && !func_197()) && Local_75.f_16 != 5)
		{
			...
			unk_0xBE20AB8238688965(&iLocal_224, 6);
		}
	}
}
...
void func_249()
{
	...
	{
		uLocal_225 = unk_0x5F920D11DDA03179(Local_75.f_2, Local_75.f_5);
		unk_0xECC9A00CF1181EC2(uLocal_225, 50);
		unk_0xB7F03636BDF7080E(uLocal_225, 220);
		unk_0x3DBD102E8C35EA16(uLocal_225, 0);
		unk_0xB023F5C66F5716C7(uLocal_225, "DCP_BLIPN");
		if (func_245())
		{
			unk_0x14C1B9C77E952C6F(uLocal_225, 0);
		}
...
void func_267()
{
	if (unk_0x8F678487EEBD8CE4(uLocal_225))
	{
		unk_0x93370FA10F15BE44(&uLocal_225);
	}
...
void func_270(struct<21> Param0)
{
	...
	if (unk_0x25DDB354A40FFCDB())
	{
		...
		func_269(16, 1);
		Local_95[unk_0x59E2AD1A8ACEDA31() /*4*/] = 0;
	}
	else
	{
		func_267();
...
void func_276(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_268();
