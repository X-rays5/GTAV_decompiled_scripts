	...
	if (unk_0xCE990E643CD9D0E5(Local_1406[unk_0x59E2AD1A8ACEDA31() /*5*/].f_2, 0))
	{
		...
		if (iLocal_396 == 1)
		{
			...
			else
			{
				...
				unk_0xBF92D2A60C7C686E(Local_325, unk_0x090239DEAF625B17(unk_0x9B0761B4C3EB8BC7(), 2) + Local_325.f_14, 2);
...
void func_113()
{
	...
	if (func_44(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (bLocal_323)
		{
			...
			unk_0x415CB5738253CAB6(Local_325, unk_0x9B0761B4C3EB8BC7(), 31086, 0f, -0.25f, 0f, 1);
		}
		else
		{
...
Vector3 func_152(int iParam0)
{
	...
	return unk_0x7EC595B99EA7C4B1(uLocal_307, 0f, (15.3f * SYSTEM::SIN(fVar0)), (-15.3f * SYSTEM::COS(fVar0)));
}
