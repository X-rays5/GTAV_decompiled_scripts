...
int func_34()
{
	...
	if (!func_55())
	{
		...
		while (iVar0 < 3)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(uLocal_85[iVar0]))
			{
				if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), unk_0x3E4D3CCC220BDFB1(uLocal_85[iVar0], 0)) < 400f)
				{
					if (!iLocal_62)
					{
						if (iLocal_83 == 2)
					...
					else if (!iLocal_64)
					{
						...
						{
							unk_0xEFBCE8F8316F89EA(5, uLocal_97, 1862763509);
					...
					else if (!func_55())
					{
						...
						if (SYSTEM::TIMERA() > 5000 && !unk_0x4FCA2ADE072802D1(uLocal_85[iVar0]))
						{
							func_54(&uLocal_99, 1);
							func_53(&uLocal_99, 1, uLocal_85[iVar0], "BorderPatrol", 0, 1);
							if (func_35() == 0)
...
int func_56()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0x5AEB5DDFFAD43CA5(uLocal_85[iVar0]))
		{
			if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), unk_0x3E4D3CCC220BDFB1(uLocal_85[iVar0], 0)) < 62500f)
			{
				return 1;
			}
			else
			...
			if (iLocal_64 || iLocal_65)
			{
				if (unk_0x47DBF174A0CB9D55(uLocal_85[iVar0], 0))
				{
					if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && !iLocal_67[iVar0])
					{
						...
						if (!iLocal_65)
						{
							SYSTEM::WAIT(unk_0x344C570D6F8700DF(400, 800));
						}
						else
						{
							SYSTEM::WAIT(0);
		...
		else
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				if (!unk_0x9A70B1BD2A5BA09C(Var0, 5f))
				{
					...
					unk_0xEFBCE8F8316F89EA(3, uLocal_97, 1862763509);
					iVar4 = 0;
					while (iVar4 < 3)
					{
...
int func_73()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_80())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_105(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
