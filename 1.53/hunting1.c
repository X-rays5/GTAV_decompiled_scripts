...
void __EntryFunction__()
{
	...
	uLocal_82 = unk_0xB3A5FF195E1A8192(joaat("weapon_sniperrifle"));
	uLocal_83 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_scope_large"));
	uLocal_84 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_ar_supp_02"));
	...
	func_515(25);
	func_514();
	func_513(&uLocal_153, 2, unk_0x9B0761B4C3EB8BC7(), "TREVOR", 0, 1);
...
void func_1()
{
	switch (iLocal_321)
	{
		case 0:
			...
			func_7();
			if (unk_0x7BCC91F3C1CF24E8(sLocal_738))
			{
				func_541(1);
			}
			else
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_82(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_93(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_82(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_167(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_168(&uVar32, Var0.f_3, Global_98992, iParam1, iParam2);
	}
}
...
void func_224()
{
	if (iLocal_621)
	{
		...
		unk_0x8F1B063BE96C56C5(unk_0x9B0761B4C3EB8BC7(), joaat("AMMO_SNIPER"), uLocal_723);
	}
	else
	{
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46())
			{
				...
				if (func_308(unk_0x9B0761B4C3EB8BC7()))
				{
					...
					if (!func_212())
					{
						func_229(unk_0x9B0761B4C3EB8BC7(), Local_913, fLocal_916, 0, 1);
					}
					if (func_308(iLocal_734))
					{
						unk_0xA785552633ED203B(unk_0x9B0761B4C3EB8BC7(), iLocal_734, -1, 0, 2);
					}
					func_228(1);
					func_226(0);
				}
...
void func_226(bool bParam0)
{
	if (func_308(iLocal_734))
	{
		if (bParam0)
		{
			...
			{
				if (!unk_0xFE6F151E15A69B3A(iLocal_734, func_227()))
				{
					unk_0x9B94F6169B0DAEFD(iLocal_734);
					unk_0xE19B69814D61BBA5(iLocal_734, func_227());
					unk_0x10162EF76529C10F(iLocal_734, 1);
					unk_0x6A8F948698B360B4(iLocal_734, 0);
				}
			}
		}
		else if (unk_0xFE6F151E15A69B3A(iLocal_734, func_227()))
		{
			unk_0x9B94F6169B0DAEFD(iLocal_734);
			unk_0x59478CBBF96AF7D1(iLocal_734);
		}
	}
}
...
void func_231(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_209(unk_0x6C5C6B207AA78253(), 1);
			if (iVar5 != -1)
			{
...
int func_268(var uParam0)
{
	if (!unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_290())
		{
			*uParam0 = func_273(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), 6, -1, 0, 1, -1);
...
int func_273(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 53)
	{
		if (iParam3 == 6 || iParam3 == func_289(iVar0))
		{
			...
			{
				fVar1 = unk_0x272784C60C397DB6(Param0, func_274(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_297(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_310()
{
	...
	if (iLocal_724 < 3)
	{
		if (!bLocal_641)
		{
			if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_769, Local_772, 20f, 0, 1, 0))
			{
				func_321();
				if (iLocal_659[17])
				{
...
void func_311()
{
	...
	while (iVar23 < 4)
	{
		if (unk_0x57CE9BB39C5D1674(iVar18[iVar23], Var0[iVar23 /*3*/], 1))
		{
			uLocal_975[iVar23] = unk_0xCE4780E24AFDFBF9(iVar18[iVar23], Var0[iVar23 /*3*/], fVar13[iVar23], 1, 1, 0);
		}
		iVar23++;
	}
...
void func_312()
{
	unk_0x74528AC0906CBABE(iLocal_729);
	unk_0x74528AC0906CBABE(iLocal_730);
}
...
{
	if (!unk_0x8F678487EEBD8CE4(iLocal_610))
	{
	...
	if (unk_0x8F678487EEBD8CE4(iLocal_610))
	{
		if (!bParam0)
		{
			unk_0xFA81E0FBD7F5ACA0(iLocal_610, 0.75f);
		}
		unk_0x009A89A6CD1E6C3E(iLocal_610, iParam1);
	}
}
		...
		while (iVar1 < 3)
		{
			if (((Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_499[iVar0 /*54*/].f_52 != 4) && Local_499[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_308(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_499[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						Local_959[iVar0 /*3*/] = { unk_0x3E4D3CCC220BDFB1(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_687[iVar0] = 1;
						Local_499[iVar0 /*54*/][iVar1 /*17*/].f_1 = 1;
						if (Local_499[iVar0 /*54*/][0 /*17*/].f_1 == 1)
						{
							if (!unk_0xA59F96B50B97E63C(Local_499[iVar0 /*54*/][1 /*17*/].f_6, 0))
							{
								Local_499[iVar0 /*54*/][1 /*17*/].f_4 = 0;
								iLocal_715 = 1;
							}
							else if (!unk_0xA59F96B50B97E63C(Local_499[iVar0 /*54*/][2 /*17*/].f_6, 0))
							{
				...
				else if (unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
					...
					while (iLocal_716 < 3)
					{
						...
						{
							Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_14 = { unk_0x3E4D3CCC220BDFB1(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 1) };
							Local_499[iVar0 /*54*/].f_52 = 4;
						}
			...
			switch (Local_499[iVar0 /*54*/].f_52)
			{
				...
				case 4:
					...
					while (iLocal_716 < 3)
					{
						if ((unk_0xAE06B9E39EBDE049(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 0)) && !unk_0x5AEB5DDFFAD43CA5(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6))
						{
				...
				case 2:
					...
					while (iLocal_716 < 3)
					{
						...
						{
							if (unk_0xAE06B9E39EBDE049(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 0))
							{
								unk_0x9FBD956DCE20684B(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, Local_959[iVar0 /*3*/], unk_0x658086F2B3C5E4E4(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_323(int iParam0, int iParam1)
{
	...
	{
		if (!unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
		{
			unk_0xB2C1D6D444EE963F(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
		}
	...
	switch (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 = (unk_0x578C4EF320340AF7() + unk_0x344C570D6F8700DF(3000, 8000));
		...
		case 4:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0x578C4EF320340AF7() > Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
					...
					while (iVar0 < 3)
					{
						if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6, 0))
						{
		...
		case 5:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 = unk_0x344C570D6F8700DF(0, 8);
				if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						unk_0x3C1B180EE30D36EF(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, unk_0x658086F2B3C5E4E4(0f, 359.9f));
					}
					else if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0))
					{
						unk_0x5596A69ED9CF00FF(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && unk_0xC2169C00B643278B(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_326(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							unk_0x9B94F6169B0DAEFD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
							unk_0x885D6EB4167FC3E8(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					unk_0xD66FADEF7D42D49B(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					unk_0xD66FADEF7D42D49B(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
				unk_0xCBA6B2B569DCAFD8(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
		...
		case 12:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_687[iParam0])
				{
					...
					{
						unk_0x9FBD956DCE20684B(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_959[iParam0 /*3*/], unk_0x658086F2B3C5E4E4(1f, 2.5f), 0, 0, 786603, -1082130432);
		...
		case 8:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0))
				{
					unk_0x5596A69ED9CF00FF(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		case 13:
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
				{
				...
				unk_0xBB7976F6FB9C9DD2(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
			}
...
{
	if ((((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_769, Local_772, 20f, 0, 1, 0) && unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_633) && iLocal_724 < 3)
	{
		if (!unk_0x8F678487EEBD8CE4(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/] = func_315(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (unk_0x8F678487EEBD8CE4(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
			{
				unk_0xFA81E0FBD7F5ACA0(Local_499[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!unk_0xA59F96B50B97E63C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				unk_0xC62EE91883AF24A2(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			}
		}
	}
	else
...
void func_346(int iParam0, int iParam1)
{
	...
	if (!func_308(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0xB3116B49FE00E2F1(26, iLocal_727, Var0, unk_0x658086F2B3C5E4E4(0f, 359.9f), 1, 1);
		if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
			unk_0x697DA7132EE43ABC(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
			unk_0x4E65320BC9AD521C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3 = 8;
		}
	}
}
...
void func_347(int iParam0, int iParam1)
{
	if (!func_308(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5 = unk_0x658086F2B3C5E4E4(0f, 359.9f);
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = unk_0xB3116B49FE00E2F1(26, iLocal_727, Local_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (unk_0xAE06B9E39EBDE049(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				unk_0x697DA7132EE43ABC(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				unk_0x4E65320BC9AD521C(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
void func_348(int iParam0, int iParam1)
{
	if (func_349())
	{
		unk_0x2DB2D4C3CB88500D(-1, "COYOTE_BARK_MASTER", Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
	else
	{
		unk_0x2DB2D4C3CB88500D(-1, "COYOTE_CRY_MASTER", Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46())
			{
				...
				if (!func_212())
				{
					func_229(unk_0x9B0761B4C3EB8BC7(), Local_803, fLocal_806, 0, 1);
					func_352();
				}
				iLocal_321 = 2;
			}
...
void func_356()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0x8F678487EEBD8CE4(Local_322[iVar0 /*10*/].f_9))
		{
			unk_0x93370FA10F15BE44(&(Local_322[iVar0 /*10*/].f_9));
		}
	...
	if (iLocal_618)
	{
		unk_0x74528AC0906CBABE(iLocal_726);
	}
}
...
void func_359()
{
	unk_0x78FCB2E22C41B9D5(iLocal_729);
	unk_0x78FCB2E22C41B9D5(iLocal_730);
	while (!unk_0x7D167B9A0CCDA347(iLocal_729) || !unk_0x7D167B9A0CCDA347(iLocal_730))
	{
		SYSTEM::WAIT(0);
	}
}
...
int func_361()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_734) && !unk_0xA59F96B50B97E63C(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!unk_0x910DFF8E55ABB8EC(iLocal_734, unk_0x9B0761B4C3EB8BC7(), Local_775, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_363()
{
	...
	func_364();
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_907, Local_910, 3.5f, 0, 1, 0) || iLocal_659[16])
	{
		func_358();
		func_351();
		iLocal_318 = 15;
...
void func_364()
{
	...
	while (iVar0 < 5)
	{
		...
		{
			func_378(iVar0);
			if (unk_0xAE06B9E39EBDE049(Local_353[iVar0 /*29*/].f_28))
			{
				if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_763, Local_766, 10f, 0, 1, 0))
				{
					if (!bLocal_636)
					{
						if (unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
						{
							bLocal_636 = true;
							func_318(6);
						}
		...
		switch (Local_353[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_353[iVar0 /*29*/].f_7 = unk_0x344C570D6F8700DF(0, 5);
				if ((!unk_0x160FF3CA76647557(Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_705 < 3) && unk_0x57CE9BB39C5D1674(Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, 1))
				{
					Local_353[iVar0 /*29*/].f_28 = unk_0xCE4780E24AFDFBF9(Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, Local_353[iVar0 /*29*/].f_4, 1, 1, 0);
					if (unk_0xAE06B9E39EBDE049(Local_353[iVar0 /*29*/].f_28) && !unk_0xA59F96B50B97E63C(Local_353[iVar0 /*29*/].f_28, 0))
					{
						unk_0xDAE36360F0F8C1ED(Local_353[iVar0 /*29*/].f_28, 1);
						unk_0x0E765FE8467F7839(Local_353[iVar0 /*29*/].f_28, 1);
						Local_353[iVar0 /*29*/].f_7 = unk_0x344C570D6F8700DF(0, 5);
						Local_353[iVar0 /*29*/].f_12 = unk_0x6A7A2C83BD302BA4(Local_353[iVar0 /*29*/].f_28, 26, Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
						if (unk_0xAE06B9E39EBDE049(Local_353[iVar0 /*29*/].f_12))
						{
							Local_353[iVar0 /*29*/].f_11 = unk_0x79CC07752E7432A1(iLocal_731, Local_353[iVar0 /*29*/].f_16, 1, 1, 0);
							if (unk_0xAE06B9E39EBDE049(Local_353[iVar0 /*29*/].f_11))
							{
								unk_0xF8A652CE310FFC53(Local_353[iVar0 /*29*/].f_11, Local_353[iVar0 /*29*/].f_12, unk_0xE6B87C42793036AA(Local_353[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								unk_0x80250B8368A4E611(Local_353[iVar0 /*29*/].f_11, 0, 0);
								unk_0xA5EAD2ACE2C8BBB2(Local_353[iVar0 /*29*/].f_12, 1, 1);
								unk_0xDAE36360F0F8C1ED(Local_353[iVar0 /*29*/].f_12, 1);
								Local_353[iVar0 /*29*/].f_2 = 0;
								Local_353[iVar0 /*29*/].f_1 = 0;
								Local_353[iVar0 /*29*/].f_3 = 0;
								unk_0x4E65320BC9AD521C(Local_353[iVar0 /*29*/].f_12, 1);
								unk_0xDEFE57D3575A1A8A(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_705++;
			...
			case 4:
				...
				{
					if (!unk_0xC2169C00B643278B(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
							...
							if (func_324(Local_353[iVar0 /*29*/].f_28))
							{
								if (func_375(iVar0))
								{
									if (!Local_353[iVar0 /*29*/].f_1)
									{
										...
										func_374(iVar0);
										unk_0xBB7976F6FB9C9DD2(Local_353[iVar0 /*29*/].f_28);
						...
						{
							if (unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(Local_353[iVar0 /*29*/].f_28, 1), 5f, 1))
							{
								iLocal_629 = 1;
							}
						}
					...
					{
						unk_0x9B94F6169B0DAEFD(Local_353[iVar0 /*29*/].f_12);
						unk_0x0E765FE8467F7839(Local_353[iVar0 /*29*/].f_28, 0);
						unk_0xD8C1C38EE8BC2AC6(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 8f, 786599);
						unk_0xCBA6B2B569DCAFD8(Local_353[iVar0 /*29*/].f_12, 1);
						Local_353[iVar0 /*29*/].f_13 = 15;
					}
				}
				else
			...
			case 5:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && func_377(Local_353[iVar0 /*29*/].f_28))
				{
					...
					{
						unk_0x2976DB62CAE67C30(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Var1, unk_0xEF7858F25585F853(Local_353[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_349())
					{
						unk_0xDC3073F7CC12181D(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						unk_0xDC3073F7CC12181D(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_230(Local_353[iVar0 /*29*/].f_28) && func_308(Local_353[iVar0 /*29*/].f_12)) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					if (unk_0xFD7B900D58065E3B(Local_353[iVar0 /*29*/].f_28))
					{
						unk_0x9B94F6169B0DAEFD(Local_353[iVar0 /*29*/].f_12);
						unk_0x4E65320BC9AD521C(Local_353[iVar0 /*29*/].f_12, 1);
						if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) || !Local_353[iVar0 /*29*/].f_2)
						{
							unk_0x1FBAE3B250A7D06D(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_369(iVar0);
			...
			case 7:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					if (!unk_0x47DBF174A0CB9D55(Local_353[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) || !Local_353[iVar0 /*29*/].f_2)
						{
					...
					else if (unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
					{
						func_369(iVar0);
					}
				}
			...
			case 8:
				if ((func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1)) && func_377(Local_353[iVar0 /*29*/].f_28))
				{
					Var4 = { unk_0x3E4D3CCC220BDFB1(Local_353[iVar0 /*29*/].f_12, 1) };
					if (!unk_0x47DBF174A0CB9D55(Local_353[iVar0 /*29*/].f_12, 0))
					{
						if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xC7EB33BFDB436C87(Var4, 3f, 1))
						{
							Local_353[iVar0 /*29*/].f_25 = { unk_0x7EC595B99EA7C4B1(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_22) };
							Local_353[iVar0 /*29*/].f_6 = (unk_0xEF7858F25585F853(Local_353[iVar0 /*29*/].f_28) + Local_353[iVar0 /*29*/].f_5);
							unk_0x9B94F6169B0DAEFD(Local_353[iVar0 /*29*/].f_12);
							unk_0x4E65320BC9AD521C(Local_353[iVar0 /*29*/].f_12, 1);
							unk_0x3C1B180EE30D36EF(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_353[iVar0 /*29*/].f_6);
			...
			case 9:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					...
					if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xC7EB33BFDB436C87(Var4, 3f, 1))
					{
						if (unk_0xC2169C00B643278B(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							unk_0x9B94F6169B0DAEFD(Local_353[iVar0 /*29*/].f_12);
							unk_0x4E65320BC9AD521C(Local_353[iVar0 /*29*/].f_12, 1);
							unk_0xD08E9EAF091A1AAB(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					...
					if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xC7EB33BFDB436C87(Var4, 3f, 1))
					{
						Local_353[iVar0 /*29*/].f_15 = unk_0x16BC17A8EDC701A2(Local_353[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					...
					if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xC7EB33BFDB436C87(Var4, 3f, 1))
					{
						unk_0x9DC06E2A59C5AEBB(&(Local_353[iVar0 /*29*/].f_14));
						...
						unk_0x19F29730874AD6F1(Local_353[iVar0 /*29*/].f_14);
						unk_0x9B6EC2CECE1010EF(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_14);
						unk_0x4F83FEE4454169D4(&(Local_353[iVar0 /*29*/].f_14));
						Local_353[iVar0 /*29*/].f_8 = unk_0x578C4EF320340AF7() + 20000;
			...
			case 12:
				if (func_308(Local_353[iVar0 /*29*/].f_12) && !unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					...
					if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1) && !unk_0xC7EB33BFDB436C87(Var4, 3f, 1))
					{
						if (unk_0x578C4EF320340AF7() > Local_353[iVar0 /*29*/].f_8)
						{
							if (unk_0xDC79F755CB11603C(Local_353[iVar0 /*29*/].f_11))
							{
								unk_0x80250B8368A4E611(Local_353[iVar0 /*29*/].f_11, 0, 0);
							}
							else
						...
						else if (unk_0x9934470AA0A08B57(Local_353[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !unk_0xDC79F755CB11603C(Local_353[iVar0 /*29*/].f_11))
						{
							unk_0x80250B8368A4E611(Local_353[iVar0 /*29*/].f_11, 1, 0);
						}
					}
					else
					{
			...
			case 13:
				if (!unk_0xCDF860E56BBCC6B4(Local_353[iVar0 /*29*/].f_28, unk_0x9B0761B4C3EB8BC7(), 1))
				{
					if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(Local_353[iVar0 /*29*/].f_28, 0), unk_0x3E4D3CCC220BDFB1(Local_353[iVar0 /*29*/].f_12, 1), 0) > 100f)
					{
						Local_353[iVar0 /*29*/].f_13 = 15;
					}
				}
			...
			case 15:
				...
				if (unk_0xAE06B9E39EBDE049(Local_353[iVar0 /*29*/].f_12))
				{
					if (!unk_0xA59F96B50B97E63C(Local_353[iVar0 /*29*/].f_12, 0))
					{
						unk_0xCBA6B2B569DCAFD8(Local_353[iVar0 /*29*/].f_12, 1);
					}
		...
		{
			if (unk_0x272784C60C397DB6(Local_800, unk_0x3E4D3CCC220BDFB1(Local_353[iVar0 /*29*/].f_28, 1), 1) > 450f)
			{
				Local_353[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_367(int iParam0)
{
	...
	if (func_308(iVar0))
	{
		if (func_377(Local_353[iParam0 /*29*/].f_28))
		{
			...
			unk_0x9DC06E2A59C5AEBB(&(Local_353[iParam0 /*29*/].f_14));
			unk_0xC584E49FC3559A86(0, Local_353[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			unk_0xD8C1C38EE8BC2AC6(0, Local_353[iParam0 /*29*/].f_28, 60f, 786468);
			unk_0x19F29730874AD6F1(Local_353[iParam0 /*29*/].f_14);
			unk_0x9B6EC2CECE1010EF(iVar0, Local_353[iParam0 /*29*/].f_14);
			unk_0xCBA6B2B569DCAFD8(iVar0, 1);
			unk_0x4F83FEE4454169D4(&(Local_353[iParam0 /*29*/].f_14));
		}
...
Vector3 func_368(int iParam0)
{
	...
	if (func_377(iParam0))
	{
		...
		if (unk_0x30EE2C844B9C410B(Var0, &Var3, 1, 1077936128, 0))
		{
			if (unk_0xFAB48A11487632DF(Var3, 0, &Var3))
			{
				if (!unk_0x160FF3CA76647557(Var3, 2f) && !unk_0xF666C0F9CA439368(Var3, 2f, 0))
				{
					return Var3;
				}
			}
...
void func_369(int iParam0)
{
	...
	{
		unk_0x9B94F6169B0DAEFD(Local_353[iParam0 /*29*/].f_12);
		unk_0x4E65320BC9AD521C(Local_353[iParam0 /*29*/].f_12, 1);
		if (func_377(Local_353[iParam0 /*29*/].f_28))
		{
			if (unk_0xE0B3BC41DDA88DF0(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, 0))
			{
				unk_0xDEFE57D3575A1A8A(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, Local_353[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_353[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				unk_0xD66FADEF7D42D49B(Local_353[iParam0 /*29*/].f_12, Local_748, 10000f, -1, 0, 0);
				Local_353[iParam0 /*29*/].f_13 = 13;
			}
		}
		Local_353[iParam0 /*29*/].f_2 = 1;
		unk_0xCBA6B2B569DCAFD8(Local_353[iParam0 /*29*/].f_12, 1);
	}
	else
	{
...
void func_370()
{
	if (!iLocal_625)
	{
		if (func_349())
		{
			iLocal_704 = unk_0x578C4EF320340AF7() + 1000;
			iLocal_625 = 1;
		}
	}
	else if (unk_0x578C4EF320340AF7() > iLocal_704)
	{
...
int func_372()
{
	...
	if (func_308(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		if (func_308(iLocal_734))
		{
			Var3 = { unk_0x3E4D3CCC220BDFB1(iLocal_734, 1) };
			if (func_373(unk_0x9B0761B4C3EB8BC7(), iLocal_734, 0) <= 10f && unk_0x0D77CDCF403AEBD2((Var0.f_2 - Var3.f_2)) < 1.5f)
			{
				return 1;
			}
		}
...
void func_374(int iParam0)
{
	...
	if (!unk_0xA59F96B50B97E63C(Local_353[iParam0 /*29*/].f_28, 0))
	{
		unk_0xC62EE91883AF24A2(Local_353[iParam0 /*29*/].f_28, 0);
	}
...
{
	if (unk_0xAE06B9E39EBDE049(Local_353[iParam0 /*29*/].f_28) && !unk_0xA59F96B50B97E63C(Local_353[iParam0 /*29*/].f_28, 0))
	{
		if (unk_0x5C87AA49B5DF6712(Local_353[iParam0 /*29*/].f_28, 1, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { 2.5f, 3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0x5C87AA49B5DF6712(Local_353[iParam0 /*29*/].f_28, 5, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { 2.5f, -3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = 90f;
			return 1;
		}
		else if (unk_0x5C87AA49B5DF6712(Local_353[iParam0 /*29*/].f_28, 4, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { -2.5f, -3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = -90f;
			return 1;
		}
		else if (unk_0x5C87AA49B5DF6712(Local_353[iParam0 /*29*/].f_28, 0, 0))
		{
			Local_353[iParam0 /*29*/].f_22 = { -2.5f, 3f, 0f };
			Local_353[iParam0 /*29*/].f_5 = -90f;
			return 1;
...
{
	if (unk_0xAE06B9E39EBDE049(Local_353[iParam0 /*29*/].f_12))
	{
		if (unk_0xA59F96B50B97E63C(Local_353[iParam0 /*29*/].f_12, 0) || !unk_0xA59F96B50B97E63C(Local_353[iParam0 /*29*/].f_12, 0))
		{
			if (unk_0xCDF860E56BBCC6B4(Local_353[iParam0 /*29*/].f_12, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				func_369(iParam0);
			}
		}
...
void func_381()
{
	if (bLocal_639)
	{
		unk_0x74528AC0906CBABE(Local_353[0 /*29*/].f_9);
		unk_0x74528AC0906CBABE(Local_353[1 /*29*/].f_9);
		unk_0x74528AC0906CBABE(Local_353[2 /*29*/].f_9);
		unk_0x74528AC0906CBABE(Local_353[3 /*29*/].f_9);
		unk_0x74528AC0906CBABE(Local_353[4 /*29*/].f_9);
		unk_0x74528AC0906CBABE(Local_353[0 /*29*/].f_10);
		unk_0x74528AC0906CBABE(Local_353[1 /*29*/].f_10);
		unk_0x74528AC0906CBABE(Local_353[2 /*29*/].f_10);
		unk_0x74528AC0906CBABE(Local_353[3 /*29*/].f_10);
		unk_0x74528AC0906CBABE(Local_353[4 /*29*/].f_10);
		unk_0x74528AC0906CBABE(iLocal_731);
		bLocal_639 = false;
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46())
			{
				...
				iLocal_319 = 13;
				unk_0xF27E737981AFB47D(Local_800, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xF27E737981AFB47D(Local_794, 50f, 0, 0, 0, 0, 0, 0);
				unk_0xF27E737981AFB47D(Local_797, 50f, 0, 0, 0, 0, 0, 0);
				unk_0x2BB0EF9DE445EA13(unk_0x9B0761B4C3EB8BC7());
				func_380();
				func_354();
				func_353();
				...
				if (!func_212())
				{
					func_229(unk_0x9B0761B4C3EB8BC7(), Local_748, fLocal_691, 0, 1);
					func_352();
				}
				iLocal_321 = 2;
			}
...
{
	func_387();
	unk_0x78FCB2E22C41B9D5(Local_353[0 /*29*/].f_9);
	unk_0x78FCB2E22C41B9D5(Local_353[1 /*29*/].f_9);
	unk_0x78FCB2E22C41B9D5(Local_353[2 /*29*/].f_9);
	unk_0x78FCB2E22C41B9D5(Local_353[3 /*29*/].f_9);
	unk_0x78FCB2E22C41B9D5(Local_353[4 /*29*/].f_9);
	unk_0x78FCB2E22C41B9D5(Local_353[0 /*29*/].f_10);
	unk_0x78FCB2E22C41B9D5(Local_353[1 /*29*/].f_10);
	unk_0x78FCB2E22C41B9D5(Local_353[2 /*29*/].f_10);
	unk_0x78FCB2E22C41B9D5(Local_353[3 /*29*/].f_10);
	unk_0x78FCB2E22C41B9D5(Local_353[4 /*29*/].f_10);
	unk_0x78FCB2E22C41B9D5(iLocal_731);
	while ((((((((((!unk_0x7D167B9A0CCDA347(Local_353[0 /*29*/].f_9) || !unk_0x7D167B9A0CCDA347(Local_353[1 /*29*/].f_9)) || !unk_0x7D167B9A0CCDA347(Local_353[2 /*29*/].f_9)) || !unk_0x7D167B9A0CCDA347(Local_353[3 /*29*/].f_9)) || !unk_0x7D167B9A0CCDA347(Local_353[4 /*29*/].f_9)) || !unk_0x7D167B9A0CCDA347(Local_353[0 /*29*/].f_10)) || !unk_0x7D167B9A0CCDA347(Local_353[1 /*29*/].f_10)) || !unk_0x7D167B9A0CCDA347(Local_353[2 /*29*/].f_10)) || !unk_0x7D167B9A0CCDA347(Local_353[3 /*29*/].f_10)) || !unk_0x7D167B9A0CCDA347(Local_353[4 /*29*/].f_10)) || !unk_0x7D167B9A0CCDA347(iLocal_731))
	{
		SYSTEM::WAIT(0);
	}
	bLocal_639 = true;
...
void func_389()
{
	...
	unk_0x5889AD4CFDF9C4D9(Local_751, fLocal_701);
	unk_0x5889AD4CFDF9C4D9(Local_754, fLocal_701);
	unk_0x49530A7462821D76(0f);
	unk_0x223E264962CEB86E(0f, 0f);
	if (unk_0xA860C15A1C027CBB() == 4)
	{
...
void func_390()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734) && !unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!bLocal_630)
		{
			if (!unk_0x910DFF8E55ABB8EC(iLocal_734, unk_0x9B0761B4C3EB8BC7(), Local_820, 0, 1, 0) || unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7()) != 0)
			{
				if (!unk_0xEC787E1D3B804A72(iLocal_734))
				{
					bLocal_630 = true;
				}
			}
		}
		else if (unk_0x910DFF8E55ABB8EC(iLocal_734, unk_0x9B0761B4C3EB8BC7(), Local_823, 0, 1, 0) && unk_0x518D695E2DBA9DB8(unk_0x9B0761B4C3EB8BC7()) == 0)
		{
			if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) || unk_0x6AFDC8F2D4262351(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
			{
				bLocal_630 = false;
			}
		}
...
void func_393()
{
	...
	if (!iLocal_640)
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_745, 50f, 50f, 50f, 0, 1, 0))
		{
			func_395();
			iLocal_640 = 1;
		}
	...
	if (!bLocal_630)
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Local_745, 5f, 5f, 5f, 0, 1, 0) && func_394(1077936128, 1))
		{
			unk_0xAF7D4BF357E8B79E(Local_794, Local_797, 0, 1);
			func_8(&iLocal_609);
			func_385();
			func_2();
			func_351();
...
void func_395()
{
	unk_0xC08A186299DFDA0A(Local_871, Local_874, 0, 1, 1, 1);
	unk_0x258412C3949C0486(Local_871, Local_874);
	unk_0x773B9DEB93E81B2F(Local_904, 5f, 0);
}
...
void func_396()
{
	...
	if (iLocal_659[3])
	{
		...
		{
			func_231(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
			if (unk_0xAE06B9E39EBDE049(iLocal_980))
			{
				unk_0x5DC21979EC6C531F(iLocal_980, 1);
			}
			if (iLocal_722 <= 3)
			{
				func_382(769, 3, 1);
...
void func_397()
{
	...
	unk_0x5889AD4CFDF9C4D9(Local_751, fLocal_701);
	unk_0x5889AD4CFDF9C4D9(Local_754, fLocal_701);
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 7f, 1, 1, 0))
	{
		if (iLocal_659[1])
		{
			iLocal_637 = 0;
...
void func_399()
{
	...
	unk_0x5889AD4CFDF9C4D9(Local_751, fLocal_701);
	unk_0x5889AD4CFDF9C4D9(Local_754, fLocal_701);
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 7f, 0, 1, 0))
	{
		func_321();
		func_404();
		func_383();
		...
		if (!unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0) && (unk_0xC2169C00B643278B(iLocal_734, Local_778, 2f, 2f, 2f, 0, 1, 0) || iLocal_724 >= 3))
		{
			if (!bLocal_641)
			{
				if (iLocal_724 >= 3)
				{
					if (!unk_0xC2169C00B643278B(iLocal_734, Local_778, 2f, 2f, 2f, 0, 1, 0))
					{
						func_226(1);
					}
					iLocal_318 = 8;
		...
		if (!unk_0x8F678487EEBD8CE4(Local_322[iVar0 /*10*/].f_9))
		{
			if (func_230(Local_322[iVar0 /*10*/]))
			{
				if (!Local_322[iVar0 /*10*/].f_7)
				{
					...
					unk_0xECC9A00CF1181EC2(Local_322[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (Local_322[iVar0 /*10*/].f_7 == 1)
		{
			if (!Local_322[iVar0 /*10*/].f_8)
			{
				...
				{
					unk_0xBB7976F6FB9C9DD2(Local_322[iVar0 /*10*/]);
					iLocal_724++;
				}
				else
				{
...
{
	if (unk_0xAE06B9E39EBDE049(Local_322[iParam0 /*10*/]) && !Local_322[iParam0 /*10*/].f_7)
	{
		Local_322[iParam0 /*10*/].f_5 = unk_0x4F5F2FB7AE0EB7AB(Local_322[iParam0 /*10*/]);
		if (Local_322[iParam0 /*10*/].f_5 < 100)
		{
			...
			unk_0xC69C2DB4DB243F74(Local_322[iParam0 /*10*/], 1, 0);
		}
	}
}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46())
			{
				...
				if (!func_212())
				{
					func_229(unk_0x9B0761B4C3EB8BC7(), Local_742, fLocal_690, 0, 1);
				}
				func_8(&iLocal_609);
				func_228(1);
...
void func_407()
{
	unk_0x773B9DEB93E81B2F(Local_877, 3f, 0);
	unk_0x258412C3949C0486(Local_880, Local_883);
	unk_0x773B9DEB93E81B2F(Local_886, 3f, 0);
	unk_0x258412C3949C0486(Local_889, Local_892);
	unk_0x773B9DEB93E81B2F(Local_895, 3f, 0);
	unk_0x258412C3949C0486(Local_898, Local_901);
}
...
int func_408()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			unk_0x4BAC0F0B99F7DCF9(Local_322[iVar0 /*10*/].f_1, 2f, 0);
			Local_322[iVar0 /*10*/] = unk_0x79CC07752E7432A1(iLocal_726, Local_322[iVar0 /*10*/].f_1, 1, 1, 0);
			if (unk_0xAE06B9E39EBDE049(Local_322[iVar0 /*10*/]))
			{
				unk_0xE922BAA80E8F9324(Local_322[iVar0 /*10*/], Local_322[iVar0 /*10*/].f_4);
				unk_0xF41C9ED1EAFB30CC(Local_322[iVar0 /*10*/], 0);
				unk_0x697DA7132EE43ABC(Local_322[iVar0 /*10*/], 100, 0);
				unk_0x9729E0DCF1C3C9A9(Local_322[iVar0 /*10*/], 1);
				Local_322[iVar0 /*10*/].f_7 = 0;
				Local_322[iVar0 /*10*/].f_8 = 0;
			}
			iVar0++;
		}
		if (((unk_0xAE06B9E39EBDE049(Local_322[0 /*10*/]) && unk_0xAE06B9E39EBDE049(Local_322[1 /*10*/])) && unk_0xAE06B9E39EBDE049(Local_322[2 /*10*/])) && func_409())
		{
			unk_0x74528AC0906CBABE(iLocal_726);
			iLocal_618 = 0;
			return 1;
...
int func_409()
{
	iLocal_721 = unk_0x344C570D6F8700DF(0, 3);
	if (unk_0xAE06B9E39EBDE049(Local_322[iLocal_721 /*10*/]))
	{
...
void func_410()
{
	unk_0x78FCB2E22C41B9D5(iLocal_726);
	while (!unk_0x7D167B9A0CCDA347(iLocal_726))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_618 = 1;
...
void func_411()
{
	...
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 7f, 1, 1, 0))
	{
		if (iLocal_659[1])
		{
			...
			unk_0xCCD157619BAD6BE2(1661506222, 0f, 1, 0);
			unk_0xDC5C33A98881772F(1661506222, 0, 1, 1);
			iLocal_318 = 6;
		}
		func_404();
		if (bLocal_641)
	...
	else
	{
		...
		if (unk_0x8F678487EEBD8CE4(iLocal_610))
		{
			if (!unk_0xB20C6CE3C679F76E(iLocal_610))
			{
				if (!unk_0x910DFF8E55ABB8EC(iLocal_734, unk_0x9B0761B4C3EB8BC7(), Local_820, 0, 1, 0))
				{
					func_2();
					func_314(1, 0);
					func_319("HT_BKHTER");
			...
			else
			{
				...
				if (unk_0x910DFF8E55ABB8EC(iLocal_734, unk_0x9B0761B4C3EB8BC7(), Local_823, 0, 1, 0))
				{
					func_314(1, 0);
					if (func_398("HT_BKHTER", 0, 0))
					{
		...
		case 1:
			if (unk_0x03DB5C6AABF8DA46())
			{
				if (unk_0x3EBB66F936A3436E())
				{
					...
					if (unk_0xAE06B9E39EBDE049(iLocal_733))
					{
						unk_0x315F7D8C33F0AB37(&iLocal_733);
					}
				}
				...
				if (!func_212())
				{
					func_229(unk_0x9B0761B4C3EB8BC7(), Local_810, fLocal_813, 0, 1);
					func_352();
				}
				func_228(1);
				unk_0xF27E737981AFB47D(Local_807, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_321 = 2;
			}
			break;
			...
			switch (iLocal_706)
			{
				case 0:
					if (func_440(1, 1093140480, 0))
					{
						...
						{
							unk_0xFA3AB7AE2A01375E(unk_0x9B0761B4C3EB8BC7(), sLocal_740, 0, 0, 0);
						}
						if (func_230(iLocal_734))
						{
							unk_0xFA3AB7AE2A01375E(iLocal_734, sLocal_741, 0, 0, 0);
							unk_0x18309CE9F0E2CADF(sLocal_741, unk_0x9B0761B4C3EB8BC7(), 0);
							iLocal_733 = func_436(iLocal_734, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
						}
						if (unk_0xAE06B9E39EBDE049(iLocal_733))
						{
							unk_0xFA3AB7AE2A01375E(iLocal_733, "Daves_Rifle", 0, 0, 0);
						}
						func_435();
						...
						{
							unk_0x03D382CB0B44E2FC(iLocal_980, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
							unk_0xE922BAA80E8F9324(iLocal_980, 76.1155f);
						}
				...
				case 1:
					if (unk_0x10447A1CD8175FC0(sLocal_741, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_623)
						{
					...
					{
						unk_0xDF1EDBFFB5215C2C(iLocal_733, unk_0x9B0761B4C3EB8BC7());
					}
					if (unk_0x10447A1CD8175FC0(sLocal_740, 0))
					{
					...
					unk_0xCCD157619BAD6BE2(1661506222, -0.8f, 1, 0);
					unk_0xDC5C33A98881772F(1661506222, 4, 1, 1);
			...
			if (unk_0x03DB5C6AABF8DA46())
			{
				if (func_408())
				{
					if (func_308(iLocal_734))
					{
						...
						{
							func_229(iLocal_734, Local_791, fLocal_698, 0, 1);
							unk_0x5EB178758AAA183E(iLocal_734, joaat("weapon_sniperrifle"));
							unk_0x9B94F6169B0DAEFD(iLocal_734);
							iLocal_319 = 2;
						}
					}
...
int func_436(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_260(iVar2, iVar8) != 0)
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			if (unk_0x0BCEF4D1482DACD2(iParam0, iVar2, func_260(iVar2, iVar8)))
			{
				...
				{
					uVar9 = unk_0x85CB1D50AB0A0A5B(func_260(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_260(iVar2, iVar10) != 0)
	{
		if (!unk_0xA59F96B50B97E63C(iParam0, 0))
		{
			if (unk_0x0BCEF4D1482DACD2(iParam0, iVar2, func_260(iVar2, iVar10)))
			{
				unk_0xC53D054996356072(uVar1, func_260(iVar2, iVar10));
...
int func_440(int iParam0, int iParam1, int iParam2)
{
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		...
		{
			if (!func_443(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_446()
{
	if (!unk_0x28BD5A3E7899F23D() && func_373(unk_0x9B0761B4C3EB8BC7(), iLocal_734, 1) > 3f)
	{
		iLocal_711 = unk_0x578C4EF320340AF7() + 2000;
		if (func_308(iLocal_734))
		{
			if (func_308(unk_0x9B0761B4C3EB8BC7()))
			{
			}
			unk_0xF1B800B6646C4019(iLocal_734, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
			unk_0x89F30480E0C49A16(fLocal_692);
			unk_0x8AA2C5E3C6438257(fLocal_693);
			unk_0x6053F87294B7C143(fLocal_694);
			unk_0xE2AA8012BC8A9464(fLocal_695);
			unk_0x381A07A730FA08C0(fLocal_696);
			unk_0x3506E790BAAF404A(1);
		}
	}
	else if (func_308(iLocal_734) && func_308(unk_0x9B0761B4C3EB8BC7()))
	{
		if (unk_0x578C4EF320340AF7() > iLocal_711 || func_373(unk_0x9B0761B4C3EB8BC7(), iLocal_734, 1) <= 3f)
		{
			if (func_373(unk_0x9B0761B4C3EB8BC7(), iLocal_734, 1) <= 3f)
			{
			}
			iLocal_706 = 0;
			iLocal_321 = 0;
...
void func_447()
{
	...
	if (func_308(iLocal_734))
	{
		unk_0x1CCBC799127EA27B(iLocal_734, 200);
		unk_0xEDBD99D0CBB76A54(iLocal_734, 0);
		unk_0xF5230D38AD1D873D(iLocal_734, 0);
		unk_0x694113444F21E39F(iLocal_734, 169, 1);
		unk_0x694113444F21E39F(iLocal_734, 206, 1);
		unk_0x694113444F21E39F(iLocal_734, 32, 0);
		unk_0xB1AC1F996633F5B4(iLocal_734, 0);
		unk_0x6D2F52D05ED0E1F6(iLocal_734);
		unk_0x2CE840C9FCC03A58(iLocal_734, 1);
		unk_0x7542EFCD7D27E5D2(iLocal_734, 0);
		unk_0xDAE36360F0F8C1ED(iLocal_734, 1);
		unk_0x5A5A1DD32AC33C2B(iLocal_734, 0);
		unk_0xE61672E3FEF081AC(iLocal_734, 1);
		unk_0xB281D47677468287(iLocal_734, 1);
	}
	iLocal_321 = 0;
	if (func_528())
	{
...
void func_450()
{
	...
	{
		iLocal_621 = 1;
		uLocal_723 = unk_0xEB97D5E3E03F4810(unk_0x9B0761B4C3EB8BC7(), joaat("AMMO_SNIPER"));
	}
}
...
void func_452()
{
	...
	while (!unk_0x7D167B9A0CCDA347(iLocal_727))
	{
		SYSTEM::WAIT(0);
	}
}
...
void func_456()
{
	if (unk_0xA860C15A1C027CBB() != 4)
	{
		if ((unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_859, Local_862, 16f, 0, 1, 0) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_865, Local_868, 19f, 0, 1, 0)) || unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_871, Local_874, 19f, 0, 1, 0))
		{
...
void func_457()
{
	...
	if (func_308(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		switch (iLocal_319)
		{
			...
			case 3:
				func_314(1, 0);
				iLocal_720 = unk_0x578C4EF320340AF7() + 2000;
				unk_0x03D382CB0B44E2FC(iLocal_734, Local_791, 1, 0, 0, 1);
				unk_0xE922BAA80E8F9324(iLocal_734, fLocal_698);
				iLocal_319 = 2;
				break;
			...
			case 2:
				if (func_308(iLocal_734))
				{
					...
					{
						bLocal_623 = true;
						iLocal_720 = unk_0x578C4EF320340AF7() + 5000;
						unk_0x5EB178758AAA183E(iLocal_734, joaat("weapon_sniperrifle"));
						unk_0x3C1B180EE30D36EF(iLocal_734, Local_778, 1f, 60000, 0.25f, 512, Local_322[iLocal_721 /*10*/].f_6);
						unk_0x5A5A1DD32AC33C2B(iLocal_734, 0);
						iLocal_319 = 4;
					}
				}
			...
			case 4:
				if (unk_0x16BC17A8EDC701A2(iLocal_734, 713668775) == 7)
				{
					if (unk_0xC2169C00B643278B(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0))
					{
						unk_0x9B94F6169B0DAEFD(iLocal_734);
						unk_0xA785552633ED203B(iLocal_734, unk_0x9B0761B4C3EB8BC7(), -1, 1024, 2);
						unk_0x5A5A1DD32AC33C2B(iLocal_734, 1);
						unk_0x4E65320BC9AD521C(iLocal_734, 1);
						iLocal_319 = 6;
					}
				}
				else if (!iLocal_659[0])
				{
					if (unk_0x578C4EF320340AF7() > iLocal_720)
					{
			...
			case 5:
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
				{
					if (unk_0x15D88F65956DC2F6(iLocal_734, joaat("weapon_sniperrifle"), 0))
					{
						unk_0x5EB178758AAA183E(iLocal_734, joaat("weapon_sniperrifle"));
					}
					if (func_488())
					{
						if (unk_0xDC79F755CB11603C(iLocal_732))
						{
						...
						func_353();
						func_8(&iLocal_610);
						unk_0x2BB0EF9DE445EA13(iLocal_734);
						unk_0x03D382CB0B44E2FC(iLocal_734, Local_778, 1, 0, 0, 1);
						unk_0xE922BAA80E8F9324(iLocal_734, fLocal_690);
						iLocal_635 = 0;
						iLocal_319 = 6;
					}
				}
			...
			case 6:
				...
				else if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 7f, 0, 1, 0) && func_372())
				{
					if (func_485())
					{
						func_380();
			...
			case 12:
				if (func_371(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_719 == -1)
					{
						iLocal_719 = unk_0x5700FF65A7E1B390(Local_853, Local_856, 0f, 0, 7);
					}
					func_380();
					iLocal_659[9] = 1;
					func_226(0);
					...
					iLocal_714 = 0;
					unk_0xA785552633ED203B(iLocal_734, unk_0x9B0761B4C3EB8BC7(), -1, 1024, 2);
					unk_0x3C1B180EE30D36EF(iLocal_734, Local_781, 1f, 60000, 0.25f, 512, fLocal_691);
					unk_0x5A5A1DD32AC33C2B(iLocal_734, 0);
					iLocal_319 = 14;
				}
				break;
			...
			case 13:
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
				{
					if (func_488())
					{
						...
						unk_0x2BB0EF9DE445EA13(iLocal_734);
						unk_0x03D382CB0B44E2FC(iLocal_734, Local_781, 1, 0, 0, 1);
						unk_0xE922BAA80E8F9324(iLocal_734, fLocal_691);
						func_380();
						func_353();
						func_354();
						func_8(&iLocal_610);
			...
			case 14:
				if (unk_0x16BC17A8EDC701A2(iLocal_734, 713668775) == 7)
				{
					if (unk_0xC2169C00B643278B(iLocal_734, Local_781, 1.25f, 1.25f, 2.5f, 0, 1, 0) && unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_763, Local_766, 10f, 0, 1, 0))
					{
						if (func_485())
						{
							if (func_371(&uLocal_153, cLocal_739, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_714 == 1)
							{
								...
								if (iLocal_719 != -1)
								{
									unk_0x9142D74AFE3ACF6B(iLocal_719);
									iLocal_719 = -1;
								}
								func_353();
								iLocal_659[11] = 1;
			...
			case 16:
				if (func_477())
				{
					iLocal_717 = 0;
					func_458();
					unk_0x3C1B180EE30D36EF(iLocal_734, Local_946[0 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
					unk_0x5A5A1DD32AC33C2B(iLocal_734, 1);
					func_314(0, 0);
					iLocal_319 = 17;
				}
			...
			case 17:
				unk_0x675CCBC7D80F079E(iLocal_734, 1.4f);
				if (!iLocal_659[15])
				{
					if (func_372())
					{
						if (!func_223())
						{
							if (unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Local_748, 1) > 10f)
							{
				...
				switch (iLocal_717)
				{
					case 0:
						...
						{
							unk_0x3C1B180EE30D36EF(iLocal_734, Local_946[1 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 1:
						...
						{
							unk_0x3C1B180EE30D36EF(iLocal_734, Local_946[2 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 2:
						...
						{
							unk_0x3C1B180EE30D36EF(iLocal_734, Local_946[3 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
							iLocal_717++;
						}
						break;
					...
					case 3:
						...
						{
							unk_0x3C1B180EE30D36EF(iLocal_734, Local_784, 1f, 60000, 0.25f, 512, fLocal_697);
							iLocal_717++;
						}
						break;
					
					case 4:
						if (unk_0x16BC17A8EDC701A2(iLocal_734, 713668775) == 7 || (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_907, Local_910, 3.5f, 0, 1, 0) && unk_0x1037B9D45CE6B788(iLocal_734, Local_907, Local_910, 3.5f, 0, 1, 0)))
						{
							unk_0x5A5A1DD32AC33C2B(iLocal_734, 0);
							iLocal_319 = 18;
						}
			...
			case 20:
				if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
				{
					if (func_488())
					{
						...
						unk_0x2BB0EF9DE445EA13(iLocal_734);
						unk_0x03D382CB0B44E2FC(iLocal_734, Local_784, 1, 0, 0, 1);
						unk_0xE922BAA80E8F9324(iLocal_734, fLocal_787);
						func_353();
						func_354();
						func_314(1, 0);
						iLocal_319 = 18;
			...
			case 18:
				...
				{
					Var0 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) };
					if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_907, Local_910, 3.5f, 0, 1, 0) || Var0.f_2 > 41f)
					{
						if (func_371(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							unk_0x9B94F6169B0DAEFD(iLocal_734);
							unk_0x3C1B180EE30D36EF(iLocal_734, Local_788, 1f, 60000, 0.25f, 512, fLocal_699);
							iLocal_659[16] = 1;
							unk_0x5A5A1DD32AC33C2B(iLocal_734, 0);
							iLocal_319 = 21;
						}
					}
					else if (unk_0x16BC17A8EDC701A2(iLocal_734, -875674219) != 1)
					{
						unk_0xD08E9EAF091A1AAB(iLocal_734, unk_0x9B0761B4C3EB8BC7(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_769, Local_772, 20f, 0, 1, 0))
				{
					...
					{
						func_316();
						iLocal_708 = unk_0x578C4EF320340AF7() + 2000;
						bLocal_626 = true;
					}
					if (func_485())
					{
				...
				if (bLocal_626)
				{
					if (unk_0x578C4EF320340AF7() > iLocal_708)
					{
						func_316();
			...
			case 24:
				...
				{
					unk_0x2BB0EF9DE445EA13(iLocal_734);
					unk_0x03D382CB0B44E2FC(iLocal_734, Local_917, 1, 0, 0, 1);
					unk_0xE922BAA80E8F9324(iLocal_734, fLocal_920);
					unk_0xA785552633ED203B(iLocal_734, unk_0x9B0761B4C3EB8BC7(), -1, 0, 2);
				...
				if (!func_223())
				{
					...
					else if (!func_223())
					{
						if (func_308(iLocal_734))
						{
							...
							unk_0x3C1B180EE30D36EF(0, Local_966, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x3C1B180EE30D36EF(0, Local_969, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x3C1B180EE30D36EF(0, Local_972, 1f, 60000, 0.25f, 0, 40000f);
							unk_0x30291E2E564E9B47(0, 1193033728, 0);
							unk_0x19F29730874AD6F1(uLocal_737);
							unk_0x9B6EC2CECE1010EF(iLocal_734, uLocal_737);
							unk_0x4F83FEE4454169D4(&uLocal_737);
							unk_0xCBA6B2B569DCAFD8(iLocal_734, 1);
						}
						iLocal_319 = 0;
					}
				}
		...
		if (((iLocal_318 != 21 && !iLocal_659[20]) && iLocal_319 != 25) && iLocal_319 != 0)
		{
			if (!iLocal_627)
			{
				...
				{
					if (unk_0xCED6B5226244381C(iLocal_734))
					{
						func_2();
						iLocal_710 = unk_0x578C4EF320340AF7() + 2400;
						iLocal_627 = 1;
					}
				}
				if (((unk_0xA59F96B50B97E63C(iLocal_734, 0) || unk_0xCDF860E56BBCC6B4(iLocal_734, unk_0x9B0761B4C3EB8BC7(), 1)) || unk_0x37BCA35686C6B213(iLocal_734, 0, 2)) || unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(iLocal_734, 0), 10f))
				{
					func_2();
					iLocal_710 = unk_0x578C4EF320340AF7() + 2400;
					iLocal_627 = 1;
			...
			else if (unk_0x578C4EF320340AF7() > iLocal_710)
			{
				if (unk_0xAE06B9E39EBDE049(iLocal_734))
				{
					if (!unk_0xA59F96B50B97E63C(iLocal_734, 0))
					{
						unk_0x9B94F6169B0DAEFD(iLocal_734);
						unk_0x8B18A80E8EB15510(iLocal_734, unk_0x9B0761B4C3EB8BC7(), 100f, -1, 0, 0);
						unk_0xCBA6B2B569DCAFD8(iLocal_734, 1);
						func_318(2);
					}
					else
	...
	if (func_462())
	{
		...
		while (iVar1 < func_461())
		{
			if (unk_0xAE06B9E39EBDE049(func_460(iVar1)))
			{
				...
				{
					if (unk_0xE95077C1E15F6307(iVar0, iLocal_727))
					{
...
void func_463()
{
	if (!unk_0x47DBF174A0CB9D55(iLocal_734, 0) && !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!iLocal_992)
		{
			iLocal_993 = unk_0x578C4EF320340AF7() + 3000;
			iLocal_992 = 1;
		}
		else if (unk_0x578C4EF320340AF7() > iLocal_993)
		{
			if (func_372())
			{
...
void func_464()
{
	if (!unk_0x7C4984752F886E92(iLocal_734, 1) && !unk_0x7C4984752F886E92(unk_0x9B0761B4C3EB8BC7(), 1))
	{
		if (unk_0x47DBF174A0CB9D55(iLocal_734, 0) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (!iLocal_638)
			{
				iLocal_703 = unk_0x578C4EF320340AF7() + 3000;
				iLocal_638 = 1;
			}
			else if (unk_0x578C4EF320340AF7() > iLocal_703)
			{
				if (!func_223())
				{
					if (!iLocal_659[8])
					{
						...
						{
							if (!unk_0x7BCC91F3C1CF24E8(&Local_982))
							{
								Local_982 = { func_465() };
							}
							else
...
void func_467()
{
	...
	if (func_308(unk_0x9B0761B4C3EB8BC7()) && func_308(iLocal_734))
	{
		if (unk_0x47DBF174A0CB9D55(iLocal_734, 0) && unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
		{
			if (func_230(iLocal_980))
			{
				if (unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0) == iLocal_980 && unk_0xA5D5B1042E8F47BD(iLocal_734, 0) == iLocal_980)
				{
					if (!iLocal_990)
					{
						iLocal_991 = unk_0x4F5F2FB7AE0EB7AB(iLocal_980);
						iLocal_990 = 1;
					}
					else
					{
						iVar0 = unk_0x4F5F2FB7AE0EB7AB(iLocal_980);
						if (iVar0 < iLocal_991)
						{
							func_468();
	...
	if (unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 0))
	{
		if (!iLocal_659[7])
		{
			if (!func_223())
			{
				if (func_372())
				{
					if (unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0) == iLocal_980)
					{
					...
					else if (unk_0x6AFDC8F2D4262351(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0)))
					{
...
void func_471()
{
	if (!unk_0x7C4984752F886E92(iLocal_734, 1) && !unk_0x7C4984752F886E92(unk_0x9B0761B4C3EB8BC7(), 1))
	{
		if (!unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 7f, 0, 1, 0))
		{
			if (!unk_0x47DBF174A0CB9D55(iLocal_734, 0) && !unk_0x47DBF174A0CB9D55(unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (!iLocal_644)
				{
					if (!func_398("HT_NXTLOC", 0, 0) && iLocal_659[4])
					{
						iLocal_718 = unk_0x578C4EF320340AF7() + 20000;
						iLocal_644 = 1;
					}
				}
				else if (unk_0x578C4EF320340AF7() > iLocal_718)
				{
...
void func_474()
{
	if (!unk_0x7C4984752F886E92(iLocal_734, 1) && !unk_0x7C4984752F886E92(unk_0x9B0761B4C3EB8BC7(), 1))
	{
		if (!iLocal_988)
		{
			...
			{
				iLocal_989 = unk_0x578C4EF320340AF7() + 3000;
				iLocal_988 = 1;
			}
		}
		else if (unk_0x578C4EF320340AF7() > iLocal_989)
		{
			if (!func_223() && func_372())
			{
				if (!iLocal_659[4])
...
void func_475()
{
	if (unk_0x1037B9D45CE6B788(unk_0x9B0761B4C3EB8BC7(), Local_757, Local_760, 16f, 0, 1, 0))
	{
		if ((iLocal_683[1] && !func_398("HT_NXTLOC", 0, 0)) && !func_223())
		{
			if (!iLocal_643)
			{
				iLocal_702 = unk_0x578C4EF320340AF7() + 15000;
				iLocal_643 = 1;
			}
			else if (unk_0x578C4EF320340AF7() > iLocal_702)
			{
...
void func_476()
{
	if (unk_0x6E0C5E7AAF8B6214(unk_0x9B0761B4C3EB8BC7()))
	{
		if (!iLocal_620)
		{
			uLocal_994 = unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0);
			if (!unk_0x47DBF174A0CB9D55(iLocal_734, 1))
			{
				if (!unk_0x6AFDC8F2D4262351(uLocal_994))
				{
					if (func_372())
					{
						if (!func_223())
...
int func_477()
{
	if (!unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		if (!unk_0xAE06B9E39EBDE049(iLocal_732))
		{
			unk_0x9B94F6169B0DAEFD(iLocal_734);
		...
		{
			unk_0x315F7D8C33F0AB37(&iLocal_732);
		}
	}
	else if (!unk_0xAE06B9E39EBDE049(iLocal_732))
	{
		unk_0x9B94F6169B0DAEFD(iLocal_734);
		return 1;
	}
...
void func_478()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0xC7EB33BFDB436C87(Local_322[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_223())
			{
...
void func_480(int iParam0)
{
	...
	if (((iLocal_724 < 3 && !func_398("HT_SHDISH", 0, 0)) && !func_398("HT_SHTYRE", 0, 0)) && !func_398("HT_SHCOY", 0, 0))
	{
		if (iLocal_624)
		{
			if (unk_0x578C4EF320340AF7() > iLocal_712)
			{
		...
		{
			iLocal_713 = unk_0x344C570D6F8700DF(10000, 15000);
			iLocal_712 = (unk_0x578C4EF320340AF7() + iLocal_713);
			iLocal_624 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_616)
						{
							if (!unk_0xC2169C00B643278B(iLocal_734, Local_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !unk_0xC21B6E3EB2C43175(iLocal_734, Local_322[iLocal_721 /*10*/].f_1, 30f))
							{
								if (unk_0x16BC17A8EDC701A2(iLocal_734, 713668775) != 1 || unk_0x16BC17A8EDC701A2(iLocal_734, 713668775) != 7)
								{
									iLocal_714 = 1;
								}
							}
					...
					case 1:
						if (!unk_0xC2169C00B643278B(iLocal_734, Local_781, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!unk_0xC2169C00B643278B(iLocal_734, Local_788, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_482(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_616)
	{
		if (func_488())
		{
			...
			if (func_308(iLocal_734))
			{
				...
				if (bParam1)
				{
					unk_0xB53E642F4F50E7C0(0, Local_322[iLocal_721 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
				...
				unk_0x9B6EC2CECE1010EF(iLocal_734, uVar0);
...
int func_488()
{
	if (unk_0xAE06B9E39EBDE049(iLocal_732) && unk_0x0A43129B43E05B32(iLocal_732, iLocal_734))
	{
		return 1;
	}
	if (!iLocal_612)
...
void func_489()
{
	unk_0x78FCB2E22C41B9D5(iLocal_728);
	while (!unk_0x7D167B9A0CCDA347(iLocal_728))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_612 = 1;
...
void func_490(bool bParam0)
{
	...
	if (func_308(iLocal_734))
	{
		if (unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3))
		{
			unk_0x4E65320BC9AD521C(iLocal_734, 1);
			unk_0xE2348E4036041923(iLocal_734);
			unk_0x9DC06E2A59C5AEBB(&uVar0);
...
void func_491(bool bParam0)
{
	...
	iVar1 = 0;
	if (func_308(iLocal_734) && func_308(unk_0x9B0761B4C3EB8BC7()))
	{
		if (func_462())
		{
			iVar1 = 0;
			while (iVar1 < func_461())
			{
				...
				{
					iVar0 = unk_0x9048E8838E822F21(func_460(iVar1));
					if (iVar0 != unk_0x9B0761B4C3EB8BC7() && iVar0 != iLocal_734)
					{
			...
			while (iVar1 < 5)
			{
				if (unk_0xAE06B9E39EBDE049(Local_353[iVar1 /*29*/].f_12))
				{
					if (unk_0xCDF860E56BBCC6B4(Local_353[iVar1 /*29*/].f_12, unk_0x9B0761B4C3EB8BC7(), 1))
					{
						unk_0xBB7976F6FB9C9DD2(Local_353[iVar1 /*29*/].f_12);
						iLocal_707++;
					}
				}
				iVar1++;
...
void func_492()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
	{
		if (((unk_0x261234EE652E3D8D(unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || unk_0x261234EE652E3D8D(unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || unk_0x261234EE652E3D8D(unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) + Vector(2f, 2f, 2f), unk_0x3E4D3CCC220BDFB1(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(iLocal_734, 0), 10f))
		{
			unk_0xF62C19B1689A771C(1, iLocal_608, 1862763509);
		}
		if (!iLocal_619)
		{
			if (func_494() || unk_0x2311EB213A0CB707(unk_0x460153A63B9477BC(), iLocal_734))
			{
				if (func_223())
				{
					func_316();
		...
		if (!bLocal_645)
		{
			if (unk_0xEC787E1D3B804A72(iLocal_734))
			{
				unk_0xDAE36360F0F8C1ED(iLocal_734, 0);
				bLocal_645 = true;
			}
		}
		else if (unk_0x12C99794D883929B(iLocal_734))
		{
			unk_0xDAE36360F0F8C1ED(iLocal_734, 1);
			bLocal_645 = false;
		}
...
int func_494()
{
	if (func_308(iLocal_734))
	{
		if (iLocal_319 != 25)
		{
			if ((!unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6) && unk_0x42A04E707DE50816(unk_0x9B0761B4C3EB8BC7())) && func_373(iLocal_734, unk_0x9B0761B4C3EB8BC7(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!unk_0xC0A3F78AF5448915(unk_0x9B0761B4C3EB8BC7(), 6) && unk_0x42A04E707DE50816(unk_0x9B0761B4C3EB8BC7())) && unk_0x04055E36623F131B(unk_0x9B0761B4C3EB8BC7(), iLocal_734, 30f)) && func_373(iLocal_734, unk_0x9B0761B4C3EB8BC7(), 1) <= 2f)
		{
			return 1;
		}
	}
...
void func_495()
{
	if (!unk_0x5AEB5DDFFAD43CA5(iLocal_734))
	{
		if ((unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && unk_0x4C06B15B376AA145(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f) || iLocal_714 == 1)
		{
			if (unk_0xAE06B9E39EBDE049(iLocal_732))
			{
				unk_0x315F7D8C33F0AB37(&iLocal_732);
		...
		if (!unk_0xAE06B9E39EBDE049(iLocal_732))
		{
			if (unk_0x9934470AA0A08B57(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro", 3) && unk_0x4C06B15B376AA145(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f)
			{
				iLocal_732 = unk_0x79CC07752E7432A1(iLocal_728, unk_0x3E4D3CCC220BDFB1(iLocal_734, 1), 0, 0, 0);
			}
		}
		else if (!unk_0x0A43129B43E05B32(iLocal_732, iLocal_734))
		{
			unk_0xF8A652CE310FFC53(iLocal_732, iLocal_734, unk_0xE6B87C42793036AA(iLocal_734, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_514()
{
	if (!iLocal_631)
	{
		unk_0xDE8F8016287F771F("FRIENDLIES", &iLocal_608);
		unk_0xD3D9D7C84656DAE5(iLocal_734, iLocal_608);
		unk_0xEFBCE8F8316F89EA(1, iLocal_608, 1862763509);
		unk_0xEFBCE8F8316F89EA(1, 1862763509, iLocal_608);
		unk_0xEFBCE8F8316F89EA(2, iLocal_608, -2065892691);
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[0]))
			{
				...
				{
					unk_0x92BD213E6A0E666B(uParam0->f_28[0], joaat("weapon_sniperrifle"), 0, 1, 1);
				}
				else
				{
					bVar4 = false;
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				unk_0xF27E737981AFB47D(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, 0, 0);
			}
			if (bVar4)
			{
				iLocal_79 = 3;
		...
		case 3:
			if (func_230(uParam0->f_28[0]))
			{
				...
				unk_0x694113444F21E39F(uParam0->f_28[0], 104, 1);
				unk_0x69C71C91F56D82B9(uParam0->f_28[0], joaat("weapon_sniperrifle"), 1);
...
void func_529()
{
	...
	if (iLocal_612)
	{
		unk_0x74528AC0906CBABE(iLocal_728);
	}
	if (bLocal_611)
	{
		unk_0x1E337EE68290597A(uLocal_735, 0);
	}
	if (iLocal_640)
	{
		unk_0x1E337EE68290597A(uLocal_736, 0);
	}
...
void func_540()
{
	unk_0x74528AC0906CBABE(iLocal_727);
}
...
int func_543(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_546())
	{
		...
		{
			iVar33 = func_302(unk_0x6C5C6B207AA78253());
			if (iVar33 > -1)
			{
