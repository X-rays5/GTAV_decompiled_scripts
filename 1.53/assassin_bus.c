...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_142(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_324(var uParam0, int iParam1)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(iVar3))
	{
		...
		unk_0x03D382CB0B44E2FC(iVar3, Var0.x, Var0.f_1, fVar8, 1, 0, 0, 1);
...
int func_334(int iParam0)
{
	...
	fVar0 = unk_0xEF7858F25585F853(unk_0x9B0761B4C3EB8BC7());
	fVar1 = (Local_2246[iParam0 /*30*/].f_4 - 180f);
	if (SYSTEM::COS(unk_0x0D77CDCF403AEBD2((fVar0 - fVar1))) <= 0.766f)
	{
		bLocal_1700 = false;
		iVar2 = 0;
	}
...
void func_453(var uParam0, var uParam1)
{
	...
	unk_0xAF7D4BF357E8B79E((Local_1776.x - 40f), (Local_1776.f_1 - 40f), (Local_1776.f_2 - 40f), (Local_1776.x + 40f), (Local_1776.f_1 + 40f), (Local_1776.f_2 + 40f), 0, 1);
	if (unk_0xAE06B9E39EBDE049(uParam1->f_1))
	{
		if (!bLocal_1703)
		{
