		...
		switch (func_263(unk_0x1EF8FCAB83E4BE53()))
		{
			case 0:
				if (func_262() == 1)
				{
					if (func_261())
					{
						Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/] = 1;
					}
				}
				break;
			...
			case 1:
				...
				{
					Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/] = 3;
				}
				break;
...
int func_33(int iParam0, var uParam1)
{
	...
	fVar34 = unk_0x658086F2B3C5E4E4(0f, fVar31);
	iVar33 = 0;
	while (iVar33 < func_36(iParam0))
	{
...
int func_38(int iParam0, int iParam1, int iParam2)
{
	...
	fVar77 = unk_0x658086F2B3C5E4E4(0f, fVar73);
	iVar78 = -1;
	iVar76 = iVar0;
	while (iVar76 <= iVar1)
	{
...
int func_47(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, int iParam18)
{
	...
	if (iParam4 && !bParam7)
	{
		if (func_57(unk_0x460153A63B9477BC(), 1, 1))
		{
			if (!unk_0x03DB5C6AABF8DA46())
			{
				...
				if (unk_0x272784C60C397DB6(func_53(unk_0x460153A63B9477BC()), Param0, 1) <= (fVar2 + fParam3))
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != unk_0x460153A63B9477BC()))
				{
					if ((func_49(iVar1) || !bParam10) && !Global_2425869[iVar1 /*443*/].f_263)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (unk_0x272784C60C397DB6(func_53(iVar1), Param0, 1) <= (fVar2 + fParam3))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && unk_0x460153A63B9477BC() != iVar1) || iParam8 == 0)
		{
			if (func_57(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!unk_0x5AEB5DDFFAD43CA5(unk_0x1FA7B77001D60F9D(iVar1)) && func_49(iVar1)))
					{
						...
						{
							if (((unk_0x6CC163E30ECE0790(unk_0x460153A63B9477BC()) == -1 && uParam9) && bParam6) && func_59(iVar1))
							{
							}
							else if (unk_0xAE06B9E39EBDE049(unk_0x1FA7B77001D60F9D(iVar1)))
							{
								if (unk_0x272784C60C397DB6(func_54(iVar1), Param0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_63(int iParam0, var uParam1)
{
	...
	{
		Global_2515173 = { func_62(iParam0) };
		Global_2515186 = { func_62(uParam1) };
...
int func_85(var uParam0, var uParam1, var uParam2)
{
	...
	func_104();
	if (!unk_0x26F63AFB9E3C323C(uParam0))
	{
		return 0;
	}
	func_87(uParam1);
...
void func_89(var uParam0, var uParam1)
{
	...
	if (bVar75)
	{
		uVar74 = unk_0x8FB84FA27FE10524(iVar67, "ed");
	}
	if (bVar77)
	{
		uVar76 = unk_0x8FB84FA27FE10524(iVar67, "gt");
	}
	iVar5 = 0;
	while (iVar5 < 1)
	{
		if (iVar82[iVar5])
		{
			StringCopy(&Var0, "bsa", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar80[iVar5] = unk_0x8FB84FA27FE10524(iVar79, &Var0);
		}
		iVar5++;
	}
	if (bVar85)
	{
		uVar84 = unk_0x8FB84FA27FE10524(iVar79, "mn");
	}
	if (bVar87)
	{
		uVar86 = unk_0x8FB84FA27FE10524(iVar79, "pos");
	}
	if (bVar89)
	{
		uVar88 = unk_0x8FB84FA27FE10524(iVar79, "head");
	}
	if (bVar91)
	{
		uVar90 = unk_0x8FB84FA27FE10524(iVar79, "col");
	}
	if (bVar93)
	{
		uVar92 = unk_0x8FB84FA27FE10524(iVar79, "int");
	}
	if (bVar96)
	{
		uVar95 = unk_0x8FB84FA27FE10524(iVar94, "sprt");
	}
	if (bVar98)
	{
		uVar97 = unk_0x8FB84FA27FE10524(iVar94, "hclr");
	}
	if (bVar100)
	{
		uVar99 = unk_0x8FB84FA27FE10524(iVar94, "scl");
	}
	if (bVar102)
	{
		uVar101 = unk_0x8FB84FA27FE10524(iVar94, "sh");
	}
	iVar5 = 0;
	while (iVar5 < 1)
	{
		if (iVar107[iVar5])
		{
			StringCopy(&Var0, "bsa", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar105[iVar5] = unk_0x8FB84FA27FE10524(iVar104, &Var0);
		}
		iVar5++;
	}
	if (bVar110)
	{
		uVar109 = unk_0x8FB84FA27FE10524(iVar104, "mn");
	}
	if (bVar112)
	{
		uVar111 = unk_0x8FB84FA27FE10524(iVar104, "pos");
	}
	if (bVar114)
	{
		uVar113 = unk_0x8FB84FA27FE10524(iVar104, "head");
	}
	if (bVar116)
	{
		uVar115 = unk_0x8FB84FA27FE10524(iVar104, "rot");
	}
	if (bVar120)
	{
		uVar119 = unk_0x8FB84FA27FE10524(iVar118, "idx");
	}
	iVar5 = 0;
	while (iVar5 < 1)
	{
		if (iVar125[iVar5])
		{
			StringCopy(&Var0, "ibs", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar123[iVar5] = unk_0x8FB84FA27FE10524(iVar122, &Var0);
		}
		iVar5++;
	}
	if (bVar128)
	{
		uVar127 = unk_0x8FB84FA27FE10524(iVar122, "vmn");
	}
	if (bVar130)
	{
		uVar129 = unk_0x8FB84FA27FE10524(iVar122, "vmx");
	}
	if (bVar132)
	{
		uVar131 = unk_0x8FB84FA27FE10524(iVar122, "fwd");
	}
	if (bVar136)
	{
		uVar135 = unk_0x8FB84FA27FE10524(iVar134, "pedi");
	}
	iVar5 = 0;
	while (iVar5 < 1)
	{
		if (iVar140[iVar5])
		{
			StringCopy(&Var0, "scro", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar138[iVar5] = unk_0x8FB84FA27FE10524(iVar137, &Var0);
		}
		if (iVar144[iVar5])
		{
			StringCopy(&Var0, "pos", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar142[iVar5] = unk_0x8FB84FA27FE10524(iVar137, &Var0);
		}
		if (iVar148[iVar5])
		{
			StringCopy(&Var0, "look", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar146[iVar5] = unk_0x8FB84FA27FE10524(iVar137, &Var0);
		}
		if (iVar152[iVar5])
		{
			StringCopy(&Var0, "dur", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar150[iVar5] = unk_0x8FB84FA27FE10524(iVar137, &Var0);
		}
		iVar5++;
	}
	if (bVar156)
	{
		uVar155 = unk_0x8FB84FA27FE10524(iVar154, "name");
	}
	if (bVar159)
	{
		uVar158 = unk_0x8FB84FA27FE10524(iVar157, "pos");
	}
	if (bVar161)
	{
		uVar160 = unk_0x8FB84FA27FE10524(iVar157, "head");
	}
	if (bVar163)
	{
		uVar162 = unk_0x8FB84FA27FE10524(iVar157, "plnkp");
	}
	iVar5 = 0;
	while (iVar5 < 1)
	{
		if (iVar166[iVar5])
		{
			StringCopy(&Var0, "ibs", 16);
			StringIntConCat(&Var0, iVar5, 16);
			uVar164[iVar5] = unk_0x8FB84FA27FE10524(iVar157, &Var0);
		}
		iVar5++;
	}
...
int func_153(struct<2> Param0, var uParam2, var uParam3, var uParam4)
{
	...
	while (iVar0 < func_155())
	{
		...
		{
			if (unk_0xCE990E643CD9D0E5(Local_126[iVar0 /*3*/].f_1, 0))
			{
				if (!unk_0xCE990E643CD9D0E5(Local_126[iVar0 /*3*/].f_1, 4))
				{
					iLocal_117++;
				}
				if (Param0.f_1 == 18)
			...
			else if (unk_0xCE990E643CD9D0E5(Local_126[iVar0 /*3*/].f_1, 1))
			{
			}
			else if (!unk_0xCE990E643CD9D0E5(Local_126[iVar0 /*3*/].f_1, 1))
			{
...
void func_175()
{
	...
	iVar0 = 10000;
	switch (Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_2)
	{
		case 0:
			if (Global_2508189.f_2 >= 4 && Global_2508189.f_2 != 8)
			{
				if (func_150(1))
				{
					unk_0xBE20AB8238688965(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 0);
					unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 1);
				}
				...
				{
					func_169(&uLocal_118);
					unk_0xBE20AB8238688965(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 3);
				}
				else
				{
					if (unk_0xCE990E643CD9D0E5(uLocal_95, 1))
					{
						iVar0 = 500;
					}
					if (func_15(&uLocal_118, iVar0, 0))
					{
						...
						func_259(4);
						unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 3);
					}
				}
			}
		...
		case 4:
			if (func_260(unk_0x460153A63B9477BC(), 0))
			{
				...
				{
					func_259(8);
					unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 0);
					unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 4);
				}
			...
			else
			{
				if (func_231())
				{
					if (!func_219())
					{
						unk_0xBE20AB8238688965(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 4);
					}
				...
				if (!func_260(unk_0x460153A63B9477BC(), 0))
				{
					...
					func_259(0);
					unk_0xBE20AB8238688965(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 1);
					unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 4);
				}
			}
			break;
			...
			if (!func_180())
			{
					...
					if (unk_0x7B70881748D166CD(unk_0x856D5567211886A2(&cVar1)) == 0)
					{
						if (!unk_0x1B2EFC1EEC84CBE3(&cVar1, -1, 0, 0) || unk_0x96799BFA3859CDC1(&cVar1, -1, 0) < 32)
						{
							if (!unk_0x1B2EFC1EEC84CBE3(&cVar1, -1, 1, 0))
							{
								...
								{
									unk_0xBE20AB8238688965(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 2);
								}
							}
						}
					}
				...
				else if (unk_0x7B70881748D166CD(unk_0x856D5567211886A2(&cVar1)) != 0)
				{
					if (Global_2508189.f_2 == 7)
					{
						...
						unk_0xD2459066EA58CE43(&(Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_1), 2);
					}
				}
			}
			break;
	...
	if (unk_0x55B9A76AF5A44EE2(&cVar0))
	{
		...
		if (unk_0x8DC2EFD1CECAA468(&cVar0))
		{
			...
			if (bParam21)
			{
				...
				while (iVar9 < 16)
				{
					if (unk_0x1B2EFC1EEC84CBE3(&cVar0, iVar9, iVar8, 0))
					{
						return 0;
					}
					iVar9++;
			...
			else if (unk_0x1B2EFC1EEC84CBE3(&cVar0, Param0.f_16, iVar8, 0))
			{
				return 0;
			}
...
int func_207(struct<3> Param0, struct<3> Param3)
{
	...
	{
		if (unk_0xC2169C00B643278B(unk_0x9B0761B4C3EB8BC7(), Var0, Param3, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_229(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11771)
	{
		...
		uVar0 = Global_2551832[iParam0 /*3*/][func_190(iParam1)];
...
{
	Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/].f_2 = iParam0;
}

bool func_260(int iParam0, int iParam1)
{
	return unk_0xCE990E643CD9D0E5(Local_126[iParam0 /*3*/].f_1, iParam1);
}
...
int func_276(struct<21> Param0)
{
	...
	unk_0xBB96A3ECD45D0317(&Local_126, 97);
	unk_0x3A396632EB359434(0);
	Local_126[unk_0x1EF8FCAB83E4BE53() /*3*/] = 0;
	func_259(0);
	return 1;
}
...
void func_280(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!unk_0x25DDB354A40FFCDB())
	{
		func_279();
