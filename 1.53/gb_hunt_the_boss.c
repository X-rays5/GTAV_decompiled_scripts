	...
	else if (iParam0 == 190)
	{
		if (uParam1->f_10 > 0)
		{
			if (func_106())
			{
				...
				iVar7 = func_283(unk_0x460153A63B9477BC(), Var0, *uParam3);
				if (Var0.f_1 == 1)
				{
...
void func_657()
{
	...
	if (fVar6 < 25f)
	{
		...
		unk_0x3E6F6B3156C4F772(0, 1000, SYSTEM::ROUND(fVar8));
	}
}
		...
		case 0:
			if (!func_17(Local_115.f_7))
			{
				if (func_696(unk_0x460153A63B9477BC(), func_16(), 1))
				{
					...
					{
						uLocal_91 = unk_0x5F920D11DDA03179(Local_115.f_7, SYSTEM::TO_FLOAT((Global_262145.f_12502 - 1)));
...
void func_778()
{
	...
	{
		if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_104) > IntToFloat(Global_262145.f_12499))
		{
			func_8(&uLocal_108);
			if (unk_0xCE990E643CD9D0E5(Local_137[unk_0x59E2AD1A8ACEDA31() /*3*/].f_2, 4))
			{
...
void func_785(int iParam0)
{
	...
	if (unk_0xAE06B9E39EBDE049(Var4))
	{
		...
		{
			uVar0 = unk_0x9048E8838E822F21(Var4);
