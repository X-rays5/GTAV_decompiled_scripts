...
void func_30()
{
	...
	if (unk_0x40397A9A17EEC1C5(uLocal_328))
	{
		...
		func_32();
		iVar10 = SYSTEM::FLOOR((unk_0xB0F4BDC84084072E(2, 218) * 127f));
		iVar11 = SYSTEM::FLOOR((unk_0xB0F4BDC84084072E(2, 219) * 127f));
		iVar12 = SYSTEM::FLOOR((unk_0xB0F4BDC84084072E(2, 220) * 127f));
		iVar13 = SYSTEM::FLOOR((unk_0xB0F4BDC84084072E(2, 221) * 127f));
		...
		unk_0x3B1D5D044BC72834(uLocal_328, unk_0x9B0761B4C3EB8BC7(), Var7.x, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
	}
	else
	{
...
void func_31(int iParam0, var uParam1, struct<3> Param2)
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(uParam0))
	{
		if (unk_0x40397A9A17EEC1C5(*uParam1))
		{
			...
			Var1.f_2 = uVar0;
			Var1 = { Var1 + Param2 };
			unk_0xBF92D2A60C7C686E(*uParam1, Var1.x, Var1.f_1, Var1.f_2, 2);
		}
	}
}
...
void func_36(struct<3> Param0, float fParam3)
{
	...
	if (unk_0x80FF6C016CDB0FAF(iLocal_306, 0))
	{
		unk_0xF27E737981AFB47D(Param0.x, Param0.f_1, Param0.f_2, 5f, 0, 0, 0, 0, 0, 0);
		unk_0x03D382CB0B44E2FC(iLocal_306, Param0.x, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
		...
		switch (iLocal_50)
		{
			...
			case 1:
				...
				if (unk_0x80FF6C016CDB0FAF(iLocal_306, 0))
				{
					...
					if (unk_0x71B5E9AB554C28B8(Local_320.x, Local_320.f_1, Local_323.x, Local_323.f_1))
					{
...
int func_144()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_151())
		{
			return 0;
		}
	}
...
void func_184()
{
	if (iLocal_318)
	{
		unk_0xB65F86FFF1334E95(Local_320.x, Local_320.f_1, Local_323.x, Local_323.f_1);
	}
}
...
void func_187()
{
	...
	unk_0xEFBCE8F8316F89EA(1, uLocal_309, 1862763509);
}
