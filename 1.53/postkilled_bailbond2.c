	...
	while (true)
	{
		...
		if ((unk_0x578C4EF320340AF7() - iVar6) > 100)
		{
			if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
			{
				...
				{
					if (SYSTEM::VDIST2(Var0, unk_0x3E4D3CCC220BDFB1(iLocal_79[iVar3], 0)) >= IntToFloat((iVar5 * iVar5)) && unk_0x1D88F87079AF2FA7(iLocal_79[iVar3]))
					{
...
void func_19()
{
	...
	unk_0xEFBCE8F8316F89EA(5, 1862763509, iLocal_145);
	unk_0xEFBCE8F8316F89EA(5, iLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
...
void func_20()
{
	...
	unk_0xF62C19B1689A771C(5, 1862763509, iLocal_145);
	unk_0xF62C19B1689A771C(5, iLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
