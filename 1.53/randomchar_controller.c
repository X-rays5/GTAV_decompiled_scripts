...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_31(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		if (!func_45(35))
		{
			if (unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 2) && !unk_0xCE990E643CD9D0E5(Global_111858.f_18570[iParam0 /*6*/], 3))
			{
				...
				{
					if (SYSTEM::VDIST2(Var0.f_6, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)) < 81f)
					{
						sVar64 = "";
