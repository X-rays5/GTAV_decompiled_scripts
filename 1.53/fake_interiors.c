...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			uLocal_33 = unk_0x9B0761B4C3EB8BC7();
		}
		if (unk_0xA59F96B50B97E63C(uLocal_33, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		Var0 = { unk_0x3E4D3CCC220BDFB1(uLocal_33, 0) };
		...
		if (SYSTEM::VDIST2(Var3, Var0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar7 < func_17(iLocal_29))
			{
				if (!bVar6)
				{
					if (unk_0x1037B9D45CE6B788(uLocal_33, func_16(iLocal_29, iVar7), func_15(iLocal_29, iVar7), func_14(iLocal_29, iVar7), 0, 1, 0))
					{
						bVar6 = true;
					}
				}
			...
			if (bVar6)
			{
				unk_0xFB66346733DDE6FA(unk_0x856D5567211886A2(func_13(iLocal_29)), Var3.x, Var3.f_1, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0x25DDB354A40FFCDB())
	{
		if (func_2())
		{
			if (unk_0xCE990E643CD9D0E5(uLocal_34, 1))
			{
				unk_0xD2459066EA58CE43(&uLocal_34, 1);
			}
			if (unk_0xF0C12886E5C1B20E())
			{
				if (!unk_0xCE990E643CD9D0E5(uLocal_34, 0))
				{
					unk_0x1D319098EA3986CC(15, 1, -1);
					unk_0xBE20AB8238688965(&uLocal_34, 0);
				}
			}
			else if (unk_0xCE990E643CD9D0E5(uLocal_34, 0))
			{
				unk_0x1D319098EA3986CC(15, 0, -1);
				unk_0xD2459066EA58CE43(&uLocal_34, 0);
			}
		}
		else if (!unk_0xCE990E643CD9D0E5(uLocal_34, 1))
		{
			unk_0x1D319098EA3986CC(15, 0, -1);
			unk_0xD2459066EA58CE43(&uLocal_34, 0);
			unk_0xBE20AB8238688965(&uLocal_34, 1);
		}
	}
}
