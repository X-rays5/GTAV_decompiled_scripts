	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				unk_0xEFBCE8F8316F89EA(5, uLocal_49, 1862763509);
			...
			if (unk_0xFC5D6FB6EECB392F(uLocal_53))
			{
				if (unk_0x369E69441C066912(uLocal_53) > 0.3f)
				{
					if (!unk_0x5AEB5DDFFAD43CA5((*iParam8)[0]))
					{
						...
						unk_0x9DC06E2A59C5AEBB(&iLocal_50);
						unk_0x88AEDBE3A7557929(0, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1) - Vector(0f, 0f, 1f), unk_0x9B0761B4C3EB8BC7(), 2f, 0, 3.5f, 5f, 1, 0, 0, -957453492, 20000);
...
int func_60(int iParam0, var uParam1)
{
	switch (iLocal_255)
	{
		...
		case 3:
			...
			{
				if (SYSTEM::TIMERA() > 8000 && unk_0xC2169C00B643278B(iParam0, Local_243, 3f, 3f, 3f, 0, 1, 0))
				{
...
int func_74(struct<3> Param0, int iParam3)
{
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Param0) > IntToFloat(iParam3))
		{
			return 1;
		}
	}
...
int func_101()
{
	...
	{
		if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_46) < (75f * 75f))
		{
			return 1;
		}
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_112())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_133(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
