...
void __EntryFunction__()
{
	...
	else if (Var0 == 30)
	{
		...
		iLocal_262 = unk_0x578C4EF320340AF7();
	}
	while (true)
	{
		SYSTEM::WAIT(0);
...
int func_174(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_217(unk_0x9B0761B4C3EB8BC7(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if ((!func_175(unk_0x9B0761B4C3EB8BC7(), -828834893) && func_205(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0))) && func_148(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				unk_0x0AB756271BADC8DF(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			}
		}
...
int func_176(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_217(unk_0x9B0761B4C3EB8BC7(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if ((!func_175(unk_0x9B0761B4C3EB8BC7(), -828834893) && func_205(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0))) && func_148(unk_0xA5D5B1042E8F47BD(unk_0x9B0761B4C3EB8BC7(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				unk_0x0AB756271BADC8DF(unk_0x9B0761B4C3EB8BC7(), 0, 0);
			}
		}
...
void func_192()
{
	...
	{
		case 0:
			if ((unk_0x578C4EF320340AF7() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_205(unk_0x9B0761B4C3EB8BC7()) && func_205(iParam0->f_28[0])) && !func_145()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam8) && func_217(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_221(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_237(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_237(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_237(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				uLocal_94 = unk_0xF341A134A5B8D4F6(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0x81493F39713559B1(uLocal_94, 1);
				unk_0xDFDB9C533700BC17(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_289(int iParam0, bool bParam1)
{
	...
	if (unk_0x8F678487EEBD8CE4(uLocal_264))
	{
		unk_0x93370FA10F15BE44(&uLocal_264);
	}
