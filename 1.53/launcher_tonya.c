...
void __EntryFunction__()
{
	...
	unk_0x555EE41D7C7078E6(Local_92, 5f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_184(var uParam0)
{
	...
	if (unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
	{
		fVar0 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_92);
		if (fVar0 < (20f * 20f) && iLocal_98)
		{
			switch (iLocal_99)
			{
				case 0:
					if (!func_146())
					{
						...
						if (*uParam0 == 58)
						{
							...
							{
								unk_0x4F83FEE4454169D4(&uLocal_96);
								unk_0x9DC06E2A59C5AEBB(&uLocal_96);
								...
								unk_0x19F29730874AD6F1(uLocal_96);
								unk_0x9B6EC2CECE1010EF(uParam0->f_28[0], uLocal_96);
								unk_0x4F83FEE4454169D4(&uLocal_96);
							}
						}
						else if (*uParam0 == 59)
				...
				case 2:
					if (func_191(&uLocal_265))
					{
						if (func_185(&uLocal_265) > unk_0x658086F2B3C5E4E4(9f, 15f))
						{
							iLocal_268++;
							switch (iLocal_268)
							{
...
float func_185(var uParam0)
{
	if (func_191(uParam0))
	{
		...
		{
			return (func_186(unk_0xCE990E643CD9D0E5(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_186(unk_0xCE990E643CD9D0E5(*uParam0, 4)) - fParam1);
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_218(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_218(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_235(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_235(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_242(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_235(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
...
int func_253(int iParam0)
{
	...
	uLocal_95 = unk_0xC08A186299DFDA0A(Local_92 - Vector(10f, 10f, 10f), Local_92 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	iLocal_97 = 1;
...
int func_254(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				uParam0->f_28[0] = unk_0xB3116B49FE00E2F1(5, joaat("ig_tonya"), -16.53f, -1473.12f, 29.61f, 319.56f, 1, 1);
				if (func_127(uParam0->f_28[0]))
				{
					unk_0x4E65320BC9AD521C(uParam0->f_28[0], 1);
					unk_0xA5EAD2ACE2C8BBB2(uParam0->f_28[0], 1, 1);
					unk_0x5476B2D1DCA6FE9D(joaat("ig_tonya"), 1);
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && unk_0x5A228A6A51E757C8(unk_0x460153A63B9477BC()))
			{
				...
				unk_0x19F29730874AD6F1(uVar1);
				unk_0x9B6EC2CECE1010EF(uParam0->f_28[0], uVar1);
				unk_0x4F83FEE4454169D4(&uVar1);
				unk_0xA785552633ED203B(uParam0->f_28[0], unk_0x9B0761B4C3EB8BC7(), -1, 0, 4);
			}
