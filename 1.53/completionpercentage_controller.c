...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_413 == 1)
		{
			if (!iLocal_410)
			{
				if (!iLocal_411)
				{
					...
					iLocal_414 = unk_0xE52A8802193E5624();
					unk_0x0DBDFF6C8EECD72B(iLocal_414, "tot_pc", Global_111858.f_10190.f_3853);
					uLocal_415 = unk_0x0DA0D2DFDCAF8646(iLocal_414, "Sect");
					uLocal_416 = unk_0x9BE78C3FABE5E79C(uLocal_415, "mgc");
					uLocal_417 = unk_0x9BE78C3FABE5E79C(uLocal_415, "msnc");
					uLocal_418 = unk_0x9BE78C3FABE5E79C(uLocal_415, "ojc");
					uLocal_419 = unk_0x9BE78C3FABE5E79C(uLocal_415, "rcc");
					uLocal_420 = unk_0x9BE78C3FABE5E79C(uLocal_415, "revc");
					uLocal_421 = unk_0x9BE78C3FABE5E79C(uLocal_415, "misc");
					iLocal_422 = 0;
					while (iLocal_422 < 321)
					{
						if (!Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 0)
						{
							if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 1 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 2)
							{
								...
								{
									uLocal_28[iLocal_396] = unk_0x416EB59129452AFC(uLocal_417);
									unk_0x357BF1136612718A(uLocal_28[iLocal_396], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_28[iLocal_396], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 1)
									{
										unk_0x81CE265566114E44(uLocal_28[iLocal_396], "100", 1);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_28[iLocal_396], "100", 0);
									}
									Local_402 = { func_125(iLocal_422) };
									unk_0x196EF710ED0C1363(uLocal_28[iLocal_396], "x", SYSTEM::ROUND(Local_402.x));
									unk_0x196EF710ED0C1363(uLocal_28[iLocal_396], "y", SYSTEM::ROUND(Local_402.f_1));
									iLocal_396++;
								}
							}
							if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 3 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 4)
							{
								if (Global_111858.f_10190[iLocal_422 /*12*/].f_5 || Global_111593 == 1)
								{
									uLocal_99[iLocal_397] = unk_0x416EB59129452AFC(uLocal_416);
									unk_0x357BF1136612718A(uLocal_99[iLocal_397], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_99[iLocal_397], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 3)
									{
										unk_0x81CE265566114E44(uLocal_99[iLocal_397], "100", 1);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_99[iLocal_397], "100", 0);
									}
									Local_402 = { func_125(iLocal_422) };
									unk_0x196EF710ED0C1363(uLocal_99[iLocal_397], "x", SYSTEM::ROUND(Local_402.x));
									unk_0x196EF710ED0C1363(uLocal_99[iLocal_397], "y", SYSTEM::ROUND(Local_402.f_1));
									iLocal_397++;
								}
							}
							if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 5 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 6)
							{
								if (Global_111858.f_10190[iLocal_422 /*12*/].f_5 || Global_111593 == 1)
								{
									uLocal_150[iLocal_398] = unk_0x416EB59129452AFC(uLocal_418);
									unk_0x357BF1136612718A(uLocal_150[iLocal_398], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_150[iLocal_398], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 5)
									{
										unk_0x81CE265566114E44(uLocal_150[iLocal_398], "100", 1);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_150[iLocal_398], "100", 0);
									}
									Local_402 = { func_125(iLocal_422) };
									unk_0x196EF710ED0C1363(uLocal_150[iLocal_398], "x", SYSTEM::ROUND(Local_402.x));
									unk_0x196EF710ED0C1363(uLocal_150[iLocal_398], "y", SYSTEM::ROUND(Local_402.f_1));
									iLocal_398++;
								}
							}
							if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 7 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 8)
							{
								if (Global_111858.f_10190[iLocal_422 /*12*/].f_5 || Global_111593 == 1)
								{
									uLocal_302[iLocal_399] = unk_0x416EB59129452AFC(uLocal_419);
									unk_0x357BF1136612718A(uLocal_302[iLocal_399], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_302[iLocal_399], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 7)
									{
										unk_0x81CE265566114E44(uLocal_302[iLocal_399], "100", 1);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_302[iLocal_399], "100", 0);
									}
									Local_402 = { func_125(iLocal_422) };
									unk_0x196EF710ED0C1363(uLocal_302[iLocal_399], "x", SYSTEM::ROUND(Local_402.x));
									unk_0x196EF710ED0C1363(uLocal_302[iLocal_399], "y", SYSTEM::ROUND(Local_402.f_1));
									iLocal_399++;
								}
							}
							if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 9 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 10)
							{
								if (Global_111858.f_10190[iLocal_422 /*12*/].f_5 || Global_111593 == 1)
								{
									uLocal_216[iLocal_400] = unk_0x416EB59129452AFC(uLocal_420);
									unk_0x357BF1136612718A(uLocal_216[iLocal_400], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_216[iLocal_400], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 9)
									{
										unk_0x81CE265566114E44(uLocal_216[iLocal_400], "100", 0);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_216[iLocal_400], "100", 0);
									}
									unk_0x196EF710ED0C1363(uLocal_216[iLocal_400], "x", SYSTEM::ROUND(Global_111858.f_10190[iLocal_422 /*12*/].f_10));
									unk_0x196EF710ED0C1363(uLocal_216[iLocal_400], "y", SYSTEM::ROUND(Global_111858.f_10190[iLocal_422 /*12*/].f_11));
									iLocal_400++;
								}
							}
							if (((Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 11 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 13) || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 12) || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 14)
							{
								if (Global_111858.f_10190[iLocal_422 /*12*/].f_5 || Global_111593 == 1)
								{
									uLocal_363[iLocal_401] = unk_0x416EB59129452AFC(uLocal_421);
									unk_0x357BF1136612718A(uLocal_363[iLocal_401], "nm", &(Global_111858.f_10190[iLocal_422 /*12*/]));
									unk_0x81CE265566114E44(uLocal_363[iLocal_401], "cmp", Global_111858.f_10190[iLocal_422 /*12*/].f_5);
									if (Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 11 || Global_111858.f_10190[iLocal_422 /*12*/].f_6 == 13)
									{
										unk_0x81CE265566114E44(uLocal_363[iLocal_401], "100", 1);
									}
									else
									{
										unk_0x81CE265566114E44(uLocal_363[iLocal_401], "100", 0);
									}
									Local_402 = { func_125(iLocal_422) };
									unk_0x196EF710ED0C1363(uLocal_363[iLocal_401], "x", SYSTEM::ROUND(Local_402.x));
									unk_0x196EF710ED0C1363(uLocal_363[iLocal_401], "y", SYSTEM::ROUND(Local_402.f_1));
									iLocal_401++;
								}
							}
						}
		...
		if (iLocal_410)
		{
			...
			else if (!unk_0x94F7712E49C86C6C(&bLocal_412))
			{
				if (bLocal_412)
				{
				}
...
void func_49(int iParam0)
{
	...
	func_50(&(Global_76647[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_7(func_53(iParam1, uParam0->f_2), Global_76644, 0);
			if (unk_0xCE990E643CD9D0E5(uVar0, uParam0->f_1))
			{
				unk_0xBE20AB8238688965(&(uParam0->f_6), 1);
			}
			uVar0 = func_7(func_52(iParam1, uParam0->f_2), Global_76644, 0);
			if (unk_0xCE990E643CD9D0E5(uVar0, uParam0->f_1))
			{
				unk_0xBE20AB8238688965(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_7(iVar1, Global_76644, 0);
				if (!unk_0xCE990E643CD9D0E5(uVar0, uParam0->f_1))
				{
					unk_0xBE20AB8238688965(&(uParam0->f_6), 4);
				}
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_50(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_50(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_38(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_141()
{
	...
	iLocal_405 = unk_0x578C4EF320340AF7();
