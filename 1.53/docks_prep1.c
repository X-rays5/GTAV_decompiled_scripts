...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_177(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_199()
{
	...
	switch (iLocal_410)
	{
		...
		case 4:
			...
			{
				fVar0 = (1f - func_203((SYSTEM::TO_FLOAT((unk_0x578C4EF320340AF7() - iLocal_2135 + 1500)) / 3000f), 0f, 1f));
...
void func_325()
{
	...
	unk_0xEFBCE8F8316F89EA(5, iLocal_395, 1862763509);
	unk_0xEFBCE8F8316F89EA(1, 1862763509, iLocal_394);
	unk_0xEFBCE8F8316F89EA(1, iLocal_394, 1862763509);
