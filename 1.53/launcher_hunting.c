...
void __EntryFunction__()
{
	...
	iLocal_94 = unk_0xB3A5FF195E1A8192(joaat("weapon_sniperrifle"));
	iLocal_95 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_scope_large"));
	iLocal_96 = unk_0x85CB1D50AB0A0A5B(joaat("component_at_ar_supp_02"));
	...
	unk_0x555EE41D7C7078E6(Var61, 3f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_197(&Var0, 1))
		...
		{
			Var67 = { unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0) };
		}
		if (Var0 == 25)
		{
		...
		if (func_169(&Var0, 0) && unk_0x0D77CDCF403AEBD2((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_260(&Var0, 1);
...
int func_184(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam8) && func_188(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
					...
					if (unk_0xC614DDE265D18415(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_200(uParam1))
								{
									unk_0x81DCDE42A0B23C21(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									unk_0x81DCDE42A0B23C21(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								unk_0x81DCDE42A0B23C21(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
						...
						{
							unk_0x81DCDE42A0B23C21(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_200(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				{
					unk_0x81DCDE42A0B23C21(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					unk_0x81DCDE42A0B23C21(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_199(iParam2) || unk_0x04055E36623F131B(iParam0, unk_0x9B0761B4C3EB8BC7(), 10f))
				{
					...
					{
						unk_0x81DCDE42A0B23C21(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_217(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_217(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_224(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_217(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uLocal_100))
			{
				iLocal_100 = unk_0xA3E0B448E324D459(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
				unk_0xC53D054996356072(iLocal_100, joaat("component_at_scope_large"));
				unk_0xC53D054996356072(iLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			if (unk_0x8865B8E834909D76(Local_97, 1f, iLocal_94, 0))
			{
				unk_0xC82085403E46A869(iLocal_100, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
