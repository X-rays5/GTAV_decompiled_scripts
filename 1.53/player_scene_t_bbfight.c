...
int func_2()
{
	...
	if (unk_0xFC5D6FB6EECB392F(Global_96285))
	{
		...
		if (func_26(iVar1))
		{
			if (!unk_0x7BCC91F3C1CF24E8(&Local_497))
			{
				if (!iLocal_502)
				{
					if (fVar0 < fLocal_501)
					...
					{
						if (!unk_0x7BCC91F3C1CF24E8(&Local_489))
						{
							func_20(&uLocal_114, func_21(), unk_0x9B0761B4C3EB8BC7(), &Local_489, 0, 1);
						}
						if (!unk_0x7BCC91F3C1CF24E8(&Local_493))
						{
	...
	if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_299) > 100f)
	{
		return 1;
	}
	return 0;
		...
		if (!unk_0x5AEB5DDFFAD43CA5((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						unk_0xDFDB9C533700BC17((*iParam0)[iVar0], Global_96284, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (unk_0xFC5D6FB6EECB392F(Global_96285))
					{
						unk_0xDFDB9C533700BC17((*iParam0)[iVar0], Global_96285, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						unk_0x131ED02492676000(&cLocal_371);
						(*iParam1)[iVar0] = 102;
					}
					break;
				
				case 102:
					if (unk_0xC614DDE265D18415(&cLocal_371) && unk_0x9934470AA0A08B57((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 2))
					{
						sVar1 = "victim_fall";
						fVar2 = -1f;
						fVar3 = -1f;
						if (unk_0x2ECACCBBE69F9A16(&cLocal_371, &(Local_420[iVar0 /*16*/]), sVar1, &fVar2, &fVar3))
						{
							if (fVar2 < unk_0x369E69441C066912(Global_96285))
							{
								if (!unk_0x96335C06FE469AF4((*iParam0)[iVar0]))
								{
									...
									unk_0x694113444F21E39F((*iParam0)[iVar0], 137, 1);
								}
							}
						}
						if (iLocal_113 == 165)
						{
							if (!unk_0x7BCC91F3C1CF24E8(&(Local_453[iVar0 /*16*/])))
							{
								...
								if (0.95f < unk_0x369E69441C066912(Global_96285))
								{
									...
									{
										unk_0x3964C1CAAE858CB1((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, 0);
				...
				case 200:
					if (unk_0xFC5D6FB6EECB392F(Global_96284))
					{
						unk_0x756D74A3EF0AB788((*iParam0)[iVar0], &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (unk_0xFC5D6FB6EECB392F(Global_96285))
					{
				...
				case 201:
					if (unk_0xFC5D6FB6EECB392F(Global_96285))
					{
						unk_0x756D74A3EF0AB788((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
				...
				case 202:
					if (unk_0xC614DDE265D18415(&cLocal_371) && unk_0x9934470AA0A08B57((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 1))
					{
						sVar5 = "victim_fall";
						fVar6 = -1f;
						fVar7 = -1f;
						if (unk_0x2ECACCBBE69F9A16(&cLocal_371, &(Local_420[iVar0 /*16*/]), sVar5, &fVar6, &fVar7))
						{
							if (fVar6 < unk_0x4C06B15B376AA145((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])))
							{
								if (!unk_0x96335C06FE469AF4((*iParam0)[iVar0]))
								{
									unk_0x9B94F6169B0DAEFD((*iParam0)[iVar0]);
						...
						{
							if (unk_0x4C06B15B376AA145((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])) > 0.954f)
							{
								if (iLocal_113 == 108)
								{
								...
								unk_0x3C1B180EE30D36EF((*iParam0)[iVar0], Local_299 + Local_303[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
								unk_0x854FB153F2EA838B((*iParam0)[iVar0], -668482597, 0, 0, 0);
				...
				case 0:
					Var8 = { unk_0x3E4D3CCC220BDFB1((*iParam0)[iVar0], 1) };
					...
					fVar15 = unk_0xEF7858F25585F853((*iParam0)[iVar0]);
					...
					fVar17 = unk_0x0D77CDCF403AEBD2((fVar15 - fVar16));
					if (fVar17 > 45f)
					{
						if (!unk_0x16BC17A8EDC701A2((*iParam0)[iVar0], 1920390111) == 1)
						{
							unk_0xF4726838A5A40509((*iParam0)[iVar0], fVar16, 0);
						}
						break;
					}
					if (!unk_0x7BCC91F3C1CF24E8(&(Local_453[iVar0 /*16*/])))
				...
				case 1:
					Var18 = { unk_0x3E4D3CCC220BDFB1((*iParam0)[iVar0], 1) };
					...
					{
						unk_0x3C1B180EE30D36EF((*iParam0)[iVar0], Var21, 0.5f, -1, 1048576000, 0, 1193033728);
						break;
					}
					break;
				...
				case 10:
					if (unk_0x16BC17A8EDC701A2((*iParam0)[iVar0], -71340211) == 7 || unk_0x16BC17A8EDC701A2((*iParam0)[iVar0], -71340211) == 1)
					{
						...
						unk_0xEFBCE8F8316F89EA(5, iLocal_289, 1862763509);
						unk_0xEFBCE8F8316F89EA(5, 1862763509, iLocal_289);
						unk_0xE37C65A5E38D26CF((*iParam0)[iVar0], 25f, -1, 0);
						unk_0xCBA6B2B569DCAFD8((*iParam0)[iVar0], 1);
				...
				case 11:
					if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_299) > 50f && SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1((*iParam0)[iVar0], 1)) > 50f)
					{
						unk_0xEFBCE8F8316F89EA(2, iLocal_289, 1862763509);
						unk_0xEFBCE8F8316F89EA(2, 1862763509, iLocal_289);
						unk_0x9B94F6169B0DAEFD((*iParam0)[iVar0]);
						unk_0x3C1B180EE30D36EF((*iParam0)[iVar0], Local_299 + Local_303[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					if (func_32((*iParam0)[iVar0]))
					{
						if (unk_0xAE06B9E39EBDE049(uLocal_290[iVar0]))
						{
							unk_0x315F7D8C33F0AB37(&(uLocal_290[iVar0]));
							unk_0x95178967C65CAD85(&(uLocal_290[iVar0]));
						}
						unk_0x9B94F6169B0DAEFD((*iParam0)[iVar0]);
					...
					{
						if (unk_0xF005CCA4263DF67F(&(Local_453[iVar0 /*16*/]), "any"))
						{
							if (unk_0xFDE4ABD9A796190D(Local_299 + Local_303[iVar0 /*3*/], 20f, 1))
							{
								unk_0x1AC55EB440F64E41((*iParam0)[iVar0], Local_299 + Local_303[iVar0 /*3*/], 20f, 0);
								iLocal_486[iVar0] = unk_0x578C4EF320340AF7();
							}
						}
						else
						{
							...
							unk_0x3964C1CAAE858CB1((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, iVar26);
							iLocal_486[iVar0] = unk_0x578C4EF320340AF7();
						}
					}
					else if (unk_0xAE06B9E39EBDE049(uLocal_290[iVar0]))
					{
						if (iLocal_486[iVar0] > 0)
						{
							if (unk_0x578C4EF320340AF7() > iLocal_486[iVar0] + 1000)
							{
								unk_0x315F7D8C33F0AB37(&(uLocal_290[iVar0]));
								unk_0x95178967C65CAD85(&(uLocal_290[iVar0]));
							}
	...
	while (iVar0 < 263)
	{
		if (unk_0xCE990E643CD9D0E5(Global_31346[iVar0 /*23*/].f_11, 0))
		{
			...
			else
			{
				...
				if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(uParam0, 1), Var1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (unk_0xCE990E643CD9D0E5(Global_31346[iVar0 /*23*/].f_11, 19))
				{
					...
					while (iVar4 < iVar5)
					{
						...
						if (!func_30(Var6))
						{
							if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(uParam0, 1), Var6) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_32(int iParam0)
{
	...
	if (unk_0x3628D28B8671F14F(-1, unk_0x3E4D3CCC220BDFB1(iParam0, 1), 15f))
	{
		return 1;
	}
	...
	while (iVar1 < 1)
	{
		...
		{
			if (func_33(unk_0x9B0761B4C3EB8BC7(), Local_299 + Local_313[iVar1 /*3*/], Local_317[iVar1 /*3*/], (fLocal_302 + fLocal_321[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
...
int func_33(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (unk_0x1037B9D45CE6B788(uParam0, Var0, Var3, (Param4.f_1 * 2f), iParam8, iParam9, iParam10))
	{
		return 1;
	}
	return 0;
...
int func_35(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_42(unk_0x9B0761B4C3EB8BC7()) && func_42(uParam0))
	{
...
int func_38(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_40(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
	...
	{
		Var3 = { func_40(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_41(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	...
	if (unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(uParam0, 1), fParam2, 1))
	{
		return 1;
	}
	return 0;
...
int func_48(int iParam0, int iParam1)
{
	...
	if (!unk_0x9CC4D06F5338CA6B())
	{
		...
		if (unk_0xAE06B9E39EBDE049(iParam1))
		{
			...
			fVar3 = SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0), Var0);
			if (fVar3 > 250f)
			{
...
void func_56()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_280)
		{
			...
			{
				unk_0x78FCB2E22C41B9D5(iLocal_286[iVar0]);
				if (!unk_0x7D167B9A0CCDA347(iLocal_286[iVar0]))
				{
					bVar2 = false;
					unk_0x78FCB2E22C41B9D5(iLocal_286[iVar0]);
				}
			...
			{
				unk_0x78FCB2E22C41B9D5(iLocal_293[iVar0]);
				if (!unk_0x7D167B9A0CCDA347(iLocal_293[iVar0]))
				{
					bVar2 = false;
					unk_0x78FCB2E22C41B9D5(iLocal_293[iVar0]);
				}
	...
	unk_0xDE8F8016287F771F("FIGHTERS", &iLocal_289);
	iVar0 = 0;
	while (iVar0 < iLocal_280)
	{
		if (iLocal_286[iVar0] != 0)
		{
			iLocal_280[iVar0] = unk_0xB3116B49FE00E2F1(26, iLocal_286[iVar0], Local_299 + Local_303[iVar0 /*3*/], 0, 1, 1);
			unk_0xE922BAA80E8F9324(iLocal_280[iVar0], (fLocal_302 + fLocal_310[iVar0]));
			unk_0xD93D982926D0D8B3(iLocal_280[iVar0], 0);
			if (iLocal_286[iVar0] == joaat("s_m_y_baywatch_01"))
			{
				if (unk_0x3FB4D40A857CEA77(iLocal_280[iVar0], 3) == 0)
				{
					if (unk_0x3FB4D40A857CEA77(iLocal_280[iVar0], 10) != 1)
					{
						unk_0x45F588C0DD767737(iLocal_280[iVar0], 10, 1, 0, 0);
					}
				}
				else if (unk_0x3FB4D40A857CEA77(iLocal_280[iVar0], 10) == 1)
				{
					if (unk_0x3FB4D40A857CEA77(iLocal_280[iVar0], 10) != 0)
					{
						unk_0x45F588C0DD767737(iLocal_280[iVar0], 10, 0, 0, 0);
					}
				}
			}
			unk_0xD3D9D7C84656DAE5(iLocal_280[iVar0], iLocal_289);
			unk_0xC1C7DE768F7675E5(iLocal_280[iVar0], -1);
			if (iLocal_113 == 285)
			{
				unk_0x16E50383DEE2A560(iLocal_280[iVar0], 105);
				unk_0x697DA7132EE43ABC(iLocal_280[iVar0], 105, 0);
			}
		}
		if (iLocal_293[iVar0] != 0)
		{
			uLocal_290[iVar0] = unk_0x79CC07752E7432A1(iLocal_293[iVar0], Local_299 + Local_303[iVar0 /*3*/], 1, 1, 0);
			unk_0xE922BAA80E8F9324(uLocal_290[iVar0], (fLocal_302 + fLocal_310[iVar0]));
			unk_0xF8A652CE310FFC53(uLocal_290[iVar0], iLocal_280[iVar0], unk_0xE6B87C42793036AA(iLocal_280[iVar0], iLocal_296[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	unk_0xEFBCE8F8316F89EA(2, iLocal_289, 1862763509);
...
void func_57()
{
	...
	switch (iLocal_113)
	{
		...
		case 166:
			...
			fLocal_310[0] = unk_0x658086F2B3C5E4E4(-180f, 180f);
		...
		case 259:
			Local_303[0 /*3*/] = { unk_0x658086F2B3C5E4E4(-10f, 10f), unk_0x658086F2B3C5E4E4(-10f, 10f), 0f };
			Local_303[1 /*3*/] = { unk_0x658086F2B3C5E4E4(-10f, 10f), unk_0x658086F2B3C5E4E4(-10f, 10f), 0f };
			fLocal_310[0] = unk_0x658086F2B3C5E4E4(-180f, 180f);
			fLocal_310[1] = unk_0x658086F2B3C5E4E4(-180f, 180f);
		...
		default:
			...
			iLocal_286[0] = joaat("a_m_y_musclbeac_01");
			iLocal_286[1] = joaat("a_m_y_musclbeac_01");
			Local_313[0 /*3*/] = { unk_0x658086F2B3C5E4E4(-10f, 10f), unk_0x658086F2B3C5E4E4(-10f, 10f), 0f };
			Local_317[0 /*3*/] = { 1f, 1f, 1f };
			fLocal_321[0] = unk_0x658086F2B3C5E4E4(-180f, 180f);
			break;
	}
}
...
int func_63(int iParam0, var uParam1, char* sParam2)
{
	...
	switch (iParam0)
	{
		...
		case 306:
			...
			*uParam1 = unk_0x9075769DD4F148B7(-Var8.x, -Var8.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 307:
			...
			*uParam1 = unk_0x9075769DD4F148B7(-Var11.x, -Var11.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 308:
			...
			*uParam1 = unk_0x9075769DD4F148B7(-Var14.x, -Var14.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
		...
		case 309:
			...
			*uParam1 = unk_0x9075769DD4F148B7(-Var17.x, -Var17.f_1);
			StringCopy(sParam2, "", 32);
			return 1;
			break;
...
void func_68()
{
	...
	while (iVar0 < iLocal_286)
	{
		if (iLocal_286[iVar0] != 0)
		{
			unk_0x74528AC0906CBABE(iLocal_286[iVar0]);
		}
		iVar0++;
	}
	unk_0xF4F95D084B662764(iLocal_289);
