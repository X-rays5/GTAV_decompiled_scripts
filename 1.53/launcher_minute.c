...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		unk_0xAF7D4BF357E8B79E(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0x6C68A6B31819E15F(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x555EE41D7C7078E6(Var61, 40f, 1, 0, 0, 0);
	}
	else if (Var0 == 34)
	{
		uLocal_97 = func_245();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, unk_0x3E4D3CCC220BDFB1(Var0.f_35[1], 1), 1056964608))
				{
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam8) && func_191(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_127(unk_0x9B0761B4C3EB8BC7())) && func_191(unk_0x9B0761B4C3EB8BC7(), Param1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f && *uParam10 == 1)
			{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !unk_0x9934470AA0A08B57(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && unk_0x272784C60C397DB6(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_228(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_228(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			unk_0x131ED02492676000("rcmminute1");
			unk_0x555EE41D7C7078E6(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_28[1]))
			{
				if (func_250(&(uParam0->f_28[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
					...
					unk_0x78024EFD31A7FAD4(uParam0->f_28[1], 1, 0, 0, 0);
				}
				else
				{
					bVar6 = false;
		...
		case 3:
			if (unk_0xC614DDE265D18415("rcmminute1"))
			{
				...
				if (func_127(uParam0->f_28[1]))
				{
					...
					unk_0x694113444F21E39F(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_259(int iParam0, var uParam1)
{
	if (unk_0xAE06B9E39EBDE049(uParam0))
	{
		...
		unk_0x74172B5AFD503628(iParam0, 0, 0);
		unk_0x1AB8D7ECA49F6A6C(iParam0, 1);
	}
}
...
void func_273(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0xAF7D4BF357E8B79E(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
