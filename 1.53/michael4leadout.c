			...
			switch (iLocal_21)
			{
				...
				case 2:
					if ((unk_0x7F18D7F6ED5D2492("SOL_5_MCS_2_P5") && func_100(0, 1)) && unk_0x51E339346E2220A4(unk_0x9B0761B4C3EB8BC7()))
					{
						...
						unk_0x555EE41D7C7078E6(-1590.055f, -1037.067f, 12.0186f, 4f, 1, 0, 0, 0);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_35(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
int func_102(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_103(uParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_64, Global_111858.f_2359.f_539[iVar0 /*65*/].f_63))
		{
...
int func_110(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_103(uParam0, Global_111858.f_2359.f_539[iVar0 /*65*/].f_61, Global_111858.f_2359.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_123(unk_0x36FE6D3220816ADA(uParam0), 14, iVar0, unk_0xEAF476EEF924D2C9(iParam0, 0, iParam2, iParam3)))
			{
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = unk_0x21A524CB091C80DE(iParam3, 7, -1, 0, -1, func_112(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
void func_155(int iParam0)
{
	...
	func_156(&(Global_76647[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_149(func_159(iParam1, uParam0->f_2), Global_76644, 0);
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_156(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, unk_0x4D0432E34C5996D9(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_76814)
		{
			...
			func_156(&(Global_76647[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, unk_0x4D0432E34C5996D9(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = unk_0x21A524CB091C80DE(iVar1, 7, -1, 0, -1, func_112(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_219(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	unk_0xF16CDD1D05F4411A(Param0, iParam5, 0);
	iVar0 = 0;
	while (!unk_0x0C7F95EB5CFEFB8B() && iVar0 < iParam4)
	{
		iVar0++;
		SYSTEM::WAIT(0);
	}
