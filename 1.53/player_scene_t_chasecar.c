...
int func_2()
{
	...
	if (!unk_0x7BCC91F3C1CF24E8(&Local_507))
	{
		...
		fVar3 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(uLocal_451[iVar1], 0), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 0));
...
int func_3(char[4] cParam0, var uParam1, int iParam2)
{
	...
	fVar5 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(uLocal_451[*iParam2], 0));
	if (fVar5 > (30f * 30f))
	{
		if (fVar5 > (150f * 150f))
		{
...
var func_72(int iParam0, int iParam1)
{
	...
	if (!unk_0xA59F96B50B97E63C(uParam1, 0))
	{
		...
		if (unk_0x47DBF174A0CB9D55(iParam1, 0))
		{
			...
			Var9.x = unk_0x2A51D23160D468D8(uVar13);
...
void func_89()
{
	...
	unk_0xEFBCE8F8316F89EA(3, uLocal_491, 1862763509);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_467[iVar0] != 0)
...
void func_90()
{
	...
	switch (iLocal_272)
	{
		...
		default:
			...
			Local_472[0 /*3*/] = { Vector(0f, SYSTEM::COS(fVar12), SYSTEM::SIN(fVar12)) * FtoV(unk_0x658086F2B3C5E4E4(15f, 25f)) };
			fLocal_485[0] = unk_0x658086F2B3C5E4E4(-5f, 5f);
			iLocal_490 = 0;
			iLocal_456[0] = joaat("a_m_y_genstreet_01");
			iLocal_456[1] = 0;
