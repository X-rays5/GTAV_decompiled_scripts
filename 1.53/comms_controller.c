...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_28(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
...
void func_40()
{
	...
	iVar1 = SYSTEM::CEIL((unk_0x9E3DAF75EFC49F5B() * 1000f));
...
int func_107()
{
	...
	{
		fVar0 = SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), func_108(212, 0));
		if (fVar0 > 22500f)
		{
			Global_93957 = -1;
			return 1;
...
int func_118()
{
	...
	if (!unk_0x5AEB5DDFFAD43CA5(unk_0x9B0761B4C3EB8BC7()))
	{
		if (SYSTEM::VDIST2(func_108(181, 0), unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)) > 40000f)
		{
			return 1;
		}
	}
