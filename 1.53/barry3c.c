...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_315(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
			...
			switch (iLocal_424)
			{
				...
				case 3:
					if (unk_0x578C4EF320340AF7() > iLocal_421)
					{
						...
						{
							unk_0x2DB2D4C3CB88500D(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0xD4974F3117C9F232(uLocal_426, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_425 * 250)) / 1000f));
