...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0x77EEA044DF18081A(Var477, Var477.f_18, Var477.f_21, Var477.f_24, Var477.f_24, 2);
		}
		...
		if (!unk_0x5AEB5DDFFAD43CA5(uLocal_263[0]))
		{
			...
			switch (Var0)
			{
				...
				case 1:
					if (SYSTEM::TIMERA() > 500 && !unk_0xCED6B5226244381C(unk_0x9B0761B4C3EB8BC7()))
					{
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_33();
		unk_0x8DDE075026DB7EFD(0.5f, (fVar1 - (func_37((2f - 0.5f)) - 0.001388889f)), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_37(25f))), 0f, 1f);
					func_33();
					unk_0x8DDE075026DB7EFD(0.5f, (fVar1 + func_37((2f * 0.5f))), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_37((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_37((25f * 0.2f)));
...
void func_246(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			else if (SYSTEM::TIMERA() > unk_0x344C570D6F8700DF(1250, 2500))
			{
				func_289(&(uParam0->f_422), &(uParam0->f_249));
				func_286(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), 0);
			}
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else
	{
		...
		*uParam0 = unk_0x79CC07752E7432A1(uParam0->f_1, Local_79, 0, 0, 0);
		...
		fVar2 = unk_0x9075769DD4F148B7((Var7.x - Var10.x), (Var7.f_1 - Var10.f_1));
		fVar2 = (fVar2 - 180f);
...
int func_302(var uParam0, var uParam1, bool bParam2)
{
	...
	fVar11 = unk_0x9075769DD4F148B7((Var3.x - Var6.x), (Var3.f_1 - Var6.f_1));
	fVar11 = (fVar11 - 180f);
	fVar9 = 90f;
...
int func_305(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch (*uParam2)
	{
		...
		case 1:
			if (SYSTEM::TIMERB() > 3000 || unk_0x1BD7199394D7F19A(2, 201))
			{
				func_306();
				*uParam2 = 0;
				return 1;
