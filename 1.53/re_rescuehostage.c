			...
			switch (iLocal_47)
			{
				...
				case 3:
					...
					else
					{
						...
						if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), Local_48) > 5625f && !unk_0x9A70B1BD2A5BA09C(Local_48, 10f))
						{
							func_28();
						}
					}
...
int func_58(int iParam0)
{
	...
	if (bVar1)
	{
		...
		{
			if (SYSTEM::VDIST(unk_0x3E4D3CCC220BDFB1(iParam0, 1), func_59(unk_0x460153A63B9477BC())) < 8f)
			{
				return 1;
			}
		}
...
bool func_64()
{
	...
	if (bVar1)
	{
		...
		fVar11 = unk_0x9075769DD4F148B7(Var2.x, Var2.f_1);
...
int func_89()
{
	...
	{
		if (SYSTEM::VMAG2(unk_0x97C0B1E5FCD8E08A(unk_0x9B0761B4C3EB8BC7())) > 1369f && !func_96())
		{
			return 0;
		}
	}
