...
void func_1()
{
	...
	{
		case 0:
			if ((unk_0x578C4EF320340AF7() - iLocal_187) > 5000 && unk_0xCDF860E56BBCC6B4(uLocal_188, unk_0x9B0761B4C3EB8BC7(), 1))
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					unk_0xBB7976F6FB9C9DD2(uLocal_188);
					iLocal_21 = 1;
				}
			}
			else if ((unk_0x578C4EF320340AF7() - iLocal_187) > 12000 && SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(uLocal_188, 1)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (SYSTEM::VDIST2(unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1), unk_0x3E4D3CCC220BDFB1(uLocal_188, 1)) >= (fVar0 * fVar0) && !unk_0xA38BFCB05DBE439D(uLocal_188))
	{
		return 0;
	}
	return 1;
...
int func_24()
{
	if (unk_0xAE06B9E39EBDE049(uLocal_188))
	{
		if (!unk_0x5AEB5DDFFAD43CA5(uLocal_188))
		{
			return 1;
		}
	}
...
int func_31()
{
	...
	{
		iVar17 = unk_0x3214CDFE45D11916(unk_0x9B0761B4C3EB8BC7(), &uVar0, -1);
		iVar18 = 0;
		while (iVar18 <= (iVar17 - 1))
		{
			if (uVar0[iVar18] != 0 && unk_0xAE06B9E39EBDE049(uVar0[iVar18]))
			{
				if (unk_0x36FE6D3220816ADA(uVar0[iVar18]) == joaat("u_m_m_aldinapoli"))
				{
					unk_0x4F3C4F457D44BB0F(uVar0[iVar18], 1, 1);
...
void func_32()
{
	...
	if (unk_0xAE06B9E39EBDE049(uLocal_188))
	{
		unk_0x2481907DEE6B85EA(&uLocal_188);
	}
