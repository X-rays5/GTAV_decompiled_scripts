...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(unk_0xCE990E643CD9D0E5(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (func_127(unk_0x9B0761B4C3EB8BC7()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			if (unk_0xAE06B9E39EBDE049(iParam0->f_28[iVar0]))
			{
				...
				{
					if (unk_0xCDF860E56BBCC6B4(iParam0->f_28[iVar0], unk_0x9B0761B4C3EB8BC7(), 1) || unk_0xC7EB33BFDB436C87(unk_0x3E4D3CCC220BDFB1(iParam0->f_28[iVar0], 1), 7.5f, 1))
					{
						if (func_179(2))
						{
							func_176(iParam0->f_27, *iParam0);
...
{
	if (func_190(uParam1, unk_0x3E4D3CCC220BDFB1(unk_0x9B0761B4C3EB8BC7(), 1)))
	{
		if (func_179(2))
		{
			if (func_177(iParam0->f_27))
...
void func_191(int iParam0, var uParam1, var uParam2)
{
	if (func_127(*uParam1))
	{
		...
		{
			case 0:
				if (unk_0x8B917081F9836EDD("CAR_TRUNK_THUMPS", 0, -1))
				{
			...
			case 1:
				...
				{
					unk_0x057194D526464DC0(iParam0->f_1, "TRUNK_THUMPS", unk_0x7EC595B99EA7C4B1(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
			...
			case 2:
				if ((unk_0x578C4EF320340AF7() - iParam0->f_6) > iParam0->f_7)
				{
					...
					iParam0->f_9 = (0.5f * SYSTEM::TO_FLOAT(unk_0x344C570D6F8700DF(-2, 3)));
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(unk_0x9B0761B4C3EB8BC7()) && func_127(iParam0->f_28[0])) && !func_145()) && (unk_0x578C4EF320340AF7() - iParam0->f_60) > iParam8) && func_197(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_198(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_179(2))
		{
			...
			else if (((func_200(sParam5) && !*uParam10 == 1) && func_127(unk_0x9B0761B4C3EB8BC7())) && func_197(unk_0x9B0761B4C3EB8BC7(), Param1, 1) >= 20f)
			{
				func_316("pause conversation");
				func_199(1);
				*uParam10 = 1;
			}
			if (func_197(unk_0x9B0761B4C3EB8BC7(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_230(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_232(unk_0x3E4D3CCC220BDFB1(iParam1, 1) - unk_0x3E4D3CCC220BDFB1(iParam0, 1)) };
	...
	{
		Var3 = { func_232(unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 5f, 0f) - unk_0x1D5C49FCA9BC5B02(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_239(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_232(Param1 - unk_0x3E4D3CCC220BDFB1(uParam0, 1)) };
		...
		case 2:
			...
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					...
					unk_0x4C5D57B67B567ADC(uParam0->f_35[0], 5, 0);
...
int func_252(var uParam0, var uParam1)
{
	...
	if (unk_0xAE06B9E39EBDE049(*uParam1) && unk_0x7D167B9A0CCDA347(iLocal_94))
	{
		*uParam0 = unk_0xB3116B49FE00E2F1(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		...
		fVar6 = (-90f + unk_0xEF7858F25585F853(*uParam1));
		Var3 = { 0f, 0f, fVar6 };
		unk_0xCBF81D3222C77066(*uParam0, Var0, 0, 0, 1);
		unk_0xC82085403E46A869(*uParam0, Var3, 2, 1);
...
int func_266(var uParam0, var uParam1)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_259(&iVar0) || !unk_0xC614DDE265D18415(uParam0->f_48)) || !unk_0xC614DDE265D18415(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x78024EFD31A7FAD4(uParam0->f_28[0], 0, 0, 0, 0);
...
int func_270(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_259(&iVar0) || !unk_0xC614DDE265D18415(sVar4))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			unk_0x756D74A3EF0AB788(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			unk_0x756D74A3EF0AB788(0, sVar4, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_271(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			if (!unk_0xAE06B9E39EBDE049(uParam0->f_35[0]))
			{
				...
				if (func_127(uParam0->f_35[0]))
				{
					...
					unk_0x4C5D57B67B567ADC(uParam0->f_35[0], 2, 0);
					unk_0xFF90B7B5F1AF504A(uParam0->f_35[0], 2, 0, 1);
			...
			if (func_127(uParam0->f_35[0]))
			{
				fVar9 = unk_0x24B1E142845E309A(uParam0->f_35[0], 2);
				if (!unk_0x7B84A40BAD2721BA(uParam0->f_35[0], 2) && fVar9 < 0.8f)
				{
					unk_0x7C3ECA5C7ACE0DDB(uParam0->f_35[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_127(uParam0->f_35[0]))
			{
				if (!unk_0x9934470AA0A08B57(uParam0->f_35[0], sVar8, "idle_speedo", 3))
				{
					if (unk_0xC614DDE265D18415(sVar8))
					{
						unk_0x2D9E9D93316D78E1(uParam0->f_35[0], sVar8, "idle_speedo");
						return 0;
					}
					else
					{
			...
			if (func_126(uParam0->f_28[0]))
			{
				...
				unk_0x756D74A3EF0AB788(uParam0->f_28[0], sVar8, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			...
			if (func_126(uParam0->f_28[2]))
			{
				...
				if (unk_0xC614DDE265D18415(sVar8))
				{
					unk_0x756D74A3EF0AB788(uParam0->f_28[2], sVar8, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			...
			if (func_127(uParam0->f_41[0]))
			{
				...
				unk_0xC62EE91883AF24A2(uParam0->f_41[0], 0);
				unk_0x0312E5501F93E5AB(uParam0->f_41[0], 1);
...
int func_275(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_262(38, 1);
			uVar9 = unk_0xC519B5898C2310B1(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0x0B1B45E748AD48BA(uVar9))
			{
				unk_0x35BA1F33F01303F1(iVar9);
			}
			iVar8 = 0;
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x78FCB2E22C41B9D5(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x131ED02492676000(uParam0->f_48);
			iLocal_91 = 1;
		...
		case 2:
			...
			if (func_126(uParam0->f_28[1]))
			{
				unk_0x0DC39BE87E4C5599(uParam0->f_28[1], 0);
			...
			while (iVar8 <= (iVar0 - 1))
			{
				unk_0x74528AC0906CBABE(iVar0[iVar8]);
				iVar8++;
			}
			unk_0x1082C25039B168F8(uParam0->f_48);
			return 1;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(uParam0->f_28[1]))
			{
				unk_0x4E65320BC9AD521C(uParam0->f_28[0], 1);
				unk_0x4E65320BC9AD521C(uParam0->f_28[1], 1);
				uVar5 = unk_0xF341A134A5B8D4F6(-1100.558f, 789.8862f, 163.3285f, 0f, 0f, 0f, 2);
				unk_0xDFDB9C533700BC17(uParam0->f_28[0], uVar5, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				unk_0xDFDB9C533700BC17(uParam0->f_28[1], uVar5, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
void func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	if (unk_0x8F678487EEBD8CE4(uLocal_109))
	{
		unk_0x93370FA10F15BE44(&uLocal_109);
	}
	if (bParam2)
	{
